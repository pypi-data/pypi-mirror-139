...
class ApplicationAssignment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, org_id, environment_name, *args, **kwargs):  # noqa: E501
        """ApplicationAssignment - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): The unique identifier for the assignment.. [optional]  # noqa: E501
            application_name (str): The display name for the application for which to give access. Provided on get for convenience. Do not set the field for modifying operations as it will be ignored. . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, org_id, environment_name, *args, **kwargs):  # noqa: E501
        """ApplicationAssignment - a model defined in OpenAPI
