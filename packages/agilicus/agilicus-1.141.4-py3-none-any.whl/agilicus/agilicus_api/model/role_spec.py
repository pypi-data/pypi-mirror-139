...
def lazy_import():
    ...
    globals()['IncludedRole'] = IncludedRole


class RoleSpec(ModelNormal):
    ...
    @included.setter
    def included(self, new_value):
       self.included = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'included': ([IncludedRole],),  # noqa: E501
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """RoleSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comments (str): A description of the role. The comments have no functional effect, but can help to clarify the purpose of a role when the name is not sufficient. . [optional]  # noqa: E501
            included ([IncludedRole]): A list of included rules for the role. This role will grant permissions for all rules associated directly with itself, and with its included roles. Note that the inclusion is recursive: a role will get the rules of roles it includes, and the roles that they include, and so on. The roles are included by ID . [optional]  # noqa: E501
