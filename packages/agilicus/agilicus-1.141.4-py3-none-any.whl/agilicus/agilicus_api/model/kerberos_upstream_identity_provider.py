...
def lazy_import():
    ...
    globals()['KerberosUpstreamStatus'] = KerberosUpstreamStatus


class KerberosUpstreamIdentityProvider(ModelNormal):
    ...
    @property
    def keytab(self):
       return self.get("keytab")

    @keytab.setter
    def keytab(self, new_value):
       self.keytab = new_value
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, keytab, *args, **kwargs):  # noqa: E501
        """KerberosUpstreamIdentityProvider - a model defined in OpenAPI

        Args:
            keytab (str): A base64 encoded keytab
        ...
        Keyword Args:
            ...
            status (KerberosUpstreamStatus): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, keytab, *args, **kwargs):  # noqa: E501
        """KerberosUpstreamIdentityProvider - a model defined in OpenAPI
