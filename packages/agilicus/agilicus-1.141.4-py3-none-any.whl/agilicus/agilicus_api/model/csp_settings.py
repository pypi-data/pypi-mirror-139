...
def lazy_import():
    ...
    globals()['CSPDirective'] = CSPDirective


class CSPSettings(ModelNormal):
    ...
    @directives.setter
    def directives(self, new_value):
       self.directives = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'mode': (str,),  # noqa: E501
            'directives': ([CSPDirective],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, enabled, mode, directives, *args, **kwargs):  # noqa: E501
        """CSPSettings - a model defined in OpenAPI
        ...
        Args:
            ...
            directives ([CSPDirective]): The directives which make up the policy. The system merges each directive into a single header by separating them with the `;` character. Duplicate directives will be merged with later directives in the array being appended to earlier ones. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, enabled, mode, directives, *args, **kwargs):  # noqa: E501
        """CSPSettings - a model defined in OpenAPI
