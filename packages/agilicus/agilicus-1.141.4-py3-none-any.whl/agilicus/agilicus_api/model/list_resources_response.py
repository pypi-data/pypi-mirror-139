...
class ListResourcesResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resources, limit, *args, **kwargs):  # noqa: E501
        """ListResourcesResponse - a model defined in OpenAPI

        Args:
            resources ([Resource]): The list of matching resources
    ...
    @convert_js_args_to_python_args
    def __init__(self, resources, limit, *args, **kwargs):  # noqa: E501
        """ListResourcesResponse - a model defined in OpenAPI
