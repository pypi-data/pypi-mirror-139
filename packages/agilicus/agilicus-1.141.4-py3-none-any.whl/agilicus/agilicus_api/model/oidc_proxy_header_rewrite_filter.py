...
def lazy_import():
    ...
    globals()['URIParameterRewriteFilter'] = URIParameterRewriteFilter


class OIDCProxyHeaderRewriteFilter(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'URIParameterRewriteFilter': URIParameterRewriteFilter,
            'uriParameterRewrite': URIParameterRewriteFilter,
        }
        if not val:
            return None
        return {'rewrite_type': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OIDCProxyHeaderRewriteFilter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            rewrite_type (str): [optional]  # noqa: E501
