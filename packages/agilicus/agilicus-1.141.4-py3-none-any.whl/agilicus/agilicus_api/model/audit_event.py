...
class AuditEvent(ModelNormal):
    ...
    @create_time.setter
    def create_time(self, new_value):
       self.create_time = new_value
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, unique_id, create_time, event, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, unique_id, create_time, event, *args, **kwargs):  # noqa: E501
        """AuditEvent - a model defined in OpenAPI
