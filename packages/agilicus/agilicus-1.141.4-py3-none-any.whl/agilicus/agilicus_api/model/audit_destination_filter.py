...
class AuditDestinationFilter(ModelNormal):
    ...
    def filter_type(self):
       return self.get("filter_type")

    @filter_type.setter
    def filter_type(self, new_value):
       self.filter_type = new_value
    ...
    @property
    def or_list(self):
       return self.get("or_list")

    @or_list.setter
    def or_list(self, new_value):
       self.or_list = new_value
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, filter_type, *args, **kwargs):  # noqa: E501
        """AuditDestinationFilter - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, filter_type, *args, **kwargs):  # noqa: E501
        """AuditDestinationFilter - a model defined in OpenAPI
