...
class DesktopResourceSpec(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, address, org_id, *args, **kwargs):  # noqa: E501
        ...
        desktop_type = kwargs.get('desktop_type', "rdp")
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, address, org_id, *args, **kwargs):  # noqa: E501
        """DesktopResourceSpec - a model defined in OpenAPI
