...
class Rule(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, method, path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            host (str): hostname to apply authz rule to. Deprecated. This is now inferred from the Environment or Service to which the rule belongs. . [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, method, path, *args, **kwargs):  # noqa: E501
        """Rule - a model defined in OpenAPI
