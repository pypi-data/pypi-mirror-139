...
def lazy_import():
    ...
    globals()['UpstreamUserIdentitySpec'] = UpstreamUserIdentitySpec


class UpstreamUserIdentity(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (UpstreamUserIdentitySpec,),  # noqa: E501
    ...
    def _from_openapi_data(cls, spec, *args, **kwargs):  # noqa: E501
        """UpstreamUserIdentity - a model defined in OpenAPI
