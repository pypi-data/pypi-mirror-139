...
class ListUpstreamUserIdentitiesResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, upstream_user_identities, limit, *args, **kwargs):  # noqa: E501
        """ListUpstreamUserIdentitiesResponse - a model defined in OpenAPI

        Args:
            upstream_user_identities ([UpstreamUserIdentity]): The matching UpstreamUserIdentity objects
    ...
    @convert_js_args_to_python_args
    def __init__(self, upstream_user_identities, limit, *args, **kwargs):  # noqa: E501
        """ListUpstreamUserIdentitiesResponse - a model defined in OpenAPI
