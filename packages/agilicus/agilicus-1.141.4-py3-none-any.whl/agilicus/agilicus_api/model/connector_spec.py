...
class ConnectorSpec(ModelNormal):
    ...
    def connector_type(self, new_value):
       self.connector_type = new_value
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, org_id, connector_type, *args, **kwargs):  # noqa: E501
        """ConnectorSpec - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, org_id, connector_type, *args, **kwargs):  # noqa: E501
        """ConnectorSpec - a model defined in OpenAPI
