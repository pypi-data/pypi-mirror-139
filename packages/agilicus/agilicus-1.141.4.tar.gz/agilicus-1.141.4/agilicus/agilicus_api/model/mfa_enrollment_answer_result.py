...
class MFAEnrollmentAnswerResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, supported_mfa_methods, *args, **kwargs):  # noqa: E501
        """MFAEnrollmentAnswerResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, supported_mfa_methods, *args, **kwargs):  # noqa: E501
        """MFAEnrollmentAnswerResult - a model defined in OpenAPI
