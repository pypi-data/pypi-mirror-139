...
class TemplatePath(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, template, prefix, *args, **kwargs):  # noqa: E501
        """TemplatePath - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, template, prefix, *args, **kwargs):  # noqa: E501
        """TemplatePath - a model defined in OpenAPI
