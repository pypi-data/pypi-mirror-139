...
class AuditEventResponse(ModelNormal):
    ...
    def status_message(self, new_value):
    ...
    def openapi_types():
        ...
        return {
            ...
            'event': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, unique_id, status, *args, **kwargs):  # noqa: E501
        """AuditEventResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status_message (bool, date, datetime, dict, float, int, list, str, none_type): An optional message describing what happened with the event. This can be useful for diagnostics. . [optional]  # noqa: E501
            event ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The primary contents of the audit event. Optional for an audit response. Returning this can help with diagnostics, but it is not necessary. . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, unique_id, status, *args, **kwargs):  # noqa: E501
        """AuditEventResponse - a model defined in OpenAPI
