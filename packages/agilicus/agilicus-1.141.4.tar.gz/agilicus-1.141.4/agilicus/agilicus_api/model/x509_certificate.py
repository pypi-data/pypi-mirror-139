...
def lazy_import():
    ...
    globals()['X509CertificateSpec'] = X509CertificateSpec
    globals()['X509CertificateStatus'] = X509CertificateStatus


class X509Certificate(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (X509CertificateSpec,),  # noqa: E501
            'metadata': (MetadataWithId,),  # noqa: E501
            'status': (X509CertificateStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, spec, *args, **kwargs):  # noqa: E501
        """X509Certificate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (X509CertificateStatus): [optional]  # noqa: E501
        """
