...
class OIDCProxyDomainNameMapping(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, internal_name, *args, **kwargs):  # noqa: E501
        """OIDCProxyDomainNameMapping - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            external_name (str): The external domain name that we want to be exposed.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, internal_name, *args, **kwargs):  # noqa: E501
        """OIDCProxyDomainNameMapping - a model defined in OpenAPI
