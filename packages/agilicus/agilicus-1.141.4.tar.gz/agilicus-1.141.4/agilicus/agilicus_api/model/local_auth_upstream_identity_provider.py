...
class LocalAuthUpstreamIdentityProvider(ModelNormal):
    ...
    def upstream_id(self):
       return self.get("upstream_id")

    @upstream_id.setter
    def upstream_id(self, new_value):
       self.upstream_id = new_value
    ...
    attribute_map = {
        'upstream_id': 'upstream_id',  # noqa: E501
        'name': 'name',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, upstream_id, *args, **kwargs):  # noqa: E501
        """LocalAuthUpstreamIdentityProvider - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, upstream_id, *args, **kwargs):  # noqa: E501
        """LocalAuthUpstreamIdentityProvider - a model defined in OpenAPI
