...
def lazy_import():
    ...
    globals()['ResourceMember'] = ResourceMember


class ResourceSpec(ModelNormal):
    ...
    def not_assignable_perm(self):
       return self.get("not_assignable_perm")

    @not_assignable_perm.setter
    def not_assignable_perm(self, new_value):
       self.not_assignable_perm = new_value
    ...
    @property
    def resource_members(self):
       return self.get("resource_members")

    @resource_members.setter
    def resource_members(self, new_value):
       self.resource_members = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'not_assignable_perm': (bool,),  # noqa: E501
            'config': (ResourceConfig,),  # noqa: E501
            'resource_members': ([ResourceMember],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'not_assignable_perm': 'not_assignable_perm',  # noqa: E501
        'config': 'config',  # noqa: E501
        'resource_members': 'resource_members',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, resource_type, org_id, *args, **kwargs):  # noqa: E501
        """ResourceSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            not_assignable_perm (bool): Most resources can be assigned permission. However when a resource cannot be assigned a permission, this field is used (set to true), which notifies consumers of this API that the resource cannot be assigned a permission. This field defaults to false. . [optional]  # noqa: E501
            config (ResourceConfig): [optional]  # noqa: E501
            resource_members ([ResourceMember]): A list of resources that are contained or associated with this Resource.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, resource_type, org_id, *args, **kwargs):  # noqa: E501
        """ResourceSpec - a model defined in OpenAPI
