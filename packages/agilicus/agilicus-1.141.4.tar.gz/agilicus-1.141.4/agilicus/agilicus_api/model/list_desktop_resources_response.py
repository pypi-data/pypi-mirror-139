...
class ListDesktopResourcesResponse(ModelNormal):
    ...
    def desktop_resources(self):
       return self.get("desktop_resources")

    @desktop_resources.setter
    def desktop_resources(self, new_value):
       self.desktop_resources = new_value
    ...
    def _from_openapi_data(cls, limit, *args, **kwargs):  # noqa: E501
        """ListDesktopResourcesResponse - a model defined in OpenAPI
