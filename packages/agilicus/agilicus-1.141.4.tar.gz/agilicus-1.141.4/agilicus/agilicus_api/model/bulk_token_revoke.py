...
class BulkTokenRevoke(ModelNormal):
    ...
    def _from_openapi_data(cls, user_id, *args, **kwargs):  # noqa: E501
        """BulkTokenRevoke - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            org_id (str): The unique id of the Organisation from which to revoke tokens . [optional]  # noqa: E501
            session_id (str): The unique id of the session from which to revoke tokens . [optional]  # noqa: E501
        """
