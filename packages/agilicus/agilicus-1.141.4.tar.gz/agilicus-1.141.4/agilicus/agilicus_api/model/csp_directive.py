...
class CSPDirective(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, values, *args, **kwargs):  # noqa: E501
        """CSPDirective - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, values, *args, **kwargs):  # noqa: E501
        """CSPDirective - a model defined in OpenAPI
