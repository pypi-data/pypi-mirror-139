...
class BulkUserMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, org_id, data_type, data, *args, **kwargs):  # noqa: E501
        """BulkUserMetadata - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, org_id, data_type, data, *args, **kwargs):  # noqa: E501
        """BulkUserMetadata - a model defined in OpenAPI
