...
class AgentConnectorSpecificStats(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, system, transport, *args, **kwargs):  # noqa: E501
        """AgentConnectorSpecificStats - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, system, transport, *args, **kwargs):  # noqa: E501
        """AgentConnectorSpecificStats - a model defined in OpenAPI
