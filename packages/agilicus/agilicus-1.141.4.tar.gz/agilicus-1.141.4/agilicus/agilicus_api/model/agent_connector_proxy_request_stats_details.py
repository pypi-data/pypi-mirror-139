...
class AgentConnectorProxyRequestStatsDetails(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, started, finished, status_1xx, status_2xx, status_3xx, status_4xx, status_5xx, status_unknown, failed_authentication, failed_authorisation, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, started, finished, status_1xx, status_2xx, status_3xx, status_4xx, status_5xx, status_unknown, failed_authentication, failed_authorisation, *args, **kwargs):  # noqa: E501
        """AgentConnectorProxyRequestStatsDetails - a model defined in OpenAPI
