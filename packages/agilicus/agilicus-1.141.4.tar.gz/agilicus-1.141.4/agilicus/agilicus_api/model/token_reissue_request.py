...
class TokenReissueRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, token, org_id, *args, **kwargs):  # noqa: E501
        """TokenReissueRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, token, org_id, *args, **kwargs):  # noqa: E501
        """TokenReissueRequest - a model defined in OpenAPI
