...
def lazy_import():
    ...
    globals()['MFAChallengeMethodSpec'] = MFAChallengeMethodSpec
    globals()['MetadataWithId'] = MetadataWithId


class MFAChallengeMethod(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (MFAChallengeMethodSpec,),  # noqa: E501
    ...
    def _from_openapi_data(cls, spec, *args, **kwargs):  # noqa: E501
        """MFAChallengeMethod - a model defined in OpenAPI
