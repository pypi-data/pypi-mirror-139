...
class baasAutoWeb():
    ...
    def open_url(self, url):
        ...
        '''
        try:
            self.drive.openUrl(url)
            return True
        except Exception as e:
            return e
        
        
    def login(self, login_type, username, password, url):
        '''
        用户登录---区分管理端和用户端
        :param login_type:
        :param username:
...
# #     pass
#     baas = baasAutoWeb(driver="chrome")
#     baas.add_user('gideon-1', '123qaz', 'asfwfe@sdf.ds', 'user')
