                  ...
                  `:null!==(e=t.children)&&void 0!==e&&e.length?"grid"===l.layout?i.dy`
                        ...
                        ${t.children.map((e=>i.dy`
                            ...
                            >
                              <div
                                ...
                                data-src=${(0,a.o)(o.show_list_images&&e.thumbnail?e.thumbnail:void 0)}
                                slot="graphic"
                              >
                                <ha-icon-button
                    ...
                    <div class="container no-items">
                      ...
                      ${"media-source://media_source/local/."===t.media_content_id?i.dy`<br />${this.hass.localize("ui.components.media-browser.learn_adding_local_media","documentation",i.dy`<a
                                href=${(0,v.R)(this.hass,"/more-info/local-media/add-media")}
                                target="_blank"
                                rel="noreferrer"
    ...
    `}},{kind:"method",key:"firstUpdated",value:function(){this._measureCard(),this._attachResizeObserver()}},{kind:"method",key:"shouldUpdate",value:function(e){if(e.size>1||!e.has("hass"))return!0;const t=e.get("hass");return void 0===t||t.localize!==this.hass.localize}},{kind:"method",key:"willUpdate",value:function(e){var t;if($(P(r.prototype),"willUpdate",this).call(this,e),e.has("entityId")&&this._setError(void 0),!e.has("navigateIds"))return;this._setError(void 0);const i=e.get("navigateIds");null===(t=this._content)||void 0===t||t.scrollTo(0,0),this._scrolled=!1;const o=this._currentItem,n=this._parentItem;this._currentItem=void 0,this._parentItem=void 0;const a=this.navigateIds[this.navigateIds.length-1],s=this.navigateIds.length>1?this.navigateIds[this.navigateIds.length-2]:void 0;let c,d;e.has("entityId")||(i&&this.navigateIds.length>i.length&&i.every(((e,t)=>{const r=this.navigateIds[t];return r.media_content_id===e.media_content_id&&r.media_content_type===e.media_content_type}))?d=Promise.resolve(o):i&&this.navigateIds.length<i.length&&this.navigateIds.every(((e,t)=>{const r=i[t];return e.media_content_id===r.media_content_id&&e.media_content_type===r.media_content_type}))&&(c=Promise.resolve(n))),c||(c=this._fetchData(this.entityId,a.media_content_id,a.media_content_type)),c.then((e=>{this._currentItem=e,(0,l.B)(this,"media-browsed",{ids:this.navigateIds,current:e})}),(e=>this._setError(e))),d||void 0===s||(d=this._fetchData(this.entityId,s.media_content_id,s.media_content_type)),d&&d.then((e=>{this._parentItem=e}))}},{kind:"method",key:"updated",value:function(e){$(P(r.prototype),"updated",this).call(this,e),e.has("_scrolled")?this._animateHeaderHeight():e.has("_currentItem")&&(this._setHeaderHeight(),this._attachIntersectionObserver())}},{kind:"method",key:"_actionClicked",value:function(e){e.stopPropagation();const t=e.currentTarget.item;this._runAction(t)}},{kind:"method",key:"_runAction",value:function(e){(0,l.B)(this,"media-picked",{item:e})}},{kind:"method",key:"_childClicked",value:async function(e){const t=e.currentTarget.item;t&&(t.can_expand?(0,l.B)(this,"media-browsed",{ids:[...this.navigateIds,t]}):this._runAction(t))}},{kind:"method",key:"_fetchData",value:async function(e,t,r){return e!==p.N8?(0,p.zz)(this.hass,e,t,r):(0,y.b)(this.hass,t)}},{kind:"method",key:"_measureCard",value:function(){this._narrow=(this.dialog?window.innerWidth:this.offsetWidth)<450}},{kind:"method",key:"_attachResizeObserver",value:async function(){this._resizeObserver||(await(0,m.P)(),this._resizeObserver=new ResizeObserver((0,d.D)((()=>this._measureCard()),250,!1))),this._resizeObserver.observe(this)}},{kind:"method",key:"_attachIntersectionObserver",value:async function(){if(!("IntersectionObserver"in window)||!this._thumbnails)return;this._intersectionObserver||(this._intersectionObserver=new IntersectionObserver((async(e,t)=>{await Promise.all(e.map((async e=>{if(!e.isIntersecting)return;const r=e.target;let i=r.dataset.src;if(i){if(i.startsWith("/")){i=(await(0,h.iI)(this.hass,i)).path}r.style.backgroundImage=`url(${i})`,t.unobserve(r)}})))})));const e=this._intersectionObserver;for(const t of this._thumbnails)e.observe(t)}},{kind:"method",key:"_closeDialogAction",value:function(){(0,l.B)(this,"close-dialog")}},{kind:"method",key:"_setError",value:function(e){this.dialog?e&&(this._closeDialogAction(),(0,u.Ys)(this,{title:this.hass.localize("ui.components.media-browser.media_browsing_error"),text:this._renderError(e)})):this._error=e}},{kind:"method",key:"_renderError",value:function(e){return"Media directory does not exist."===e.message?i.dy`
        ...
        <p>
          ...
          ${this.hass.localize("ui.components.media-browser.setup_local_help","documentation",i.dy`<a
              href=${(0,v.R)(this.hass,"/more-info/local-media/setup-media")}
              target="_blank"
              rel="noreferrer"
              >${this.hass.localize("ui.components.media-browser.documentation")}</a
            >`)}
      ...
      `]}}]}}),i.oi)},72371:(e,t,r)=>{r.d(t,{u:()=>i,b:()=>o});const i=(e,t)=>e.callWS({type:"media_source/resolve_media",media_content_id:t}),o=(e,t)=>e.callWS({type:"media_source/browse_media",media_content_id:t})},27322:(e,t,r)=>{r.d(t,{R:()=>i});const i=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`}}]);
//# sourceMappingURL=d2c30e69.js.map