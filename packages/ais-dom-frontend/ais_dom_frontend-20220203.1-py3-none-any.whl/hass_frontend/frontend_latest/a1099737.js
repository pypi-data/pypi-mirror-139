/*! For license information please see a1099737.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[85199],{39841:(e,t,r)=>{r(94604),r(65660);var i=r(9672),n=r(87156),o=r(50856),a=r(44181);(0,i.k)({_template:o.d`
    <style>
      :host {
        display: block;
        /**
...
`,is:"app-header-layout",behaviors:[a.Y],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return(0,n.vz)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var e=this.header;if(this.isAttached&&e){this.$.wrapper.classList.remove("initializing"),e.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var t=e.offsetHeight;this.hasScrollingRegion?(e.style.left="",e.style.right=""):requestAnimationFrame(function(){var t=this.getBoundingClientRect(),r=document.documentElement.clientWidth-t.right;e.style.left=t.left+"px",e.style.right=r+"px"}.bind(this));var r=this.$.contentContainer.style;e.fixed&&!e.condenses&&this.hasScrollingRegion?(r.marginTop=t+"px",r.paddingTop=""):(r.paddingTop=t+"px",r.marginTop="")}}})},27269:(e,t,r)=>{r.d(t,{p:()=>i});const i=e=>e.substr(e.indexOf(".")+1)},22311:(e,t,r)=>{r.d(t,{N:()=>n});var i=r(58831);const n=e=>(0,i.M)(e.entity_id)},91741:(e,t,r)=>{r.d(t,{C:()=>n});var i=r(27269);const n=e=>void 0===e.attributes.friendly_name?(0,i.p)(e.entity_id).replace(/_/g," "):e.attributes.friendly_name||""},27849:(e,t,r)=>{r(39841);var i=r(50856);r(28426);class n extends(customElements.get("app-header-layout")){static get template(){return i.d`
    ...
    `}},{kind:"method",key:"_openZonesEditor",value:function(){(0,a.c)("/config/zone")}},{kind:"method",key:"willUpdate",value:function(e){if(y(v(r.prototype),"willUpdate",this).call(this,e),!e.has("hass"))return;const t=e.get("hass");this._getStates(t)}},{kind:"method",key:"_getStates",value:function(e){let t=!1;const r=new Set,i=[];Object.values(this.hass.states).forEach((n=>{"home"!==n.state&&"latitude"in n.attributes&&"longitude"in n.attributes&&(i.push(n.entity_id),"person"===(0,o.N)(n)&&n.attributes.source&&r.add(n.attributes.source),(null==e?void 0:e.states[n.entity_id])!==n&&(t=!0))})),t&&(this._entities=i.filter((e=>!r.has(e))))}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,i.iv`
        ha-map {
          height: calc(100vh - var(--header-height));
        }
      `]}}]}}),i.oi);customElements.define("ha-panel-map",g)}}]);
//# sourceMappingURL=a1099737.js.map