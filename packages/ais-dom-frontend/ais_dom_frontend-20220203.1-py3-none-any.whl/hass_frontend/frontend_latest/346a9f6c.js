/*! For license information please see 346a9f6c.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[36215,93098,11139,5713,22946,92887],{38323:(e,t,i)=>{i(94604);(0,i(9672).k)({is:"iron-media-query",properties:{queryMatches:{type:Boolean,value:!1,readOnly:!0,notify:!0},query:{type:String,observer:"queryChanged"},full:{type:Boolean,value:!1},_boundMQHandler:{value:function(){return this.queryHandler.bind(this)}},_mq:{value:null}},attached:function(){this.style.display="none",this.queryChanged()},detached:function(){this._remove()},_add:function(){this._mq&&this._mq.addListener(this._boundMQHandler)},_remove:function(){this._mq&&this._mq.removeListener(this._boundMQHandler),this._mq=null},queryChanged:function(){this._remove();var e=this.query;e&&(this.full||"("===e[0]||(e="("+e+")"),this._mq=window.matchMedia(e),this._add(),this.queryHandler(this._mq))},queryHandler:function(e){this._setQueryMatches(e.matches)}})},8878:(e,t,i)=>{i(94604),i(8621),i(63207),i(30879),i(78814),i(60748),i(57548),i(73962);var a=i(51644),o=i(26110),n=i(21006),s=i(98235),r=i(18890),l=i(9672),d=i(87156),h=i(81668),c=i(50856),u=i(62276);const p=(0,r.x)(HTMLElement);(0,l.k)({_template:c.d`
...
`,is:"paper-dropdown-menu",behaviors:[a.P,o.a,n.V,s.x],properties:{selectedItemLabel:{type:String,notify:!0,readOnly:!0},selectedItem:{type:Object,notify:!0,readOnly:!0},value:{type:String,notify:!0},label:{type:String},placeholder:{type:String},errorMessage:{type:String},opened:{type:Boolean,notify:!0,value:!1,observer:"_openedChanged"},allowOutsideScroll:{type:Boolean,value:!1},noLabelFloat:{type:Boolean,value:!1,reflectToAttribute:!0},alwaysFloatLabel:{type:Boolean,value:!1},noAnimations:{type:Boolean,value:!1},horizontalAlign:{type:String,value:"right"},verticalAlign:{type:String,value:"top"},verticalOffset:Number,dynamicAlign:{type:Boolean},restoreFocusOnClose:{type:Boolean,value:!0},expandSizingTargetForScrollbars:{type:Boolean,value:!1}},listeners:{tap:"_onTap"},keyBindings:{"up down":"open",esc:"close"},observers:["_selectedItemChanged(selectedItem)"],_attachDom(e){const t=(0,u.r)(this);return t.attachShadow({mode:"open",delegatesFocus:!0,shadyUpgradeFragment:e}),t.shadowRoot.appendChild(e),p.prototype._attachDom.call(this,e)},focus(){this.$.input._focusableElement.focus()},attached:function(){var e=this.contentElement;e&&e.selectedItem&&this._setSelectedItem(e.selectedItem)},get contentElement(){for(var e=(0,d.vz)(this.$.content).getDistributedNodes(),t=0,i=e.length;t<i;t++)if(e[t].nodeType===Node.ELEMENT_NODE)return e[t]},open:function(){this.$.menuButton.open()},close:function(){this.$.menuButton.close()},_onIronSelect:function(e){this._setSelectedItem(e.detail.item)},_onIronDeselect:function(e){this._setSelectedItem(null)},_onTap:function(e){h.nJ(e)===this&&this.open()},_selectedItemChanged:function(e){var t="";t=e?e.label||e.getAttribute("label")||e.textContent.trim():"",this.value=t,this._setSelectedItemLabel(t)},_computeMenuVerticalOffset:function(e,t){return t||(e?-4:8)},_getValidity:function(e){return this.disabled||!this.required||this.required&&!!this.value},_openedChanged:function(){var e=this.opened?"true":"false",t=this.contentElement;t&&t.setAttribute("aria-expanded",e)}})},33760:(e,t,i)=>{i.d(t,{U:()=>n});i(94604);var a=i(51644),o=i(26110);const n=[a.P,o.a,{hostAttributes:{role:"option",tabindex:"0"}}]},97968:(e,t,i)=>{i(65660),i(70019);const a=document.createElement("template");a.setAttribute("style","display: none;"),a.innerHTML="<dom-module id=\"paper-item-shared-styles\">\n  <template>\n    <style>\n      :host, .paper-item {\n        display: block;\n        position: relative;\n        min-height: var(--paper-item-min-height, 48px);\n        padding: 0px 16px;\n      }\n\n      .paper-item {\n        @apply --paper-font-subhead;\n        border:none;\n        outline: none;\n        background: white;\n        width: 100%;\n        text-align: left;\n      }\n\n      :host([hidden]), .paper-item[hidden] {\n        display: none !important;\n      }\n\n      :host(.iron-selected), .paper-item.iron-selected {\n        font-weight: var(--paper-item-selected-weight, bold);\n\n        @apply --paper-item-selected;\n      }\n\n      :host([disabled]), .paper-item[disabled] {\n        color: var(--paper-item-disabled-color, var(--disabled-text-color));\n\n        @apply --paper-item-disabled;\n      }\n\n      :host(:focus), .paper-item:focus {\n        position: relative;\n        outline: 0;\n\n        @apply --paper-item-focused;\n      }\n\n      :host(:focus):before, .paper-item:focus:before {\n        @apply --layout-fit;\n\n        background: currentColor;\n        content: '';\n        opacity: var(--dark-divider-opacity);\n        pointer-events: none;\n\n        @apply --paper-item-focused-before;\n      }\n    </style>\n  </template>\n</dom-module>",document.head.appendChild(a.content)},53973:(e,t,i)=>{i(94604),i(65660),i(97968);var a=i(9672),o=i(50856),n=i(33760);(0,a.k)({_template:o.d`
    ...
    <slot></slot>
`,is:"paper-item",behaviors:[n.U]})},51095:(e,t,i)=>{i(94604);var a=i(78161),o=i(9672),n=i(50856);(0,o.k)({_template:n.d`
    <style>
      :host {
        display: block;
        padding: 8px 0;
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[a.i],hostAttributes:{role:"listbox"}})},63670:(e,t,i)=>{var a=i(89229);i(85408);(0,a.hC)("vaadin-date-picker-overlay",a.iv`
    :host([fullscreen]) {
      top: 0 !important;
      right: 0 !important;
  ...
  `,{include:["material-overlay"],moduleId:"material-date-picker-overlay"});i(85466),i(37365);(0,a.hC)("vaadin-button",a.iv`
    :host {
      padding: 8px;
      min-width: 64px;
  ...
  `,{moduleId:"material-button"});var o=i(28426),n=i(60995),s=i(81668),r=i(4358);let l=!1;window.addEventListener("keydown",(()=>{l=!0}),{capture:!0}),window.addEventListener("mousedown",(()=>{l=!1}),{capture:!0});const d=e=>class extends((e=>class extends e{static get properties(){return{tabindex:{type:Number,value:0,reflectToAttribute:!0,observer:"_tabindexChanged"}}}})(e)){static get properties(){return{autofocus:{type:Boolean},_previousTabIndex:{type:Number},disabled:{type:Boolean,observer:"_disabledChanged",reflectToAttribute:!0},_isShiftTabbing:{type:Boolean}}}ready(){this.addEventListener("focusin",(e=>{e.composedPath()[0]===this?this.contains(e.relatedTarget)||this._focus():-1===e.composedPath().indexOf(this.focusElement)||this.disabled||this._setFocused(!0)})),this.addEventListener("focusout",(()=>this._setFocused(!1))),super.ready(),this.addEventListener("keydown",(e=>{!e.defaultPrevented&&9===e.keyCode&&e.shiftKey&&(this._isShiftTabbing=!0,HTMLElement.prototype.focus.apply(this),this._setFocused(!1),setTimeout((()=>this._isShiftTabbing=!1),0))})),this.autofocus&&!this.disabled&&window.requestAnimationFrame((()=>{this._focus(),this._setFocused(!0),this.setAttribute("focus-ring","")}))}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("focused")&&this._setFocused(!1)}_setFocused(e){e?this.setAttribute("focused",""):this.removeAttribute("focused"),e&&l?this.setAttribute("focus-ring",""):this.removeAttribute("focus-ring")}get focusElement(){return window.console.warn(`Please implement the 'focusElement' property in <${this.localName}>`),this}_focus(){this.focusElement&&!this._isShiftTabbing&&(this.focusElement.focus(),this._setFocused(!0))}focus(){this.focusElement&&!this.disabled&&(this.focusElement.focus(),this._setFocused(!0))}blur(){this.focusElement&&(this.focusElement.blur(),this._setFocused(!1))}_disabledChanged(e){this.focusElement.disabled=e,e?(this.blur(),this._previousTabIndex=this.tabindex,this.tabindex=-1,this.setAttribute("aria-disabled","true")):(void 0!==this._previousTabIndex&&(this.tabindex=this._previousTabIndex),this.removeAttribute("aria-disabled"))}_tabindexChanged(e){void 0!==e&&(this.focusElement.tabIndex=e),this.disabled&&this.tabindex&&(-1!==this.tabindex&&(this._previousTabIndex=this.tabindex),this.tabindex=e=void 0)}click(){this.disabled||super.click()}};var h=i(21683),c=i(78956);const u=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,p=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function m(e,t){if("function"!=typeof e)return;const i=u.exec(e.toString());if(i)try{e=new Function(i[1])}catch(e){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",e)}return e(t)}window.Vaadin=window.Vaadin||{};const _=function(e,t){if(window.Vaadin.developmentMode)return m(e,t)};function f(){}void 0===window.Vaadin.developmentMode&&(window.Vaadin.developmentMode=function(){try{return!!localStorage.getItem("vaadin.developmentmode.force")||["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0&&(p?!(p&&Object.keys(p).map((e=>p[e])).filter((e=>e.productionMode)).length>0):!m((function(){return!0})))}catch(e){return!1}}());var v=i(59898);let g;window.Vaadin=window.Vaadin||{},window.Vaadin.registrations=window.Vaadin.registrations||[],window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{},window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){_(f)};const b=new Set,y=e=>class extends((0,v.U)(e)){static finalize(){super.finalize();const{is:e}=this;e&&!b.has(e)&&(window.Vaadin.registrations.push(this),b.add(e),window.Vaadin.developmentModeCallback&&(g=c.dx.debounce(g,h.t$,(()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()})),(0,c.Ex)(g)))}constructor(){super(),null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}};class D extends(y(d((0,r.T)((0,n._)(o.H3))))){static get template(){return o.dy`
      <style>
        :host {
    ...
    `}static get is(){return"vaadin-button"}static get version(){return"21.0.2"}ready(){super.ready(),this.setAttribute("role","button"),this.$.button.setAttribute("role","presentation"),this._addActiveListeners()}disconnectedCallback(){super.disconnectedCallback(),this.toggleAttribute("active",!1)}_addActiveListeners(){(0,s.NH)(this,"down",(()=>!this.disabled&&this.setAttribute("active",""))),(0,s.NH)(this,"up",(()=>this.removeAttribute("active"))),this.addEventListener("keydown",(e=>!this.disabled&&[13,32].indexOf(e.keyCode)>=0&&this.setAttribute("active",""))),this.addEventListener("keyup",(()=>this.removeAttribute("active"))),this.addEventListener("blur",(()=>this.removeAttribute("active")))}get focusElement(){return this.$.button}}customElements.define(D.is,D),(0,a.hC)("vaadin-date-picker-overlay-content",a.iv`
    :host {
      font-family: var(--material-font-family);
  ...
  `,{moduleId:"material-date-picker-overlay-content"}),(0,a.hC)("vaadin-month-calendar",a.iv`
    :host {
      color: var(--material-body-text-color);
  ...
  `,{moduleId:"material-date-picker-month-calendar"});var w=i(67130),x=(i(38323),i(1335)),k=i(16777);class S extends((0,k.f)(x.G)){static get is(){return"vaadin-date-picker-overlay"}}customElements.define(S.is,S);var C=i(8621),E=i(23916);i(42173);function M(e){let t=e.getDay();0===t&&(t=7);const i=4-t,a=new Date(e.getTime()+24*i*3600*1e3),o=new Date(0,0);o.setFullYear(a.getFullYear());const n=a.getTime()-o.getTime(),s=Math.round(n/864e5);return Math.floor(s/7+1)}function T(e,t){return e instanceof Date&&t instanceof Date&&e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function A(e,t,i){return(!t||e>=t)&&(!i||e<=i)}function I(e,t){return t.filter((e=>void 0!==e)).reduce(((t,i)=>i?t?Math.abs(e.getTime()-i.getTime())<Math.abs(t.getTime()-e.getTime())?i:t:i:t))}function F(e){return{day:e.getDate(),month:e.getMonth(),year:e.getFullYear()}}class O extends((0,r.T)((0,n._)(o.H3))){static get template(){return o.dy`
      <style>
        :host {
          display: block;
        }
  ...
  `,{moduleId:"vaadin-date-picker-overlay-styles"});class z extends((0,r.T)((0,v.U)((0,n._)(o.H3)))){static get template(){return o.dy`
      <style>
        :host {
          display: flex;
          flex-direction: column;
...
//# sourceMappingURL=346a9f6c.js.map