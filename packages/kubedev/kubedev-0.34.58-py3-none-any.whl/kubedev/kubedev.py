      ...
      try:
          ...
          if appType == 'cronjobs':
            ...
            if createCluster:
              ...
              if not KubernetesTools.apply(network, wslClusterConfig, KubernetesTools.get_tiller_rbac_setup(), shell_executor):
                return False
              ...
              if not KubernetesTools.wait_for_deployment(network, wslClusterConfig, "kube-system", "tiller-deploy", timeout, shell_executor, sleeper):
