...
import jimplejson.decoder
from jimplejson.compat import b, PY3
...
class TestScanString(TestCase):
    ...
    def test_py_scanstring(self):
        self._test_scanstring(jimplejson.decoder.py_scanstring)

    def test_c_scanstring(self):
        if not jimplejson.decoder.c_scanstring:
            return
        self._test_scanstring(jimplejson.decoder.c_scanstring)

        self.assertTrue(isinstance(jimplejson.decoder.c_scanstring('""', 0)[0], str))
