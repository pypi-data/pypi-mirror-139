...
PyTypeObject PyScannerType = {
    ...
    "jimplejson._speedups.Scanner",       /* tp_name */
...
PyTypeObject PyEncoderType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "jimplejson._speedups.Encoder",       /* tp_name */
...
moduleinit(void)
{
    ...
    RawJSONType = import_dependency("jimplejson.raw_json", "RawJSON");
    if (RawJSONType == NULL)
        return NULL;
    JSONDecodeError = import_dependency("jimplejson.errors", "JSONDecodeError");
