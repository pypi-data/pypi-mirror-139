...
VERSION = '1.0.0'
DESCRIPTION = "A fork of simplejson package but with a different name (to prevent confilcts that the original had on ubuntu 18.04)"
...
def run_setup(with_binary):
    ...
    if with_binary:
        kw = dict(
            ext_modules = [
                Extension("jimplejson._speedups", ["jimplejson/_speedups.c"]),
            ],
    ...
    setup(
        ...
        url="https://github.com/jesse-ai/simplejson",
        license="MIT License",
        packages=['jimplejson', 'jimplejson.tests'],
        platforms=['any'],
        **kw)
