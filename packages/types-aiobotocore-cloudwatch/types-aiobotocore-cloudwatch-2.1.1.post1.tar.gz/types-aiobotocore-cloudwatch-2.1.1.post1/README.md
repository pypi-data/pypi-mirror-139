...
[aiobotocore.CloudWatch 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudwatch.html#CloudWatch)
...
[types-aiobotocore-cloudwatch docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/)
...
`types_aiobotocore_cloudwatch.waiter` module contains type annotations for all waiters.
...
`CloudWatchServiceResource` provides annotations for `aiobotocore.resource("cloudwatch")`.
...
```python
from types_aiobotocore_cloudwatch.literals import (
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/)
