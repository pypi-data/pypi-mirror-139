...
class DataLake(
    ...
    def __init__(
        ...
        *,
        ...
        :param lake_type: The Type of DataLake this instance is. This can be a DATA_PRODUCT only, CENTRAL_CATALOG, CONSUMER, or DATA_PRODUCT_AND_CATALOG type.
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="lakeType")
    def lake_type(self) -> "LakeType":
        return typing.cast("LakeType", jsii.get(self, "lakeType"))
...
class DataLakeProperties:
    ...
    def lake_type(self) -> "LakeType":
        ...
        return typing.cast("LakeType", result)
...
class DataSet(
    ...
    def __init__(
        ...
        *,
        ...
        data_tiers: typing.Sequence["DataTier"],
        lake_type: "LakeType",
        log_bucket: aws_cdk.aws_s3.Bucket,
        pipeline: "Pipeline",
        stage: "Stage",
    ...
    @jsii.member(jsii_name="getDataSetBucketName")
    def get_data_set_bucket_name(
        self,
        data_tier: "DataTier",
        ...
        :param data_tier: -
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.invoke(self, "getDataSetBucketName", [data_tier]))
    ...
    def drop_location(self) -> typing.Optional["DataTier"]:
        return typing.cast(typing.Optional["DataTier"], jsii.get(self, "dropLocation"))
    ...
    def raw_bucket_name(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "rawBucketName"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="refinedBucketName")
    def refined_bucket_name(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "refinedBucketName"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="trustedBucketName")
    def trusted_bucket_name(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "trustedBucketName"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="locationRegistry")
    def location_registry(self) -> typing.List[aws_cdk.aws_lakeformation.CfnResource]:
        return typing.cast(typing.List[aws_cdk.aws_lakeformation.CfnResource], jsii.get(self, "locationRegistry"))

    @location_registry.setter
    def location_registry(
        self,
        value: typing.List[aws_cdk.aws_lakeformation.CfnResource],
    ) -> None:
        jsii.set(self, "locationRegistry", value)
...
class DataSetProperties:
    ...
    @builtins.property
    def data_tiers(self) -> typing.List["DataTier"]:
        result = self._values.get("data_tiers")
        assert result is not None, "Required property 'data_tiers' is missing"
        return typing.cast(typing.List["DataTier"], result)
...
@jsii.enum(jsii_type="@randyridgley/cdk-datalake-constructs.LakeType")
class LakeType(enum.Enum):
    DATA_PRODUCT = "DATA_PRODUCT"
    ...
    def __init__(
        ...
        *,
        ...
        props = PipelineProperties(
            data_set_drop_tier=data_set_drop_tier,
            destination_prefix=destination_prefix,
            name=name,
            type=type,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={
        "data_set_drop_tier": "dataSetDropTier",
        "destination_prefix": "destinationPrefix",
        "name": "name",
        "type": "type",
...
class PipelineProperties:
    ...
    @builtins.property
    def data_set_drop_tier(self) -> DataTier:
        result = self._values.get("data_set_drop_tier")
        assert result is not None, "Required property 'data_set_drop_tier' is missing"
        return typing.cast(DataTier, result)
