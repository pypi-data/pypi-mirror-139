                    ...
                    if available:
                        ...
                        if dt_status == 'GROUP':
                            if code in dt_group:
                                ...
                                f"ids {ids}"
                                level = 20
                                scheduler.queue_log.put(("Assignator",
                                                         msg, level, {}))
                            ...
                            print(self.scheduler.assigned_tasks)
                            self.scheduler.add_sta_assigned(
                                ipt, ico, ids)
                            self.locker.release()
                        ...
                        print(now(), "Assignator", msg)
                        level = 30 #warning
                        scheduler.queue_log.put(("Assignator", msg,
                                                 level, {}))
