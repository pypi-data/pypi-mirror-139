...
VERSION = "3.14.0a1645656307"
PLUGIN_VERSION = "3.14.0-alpha.1645656307+fcb25ae3"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the fastly resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource fastly {PLUGIN_VERSION}`
                """)
            else:
                raise
