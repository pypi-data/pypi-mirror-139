...
class Consumer(object):
    ...
    def send_data(self, request_url, data, headers=None):
        return self._write_request(request_url, data, headers)

    def _write_request(self, request_url, data, headers=None):
        print(data)
