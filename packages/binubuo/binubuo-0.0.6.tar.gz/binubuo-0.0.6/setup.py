...
**Binubuo** is a simple and powerful client to the Binubuo API. The API is used to generate fake or synthetic data that is realistic. Simply import the module, generate a temporary key
and you are good to go. Start generating your data straight away.
...
To use **Binubuo** and have any created datasets or custom settings be available anytime, you need an API key from RapidAPI. If you do not have an account with RapidAPI, 
you can create one here: https://rapidapi.com/auth/sign-up.
Once you have signed up, go to the Binubuo page, and choose the plan that fits you (free plan available): https://rapidapi.com/codemonth/api/binubuo/pricing. A full
explanantion of how to enable this API, can be found here: https://binubuo.com/ords/r/binubuo_ui/binubuo/documentation-getting-started. Now you are ready to use the API with a real key,
