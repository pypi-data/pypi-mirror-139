...
class DistilCommunityDetectionPrimitive(
    ...
    metadata = metadata_base.PrimitiveMetadata(
        {
            ...
            "source": {
                ...
                "uris": [
                    "https://gitlab.com/datadrivendiscovery/contrib/distil-primitives/-/blob/main/distil/primitives/community_detection.py",
            ...
            "installation": [
                CYTHON_DEP,
                {
                    ...
                    "package_uri": "git+https://gitlab.com/datadrivendiscovery/contrib/distil-primitives.git@{git_commit}#egg=distil-primitives".format(
    ...
    def get_params(self) -> Params:
        return Params(target_col=self._target_col, model=self._model)
