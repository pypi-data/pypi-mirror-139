...
class BaseField(IBaseConfig):
    ...
    def set_display_in_form_add_selected(self, display_in_form_add_selected):
    ...
    def set_required_form_add(self, required_form_add):
    ...
    def set_display_in_form_update(self, display_in_form_update):
    ...
    def set_display_in_form_update_selected(self, display_in_form_update_selected):
        self.result[
    ...
    def set_required_form_update(self, required_form_update):
    ...
    def set_display_in_import_file(self, display_in_import_file):
    ...
    def set_display_in_list_field(self, display_in_list_field):
    ...
    def set_display_in_list_field_selected(self, display_in_list_field_selected):
        self.result[
    ...
    def set_display_in_filter(self, display_in_filter):
    ...
    def set_disable_remove_form_input(self, disable_remove_form_input):
    ...
    def set_disable_remove_list(self, disable_remove_list):
    ...
    def set_disable_required_form_input(self, disable_required_form_input):
    ...
    def set_enable_data_color(self, enable_data_color):
    ...
    def set_field_key(self, field_key: str):
        if not field_key.startswith(MerchantConfigCommon.PREFIX_DYNAMIC_FIELD):
            raise Exception("{}: {} is not valid".format(self.FIELD_KEY, field_key))
