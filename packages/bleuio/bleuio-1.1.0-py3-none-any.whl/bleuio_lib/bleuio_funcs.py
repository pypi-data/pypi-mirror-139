...
class BleuIo(object):
    ...
    def __poll_serial(self):
        ...
        if not self.rx_buffer.isspace():
            ...
            #         print("SPS Response: " + self.rx_buffer.decode("utf-8", "ignore"))
    ...
    def __at_get_conn(self):
        ...
        while not self.rx_state.__eq__("rx_ready"):
            if self.rx_buffer.decode("utf-8", "ignore").__contains__("Our Role:") or self.rx_buffer.decode("utf-8", "ignore").__contains__("\r\nNo Connections found.\r\n"):
                self.rx_state = "rx_ready"
                response = self.rx_response
            if self.rx_buffer.decode("utf-8", "ignore").__contains__("\r\nERROR\r\n"):
                self.rx_state = "rx_ready"
    ...
    def __at_sec_lvl(self, sec_lvl):
        ...
        while not self.rx_state.__eq__("rx_ready"):
            if self.rx_buffer.decode("utf-8", "ignore").__contains__("SECURITY LEVEL =") or self.rx_buffer.decode("utf-8", "ignore").__contains__("\r\nOK\r\n"):
                self.rx_state = "rx_ready"
                response = self.rx_response
            if self.rx_buffer.decode("utf-8", "ignore").__contains__("\r\nERROR\r\n"):
                self.rx_state = "rx_ready"
