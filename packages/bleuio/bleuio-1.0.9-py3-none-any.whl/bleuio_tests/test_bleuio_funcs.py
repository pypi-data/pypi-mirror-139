...
print(my_dongle.ati())
print(my_dongle.at_target_conn())
print(my_dongle.at_get_conn())
print(my_dongle.at_server())
print(my_dongle.at_client())
# print(my_dongle.at_gapscan(4))
...
# print(scan)
# print("="*21)
# print(my_dongle.at_spssend("howdy"))
# print(my_dongle.at_spssend())
# print(my_dongle.send_command("Hello EVERYBODY"))
# print(my_dongle.send_command("Hello"))
# print(my_dongle.stop_sps())
# time.sleep(0.5)
# print(my_dongle.at_spssend("howdy"))
