...
###
# Aero Token Information
AERO_REFRESH_TOKEN = from_conf('AERO_REFRESH_TOKEN')
AERO_IDENTITY_POOL = from_conf('AERO_IDENTITY_POOL')
AERO_PROVIDER = from_conf('AERO_PROVIDER')
USER_POOL_CLIENT_ID = from_conf('USER_POOL_CLIENT_ID')
