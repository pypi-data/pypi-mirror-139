...
[aiobotocore.IoTEvents 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/iotevents.html#IoTEvents)
...
[types-aiobotocore-iotevents docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotevents/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-iotevents](#types-aiobotocore-iotevents)
...
- Install `types-aiobotocore[iotevents]` in your environment:
...
Install `types-aiobotocore-lite[iotevents]` in your environment:
...
- Install `types-aiobotocore[iotevents]` with services you use in your
  environment:
...
`IoTEventsClient` provides annotations for
`session.create_client("iotevents")`.

```python
from aiobotocore.session import get_session

from types_aiobotocore_iotevents import IoTEventsClient
...
`types_aiobotocore_iotevents.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

```python
from types_aiobotocore_iotevents.literals import (
...
`types-aiobotocore-iotevents` version is the same as related `aiobotocore`
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotevents/)
