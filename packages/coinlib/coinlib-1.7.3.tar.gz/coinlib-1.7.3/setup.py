...
setup(
    ...
    install_requires=[
        "requests", "semver", "datascience", "munch", "packaging", "coolname", "google", "aio_pika", "grpcio", "grpcio-tools", "protobuf", "cython", "ipython", "ipykernel", "pandas", "websocket-client", "plotly", "simplejson", "ipynb_path",
