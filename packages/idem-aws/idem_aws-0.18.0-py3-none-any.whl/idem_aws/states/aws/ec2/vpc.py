...
async def present(
    ...
    **Autogenerated function**
    ...
    if ctx.get("test", False):
        if before:
            result["comment"] = f"Would update aws.ec2.vpc {name}"
            result["result"] = True
        else:
    ...
    if before:
        try:
            result["old_state"] = hub.tool.aws.ec2.vpc_utils.convert_raw_vpc_to_present(
    ...
    try:
        if (not before) or resource_updated:
            ...
            result["new_state"] = hub.tool.aws.ec2.vpc_utils.convert_raw_vpc_to_present(
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    for resource in ret["ret"]["Vpcs"]:
        ...
        resource_translated = hub.tool.aws.ec2.vpc_utils.convert_raw_vpc_to_present(
