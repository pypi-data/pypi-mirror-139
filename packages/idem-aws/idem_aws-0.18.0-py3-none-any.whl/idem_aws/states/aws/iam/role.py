...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    **Autogenerated function**
    ...
    for role in ret["ret"]["Roles"]:
        ...
        if resource.get("AssumeRolePolicyDocument"):
            resource_translated.append(
                {
                    "assume_role_policy_document": json.dumps(
                        resource.get("AssumeRolePolicyDocument")
                    )
                }
            )
        result[resource_name] = {"aws.iam.role.present": resource_translated}
    return result
