...
async def present(
    hub, ctx, name: str, role_name: str, policy_document: Dict or str
) -> Dict[str, Any]:
    r"""
    **Autogenerated function**
    ...
    resource = hub.tool.boto3.resource.create(
        ctx, "iam", "RolePolicy", role_name=role_name, name=name
    )
...
async def absent(hub, ctx, name: str, role_name: str) -> Dict[str, Any]:
    r"""
    **Autogenerated function**
    ...
    if not before:
        ...
        try:
            ...
            ret = await hub.exec.boto3.client.iam.delete_role_policy(
                ctx, RoleName=role_name, PolicyName=name
            )
            result["result"] = ret["result"]
            if not result["result"]:
                result["comment"] = ret["comment"]
            ...
            if not ret_role_policies["result"]:
                ...
                for get_role_policy in asyncio.as_completed(
                    ...
                    if not ret_role_policy["result"]:
                        ...
                        describe_parameters = OrderedDict({"RoleName": "role_name"})
                        resource_translated = []
                        for (
                            parameter_old_key,
                            parameter_new_key,
                        ...
                        result[resource_name] = {
                            "aws.iam.role_policy.present": resource_translated
                        }
    return result
