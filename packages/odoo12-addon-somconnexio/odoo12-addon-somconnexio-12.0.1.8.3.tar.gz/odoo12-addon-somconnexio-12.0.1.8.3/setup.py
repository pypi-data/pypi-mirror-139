...
setuptools.setup(
    ...
    odoo_addon={
        'depends_override': {
            ...
            'l10n_es_aeat': 'odoo12-addon-l10n-es-aeat==12.0.2.3.0.99.dev2',
            'l10n_es_aeat_mod111': 'odoo12-addon-l10n-es-aeat-mod111==12.0.1.3.1.99.dev1',
            'l10n_es_aeat_mod190': 'odoo12-addon-l10n-es-aeat-mod190==12.0.1.0.2',
            'l10n_es_aeat_mod303': 'odoo12-addon-l10n-es-aeat-mod303==12.0.1.14.1.99.dev2',
            'l10n_es_aeat_mod347': 'odoo12-addon-l10n-es-aeat-mod347==12.0.1.8.0',
            'l10n_es_aeat_mod349': 'odoo12-addon-l10n-es-aeat-mod349==12.0.1.3.1.99.dev2',
            'l10n_es_aeat_mod390': 'odoo12-addon-l10n-es-aeat-mod390==12.0.2.8.0.99.dev1',
        ...
        'external_dependencies_override': {
            'python': {
                'faker': 'faker==9.3.1',
                'factory': 'factory-boy',
                'otrs_somconnexio': 'otrs-somconnexio==0.4.21',
