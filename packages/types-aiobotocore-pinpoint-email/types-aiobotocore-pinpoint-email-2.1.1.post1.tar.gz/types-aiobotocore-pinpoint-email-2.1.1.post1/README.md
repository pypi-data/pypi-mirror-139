...
[aiobotocore.PinpointEmail 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-email.html#PinpointEmail)
...
[types-aiobotocore-pinpoint-email docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_pinpoint_email/)
...
`types_aiobotocore_pinpoint_email.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

```python
from types_aiobotocore_pinpoint_email.literals import (
...
```python
from types_aiobotocore_pinpoint_email.type_defs import (
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_pinpoint_email/)
