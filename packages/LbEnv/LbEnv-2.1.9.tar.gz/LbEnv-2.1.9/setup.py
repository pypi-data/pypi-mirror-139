...
setup(
    ...
    description="LHCb Environment tools",  # Required
    ...
    url="https://gitlab.cern.ch/lhcb-core/LbEnv",  # Optional
    ...
    install_requires=["LbPlatformUtils>=4.2.3", "xenv<1.0.0", "six"],
    ...
    setup_requires=["nose>=1.0", "setuptools_scm<6"],
    ...
    #     'LbEnv': ['LICENSE', 'README.rst', 'share/projects.txt', 'toto'],
    # },
    ...
    data_files=[
        ("share/bash-completion", ["shell-completion/bash_completion"]),
        (
            "share/bash-completion/completions",
            [
                "shell-completion/bash/_lb-run",
                "shell-completion/bash/_lb-set-platform",
                "shell-completion/bash/LbEnv_helpers",
            ],
        ),
        (
            "share/zsh",
        ...
        (
            ...
            [
                "shell-completion/zsh/_lb-run",
                "shell-completion/zsh/_lb-set-platform",
            ],
        ),
    ],  # Optional
