...
from leapcli.exceptions import InvalidOrgName, CredentialsNotFound, AlreadyInitialized, InvalidProjectName, \
    ProjectNotFoundException, DatabaseAmbiguityException
...
class Project:
    ...
    def project_id(self, api: DefaultApi, throw_on_project_not_found=True) -> Optional[str]:
