...
<template>
  <div>
    <div v-if="fileSize > maxFileSize && !forceLoad">
      <button class="btn btn-sm btn-light mb-2" @click="loadFile">
        <i class="fa-solid fa-eye"></i> {{ $t('Load preview') }}
      </button>
    </div>
    <div class="card bg-light p-1" ref="container" v-else>
