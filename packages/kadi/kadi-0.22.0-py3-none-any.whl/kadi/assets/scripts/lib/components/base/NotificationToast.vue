...
<template>
  <div class="toast" data-animation="false" data-autohide="false" data-delay="0" ref="toast" style="min-width: 100%;">
  ...
  methods: {
    dismiss() {
      axios.delete(this.notification._actions.dismiss)
        ...
        .catch((error) => kadi.alert($t('Error dismissing notification.'), {request: error.request}));
    },
  },
  mounted() {
