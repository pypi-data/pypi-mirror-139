      ...
      <div v-for="(revision, index) in props.items"
        ...
        <div class="form-row align-items-center">
          ...
          <div class="col-xl-8">
            ...
            <span v-if="revision.data.state === activeState">
              <span v-if="revision.diff.state">
                <span v-if="revision.diff.state.prev === null">{{ $t('created') }}</span>
                <span v-else>restored</span>
              </span>
              <span v-if="!revision.diff.state">{{ $t('updated') }}</span>
            </span>
            <span v-if="revision.data.state === deletedState">{{ $t('deleted') }}</span>
