...
def edit_record_link(record_id, link_id, schema):
    ...
    name = schema.load_or_400()["name"]

    try:
        update_record_link(record_link, name)
        db.session.commit()
