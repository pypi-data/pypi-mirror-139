...
class LocalIdentity(Identity):
    ...
    class Meta:
        ...
        identity_type = {"type": "local", "name": _l("Local")}
    ...
    def get_email_confirmation_token(self, email=None):
        ...
        Besides its type, the JWT includes the ID and email address of this identity.
        Note that the JWT always expires in one hour.
    ...
    def get_password_reset_token(self):
        ...
        Besides its type, the JWT includes the ID of this identity. Note that the JWT
        always expires in one hour.
...
class LDAPIdentity(Identity):
    ...
    class Meta:
        ...
        identity_type = {"type": "ldap", "name": _l("LDAP")}
        """The type and full name of the identity."""
...
class ShibIdentity(Identity):
    ...
    class Meta:
        ...
        identity_type = {"type": "shib", "name": _l("Shibboleth")}
        """The type and full name of the identity."""
