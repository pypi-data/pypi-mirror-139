...
def internal(func):
    ...
    tokens. Useful for e.g. returning additional data that is only relevant for internal
    usage.

    See also :func:`.utils.is_internal_api_request`.
    """
