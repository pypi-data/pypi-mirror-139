...
class BaseStorage(ABC):
    ...
    :param storage_type: The name of storage. Should be unique.
    :param upload_type: The type of the upload, currently either ``"chunked"`` or
        ``"direct"``.
    ...
    def __init__(self, storage_type, upload_type, max_size=None):
...
def get_storage(storage_type):
    ...
    :return: The storage.
    """
    return current_app.config["STORAGES"][storage_type]
