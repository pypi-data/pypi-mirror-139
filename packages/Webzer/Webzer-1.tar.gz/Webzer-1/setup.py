...
setup(
  ...
  url = 'https://github.com/KodeyCode/Webby',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/KodeyCode/BaconEngine/archive/v_03.tar.gz',    # I explain this later on
  keywords = ['WebModule', 'EASY-TO-USE', 'Websites'],   # Keywords that define your package best
  install_requires=[''],
  classifiers=[
