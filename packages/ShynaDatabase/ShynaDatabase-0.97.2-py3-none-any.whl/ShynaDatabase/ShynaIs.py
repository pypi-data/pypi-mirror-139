        ...
        try:
            ...
            if "Empty" in self.result:
                ...
                for face_time in self.result:
                    time_diff = (self.s_time.string_to_time_with_date(self.s_time.now_time) - self.s_time.string_to_time_with_date(face_time[0])).total_seconds()
                    face_time_list.append(time_diff)
