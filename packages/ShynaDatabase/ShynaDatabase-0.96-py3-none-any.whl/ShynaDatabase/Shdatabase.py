...
now_date = "ok"
now_time = "no"
email_date = ['some', 'thing']
email_subject = "shutup"
email_sent_from = "someone"
email_uid = "some id"
query = """INSERT INTO emaildetails (task_date, task_time, email_date,email_time ,email_subject, email_sent_from, email_uid) VALUES('"+str(self.s_time.now_date)+"','"+str(self.s_time.now_time)+"','"+str(email_date[0])+"', '"+str(email_date[1])+"','"+str(email_subject)+"', '"+str(email_sent_from)+"', '"+str(email_uid)+"')"""
print(query)