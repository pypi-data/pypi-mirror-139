        ...
        try:
            ...
            if "Empty" in self.result:
                ...
                for i in range(len(self.result)-1):
                    ...
                    time_diff = (self.s_time.string_to_time_with_date(str(self.s_time.now_time)) - self.s_time.string_to_time_with_date(str(self.result[i][0]))).total_seconds()
                    # print(time_diff)
                    if int(time_diff) < 60:
