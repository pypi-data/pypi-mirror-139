				...
				OrderedDict(
					[
						...
						("policy", Static_variant(
							Policy(begin_timestamp=kwargs["policy"][1]["begin_timestamp"], vesting_cliff_seconds=kwargs["policy"][1]["vesting_cliff_seconds"], vesting_duration_seconds=kwargs["policy"][1]["vesting_duration_seconds"]), 0)
						)
					]
				)
			)	
