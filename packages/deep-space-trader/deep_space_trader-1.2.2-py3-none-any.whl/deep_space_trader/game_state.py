...
class State(object):
    ...
    def battle_won(self):
        percent_for_curr_level = self.battle_level_chance_map[self.battle_level]
        win_chance_percent = (float(self.battle_level) / float(self.max_battle_level)) * percent_for_curr_level
