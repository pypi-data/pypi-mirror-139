...
from .moduli import MODULI_SM, MODULI_RT, MODULI_CT
import itertools
...
MODULI_SMALL = -1  # ??
MODULI_ST = 3
# Note: due to the addition of MODULI_TL in moduli.py, which is not present in the code below,
# we have to manually set the value of MODULI_ST to 3 here (it is 4 in the file moduli.py)
# All functions calling DR.py with the option moduli_type should use the function
# get_moduli(m, DRpy=True) to correctly translate to the conventions of the file below.
...
def get_memory_usage():
    ...
    EXAMPLES::
        ...
        sage: from admcycles.DR import get_memory_usage
...
def interpolate(A, B, var='x'):
    ...
    TESTS::
        ...
        sage: from admcycles.DR import interpolate
