...
[aiobotocore.BackupGateway 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/backup-gateway.html#BackupGateway)
...
- Install `types-aiobotocore[backup-gateway]` with services you use in your
  environment:
