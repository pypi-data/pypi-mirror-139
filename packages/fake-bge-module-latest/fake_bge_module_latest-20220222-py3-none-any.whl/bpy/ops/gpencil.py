...
def interpolate(shift: float = 0.0,
                layers: typing.Union[int, str] = 'ACTIVE',
                interpolate_selected_only: bool = False,
                flip: typing.Union[int, str] = 'AUTO',
                smooth_steps: int = 1,
    ...
    :type layers: typing.Union[int, str]
    ...
    :type flip: typing.Union[int, str]
...
def interpolate_sequence(step: int = 1,
                         ...
                         smooth_steps: int = 1,
                         smooth_factor: float = 0.0,
                         type: typing.Union[int, str] = 'LINEAR',
                         easing: typing.Union[int, str] = 'AUTO',
                         back: float = 1.702,
    ...
    :type easing: typing.Union[int, str]
...
def layer_duplicate(mode: typing.Union[int, str] = 'ALL'):
...
def layer_duplicate_object(mode: typing.Union[int, str] = 'ALL',
...
def layer_mask_move(type: typing.Union[int, str] = 'UP'):
...
def layer_merge(mode: typing.Union[int, str] = 'ACTIVE'):
    ''' Combine Layers
...
def materials_copy_to_object(only_active: bool = True):
...
def segment_move(modifier: str = "", type: typing.Union[int, str] = 'UP'):
...
def segment_remove(modifier: str = "", index: int = 0):
...
def stroke_normalize(mode: typing.Union[int, str] = 'THICKNESS',
                     factor: float = 1.0,
                     value: int = 10):
...
def tint_flip():
    ''' Switch tint colors :file: startup/bl_ui/properties_grease_pencil_common.py\:879 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_ui/properties_grease_pencil_common.py$879> _
