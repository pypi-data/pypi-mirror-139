...
setup(
    ...
    description="Type annotations for aiobotocore.MigrationHubStrategyRecommendations 2.1.1 service generated with mypy-boto3-builder 7.1.1",
    classifiers=[
    ...
    keywords="aiobotocore migrationhubstrategy type-annotations boto3-stubs mypy typeshed autocomplete",
    long_description=LONG_DESCRIPTION,
    long_description_content_type="text/markdown",
    package_data={"types_aiobotocore_migrationhubstrategy": ["py.typed", "*.pyi"]},
    python_requires=">=3.6",
    project_urls={
