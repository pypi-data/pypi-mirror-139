...
from gym_covid19outbreak.envs.diseaseOutbreaks import DiseaseOutbreaks
import numpy as np

SPEED_PLAYER = 2.5

class Covid19OutbreakEnv(gym.Env):

	metadata = {"render.modes": ['human']}

	def __init__(self):
		super(Covid19OutbreakEnv, self).__init__()

		self.game = DiseaseOutbreaks()
