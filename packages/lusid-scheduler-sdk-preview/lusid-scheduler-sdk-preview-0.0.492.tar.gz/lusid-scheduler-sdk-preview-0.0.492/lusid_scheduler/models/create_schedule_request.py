...
class CreateScheduleRequest(object):
    ...
    def author(self, author):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                author is not None and len(author) > 50):
    ...
    def owner(self, owner):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                owner is not None and len(owner) > 50):
            raise ValueError("Invalid value for `owner`, length must be less than or equal to `50`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
