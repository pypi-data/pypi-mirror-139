...
"""
    ...
    The version of the OpenAPI document: 0.0.492
...
class JobHistory(object):
    ...
    def __init__(self, run_id=None, job_id=None, name=None, start_date=None, end_date=None, arguments=None, environment_variables=None, job_status=None, job_result=None, description=None, schedule_id=None, result_url=None, manually_triggered_by=None, command=None, message=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type name: str
        :param start_date:  Start date of the job  Defaults to null if the job has not started yet ( is in a pending status )
    ...
    def start_date(self):
        ...
        Start date of the job  Defaults to null if the job has not started yet ( is in a pending status )  # noqa: E501
