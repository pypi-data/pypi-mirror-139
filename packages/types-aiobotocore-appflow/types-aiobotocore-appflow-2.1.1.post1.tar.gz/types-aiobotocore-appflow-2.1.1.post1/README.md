...
[aiobotocore.Appflow 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/appflow.html#Appflow)
...
- Install `types-aiobotocore[appflow]` with services you use in your
  environment:
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appflow/)
