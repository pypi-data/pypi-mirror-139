...
class TaskStatus(object):
    ...
    def __init__(self, id=None, status=None, task=None, deleted=None, created_dt=None, local_vars_configuration=None):  # noqa: E501
