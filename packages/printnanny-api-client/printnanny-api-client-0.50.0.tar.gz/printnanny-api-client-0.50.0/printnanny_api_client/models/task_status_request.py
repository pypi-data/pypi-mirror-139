...
class TaskStatusRequest(object):
    ...
    def __init__(self, status=None, task=None, local_vars_configuration=None):  # noqa: E501
    ...
    def task(self, task):
        ...
        :type task: PolymorphicTaskRequest
        """
