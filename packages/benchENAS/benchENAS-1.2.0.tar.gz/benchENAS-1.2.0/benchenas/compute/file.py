...
def get_pop_siz():
    '''
    :return:Get the population size
    '''
...
def get_algo_local_dir():
    '''
    :return:Get the corresponding folder under the running algorithm runtime folder
    '''
...
def get_population_dir():
    '''
        :return:Get the populations folder in the corresponding folder under the running algorithm runtime folder and create it
    '''
...
def init_work_dir_on_all_workers():
    ...
    for sec in gpu_info.keys():
        ...
        if Config_ini.dataset not in ls_dataset:
            transfer_dataset_image(ssh_name, ssh_password, worker_ip, Config_ini.data_dir)
