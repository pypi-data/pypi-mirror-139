...
class ImportExportMixin(GenericAPIView):
    ...
    def obj_export(self, request, pk: int):
        ...
        if not err:
            try:
                ...
                err = f'Error export object {instance.__class__.__name__} {instance.name=} {instance.pk=}, {str(e)}'
    ...
    def obj_import(self, request):
        ...
        try:
            msgs = dump_import(self.models_module_name, object_dump, model)
