...
class JobSchedule(BackgroundTasks):
    ...
    __distributed_id__ = str(SonyFlakeId())  # 分布式id
    ...
    def init_scheduler(self, distributed=False) -> None:
        ...
        self.logger.info("init_scheduler start1")
        self.__schedule__ = AsyncIOScheduler(jobstores=job_stores)
        self.logger.info("init_scheduler start2")
        self.__schedule__.start()
        self.logger.info("init_scheduler start3")
        # 上线注册
        ...
        self.logger.info("init_scheduler end")
