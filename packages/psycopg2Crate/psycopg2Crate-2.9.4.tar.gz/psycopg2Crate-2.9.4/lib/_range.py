...
from psycopg2Crate._psycopg import ProgrammingError, InterfaceError
from psycopg2Crate.extensions import ISQLQuote, adapt, register_adapter
from psycopg2Crate.extensions import new_type, new_array_type, register_type
...
def register_range(pgrange, pyrange, conn_or_curs, globally=False):
    ...
    *pgrange* type and raises `~psycopg2Crate.ProgrammingError` if the type is not
