...
psycopg2Crate is a PostgreSQL database adapter for the Python programming
language.  psycopg2Crate was written with the aim of being very small and fast,
and stable as a rock.

psycopg2Crate is different from the other database adapter because it was
designed for heavily multi-threaded applications that create and destroy
lots of cursors and make a conspicuous number of concurrent INSERTs or
UPDATEs. psycopg2Crate also provide full asynchronous operations and support
...
pg_config is required to build psycopg2Crate from source.  Please add the directory
...
If you prefer to avoid building psycopg2Crate from source, please install the PyPI
'psycopg2Crate-binary' package instead.
...
You may install a binary package by installing 'psycopg2Crate-binary' from PyPI.
If you want to install psycopg2Crate from source, please install the packages
...
ext.append(Extension("psycopg2Crate._psycopg", sources,
...
setup(name="psycopg2Crate",
      ...
      package_dir={'psycopg2Crate': 'lib'},
      packages=['psycopg2Crate'],
