...
class PersistentGraph(Graph):
    def __init__(self, uri: str, *args, **kwargs):
        store = plugin.get("SQLAlchemy", Store)(identifier="brickschema_persistent_graph")
...
class PersistentGraphCollectio(GraphCollection):
    def __init__(self, uri: str, *args, **kwargs):
        store = plugin.get("SQLAlchemy", Store)(identifier="brickschema_persistent_graph")
        super().__init__(store, *args, **kwargs)
        kwargs.update({'create': True})
...
class VersionedGraphCollection(PersistentGraphCollectio):
    def __init__(self, uri: str, *args, **kwargs):
