...
class AccessKeysApi(object):
    ...
    def delete(self, organization_id, access_key_id, **kwargs):  # noqa: E501
        """Delete an individual AccessKey  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(organization_id, access_key_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_with_http_info(organization_id, access_key_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_with_http_info(organization_id, access_key_id, **kwargs)  # noqa: E501
            return data

    def delete_with_http_info(self, organization_id, access_key_id, **kwargs):  # noqa: E501
        """Delete an individual AccessKey  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(organization_id, access_key_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['organization_id', 'access_key_id']  # noqa: E501
        ...
        if ('access_key_id' not in params or
            ...
            raise ValueError("Missing the required parameter `access_key_id` when calling `delete`")  # noqa: E501
        ...
        if 'access_key_id' in params:
            path_params['access_key_id'] = params['access_key_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/organizations/{organization_id}/access-keys/{access_key_id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='AccessKeyResponse',  # noqa: E501
    ...
    def index_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/organizations/{organization_id}/access-keys', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AccessKeysResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def insert(self, body, organization_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AccessKey body: AccessKey data. (required)
        :param str organization_id: (required)
        :return: AccessKeyResponse
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def insert_with_http_info(self, body, organization_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/organizations/{organization_id}/access-keys', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
