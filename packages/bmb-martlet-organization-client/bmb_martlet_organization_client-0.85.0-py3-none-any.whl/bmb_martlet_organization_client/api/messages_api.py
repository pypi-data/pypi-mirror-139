...
class MessagesApi(object):
    ...
    def query_with_http_info(self, address_id, **kwargs):  # noqa: E501
        ...
        all_params = ['address_id', 'pointer', 'limit', 'message_id', 'to_address_id', 'from_submission_timestamp', 'to_submission_timestamp', 'message_type', 'sender_reference', 'receipted_status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def select_received_messages_with_http_info(self, organization_id, address_id, **kwargs):  # noqa: E501
        ...
        all_params = ['organization_id', 'address_id', 'pointer', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
