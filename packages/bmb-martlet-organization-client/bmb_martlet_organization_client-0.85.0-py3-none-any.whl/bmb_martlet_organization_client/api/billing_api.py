...
class BillingApi(object):
    ...
    def usage_report(self, organization_id, **kwargs):  # noqa: E501
        """Gets information to calculate current charges  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usage_report(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.usage_report_with_http_info(organization_id, **kwargs)  # noqa: E501
        else:
            (data) = self.usage_report_with_http_info(organization_id, **kwargs)  # noqa: E501
            return data

    def usage_report_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        """Gets information to calculate current charges  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usage_report_with_http_info(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('organization_id' not in params or
                params['organization_id'] is None):
            raise ValueError("Missing the required parameter `organization_id` when calling `usage_report`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/organizations/{organization_id}/usage-report', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
