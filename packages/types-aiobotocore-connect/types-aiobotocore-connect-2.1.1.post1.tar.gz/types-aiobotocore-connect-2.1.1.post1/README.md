...
[aiobotocore.Connect 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connect.html#Connect)
...
[types-aiobotocore-connect docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connect/)
...
`types_aiobotocore_connect.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

```python
from types_aiobotocore_connect.literals import (
...
```python
from types_aiobotocore_connect.type_defs import (
    AgentInfoTypeDef,
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connect/)
