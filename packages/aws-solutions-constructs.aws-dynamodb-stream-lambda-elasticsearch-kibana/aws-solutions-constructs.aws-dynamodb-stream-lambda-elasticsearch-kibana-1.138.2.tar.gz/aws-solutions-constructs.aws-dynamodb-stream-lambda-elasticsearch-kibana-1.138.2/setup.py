    ...
    """
{
    ...
    "packages": [
        ...
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana._jsii"
    ],
    "package_data": {
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodb-stream-lambda-elasticsearch-kibana@1.138.2.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-event-sources==1.138.2",
        "aws-cdk.aws-lambda==1.138.2",
        "aws-cdk.aws-sqs==1.138.2",
        "aws-cdk.core==1.138.2",
        "aws-solutions-constructs.aws-dynamodbstreams-lambda-elasticsearch-kibana==1.138.2",
