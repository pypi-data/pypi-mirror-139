...
class Cursor(object):
    ...
    def description(self):
        ...
        column:
            ...
            type_code (Rockset data type name
                       see https://rockset.com/docs/data-types/)
    ...
    def execute(self, operation, parameters=None, generate_warnings=False):
        ...
        # setup the cursor
        self._cursor = self._rs_client.sql(q=q, generate_warnings=generate_warnings)
...
DATETIME = _DBAPITypeObject(
    [
        rockset.document.DATATYPE_DATE,
        rockset.document.DATATYPE_DATETIME,
        rockset.document.DATATYPE_TIME,
        rockset.document.DATATYPE_TIMESTAMP,
    ]
)
