...
[aiobotocore.Amplify 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/amplify.html#Amplify)
...
- Install `types-aiobotocore[amplify]` with services you use in your
  environment:
