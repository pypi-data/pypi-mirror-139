...
[aiobotocore.PinpointSMSVoice 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sms-voice.html#PinpointSMSVoice)
...
[types-aiobotocore-sms-voice docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/)
...
- Install `types-aiobotocore[sms-voice]` with services you use in your
  environment:
...
`types-aiobotocore-sms-voice` version is the same as related `aiobotocore`
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/)
