...
class Flywheel:
    ...
    def modify_user(self, user_id, body, **kwargs):  # noqa: E501
        ...
        :param str user_id: (required)
        :param User body: Accepts an object matching the User type except all fields are optional
 (required)
        :param bool async_: Perform the request asynchronously
    ...
    def read_view_data(self, view, container_id, decode=True, **kwargs):
        ...
        if self.get_config().get("features").get("task_manager_data_views"):
            ...
            resp = self.get_data_view_execution_data(data_view_execution_id, **kwargs)
        else:
            if isinstance(view, six.string_types):
