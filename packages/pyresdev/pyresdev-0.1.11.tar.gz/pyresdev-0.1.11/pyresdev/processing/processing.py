...
def preprocessing_training_common(df, config, model_type: str, mapping_dicts=None, imp=None):
    ...
    if mapping_dicts is None:
        ...
        pickle.dump(imp, open(mapping_dicts_output_path, 'wb'))
    else:
...
def preprocessing_training(df, config, model_type,
                           use_one_hot_encoding, mapping_dicts=None, imp=None):
