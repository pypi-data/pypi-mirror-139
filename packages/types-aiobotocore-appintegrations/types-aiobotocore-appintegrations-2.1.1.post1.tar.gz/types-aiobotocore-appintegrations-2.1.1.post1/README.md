...
[aiobotocore.AppIntegrationsService 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/appintegrations.html#AppIntegrationsService)
...
- Install `types-aiobotocore[appintegrations]` with services you use in your
  environment:
