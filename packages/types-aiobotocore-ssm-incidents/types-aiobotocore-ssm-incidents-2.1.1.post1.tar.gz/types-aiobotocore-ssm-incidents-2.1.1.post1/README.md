...
[aiobotocore.SSMIncidents 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ssm-incidents.html#SSMIncidents)
...
Install `types-aiobotocore-lite[ssm-incidents]` in your environment:
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_incidents/)
