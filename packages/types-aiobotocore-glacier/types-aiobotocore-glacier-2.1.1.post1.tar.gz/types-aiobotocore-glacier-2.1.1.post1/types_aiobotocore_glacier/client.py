...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html)
...
class GlacierClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#exceptions)
        """

    async def abort_multipart_upload(
        self, *, accountId: str, vaultName: str, uploadId: str
    ) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#abort_multipart_upload)
        """

    async def abort_vault_lock(self, *, accountId: str, vaultName: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#abort_vault_lock)
        """

    async def add_tags_to_vault(
        self, *, accountId: str, vaultName: str, Tags: Mapping[str, str] = ...
    ) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#add_tags_to_vault)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#can_paginate)
        """
    ...
    async def complete_multipart_upload(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#complete_multipart_upload)
        """

    async def complete_vault_lock(self, *, accountId: str, vaultName: str, lockId: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#complete_vault_lock)
        """

    async def create_vault(self, *, accountId: str, vaultName: str) -> CreateVaultOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#create_vault)
        """

    async def delete_archive(self, *, accountId: str, vaultName: str, archiveId: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#delete_archive)
        """

    async def delete_vault(self, *, accountId: str, vaultName: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#delete_vault)
        """

    async def delete_vault_access_policy(self, *, accountId: str, vaultName: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#delete_vault_access_policy)
        """

    async def delete_vault_notifications(self, *, accountId: str, vaultName: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#delete_vault_notifications)
        """
    ...
    async def describe_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#describe_job)
        """
    ...
    async def describe_vault(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#describe_vault)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#generate_presigned_url)
        """
    ...
    async def get_data_retrieval_policy(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#get_data_retrieval_policy)
        """

    async def get_job_output(
        self, *, accountId: str, vaultName: str, jobId: str, range: str = ...
    ) -> GetJobOutputOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#get_job_output)
        """
    ...
    async def get_vault_access_policy(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#get_vault_access_policy)
        """

    async def get_vault_lock(self, *, accountId: str, vaultName: str) -> GetVaultLockOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#get_vault_lock)
        """
    ...
    async def get_vault_notifications(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#get_vault_notifications)
        """

    async def initiate_job(
        self, *, accountId: str, vaultName: str, jobParameters: "JobParametersTypeDef" = ...
    ) -> InitiateJobOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#initiate_job)
        """

    async def initiate_multipart_upload(
        self, *, accountId: str, vaultName: str, archiveDescription: str = ..., partSize: str = ...
    ) -> InitiateMultipartUploadOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#initiate_multipart_upload)
        """

    async def initiate_vault_lock(
        self, *, accountId: str, vaultName: str, policy: "VaultLockPolicyTypeDef" = ...
    ) -> InitiateVaultLockOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#initiate_vault_lock)
        """
    ...
    async def list_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#list_jobs)
        """

    async def list_multipart_uploads(
        self, *, accountId: str, vaultName: str, marker: str = ..., limit: str = ...
    ) -> ListMultipartUploadsOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#list_multipart_uploads)
        """

    async def list_parts(
        self, *, accountId: str, vaultName: str, uploadId: str, marker: str = ..., limit: str = ...
    ) -> ListPartsOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#list_parts)
        """
    ...
    async def list_provisioned_capacity(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#list_provisioned_capacity)
        """
    ...
    async def list_tags_for_vault(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#list_tags_for_vault)
        """
    ...
    async def list_vaults(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#list_vaults)
        """
    ...
    async def purchase_provisioned_capacity(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#purchase_provisioned_capacity)
        """

    async def remove_tags_from_vault(
        self, *, accountId: str, vaultName: str, TagKeys: Sequence[str] = ...
    ) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#remove_tags_from_vault)
        """
    ...
    async def set_data_retrieval_policy(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#set_data_retrieval_policy)
        """

    async def set_vault_access_policy(
        self, *, accountId: str, vaultName: str, policy: "VaultAccessPolicyTypeDef" = ...
    ) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#set_vault_access_policy)
        """
    ...
    async def set_vault_notifications(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#set_vault_notifications)
        """
    ...
    async def upload_archive(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#upload_archive)
        """
    ...
    async def upload_multipart_part(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#upload_multipart_part)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#get_paginator)
        """
    ...
    def get_waiter(self, waiter_name: Literal["vault_exists"]) -> VaultExistsWaiter:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/client.html#get_waiter)
        """
