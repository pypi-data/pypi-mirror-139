...
class Spellbook:
    ...
    component_alias_references = {
        ...
        'dep.untyped': ('dependency_conllu', 'model'),  # default untyped dependency
    ...
    pretrained_models_references = {
        ...
        'nb': {
            'nb.lemma': 'lemma',
            # 'nb.pos.ud_bokmaal': 'pos_ud_bokmaal', # Depracated
        ...
        'fi': {
            ...
            # 'fi.embed_sentence': 'sent_bert_finnish_cased', # Broken bad TF Graph
            # 'fi.embed_sentence.bert.cased': 'sent_bert_finnish_cased', # Broken bad TF Graph
            # 'fi.embed_sentence.bert.uncased': 'sent_bert_finnish_uncased', # Broken bad TF Graph
        ...
        'en':
            {
                ...
                'en.classify.ade.seq_biobert': 'bert_sequence_classifier_ade_biobert',
    ...
    nlp_ref_to_anno_class = {
        ...
        'bert_sequence_classifier_ade_biobert': 'MedicalBertForSequenceClassification',
        ...
        # Generated below
        'lemma': 'LemmatizerModel', 'sentence_detector_dl': 'SentenceDetectorDLModel',
        'pos_ud_alpino': 'PerceptronModel', 'wikiner_6B_100': 'NerDLModel',
        'wikiner_6B_300': 'NerDLModel', 'wikiner_840B_300': 'NerDLModel',
        ...
        'onto_bert_base_cased': 'NerDLModel', 'onto_bert_large_cased': 'NerDLModel',
        'onto_electra_large_uncased': 'NerDLModel', 'onto_small_bert_L2_128': 'NerDLModel',
        ...
        'stopwords_en': 'StopWordsCleaner', 'nerdl_fewnerd_100d': 'NerDLModel',
        ...
        'glove_100d': 'WordEmbeddingsModel', 'bert_base_uncased': 'BertEmbeddings',
        'bert_large_uncased': 'BertEmbeddings', 'bert_large_cased': 'BertEmbeddings',
        'biobert_pubmed_base_cased': 'BertEmbeddings',
        'biobert_pubmed_large_cased': 'BertEmbeddings', 'biobert_pmc_base_cased': 'BertEmbeddings',
        'biobert_pubmed_pmc_base_cased': 'BertEmbeddings',
        'biobert_clinical_base_cased': 'BertEmbeddings',
        'biobert_discharge_base_cased': 'BertEmbeddings', 'elmo': 'ElmoEmbeddings',
        'tfhub_use': 'UniversalSentenceEncoder', 'tfhub_use_lg': 'UniversalSentenceEncoder',
        'albert_base_uncased': 'AlbertEmbeddings', 'albert_large_uncased': 'AlbertEmbeddings',
        'albert_xlarge_uncased': 'AlbertEmbeddings', 'albert_xxlarge_uncased': 'AlbertEmbeddings',
        'xlnet_base_cased': 'XlnetEmbeddings', 'xlnet_large_cased': 'XlnetEmbeddings',
        ...
        'sentimentdl_use_imdb': 'SentimentDLModel', 'sentimentdl_use_twitter': 'SentimentDLModel',
        'sentimentdl_glove_imdb': 'SentimentDLModel', 'yake': 'YakeKeywordExtraction',
        'electra_small_uncased': 'BertEmbeddings', 'electra_base_uncased': 'BertEmbeddings',
        'electra_large_uncased': 'BertEmbeddings', 'covidbert_large_uncased': 'BertEmbeddings',
        'small_bert_L2_128': 'BertEmbeddings', 'small_bert_L4_128': 'BertEmbeddings',
        'small_bert_L6_128': 'BertEmbeddings', 'small_bert_L8_128': 'BertEmbeddings',
        'small_bert_L10_128': 'BertEmbeddings', 'small_bert_L12_128': 'BertEmbeddings',
        'small_bert_L2_256': 'BertEmbeddings', 'small_bert_L4_256': 'BertEmbeddings',
        'small_bert_L6_256': 'BertEmbeddings', 'small_bert_L8_256': 'BertEmbeddings',
        'small_bert_L10_256': 'BertEmbeddings', 'small_bert_L12_256': 'BertEmbeddings',
        'small_bert_L2_512': 'BertEmbeddings', 'small_bert_L4_512': 'BertEmbeddings',
        'small_bert_L6_512': 'BertEmbeddings', 'small_bert_L8_512': 'BertEmbeddings',
        'small_bert_L10_512': 'BertEmbeddings', 'small_bert_L12_512': 'BertEmbeddings',
        'small_bert_L2_768': 'BertEmbeddings', 'small_bert_L4_768': 'BertEmbeddings',
        'small_bert_L6_768': 'BertEmbeddings', 'small_bert_L8_768': 'BertEmbeddings',
        'small_bert_L10_768': 'BertEmbeddings', 'small_bert_L12_768': 'BertEmbeddings',
        ...
        'google_t5_small_ssm_nq': 'T5Transformer', 't5_small': 'T5Transformer',
        't5_base': 'T5Transformer', 'classifierdl_use_atis': 'ClassifierDLModel',
        'nerdl_atis_840b_300d': 'NerDLModel', 'nerdl_snips_100d': 'NerDLModel',
        'classifierdl_use_snips': 'ClassifierDLModel',
        'distilbert_base_cased': 'DistilBertEmbeddings',
        'distilbert_base_uncased': 'DistilBertEmbeddings',
        'distilroberta_base': 'RoBertaEmbeddings', 'roberta_base': 'RoBertaEmbeddings',
        ...
        'ner_ontonotes_roberta_base': 'NerDLModel', 'ner_ontonotes_roberta_large': 'NerDLModel',
        'ner_ontonotes_distilbert_base_cased': 'NerDLModel',
        'ner_conll_bert_base_cased': 'NerDLModel', 'ner_conll_distilbert_base_cased': 'NerDLModel',
        'ner_conll_roberta_base': 'NerDLModel', 'ner_conll_roberta_large': 'NerDLModel',
        'ner_conll_xlm_roberta_base': 'NerDLModel',
        'ner_conll_longformer_large_4096': 'NerDLModel',
        'ner_conll_albert_base_uncased': 'NerDLModel',
        'ner_conll_albert_large_uncased': 'NerDLModel', 'ner_conll_xlnet_base_cased': 'NerDLModel',
        'bert_wiki_books_sst2': 'BertEmbeddings', 'bert_wiki_books_squad2': 'BertEmbeddings',
        'bert_wiki_books_qqp': 'BertEmbeddings', 'bert_wiki_books_qnli': 'BertEmbeddings',
        'bert_wiki_books_mnli': 'BertEmbeddings', 'bert_wiki_books': 'BertEmbeddings',
        'bert_pubmed_squad2': 'BertEmbeddings', 'bert_pubmed': 'BertEmbeddings',
        ...
        'sent_bert_pubmed': 'BertSentenceEmbeddings', 'bert_base_uncased_legal': 'BertEmbeddings',
        ...
        'doc2vec_gigaword_300': 'Doc2VecModel', 'doc2vec_gigaword_wiki_300': 'Doc2VecModel',
        'pos_ud_gsd': 'PerceptronModel', 'stopwords_fr': 'StopWordsCleaner',
        ...
        'pos_ud_hdt': 'PerceptronModel', 'stopwords_de': 'StopWordsCleaner',
        'bert_base_german_cased': 'BertEmbeddings', 'bert_base_german_uncased': 'BertEmbeddings',
        'classifierdl_bert_news': 'ClassifierDLModel', 'lemma_dxc': 'LemmatizerModel',
        'pos_ud_isdt': 'PerceptronModel', 'stopwords_it': 'StopWordsCleaner',
        'bert_base_italian_cased': 'BertEmbeddings', 'bert_base_italian_uncased': 'BertEmbeddings',
        'norne_6B_100': 'NerDLModel', 'norne_6B_300': 'NerDLModel', 'norne_840B_300': 'NerDLModel',
        'pos_ud_nynorsk': 'PerceptronModel', 'pos_ud_lfg': 'PerceptronModel',
        'stopwords_pl': 'StopWordsCleaner', 'pos_ud_bosque': 'PerceptronModel',
        'stopwords_pt': 'StopWordsCleaner', 'bert_portuguese_base_cased': 'BertEmbeddings',
        'bert_portuguese_large_cased': 'BertEmbeddings', 'stopwords_ru': 'StopWordsCleaner',
        'stopwords_es': 'StopWordsCleaner',
        'bert_token_classifier_spanish_ner': 'BertForTokenClassification',
        'stopwords_af': 'StopWordsCleaner', 'pos_afribooms': 'PerceptronModel',
        'stopwords_ar': 'StopWordsCleaner', 'pos_ud_padt': 'PerceptronModel',
        'arabic_w2v_cc_300d': 'WordEmbeddingsModel', 'aner_cc_300d': 'NerDLModel',
        'stopwords_hy': 'StopWordsCleaner', 'pos_ud_armtdp': 'PerceptronModel',
        'stopwords_eu': 'StopWordsCleaner', 'pos_ud_bdt': 'PerceptronModel',
        'stopwords_bn': 'StopWordsCleaner', 'pos_msri': 'PerceptronModel',
        'bengaliner_cc_300d': 'NerDLModel', 'ner_jifs_glove_840B_300d': 'NerDLModel',
        'bengali_cc_300d': 'WordEmbeddingsModel', 'stopwords_br': 'StopWordsCleaner',
        'pos_ud_keb': 'PerceptronModel', 'pos_ud_btb': 'PerceptronModel',
        'stopwords_bg': 'StopWordsCleaner', 'stopwords_ca': 'StopWordsCleaner',
        'pos_ud_ancora': 'PerceptronModel', 'pos_ud_pdt': 'PerceptronModel',
        'stopwords_cs': 'StopWordsCleaner', 'stopwords_eo': 'StopWordsCleaner',
        'pos_ud_tdt': 'PerceptronModel', 'stopwords_fi': 'StopWordsCleaner',
        'bert_finnish_cased': 'BertEmbeddings', 'bert_finnish_uncased': 'BertEmbeddings',
        'finnish_ner_6B_100': 'NerDLModel', 'finnish_ner_6B_300': 'NerDLModel',
        'finnish_ner_840B_300': 'NerDLModel', 'stopwords_gl': 'StopWordsCleaner',
        'pos_ud_treegal': 'PerceptronModel', 'pos_ud_gdt': 'PerceptronModel',
        'stopwords_el': 'StopWordsCleaner', 'stopwords_ha': 'StopWordsCleaner',
        'xlm_roberta_base_finetuned_hausa': 'XlmRoBertaEmbeddings',
        'sent_xlm_roberta_base_finetuned_hausa': 'XlmRoBertaSentenceEmbeddings',
        'stopwords_he': 'StopWordsCleaner', 'hebrew_cc_300d': 'WordEmbeddingsModel',
        'hebrewner_cc_300d': 'NerDLModel', 'pos_ud_htb': 'PerceptronModel',
        'stopwords_hi': 'StopWordsCleaner', 'pos_ud_hdtb': 'PerceptronModel',
        'hindi_cc_300d': 'WordEmbeddingsModel', 'pos_ud_szeged': 'PerceptronModel',
        'stopwords_hu': 'StopWordsCleaner', 'stopwords_id': 'StopWordsCleaner',
        'stopwords_ga': 'StopWordsCleaner', 'pos_ud_idt': 'PerceptronModel',
        'pos_ud_ddt': 'PerceptronModel', 'dane_ner_6B_100': 'NerDLModel',
        'dane_ner_6B_300': 'NerDLModel', 'dane_ner_840B_300': 'NerDLModel',
        'stopwords_ja': 'StopWordsCleaner', 'wordseg_gsd_ud': 'WordSegmenterModel',
        'ner_ud_gsd_glove_840B_300d': 'NerDLModel', 'japanese_cc_300d': 'WordEmbeddingsModel',
        'ner_ud_gsd_cc_300d': 'NerDLModel', 'ner_ud_gsd_xlm_roberta_base': 'NerDLModel',
        'bert_token_classifier_ner_ud_gsd': 'BertForTokenClassification',
        'stopwords_la': 'StopWordsCleaner', 'pos_ud_llct': 'PerceptronModel',
        'stopwords_lv': 'StopWordsCleaner', 'pos_ud_lvtb': 'PerceptronModel',
        'stopwords_mr': 'StopWordsCleaner', 'pos_ud_ufal': 'PerceptronModel',
        'stopwords_fa': 'StopWordsCleaner', 'pos_ud_perdt': 'PerceptronModel',
        'personer_cc_300d': 'NerDLModel', 'persian_w2v_cc_300d': 'WordEmbeddingsModel',
        ...
        'pos_ud_rrt': 'PerceptronModel', 'stopwords_ro': 'StopWordsCleaner',
        'pos_ud_snk': 'PerceptronModel', 'stopwords_sk': 'StopWordsCleaner',
        'stopwords_sl': 'StopWordsCleaner', 'pos_ud_ssj': 'PerceptronModel',
        'stopwords_so': 'StopWordsCleaner', 'stopwords_st': 'StopWordsCleaner',
        ...
        'pos_ud_tal': 'PerceptronModel', 'stopwords_sv': 'StopWordsCleaner',
        'swedish_ner_6B_100': 'NerDLModel', 'swedish_ner_6B_300': 'NerDLModel',
        'swedish_ner_840B_300': 'NerDLModel',
        'bert_token_classifier_swedish_ner': 'BertForTokenClassification',
        'stopwords_th': 'StopWordsCleaner', 'ner_lst20_glove_840B_300d': 'NerDLModel',
        'wordseg_best': 'WordSegmenterModel', 'pos_lst20': 'PerceptronModel',
        'sentiment_jager_use': 'SentimentDLModel', 'pos_ud_imst': 'PerceptronModel',
        'stopwords_tr': 'StopWordsCleaner', 'turkish_ner_840B_300': 'NerDLModel',
        'turkish_ner_bert': 'NerDLModel', 'bert_base_turkish_cased': 'BertEmbeddings',
        ...
        'pos_ud_iu': 'PerceptronModel', 'stopwords_yo': 'StopWordsCleaner',
        ...
        'stopwords_zu': 'StopWordsCleaner', 'wordseg_weibo': 'WordSegmenterModel',
        'wordseg_pku': 'WordSegmenterModel', 'wordseg_msra': 'WordSegmenterModel',
        'wordseg_large': 'WordSegmenterModel', 'wordseg_ctb9': 'WordSegmenterModel',
        'wordseg_gsd_ud_trad': 'WordSegmenterModel', 'pos_ud_gsd_trad': 'PerceptronModel',
        'ner_msra_bert_768d': 'NerDLModel', 'ner_weibo_bert_768d': 'NerDLModel',
        'bert_base_chinese': 'BertEmbeddings', 'chinese_bert_wwm': 'BertEmbeddings',
        'chinese_xlnet_base': 'XlnetEmbeddings', 'pos_ud_udtb': 'PerceptronModel',
        'sentimentdl_urduvec_imdb': 'SentimentDLModel', 'urduvec_140M_300d': 'WordEmbeddingsModel',
        'uner_mk_140M_300d': 'NerDLModel', 'wordseg_kaist_ud': 'WordSegmenterModel',
        'ner_kmou_glove_840B_300d': 'NerDLModel', 'pos_ud_bhtb': 'PerceptronModel',
        ...
        'bert_muril': 'BertEmbeddings', 'sent_bert_muril': 'BertSentenceEmbeddings',
        'ner_xtreme_glove_840B_300': 'NerDLModel',
        'ner_xtreme_xlm_roberta_xtreme_base': 'NerDLModel',
        'ner_wikiner_glove_840B_300': 'NerDLModel', 'ner_wikiner_xlm_roberta_base': 'NerDLModel',
        ...
        'glove_840B_300': 'WordEmbeddingsModel', 'glove_6B_300': 'WordEmbeddingsModel',
        'glove_6B_100': 'WordEmbeddingsModel', 'bert_multi_cased': 'BertEmbeddings',
        'ld_wiki_tatoeba_cnn_21': 'LanguageDetectorDL',
        'ld_tatoeba_bigru_21': 'LanguageDetectorDL', 'ld_tatoeba_cnn_99': 'LanguageDetectorDL',
        'ld_wiki_cnn_231': 'LanguageDetectorDL', 'ld_wiki_tatoeba_cnn_43': 'LanguageDetectorDL',
        ...
        'sent_bert_multi_cased': 'BertSentenceEmbeddings', 'labse': 'BertSentenceEmbeddings',
        ...
        'tfhub_use_multi_lg': 'UniversalSentenceEncoder', 'opus_mt_swc_en': 'MarianTransformer',
        'opus_mt_en_umb': 'MarianTransformer', 'opus_mt_en_bem': 'MarianTransformer',
        'opus_mt_kwy_en': 'MarianTransformer', 'opus_mt_en_ti': 'MarianTransformer',
        'opus_mt_efi_en': 'MarianTransformer', 'opus_mt_taw_en': 'MarianTransformer',
        'opus_mt_bem_en': 'MarianTransformer', 'opus_mt_en_sw': 'MarianTransformer',
        'opus_mt_en_sn': 'MarianTransformer', 'opus_mt_pqe_en': 'MarianTransformer',
        'opus_mt_ny_en': 'MarianTransformer', 'opus_mt_urj_en': 'MarianTransformer',
        'opus_mt_war_en': 'MarianTransformer', 'opus_mt_nso_en': 'MarianTransformer',
        'opus_mt_en_hu': 'MarianTransformer', 'opus_mt_en_cpp': 'MarianTransformer',
        'opus_mt_ja_en': 'MarianTransformer', 'opus_mt_en_rn': 'MarianTransformer',
        'opus_mt_en_bcl': 'MarianTransformer', 'opus_mt_en_bi': 'MarianTransformer',
        'opus_mt_vi_en': 'MarianTransformer', 'opus_mt_ln_en': 'MarianTransformer',
        'opus_mt_en_itc': 'MarianTransformer', 'opus_mt_itc_en': 'MarianTransformer',
        'opus_mt_uk_en': 'MarianTransformer', 'opus_mt_en_gmq': 'MarianTransformer',
        'opus_mt_loz_en': 'MarianTransformer', 'opus_mt_mg_en': 'MarianTransformer',
        'opus_mt_bnt_en': 'MarianTransformer', 'opus_mt_en_zls': 'MarianTransformer',
        'opus_mt_mkh_en': 'MarianTransformer', 'opus_mt_en_lg': 'MarianTransformer',
        'opus_mt_et_en': 'MarianTransformer', 'opus_mt_fi_en': 'MarianTransformer',
        'opus_mt_en_vi': 'MarianTransformer', 'opus_mt_en_ga': 'MarianTransformer',
        'opus_mt_nic_en': 'MarianTransformer', 'opus_mt_lua_en': 'MarianTransformer',
        'opus_mt_afa_en': 'MarianTransformer', 'opus_mt_en_pis': 'MarianTransformer',
        'opus_mt_en_ts': 'MarianTransformer', 'opus_mt_sv_en': 'MarianTransformer',
        'opus_mt_en_dra': 'MarianTransformer', 'opus_mt_en_pag': 'MarianTransformer',
        'opus_mt_en_ln': 'MarianTransformer', 'opus_mt_alv_en': 'MarianTransformer',
        'opus_mt_ee_en': 'MarianTransformer', 'opus_mt_bg_en': 'MarianTransformer',
        'opus_mt_en_tw': 'MarianTransformer', 'opus_mt_en_gaa': 'MarianTransformer',
        'opus_mt_en_tll': 'MarianTransformer', 'opus_mt_en_phi': 'MarianTransformer',
        'opus_mt_en_tiv': 'MarianTransformer', 'opus_mt_en_ss': 'MarianTransformer',
        'opus_mt_en_cs': 'MarianTransformer', 'opus_mt_kwn_en': 'MarianTransformer',
        'opus_mt_mh_en': 'MarianTransformer', 'opus_mt_en_cy': 'MarianTransformer',
        'opus_mt_en_mt': 'MarianTransformer', 'opus_mt_en_ber': 'MarianTransformer',
        'opus_mt_ine_en': 'MarianTransformer', 'opus_mt_ng_en': 'MarianTransformer',
        'opus_mt_ase_en': 'MarianTransformer', 'opus_mt_en_afa': 'MarianTransformer',
        'opus_mt_en_ml': 'MarianTransformer', 'opus_mt_en_zle': 'MarianTransformer',
        'opus_mt_wal_en': 'MarianTransformer', 'opus_mt_en_sit': 'MarianTransformer',
        'opus_mt_hy_en': 'MarianTransformer', 'opus_mt_umb_en': 'MarianTransformer',
        'opus_mt_en_cpf': 'MarianTransformer', 'opus_mt_en_gv': 'MarianTransformer',
        'opus_mt_en_pap': 'MarianTransformer', 'opus_mt_gl_en': 'MarianTransformer',
        'opus_mt_kqn_en': 'MarianTransformer', 'opus_mt_ca_en': 'MarianTransformer',
        'opus_mt_gem_en': 'MarianTransformer', 'opus_mt_en_crs': 'MarianTransformer',
        'opus_mt_en_rw': 'MarianTransformer', 'opus_mt_en_ig': 'MarianTransformer',
        'opus_mt_en_aav': 'MarianTransformer', 'opus_mt_en_tl': 'MarianTransformer',
        'opus_mt_sm_en': 'MarianTransformer', 'opus_mt_en_hi': 'MarianTransformer',
        'opus_mt_chk_en': 'MarianTransformer', 'opus_mt_en_kwy': 'MarianTransformer',
        'opus_mt_en_ho': 'MarianTransformer', 'opus_mt_ve_en': 'MarianTransformer',
        'opus_mt_ceb_en': 'MarianTransformer', 'opus_mt_aav_en': 'MarianTransformer',
        'opus_mt_st_en': 'MarianTransformer', 'opus_mt_en_cus': 'MarianTransformer',
        'opus_mt_en_bnt': 'MarianTransformer', 'opus_mt_iso_en': 'MarianTransformer',
        'opus_mt_tr_en': 'MarianTransformer', 'opus_mt_om_en': 'MarianTransformer',
        'opus_mt_fj_en': 'MarianTransformer', 'opus_mt_ml_en': 'MarianTransformer',
        'opus_mt_en_ro': 'MarianTransformer', 'opus_mt_en_ny': 'MarianTransformer',
        'opus_mt_en_ty': 'MarianTransformer', 'opus_mt_cel_en': 'MarianTransformer',
        'opus_mt_ccs_en': 'MarianTransformer', 'opus_mt_hu_en': 'MarianTransformer',
        'opus_mt_art_en': 'MarianTransformer', 'opus_mt_en_ar': 'MarianTransformer',
        'opus_mt_en_mfe': 'MarianTransformer', 'opus_mt_yap_en': 'MarianTransformer',
        'opus_mt_ha_en': 'MarianTransformer', 'opus_mt_cpf_en': 'MarianTransformer',
        'opus_mt_en_hy': 'MarianTransformer', 'opus_mt_en_roa': 'MarianTransformer',
        'opus_mt_crs_en': 'MarianTransformer', 'opus_mt_en_lun': 'MarianTransformer',
        'opus_mt_zls_en': 'MarianTransformer', 'opus_mt_en_mk': 'MarianTransformer',
        'opus_mt_en_fiu': 'MarianTransformer', 'opus_mt_en_sv': 'MarianTransformer',
        'opus_mt_gmw_en': 'MarianTransformer', 'opus_mt_en_st': 'MarianTransformer',
        'opus_mt_en_om': 'MarianTransformer', 'opus_mt_en_pqw': 'MarianTransformer',
        'opus_mt_en_hil': 'MarianTransformer', 'opus_mt_sk_en': 'MarianTransformer',
        'opus_mt_en_mr': 'MarianTransformer', 'opus_mt_tll_en': 'MarianTransformer',
        'opus_mt_en_jap': 'MarianTransformer', 'opus_mt_en_chk': 'MarianTransformer',
        'opus_mt_tum_en': 'MarianTransformer', 'opus_mt_dra_en': 'MarianTransformer',
        'opus_mt_en_kqn': 'MarianTransformer', 'opus_mt_en_tdt': 'MarianTransformer',
        'opus_mt_en_tvl': 'MarianTransformer', 'opus_mt_en_lue': 'MarianTransformer',
        'opus_mt_en_ilo': 'MarianTransformer', 'opus_mt_en_poz': 'MarianTransformer',
        'opus_mt_pap_en': 'MarianTransformer', 'opus_mt_af_en': 'MarianTransformer',
        'opus_mt_en_bzs': 'MarianTransformer', 'opus_mt_toi_en': 'MarianTransformer',
        'opus_mt_en_mg': 'MarianTransformer', 'opus_mt_ber_en': 'MarianTransformer',
        'opus_mt_kj_en': 'MarianTransformer', 'opus_mt_ko_en': 'MarianTransformer',
        'opus_mt_inc_en': 'MarianTransformer', 'opus_mt_en_is': 'MarianTransformer',
        'opus_mt_mr_en': 'MarianTransformer', 'opus_mt_ka_en': 'MarianTransformer',
        'opus_mt_en_nic': 'MarianTransformer', 'opus_mt_en_eu': 'MarianTransformer',
        'opus_mt_pl_en': 'MarianTransformer', 'opus_mt_hil_en': 'MarianTransformer',
        'opus_mt_en_luo': 'MarianTransformer', 'opus_mt_en_zh': 'MarianTransformer',
        'opus_mt_en_fi': 'MarianTransformer', 'opus_mt_en_kg': 'MarianTransformer',
        'opus_mt_bi_en': 'MarianTransformer', 'opus_mt_sg_en': 'MarianTransformer',
        'opus_mt_en_ng': 'MarianTransformer', 'opus_mt_en_inc': 'MarianTransformer',
        'opus_mt_en_uk': 'MarianTransformer', 'opus_mt_en_es': 'MarianTransformer',
        'opus_mt_en_swc': 'MarianTransformer', 'opus_mt_sq_en': 'MarianTransformer',
        'opus_mt_en_niu': 'MarianTransformer', 'opus_mt_trk_en': 'MarianTransformer',
        'opus_mt_en_mh': 'MarianTransformer', 'opus_mt_luo_en': 'MarianTransformer',
        'opus_mt_mt_en': 'MarianTransformer', 'opus_mt_to_en': 'MarianTransformer',
        'opus_mt_tiv_en': 'MarianTransformer', 'opus_mt_en_ca': 'MarianTransformer',
        'opus_mt_en_iso': 'MarianTransformer', 'opus_mt_gil_en': 'MarianTransformer',
        'opus_mt_en_trk': 'MarianTransformer', 'opus_mt_ga_en': 'MarianTransformer',
        'opus_mt_en_sem': 'MarianTransformer', 'opus_mt_da_en': 'MarianTransformer',
        'opus_mt_is_en': 'MarianTransformer', 'opus_mt_en_mul': 'MarianTransformer',
        'opus_mt_en_nyk': 'MarianTransformer', 'opus_mt_de_en': 'MarianTransformer',
        'opus_mt_rn_en': 'MarianTransformer', 'opus_mt_yo_en': 'MarianTransformer',
        'opus_mt_sn_en': 'MarianTransformer', 'opus_mt_lun_en': 'MarianTransformer',
        'opus_mt_en_iir': 'MarianTransformer', 'opus_mt_en_toi': 'MarianTransformer',
        'opus_mt_pag_en': 'MarianTransformer', 'opus_mt_en_ee': 'MarianTransformer',
        'opus_mt_grk_en': 'MarianTransformer', 'opus_mt_zle_en': 'MarianTransformer',
        'opus_mt_zh_en': 'MarianTransformer', 'opus_mt_en_tn': 'MarianTransformer',
        'opus_mt_en_az': 'MarianTransformer', 'opus_mt_en_bat': 'MarianTransformer',
        'opus_mt_en_tut': 'MarianTransformer', 'opus_mt_eu_en': 'MarianTransformer',
        'opus_mt_kab_en': 'MarianTransformer', 'opus_mt_rnd_en': 'MarianTransformer',
        'opus_mt_ur_en': 'MarianTransformer', 'opus_mt_ss_en': 'MarianTransformer',
        'opus_mt_cau_en': 'MarianTransformer', 'opus_mt_cs_en': 'MarianTransformer',
        'opus_mt_en_de': 'MarianTransformer', 'opus_mt_en_sq': 'MarianTransformer',
        'opus_mt_roa_en': 'MarianTransformer', 'opus_mt_eo_en': 'MarianTransformer',
        'opus_mt_wa_en': 'MarianTransformer', 'opus_mt_zlw_en': 'MarianTransformer',
        'opus_mt_lg_en': 'MarianTransformer', 'opus_mt_en_gmw': 'MarianTransformer',
        'opus_mt_fr_en': 'MarianTransformer', 'opus_mt_en_it': 'MarianTransformer',
        'opus_mt_tpi_en': 'MarianTransformer', 'opus_mt_bcl_en': 'MarianTransformer',
        'opus_mt_id_en': 'MarianTransformer', 'opus_mt_ht_en': 'MarianTransformer',
        'opus_mt_en_run': 'MarianTransformer', 'opus_mt_en_bg': 'MarianTransformer',
        'opus_mt_mul_en': 'MarianTransformer', 'opus_mt_mk_en': 'MarianTransformer',
        'opus_mt_en_gil': 'MarianTransformer', 'opus_mt_en_nso': 'MarianTransformer',
        'opus_mt_gv_en': 'MarianTransformer', 'opus_mt_es_en': 'MarianTransformer',
        'opus_mt_ilo_en': 'MarianTransformer', 'opus_mt_srn_en': 'MarianTransformer',
        'opus_mt_guw_en': 'MarianTransformer', 'opus_mt_fiu_en': 'MarianTransformer',
        'opus_mt_wls_en': 'MarianTransformer', 'opus_mt_en_nl': 'MarianTransformer',
        'opus_mt_rw_en': 'MarianTransformer', 'opus_mt_en_ceb': 'MarianTransformer',
        'opus_mt_run_en': 'MarianTransformer', 'opus_mt_nyk_en': 'MarianTransformer',
        'opus_mt_ho_en': 'MarianTransformer', 'opus_mt_en_urj': 'MarianTransformer',
        'opus_mt_en_pon': 'MarianTransformer', 'opus_mt_phi_en': 'MarianTransformer',
        'opus_mt_kl_en': 'MarianTransformer', 'opus_mt_bn_en': 'MarianTransformer',
        'opus_mt_en_efi': 'MarianTransformer', 'opus_mt_en_pqe': 'MarianTransformer',
        'opus_mt_en_rnd': 'MarianTransformer', 'opus_mt_en_id': 'MarianTransformer',
        'opus_mt_nl_en': 'MarianTransformer', 'opus_mt_ru_en': 'MarianTransformer',
        'opus_mt_en_sla': 'MarianTransformer', 'opus_mt_en_guw': 'MarianTransformer',
        'opus_mt_euq_en': 'MarianTransformer', 'opus_mt_lu_en': 'MarianTransformer',
        'opus_mt_en_fj': 'MarianTransformer', 'opus_mt_en_ru': 'MarianTransformer',
        'opus_mt_en_gem': 'MarianTransformer', 'opus_mt_en_map': 'MarianTransformer',
        'opus_mt_en_euq': 'MarianTransformer', 'opus_mt_en_kwn': 'MarianTransformer',
        'opus_mt_en_gl': 'MarianTransformer', 'opus_mt_en_ha': 'MarianTransformer',
        'opus_mt_cpp_en': 'MarianTransformer', 'opus_mt_en_mkh': 'MarianTransformer',
        'opus_mt_en_kj': 'MarianTransformer', 'opus_mt_bat_en': 'MarianTransformer',
        'opus_mt_en_sal': 'MarianTransformer', 'opus_mt_pa_en': 'MarianTransformer',
        'opus_mt_jap_en': 'MarianTransformer', 'opus_mt_sla_en': 'MarianTransformer',
        'opus_mt_ar_en': 'MarianTransformer', 'opus_mt_xh_en': 'MarianTransformer',
        'opus_mt_mfe_en': 'MarianTransformer', 'opus_mt_en_zlw': 'MarianTransformer',
        'opus_mt_en_lua': 'MarianTransformer', 'opus_mt_en_ine': 'MarianTransformer',
        'opus_mt_en_loz': 'MarianTransformer', 'opus_mt_lus_en': 'MarianTransformer',
        'opus_mt_lv_en': 'MarianTransformer', 'opus_mt_en_af': 'MarianTransformer',
        'opus_mt_sal_en': 'MarianTransformer', 'opus_mt_hi_en': 'MarianTransformer',
        'opus_mt_gaa_en': 'MarianTransformer', 'opus_mt_pon_en': 'MarianTransformer',
        'opus_mt_ig_en': 'MarianTransformer', 'opus_mt_en_lus': 'MarianTransformer',
        'opus_mt_th_en': 'MarianTransformer', 'opus_mt_kg_en': 'MarianTransformer',
        'opus_mt_cus_en': 'MarianTransformer', 'opus_mt_cy_en': 'MarianTransformer',
        'opus_mt_en_alv': 'MarianTransformer', 'opus_mt_sem_en': 'MarianTransformer',
        'opus_mt_en_tpi': 'MarianTransformer', 'opus_mt_en_grk': 'MarianTransformer',
        'opus_mt_gmq_en': 'MarianTransformer', 'opus_mt_tn_en': 'MarianTransformer',
        'opus_mt_en_sg': 'MarianTransformer', 'opus_mt_pis_en': 'MarianTransformer',
        'opus_mt_en_sm': 'MarianTransformer', 'opus_mt_en_ht': 'MarianTransformer',
        'opus_mt_mos_en': 'MarianTransformer', 'opus_mt_iir_en': 'MarianTransformer',
        'opus_mt_en_mos': 'MarianTransformer', 'opus_mt_ts_en': 'MarianTransformer',
        'opus_mt_en_he': 'MarianTransformer', 'opus_mt_en_da': 'MarianTransformer',
        'opus_mt_it_en': 'MarianTransformer', 'opus_mt_en_cel': 'MarianTransformer',
        'opus_mt_en_el': 'MarianTransformer', 'opus_mt_en_xh': 'MarianTransformer',
        'opus_mt_en_eo': 'MarianTransformer', 'opus_mt_az_en': 'MarianTransformer',
        'opus_mt_tvl_en': 'MarianTransformer', 'opus_mt_tl_en': 'MarianTransformer',
        'opus_mt_bzs_en': 'MarianTransformer', 'opus_mt_en_et': 'MarianTransformer',
        'opus_mt_en_sk': 'MarianTransformer', 'opus_mt_en_to': 'MarianTransformer',
        'opus_mt_en_ur': 'MarianTransformer', 'opus_mt_lue_en': 'MarianTransformer',
        'opus_mt_niu_en': 'MarianTransformer', 'opus_mt_ti_en': 'MarianTransformer',
        'opus_mt_en_lu': 'MarianTransformer', 'opus_mt_bcl_fr': 'MarianTransformer',
        'opus_mt_ar_tr': 'MarianTransformer', 'opus_mt_af_sv': 'MarianTransformer',
        'opus_mt_ar_de': 'MarianTransformer', 'opus_mt_bi_fr': 'MarianTransformer',
        'opus_mt_bi_es': 'MarianTransformer', 'opus_mt_af_fi': 'MarianTransformer',
        'opus_mt_crs_fi': 'MarianTransformer', 'opus_mt_bem_fi': 'MarianTransformer',
        'opus_mt_bem_sv': 'MarianTransformer', 'opus_mt_ca_it': 'MarianTransformer',
        'opus_mt_ca_fr': 'MarianTransformer', 'opus_mt_bcl_es': 'MarianTransformer',
        'opus_mt_ca_uk': 'MarianTransformer', 'opus_mt_bem_fr': 'MarianTransformer',
        'opus_mt_af_de': 'MarianTransformer', 'opus_mt_af_nl': 'MarianTransformer',
        'opus_mt_ase_fr': 'MarianTransformer', 'opus_mt_az_es': 'MarianTransformer',
        'opus_mt_chk_es': 'MarianTransformer', 'opus_mt_ceb_sv': 'MarianTransformer',
        'opus_mt_ceb_es': 'MarianTransformer', 'opus_mt_aed_es': 'MarianTransformer',
        'opus_mt_ar_pl': 'MarianTransformer', 'opus_mt_bem_es': 'MarianTransformer',
        'opus_mt_af_eo': 'MarianTransformer', 'opus_mt_cs_fr': 'MarianTransformer',
        'opus_mt_bcl_fi': 'MarianTransformer', 'opus_mt_crs_es': 'MarianTransformer',
        'opus_mt_bi_sv': 'MarianTransformer', 'opus_mt_bg_de': 'MarianTransformer',
        'opus_mt_ar_ru': 'MarianTransformer', 'opus_mt_bg_es': 'MarianTransformer',
        'opus_mt_cs_uk': 'MarianTransformer', 'opus_mt_bzs_sv': 'MarianTransformer',
        'opus_mt_be_es': 'MarianTransformer', 'opus_mt_bzs_es': 'MarianTransformer',
        'opus_mt_af_fr': 'MarianTransformer', 'opus_mt_ca_pt': 'MarianTransformer',
        'opus_mt_chk_fr': 'MarianTransformer', 'opus_mt_ase_de': 'MarianTransformer',
        'opus_mt_ar_it': 'MarianTransformer', 'opus_mt_ceb_fi': 'MarianTransformer',
        'opus_mt_cpp_cpp': 'MarianTransformer', 'opus_mt_ber_fr': 'MarianTransformer',
        'opus_mt_bg_ru': 'MarianTransformer', 'opus_mt_ase_es': 'MarianTransformer',
        'opus_mt_af_es': 'MarianTransformer', 'opus_mt_bg_it': 'MarianTransformer',
        'opus_mt_am_sv': 'MarianTransformer', 'opus_mt_ar_eo': 'MarianTransformer',
        'opus_mt_ceb_fr': 'MarianTransformer', 'opus_mt_ca_es': 'MarianTransformer',
        'opus_mt_bzs_fi': 'MarianTransformer', 'opus_mt_crs_de': 'MarianTransformer',
        'opus_mt_cs_fi': 'MarianTransformer', 'opus_mt_afa_afa': 'MarianTransformer',
        'opus_mt_bg_sv': 'MarianTransformer', 'opus_mt_bg_tr': 'MarianTransformer',
        'opus_mt_crs_fr': 'MarianTransformer', 'opus_mt_ase_sv': 'MarianTransformer',
        'opus_mt_cs_de': 'MarianTransformer', 'opus_mt_cs_eo': 'MarianTransformer',
        'opus_mt_chk_sv': 'MarianTransformer', 'opus_mt_bcl_sv': 'MarianTransformer',
        'opus_mt_ar_fr': 'MarianTransformer', 'opus_mt_af_ru': 'MarianTransformer',
        'opus_mt_ar_he': 'MarianTransformer', 'opus_mt_bg_fi': 'MarianTransformer',
        'opus_mt_ber_es': 'MarianTransformer', 'opus_mt_ar_es': 'MarianTransformer',
        'opus_mt_bg_uk': 'MarianTransformer', 'opus_mt_bzs_fr': 'MarianTransformer',
        'opus_mt_ar_el': 'MarianTransformer', 'opus_mt_ca_nl': 'MarianTransformer',
        'opus_mt_bcl_de': 'MarianTransformer', 'opus_mt_bg_eo': 'MarianTransformer',
        'opus_mt_efi_de': 'MarianTransformer', 'opus_mt_de_bzs': 'MarianTransformer',
        'opus_mt_de_fj': 'MarianTransformer', 'opus_mt_da_fi': 'MarianTransformer',
        'opus_mt_da_no': 'MarianTransformer', 'opus_mt_de_cs': 'MarianTransformer',
        'opus_mt_de_efi': 'MarianTransformer', 'opus_mt_de_gil': 'MarianTransformer',
        'opus_mt_de_bcl': 'MarianTransformer', 'opus_mt_de_pag': 'MarianTransformer',
        'opus_mt_de_kg': 'MarianTransformer', 'opus_mt_efi_fi': 'MarianTransformer',
        'opus_mt_de_is': 'MarianTransformer', 'opus_mt_da_fr': 'MarianTransformer',
        'opus_mt_de_pl': 'MarianTransformer', 'opus_mt_de_ln': 'MarianTransformer',
        'opus_mt_de_pap': 'MarianTransformer', 'opus_mt_de_vi': 'MarianTransformer',
        'opus_mt_de_no': 'MarianTransformer', 'opus_mt_el_eo': 'MarianTransformer',
        'opus_mt_de_af': 'MarianTransformer', 'opus_mt_ee_es': 'MarianTransformer',
        'opus_mt_de_eo': 'MarianTransformer', 'opus_mt_de_bi': 'MarianTransformer',
        'opus_mt_de_mt': 'MarianTransformer', 'opus_mt_de_lt': 'MarianTransformer',
        'opus_mt_de_bg': 'MarianTransformer', 'opus_mt_de_hil': 'MarianTransformer',
        'opus_mt_de_eu': 'MarianTransformer', 'opus_mt_de_da': 'MarianTransformer',
        'opus_mt_de_ms': 'MarianTransformer', 'opus_mt_de_he': 'MarianTransformer',
        'opus_mt_de_et': 'MarianTransformer', 'opus_mt_de_es': 'MarianTransformer',
        'opus_mt_el_fr': 'MarianTransformer', 'opus_mt_ee_fr': 'MarianTransformer',
        'opus_mt_de_el': 'MarianTransformer', 'opus_mt_el_sv': 'MarianTransformer',
        'opus_mt_csn_es': 'MarianTransformer', 'opus_mt_de_tl': 'MarianTransformer',
        'opus_mt_de_pon': 'MarianTransformer', 'opus_mt_efi_fr': 'MarianTransformer',
        'opus_mt_de_uk': 'MarianTransformer', 'opus_mt_el_ar': 'MarianTransformer',
        'opus_mt_el_fi': 'MarianTransformer', 'opus_mt_de_ig': 'MarianTransformer',
        'opus_mt_de_guw': 'MarianTransformer', 'opus_mt_de_iso': 'MarianTransformer',
        'opus_mt_efi_sv': 'MarianTransformer', 'opus_mt_de_ha': 'MarianTransformer',
        'opus_mt_de_fr': 'MarianTransformer', 'opus_mt_de_gaa': 'MarianTransformer',
        'opus_mt_de_nso': 'MarianTransformer', 'opus_mt_de_ht': 'MarianTransformer',
        'opus_mt_de_nl': 'MarianTransformer', 'opus_mt_ee_sv': 'MarianTransformer',
        'opus_mt_ee_fi': 'MarianTransformer', 'opus_mt_ee_de': 'MarianTransformer',
        'opus_mt_da_eo': 'MarianTransformer', 'opus_mt_csg_es': 'MarianTransformer',
        'opus_mt_da_de': 'MarianTransformer', 'opus_mt_de_ar': 'MarianTransformer',
        'opus_mt_de_hu': 'MarianTransformer', 'opus_mt_de_ca': 'MarianTransformer',
        'opus_mt_de_pis': 'MarianTransformer', 'opus_mt_de_ho': 'MarianTransformer',
        'opus_mt_de_de': 'MarianTransformer', 'opus_mt_de_lua': 'MarianTransformer',
        'opus_mt_de_loz': 'MarianTransformer', 'opus_mt_de_crs': 'MarianTransformer',
        'opus_mt_da_es': 'MarianTransformer', 'opus_mt_de_ee': 'MarianTransformer',
        'opus_mt_de_it': 'MarianTransformer', 'opus_mt_de_ilo': 'MarianTransformer',
        'opus_mt_de_ny': 'MarianTransformer', 'opus_mt_de_fi': 'MarianTransformer',
        'opus_mt_de_ase': 'MarianTransformer', 'opus_mt_de_hr': 'MarianTransformer',
        'opus_mt_fi_sl': 'MarianTransformer', 'opus_mt_fi_sk': 'MarianTransformer',
        'opus_mt_es_ru': 'MarianTransformer', 'opus_mt_fi_sn': 'MarianTransformer',
        'opus_mt_eo_pl': 'MarianTransformer', 'opus_mt_es_cs': 'MarianTransformer',
        'opus_mt_fi_wls': 'MarianTransformer', 'opus_mt_fi_gaa': 'MarianTransformer',
        'opus_mt_fi_is': 'MarianTransformer', 'opus_mt_es_ha': 'MarianTransformer',
        'opus_mt_es_nl': 'MarianTransformer', 'opus_mt_fi_ha': 'MarianTransformer',
        'opus_mt_fi_fj': 'MarianTransformer', 'opus_mt_es_ber': 'MarianTransformer',
        'opus_mt_fi_ho': 'MarianTransformer', 'opus_mt_fi_ny': 'MarianTransformer',
        'opus_mt_es_sl': 'MarianTransformer', 'opus_mt_fi_ts': 'MarianTransformer',
        'opus_mt_eo_el': 'MarianTransformer', 'opus_mt_fi_war': 'MarianTransformer',
        'opus_mt_fi_cs': 'MarianTransformer', 'opus_mt_es_loz': 'MarianTransformer',
        'opus_mt_fi_mk': 'MarianTransformer', 'opus_mt_es_bg': 'MarianTransformer',
        'opus_mt_fi_srn': 'MarianTransformer', 'opus_mt_es_is': 'MarianTransformer',
        'opus_mt_eo_hu': 'MarianTransformer', 'opus_mt_fi_tw': 'MarianTransformer',
        'opus_mt_fi_mt': 'MarianTransformer', 'opus_mt_es_fr': 'MarianTransformer',
        'opus_mt_es_yo': 'MarianTransformer', 'opus_mt_fi_xh': 'MarianTransformer',
        'opus_mt_fi_lv': 'MarianTransformer', 'opus_mt_fi_de': 'MarianTransformer',
        'opus_mt_es_ve': 'MarianTransformer', 'opus_mt_fi_es': 'MarianTransformer',
        'opus_mt_es_eo': 'MarianTransformer', 'opus_mt_eo_cs': 'MarianTransformer',
        'opus_mt_es_mt': 'MarianTransformer', 'opus_mt_es_el': 'MarianTransformer',
        'opus_mt_es_ee': 'MarianTransformer', 'opus_mt_eu_de': 'MarianTransformer',
        'opus_mt_es_et': 'MarianTransformer', 'opus_mt_et_fi': 'MarianTransformer',
        'opus_mt_es_wls': 'MarianTransformer', 'opus_mt_fi_mg': 'MarianTransformer',
        'opus_mt_es_eu': 'MarianTransformer', 'opus_mt_es_lua': 'MarianTransformer',
        'opus_mt_es_pon': 'MarianTransformer', 'opus_mt_fi_mfe': 'MarianTransformer',
        'opus_mt_eo_he': 'MarianTransformer', 'opus_mt_es_id': 'MarianTransformer',
        'opus_mt_es_xh': 'MarianTransformer', 'opus_mt_es_ar': 'MarianTransformer',
        'opus_mt_es_crs': 'MarianTransformer', 'opus_mt_eu_es': 'MarianTransformer',
        'opus_mt_fi_tpi': 'MarianTransformer', 'opus_mt_fi_pis': 'MarianTransformer',
        'opus_mt_es_vi': 'MarianTransformer', 'opus_mt_et_es': 'MarianTransformer',
        'opus_mt_fi_rw': 'MarianTransformer', 'opus_mt_es_gl': 'MarianTransformer',
        'opus_mt_eo_pt': 'MarianTransformer', 'opus_mt_fi_he': 'MarianTransformer',
        'opus_mt_fi_af': 'MarianTransformer', 'opus_mt_fi_ru': 'MarianTransformer',
        'opus_mt_fi_ve': 'MarianTransformer', 'opus_mt_es_ca': 'MarianTransformer',
        'opus_mt_fi_tr': 'MarianTransformer', 'opus_mt_fi_ht': 'MarianTransformer',
        'opus_mt_fi_nl': 'MarianTransformer', 'opus_mt_fi_iso': 'MarianTransformer',
        'opus_mt_es_fi': 'MarianTransformer', 'opus_mt_eo_da': 'MarianTransformer',
        'opus_mt_es_ln': 'MarianTransformer', 'opus_mt_es_csn': 'MarianTransformer',
        'opus_mt_fi_pon': 'MarianTransformer', 'opus_mt_eo_af': 'MarianTransformer',
        'opus_mt_fi_bzs': 'MarianTransformer', 'opus_mt_es_no': 'MarianTransformer',
        'opus_mt_es_es': 'MarianTransformer', 'opus_mt_fi_lua': 'MarianTransformer',
        'opus_mt_es_yua': 'MarianTransformer', 'opus_mt_eu_ru': 'MarianTransformer',
        'opus_mt_es_tpi': 'MarianTransformer', 'opus_mt_fi_lue': 'MarianTransformer',
        'opus_mt_eo_sv': 'MarianTransformer', 'opus_mt_es_niu': 'MarianTransformer',
        'opus_mt_fi_tiv': 'MarianTransformer', 'opus_mt_es_pag': 'MarianTransformer',
        'opus_mt_fi_run': 'MarianTransformer', 'opus_mt_es_ty': 'MarianTransformer',
        'opus_mt_es_gil': 'MarianTransformer', 'opus_mt_fi_ln': 'MarianTransformer',
        'opus_mt_fi_ty': 'MarianTransformer', 'opus_mt_es_prl': 'MarianTransformer',
        'opus_mt_es_kg': 'MarianTransformer', 'opus_mt_es_rw': 'MarianTransformer',
        'opus_mt_fi_kqn': 'MarianTransformer', 'opus_mt_fi_sq': 'MarianTransformer',
        'opus_mt_fi_sw': 'MarianTransformer', 'opus_mt_es_csg': 'MarianTransformer',
        'opus_mt_es_ro': 'MarianTransformer', 'opus_mt_fi_ee': 'MarianTransformer',
        'opus_mt_fi_ilo': 'MarianTransformer', 'opus_mt_fi_eo': 'MarianTransformer',
        'opus_mt_es_iso': 'MarianTransformer', 'opus_mt_fi_bem': 'MarianTransformer',
        'opus_mt_fi_tn': 'MarianTransformer', 'opus_mt_es_da': 'MarianTransformer',
        'opus_mt_eo_es': 'MarianTransformer', 'opus_mt_eo_ru': 'MarianTransformer',
        'opus_mt_es_rn': 'MarianTransformer', 'opus_mt_es_lt': 'MarianTransformer',
        'opus_mt_es_guw': 'MarianTransformer', 'opus_mt_es_tvl': 'MarianTransformer',
        'opus_mt_et_fr': 'MarianTransformer', 'opus_mt_es_ht': 'MarianTransformer',
        'opus_mt_fi_mos': 'MarianTransformer', 'opus_mt_es_ase': 'MarianTransformer',
        'opus_mt_fi_crs': 'MarianTransformer', 'opus_mt_fi_bcl': 'MarianTransformer',
        'opus_mt_fi_tvl': 'MarianTransformer', 'opus_mt_fi_lus': 'MarianTransformer',
        'opus_mt_es_he': 'MarianTransformer', 'opus_mt_es_pis': 'MarianTransformer',
        'opus_mt_es_it': 'MarianTransformer', 'opus_mt_eo_fi': 'MarianTransformer',
        'opus_mt_es_tw': 'MarianTransformer', 'opus_mt_es_aed': 'MarianTransformer',
        'opus_mt_es_bzs': 'MarianTransformer', 'opus_mt_fi_nso': 'MarianTransformer',
        'opus_mt_es_gaa': 'MarianTransformer', 'opus_mt_es_zai': 'MarianTransformer',
        'opus_mt_fi_no': 'MarianTransformer', 'opus_mt_fi_uk': 'MarianTransformer',
        'opus_mt_es_sg': 'MarianTransformer', 'opus_mt_es_ilo': 'MarianTransformer',
        'opus_mt_eo_bg': 'MarianTransformer', 'opus_mt_fi_pap': 'MarianTransformer',
        'opus_mt_es_ho': 'MarianTransformer', 'opus_mt_fi_toi': 'MarianTransformer',
        'opus_mt_es_st': 'MarianTransformer', 'opus_mt_fi_to': 'MarianTransformer',
        'opus_mt_fi_kg': 'MarianTransformer', 'opus_mt_fi_sv': 'MarianTransformer',
        'opus_mt_fi_tll': 'MarianTransformer', 'opus_mt_es_ceb': 'MarianTransformer',
        'opus_mt_es_ig': 'MarianTransformer', 'opus_mt_et_sv': 'MarianTransformer',
        'opus_mt_es_af': 'MarianTransformer', 'opus_mt_es_pl': 'MarianTransformer',
        'opus_mt_eo_ro': 'MarianTransformer', 'opus_mt_es_tn': 'MarianTransformer',
        'opus_mt_fi_sm': 'MarianTransformer', 'opus_mt_es_mk': 'MarianTransformer',
        'opus_mt_fi_id': 'MarianTransformer', 'opus_mt_fi_hr': 'MarianTransformer',
        'opus_mt_fi_sg': 'MarianTransformer', 'opus_mt_fi_hil': 'MarianTransformer',
        'opus_mt_eo_nl': 'MarianTransformer', 'opus_mt_es_pap': 'MarianTransformer',
        'opus_mt_fi_fr': 'MarianTransformer', 'opus_mt_es_bi': 'MarianTransformer',
        'opus_mt_fi_fi': 'MarianTransformer', 'opus_mt_es_nso': 'MarianTransformer',
        'opus_mt_fi_et': 'MarianTransformer', 'opus_mt_es_uk': 'MarianTransformer',
        'opus_mt_eo_sh': 'MarianTransformer', 'opus_mt_fi_lu': 'MarianTransformer',
        'opus_mt_fi_gil': 'MarianTransformer', 'opus_mt_fi_ro': 'MarianTransformer',
        'opus_mt_eo_it': 'MarianTransformer', 'opus_mt_fi_hu': 'MarianTransformer',
        'opus_mt_es_bcl': 'MarianTransformer', 'opus_mt_fi_fse': 'MarianTransformer',
        'opus_mt_es_hil': 'MarianTransformer', 'opus_mt_fi_ig': 'MarianTransformer',
        'opus_mt_es_tl': 'MarianTransformer', 'opus_mt_fi_pag': 'MarianTransformer',
        'opus_mt_fi_guw': 'MarianTransformer', 'opus_mt_es_swc': 'MarianTransformer',
        'opus_mt_fi_swc': 'MarianTransformer', 'opus_mt_fi_lg': 'MarianTransformer',
        'opus_mt_es_srn': 'MarianTransformer', 'opus_mt_es_hr': 'MarianTransformer',
        'opus_mt_es_sm': 'MarianTransformer', 'opus_mt_es_de': 'MarianTransformer',
        'opus_mt_fi_st': 'MarianTransformer', 'opus_mt_eo_fr': 'MarianTransformer',
        'opus_mt_et_de': 'MarianTransformer', 'opus_mt_fi_niu': 'MarianTransformer',
        'opus_mt_fi_el': 'MarianTransformer', 'opus_mt_fi_efi': 'MarianTransformer',
        'opus_mt_es_war': 'MarianTransformer', 'opus_mt_es_mfs': 'MarianTransformer',
        'opus_mt_fi_bg': 'MarianTransformer', 'opus_mt_es_lus': 'MarianTransformer',
        'opus_mt_eo_de': 'MarianTransformer', 'opus_mt_fi_it': 'MarianTransformer',
        'opus_mt_es_efi': 'MarianTransformer', 'opus_mt_es_ny': 'MarianTransformer',
        'opus_mt_es_fj': 'MarianTransformer', 'opus_mt_et_ru': 'MarianTransformer',
        'opus_mt_fi_mh': 'MarianTransformer', 'opus_mt_ig_es': 'MarianTransformer',
        'opus_mt_hu_sv': 'MarianTransformer', 'opus_mt_fr_lue': 'MarianTransformer',
        'opus_mt_ha_fi': 'MarianTransformer', 'opus_mt_it_ca': 'MarianTransformer',
        'opus_mt_ilo_de': 'MarianTransformer', 'opus_mt_he_it': 'MarianTransformer',
        'opus_mt_fr_loz': 'MarianTransformer', 'opus_mt_fr_ms': 'MarianTransformer',
        'opus_mt_it_uk': 'MarianTransformer', 'opus_mt_fr_gaa': 'MarianTransformer',
        'opus_mt_fr_pap': 'MarianTransformer', 'opus_mt_ilo_fi': 'MarianTransformer',
        'opus_mt_fr_lg': 'MarianTransformer', 'opus_mt_is_it': 'MarianTransformer',
        'opus_mt_it_ms': 'MarianTransformer', 'opus_mt_fr_es': 'MarianTransformer',
        'opus_mt_he_ar': 'MarianTransformer', 'opus_mt_fr_ro': 'MarianTransformer',
        'opus_mt_fr_ru': 'MarianTransformer', 'opus_mt_ht_fi': 'MarianTransformer',
        'opus_mt_it_bg': 'MarianTransformer', 'opus_mt_fr_mh': 'MarianTransformer',
        'opus_mt_fr_to': 'MarianTransformer', 'opus_mt_fr_sl': 'MarianTransformer',
        'opus_mt_gil_fr': 'MarianTransformer', 'opus_mt_hr_es': 'MarianTransformer',
        'opus_mt_fr_ilo': 'MarianTransformer', 'opus_mt_fr_ee': 'MarianTransformer',
        'opus_mt_he_sv': 'MarianTransformer', 'opus_mt_ha_fr': 'MarianTransformer',
        'opus_mt_fr_gil': 'MarianTransformer', 'opus_mt_id_fi': 'MarianTransformer',
        'opus_mt_iir_iir': 'MarianTransformer', 'opus_mt_fr_pl': 'MarianTransformer',
        'opus_mt_fr_tw': 'MarianTransformer', 'opus_mt_gaa_sv': 'MarianTransformer',
        'opus_mt_it_ar': 'MarianTransformer', 'opus_mt_gil_es': 'MarianTransformer',
        'opus_mt_fr_ase': 'MarianTransformer', 'opus_mt_gaa_fr': 'MarianTransformer',
        'opus_mt_fr_lus': 'MarianTransformer', 'opus_mt_iso_fr': 'MarianTransformer',
        'opus_mt_fr_sm': 'MarianTransformer', 'opus_mt_fr_mfe': 'MarianTransformer',
        'opus_mt_fr_af': 'MarianTransformer', 'opus_mt_ig_de': 'MarianTransformer',
        'opus_mt_id_es': 'MarianTransformer', 'opus_mt_fr_kqn': 'MarianTransformer',
        'opus_mt_fi_zne': 'MarianTransformer', 'opus_mt_fr_rw': 'MarianTransformer',
        'opus_mt_fr_ny': 'MarianTransformer', 'opus_mt_fr_ig': 'MarianTransformer',
        'opus_mt_hi_ur': 'MarianTransformer', 'opus_mt_it_lt': 'MarianTransformer',
        'opus_mt_fr_srn': 'MarianTransformer', 'opus_mt_fr_tiv': 'MarianTransformer',
        'opus_mt_fr_war': 'MarianTransformer', 'opus_mt_is_fr': 'MarianTransformer',
        'opus_mt_gaa_de': 'MarianTransformer', 'opus_mt_fr_kwy': 'MarianTransformer',
        'opus_mt_gil_sv': 'MarianTransformer', 'opus_mt_fr_hr': 'MarianTransformer',
        'opus_mt_ig_fr': 'MarianTransformer', 'opus_mt_ht_sv': 'MarianTransformer',
        'opus_mt_fr_de': 'MarianTransformer', 'opus_mt_fiu_fiu': 'MarianTransformer',
        'opus_mt_fr_wls': 'MarianTransformer', 'opus_mt_hu_eo': 'MarianTransformer',
        'opus_mt_fr_guw': 'MarianTransformer', 'opus_mt_is_de': 'MarianTransformer',
        'opus_mt_fr_tvl': 'MarianTransformer', 'opus_mt_fr_zne': 'MarianTransformer',
        'opus_mt_fr_ha': 'MarianTransformer', 'opus_mt_guw_fi': 'MarianTransformer',
        'opus_mt_is_es': 'MarianTransformer', 'opus_mt_it_sv': 'MarianTransformer',
        'opus_mt_fr_uk': 'MarianTransformer', 'opus_mt_hu_uk': 'MarianTransformer',
        'opus_mt_fr_mt': 'MarianTransformer', 'opus_mt_gem_gem': 'MarianTransformer',
        'opus_mt_fj_fr': 'MarianTransformer', 'opus_mt_gil_fi': 'MarianTransformer',
        'opus_mt_hu_fr': 'MarianTransformer', 'opus_mt_fr_bcl': 'MarianTransformer',
        'opus_mt_gmq_gmq': 'MarianTransformer', 'opus_mt_fr_kg': 'MarianTransformer',
        'opus_mt_fr_sn': 'MarianTransformer', 'opus_mt_fr_bg': 'MarianTransformer',
        'opus_mt_guw_fr': 'MarianTransformer', 'opus_mt_fr_ts': 'MarianTransformer',
        'opus_mt_fr_pis': 'MarianTransformer', 'opus_mt_fr_bi': 'MarianTransformer',
        'opus_mt_fr_ln': 'MarianTransformer', 'opus_mt_hil_de': 'MarianTransformer',
        'opus_mt_fr_nso': 'MarianTransformer', 'opus_mt_iso_es': 'MarianTransformer',
        'opus_mt_fr_crs': 'MarianTransformer', 'opus_mt_fr_niu': 'MarianTransformer',
        'opus_mt_ht_fr': 'MarianTransformer', 'opus_mt_he_fi': 'MarianTransformer',
        'opus_mt_gmw_gmw': 'MarianTransformer', 'opus_mt_hr_fr': 'MarianTransformer',
        'opus_mt_fr_sg': 'MarianTransformer', 'opus_mt_fr_pon': 'MarianTransformer',
        'opus_mt_gaa_fi': 'MarianTransformer', 'opus_mt_fr_pag': 'MarianTransformer',
        'opus_mt_is_fi': 'MarianTransformer', 'opus_mt_fr_sk': 'MarianTransformer',
        'opus_mt_fr_yap': 'MarianTransformer', 'opus_mt_ha_es': 'MarianTransformer',
        'opus_mt_fr_no': 'MarianTransformer', 'opus_mt_ine_ine': 'MarianTransformer',
        'opus_mt_id_fr': 'MarianTransformer', 'opus_mt_fr_bzs': 'MarianTransformer',
        'opus_mt_fr_he': 'MarianTransformer', 'opus_mt_fr_sv': 'MarianTransformer',
        'opus_mt_he_uk': 'MarianTransformer', 'opus_mt_it_fr': 'MarianTransformer',
        'opus_mt_ig_fi': 'MarianTransformer', 'opus_mt_fr_vi': 'MarianTransformer',
        'opus_mt_fse_fi': 'MarianTransformer', 'opus_mt_guw_es': 'MarianTransformer',
        'opus_mt_fr_tll': 'MarianTransformer', 'opus_mt_fr_lua': 'MarianTransformer',
        'opus_mt_fi_yap': 'MarianTransformer', 'opus_mt_gaa_es': 'MarianTransformer',
        'opus_mt_ig_sv': 'MarianTransformer', 'opus_mt_fr_ht': 'MarianTransformer',
        'opus_mt_fr_el': 'MarianTransformer', 'opus_mt_inc_inc': 'MarianTransformer',
        'opus_mt_fr_swc': 'MarianTransformer', 'opus_mt_fr_ar': 'MarianTransformer',
        'opus_mt_ilo_es': 'MarianTransformer', 'opus_mt_hr_fi': 'MarianTransformer',
        'opus_mt_fr_tpi': 'MarianTransformer', 'opus_mt_fr_ve': 'MarianTransformer',
        'opus_mt_guw_sv': 'MarianTransformer', 'opus_mt_iso_sv': 'MarianTransformer',
        'opus_mt_is_sv': 'MarianTransformer', 'opus_mt_fr_tum': 'MarianTransformer',
        'opus_mt_ht_es': 'MarianTransformer', 'opus_mt_fr_ho': 'MarianTransformer',
        'opus_mt_fr_efi': 'MarianTransformer', 'opus_mt_gl_es': 'MarianTransformer',
        'opus_mt_he_ru': 'MarianTransformer', 'opus_mt_hil_fi': 'MarianTransformer',
        'opus_mt_he_eo': 'MarianTransformer', 'opus_mt_fr_lu': 'MarianTransformer',
        'opus_mt_ha_sv': 'MarianTransformer', 'opus_mt_fr_rnd': 'MarianTransformer',
        'opus_mt_fr_st': 'MarianTransformer', 'opus_mt_fr_tl': 'MarianTransformer',
        'opus_mt_fr_bem': 'MarianTransformer', 'opus_mt_is_eo': 'MarianTransformer',
        'opus_mt_it_is': 'MarianTransformer', 'opus_mt_fr_hu': 'MarianTransformer',
        'opus_mt_fi_yo': 'MarianTransformer', 'opus_mt_fr_iso': 'MarianTransformer',
        'opus_mt_it_de': 'MarianTransformer', 'opus_mt_fr_ty': 'MarianTransformer',
        'opus_mt_fr_hil': 'MarianTransformer', 'opus_mt_it_eo': 'MarianTransformer',
        'opus_mt_hr_sv': 'MarianTransformer', 'opus_mt_fr_ber': 'MarianTransformer',
        'opus_mt_guw_de': 'MarianTransformer', 'opus_mt_hu_fi': 'MarianTransformer',
        'opus_mt_it_es': 'MarianTransformer', 'opus_mt_hu_de': 'MarianTransformer',
        'opus_mt_fr_fj': 'MarianTransformer', 'opus_mt_id_sv': 'MarianTransformer',
        'opus_mt_fr_xh': 'MarianTransformer', 'opus_mt_fr_yo': 'MarianTransformer',
        'opus_mt_fr_ca': 'MarianTransformer', 'opus_mt_he_es': 'MarianTransformer',
        'opus_mt_he_de': 'MarianTransformer', 'opus_mt_gl_pt': 'MarianTransformer',
        'opus_mt_hy_ru': 'MarianTransformer', 'opus_mt_fr_mos': 'MarianTransformer',
        'opus_mt_fr_ceb': 'MarianTransformer', 'opus_mt_ja_sh': 'MarianTransformer',
        'opus_mt_ja_bg': 'MarianTransformer', 'opus_mt_ja_sv': 'MarianTransformer',
        'opus_mt_lv_ru': 'MarianTransformer', 'opus_mt_ms_fr': 'MarianTransformer',
        'opus_mt_mt_sv': 'MarianTransformer', 'opus_mt_ja_da': 'MarianTransformer',
        'opus_mt_niu_de': 'MarianTransformer', 'opus_mt_niu_es': 'MarianTransformer',
        'opus_mt_lus_sv': 'MarianTransformer', 'opus_mt_lg_sv': 'MarianTransformer',
        'opus_mt_pon_sv': 'MarianTransformer', 'opus_mt_lt_ru': 'MarianTransformer',
        'opus_mt_lg_fi': 'MarianTransformer', 'opus_mt_kg_sv': 'MarianTransformer',
        'opus_mt_nl_fr': 'MarianTransformer', 'opus_mt_ms_ms': 'MarianTransformer',
        'opus_mt_lg_es': 'MarianTransformer', 'opus_mt_lu_fr': 'MarianTransformer',
        'opus_mt_loz_fr': 'MarianTransformer', 'opus_mt_nl_ca': 'MarianTransformer',
        'opus_mt_lue_sv': 'MarianTransformer', 'opus_mt_ja_vi': 'MarianTransformer',
        'opus_mt_ja_fr': 'MarianTransformer', 'opus_mt_pap_fi': 'MarianTransformer',
        'opus_mt_lt_pl': 'MarianTransformer', 'opus_mt_ny_de': 'MarianTransformer',
        'opus_mt_lue_fr': 'MarianTransformer', 'opus_mt_pt_gl': 'MarianTransformer',
        'opus_mt_pap_fr': 'MarianTransformer', 'opus_mt_pl_uk': 'MarianTransformer',
        'opus_mt_niu_fi': 'MarianTransformer', 'opus_mt_ja_ar': 'MarianTransformer',
        'opus_mt_mh_es': 'MarianTransformer', 'opus_mt_pl_ar': 'MarianTransformer',
        'opus_mt_pag_de': 'MarianTransformer', 'opus_mt_no_es': 'MarianTransformer',
        'opus_mt_mfs_es': 'MarianTransformer', 'opus_mt_pis_fr': 'MarianTransformer',
        'opus_mt_pt_eo': 'MarianTransformer', 'opus_mt_lt_de': 'MarianTransformer',
        'opus_mt_ln_fr': 'MarianTransformer', 'opus_mt_pag_es': 'MarianTransformer',
        'opus_mt_nl_fi': 'MarianTransformer', 'opus_mt_it_vi': 'MarianTransformer',
        'opus_mt_ko_fi': 'MarianTransformer', 'opus_mt_nso_de': 'MarianTransformer',
        'opus_mt_niu_fr': 'MarianTransformer', 'opus_mt_pt_ca': 'MarianTransformer',
        'opus_mt_kwy_fr': 'MarianTransformer', 'opus_mt_no_ru': 'MarianTransformer',
        'opus_mt_pon_fi': 'MarianTransformer', 'opus_mt_lu_fi': 'MarianTransformer',
        'opus_mt_ko_es': 'MarianTransformer', 'opus_mt_ny_es': 'MarianTransformer',
        'opus_mt_itc_itc': 'MarianTransformer', 'opus_mt_ja_es': 'MarianTransformer',
        'opus_mt_mk_fr': 'MarianTransformer', 'opus_mt_ms_it': 'MarianTransformer',
        'opus_mt_lu_sv': 'MarianTransformer', 'opus_mt_nso_fr': 'MarianTransformer',
        'opus_mt_pt_uk': 'MarianTransformer', 'opus_mt_no_no': 'MarianTransformer',
        'opus_mt_lua_sv': 'MarianTransformer', 'opus_mt_pl_es': 'MarianTransformer',
        'opus_mt_lu_es': 'MarianTransformer', 'opus_mt_lus_fr': 'MarianTransformer',
        'opus_mt_ja_tr': 'MarianTransformer', 'opus_mt_pag_fi': 'MarianTransformer',
        'opus_mt_kqn_fr': 'MarianTransformer', 'opus_mt_ja_fi': 'MarianTransformer',
        'opus_mt_nl_af': 'MarianTransformer', 'opus_mt_pag_sv': 'MarianTransformer',
        'opus_mt_nl_sv': 'MarianTransformer', 'opus_mt_no_uk': 'MarianTransformer',
        'opus_mt_lua_es': 'MarianTransformer', 'opus_mt_mt_fi': 'MarianTransformer',
        'opus_mt_lt_eo': 'MarianTransformer', 'opus_mt_no_de': 'MarianTransformer',
        'opus_mt_pl_eo': 'MarianTransformer', 'opus_mt_loz_es': 'MarianTransformer',
        'opus_mt_ja_ru': 'MarianTransformer', 'opus_mt_pl_sv': 'MarianTransformer',
        'opus_mt_mh_fi': 'MarianTransformer', 'opus_mt_ja_hu': 'MarianTransformer',
        'opus_mt_mk_fi': 'MarianTransformer', 'opus_mt_lue_es': 'MarianTransformer',
        'opus_mt_lt_sv': 'MarianTransformer', 'opus_mt_pon_fr': 'MarianTransformer',
        'opus_mt_pap_es': 'MarianTransformer', 'opus_mt_ln_es': 'MarianTransformer',
        'opus_mt_loz_de': 'MarianTransformer', 'opus_mt_ka_ru': 'MarianTransformer',
        'opus_mt_kwy_sv': 'MarianTransformer', 'opus_mt_lv_fi': 'MarianTransformer',
        'opus_mt_ja_pl': 'MarianTransformer', 'opus_mt_ko_hu': 'MarianTransformer',
        'opus_mt_ja_de': 'MarianTransformer', 'opus_mt_ko_de': 'MarianTransformer',
        'opus_mt_kg_es': 'MarianTransformer', 'opus_mt_pap_de': 'MarianTransformer',
        'opus_mt_no_fi': 'MarianTransformer', 'opus_mt_lue_fi': 'MarianTransformer',
        'opus_mt_pl_no': 'MarianTransformer', 'opus_mt_mt_fr': 'MarianTransformer',
        'opus_mt_mg_es': 'MarianTransformer', 'opus_mt_pis_es': 'MarianTransformer',
        'opus_mt_pl_fr': 'MarianTransformer', 'opus_mt_ko_sv': 'MarianTransformer',
        'opus_mt_loz_sv': 'MarianTransformer', 'opus_mt_loz_fi': 'MarianTransformer',
        'opus_mt_no_pl': 'MarianTransformer', 'opus_mt_ja_nl': 'MarianTransformer',
        'opus_mt_pl_de': 'MarianTransformer', 'opus_mt_pl_lt': 'MarianTransformer',
        'opus_mt_ko_ru': 'MarianTransformer', 'opus_mt_lv_fr': 'MarianTransformer',
        'opus_mt_ja_he': 'MarianTransformer', 'opus_mt_niu_sv': 'MarianTransformer',
        'opus_mt_ms_de': 'MarianTransformer', 'opus_mt_lt_es': 'MarianTransformer',
        'opus_mt_no_sv': 'MarianTransformer', 'opus_mt_no_nl': 'MarianTransformer',
        'opus_mt_lua_fi': 'MarianTransformer', 'opus_mt_lt_fr': 'MarianTransformer',
        'opus_mt_ja_ms': 'MarianTransformer', 'opus_mt_kqn_es': 'MarianTransformer',
        'opus_mt_lg_fr': 'MarianTransformer', 'opus_mt_mk_es': 'MarianTransformer',
        'opus_mt_no_da': 'MarianTransformer', 'opus_mt_lt_it': 'MarianTransformer',
        'opus_mt_prl_es': 'MarianTransformer', 'opus_mt_lua_fr': 'MarianTransformer',
        'opus_mt_nso_es': 'MarianTransformer', 'opus_mt_lv_sv': 'MarianTransformer',
        'opus_mt_pis_fi': 'MarianTransformer', 'opus_mt_pon_es': 'MarianTransformer',
        'opus_mt_ko_fr': 'MarianTransformer', 'opus_mt_ln_de': 'MarianTransformer',
        'opus_mt_nl_uk': 'MarianTransformer', 'opus_mt_nl_eo': 'MarianTransformer',
        'opus_mt_lv_es': 'MarianTransformer', 'opus_mt_lt_tr': 'MarianTransformer',
        'opus_mt_mt_es': 'MarianTransformer', 'opus_mt_lus_fi': 'MarianTransformer',
        'opus_mt_pt_tl': 'MarianTransformer', 'opus_mt_nl_no': 'MarianTransformer',
        'opus_mt_kqn_sv': 'MarianTransformer', 'opus_mt_ja_pt': 'MarianTransformer',
        'opus_mt_nso_fi': 'MarianTransformer', 'opus_mt_kg_fr': 'MarianTransformer',
        'opus_mt_pis_sv': 'MarianTransformer', 'opus_mt_sv_is': 'MarianTransformer',
        'opus_mt_sla_sla': 'MarianTransformer', 'opus_mt_srn_sv': 'MarianTransformer',
        'opus_mt_sv_niu': 'MarianTransformer', 'opus_mt_sv_to': 'MarianTransformer',
        'opus_mt_sv_guw': 'MarianTransformer', 'opus_mt_sv_sn': 'MarianTransformer',
        'opus_mt_rnd_sv': 'MarianTransformer', 'opus_mt_sv_tum': 'MarianTransformer',
        'opus_mt_sv_mos': 'MarianTransformer', 'opus_mt_sv_srn': 'MarianTransformer',
        'opus_mt_sv_ht': 'MarianTransformer', 'opus_mt_ru_no': 'MarianTransformer',
        'opus_mt_sv_sl': 'MarianTransformer', 'opus_mt_sv_fr': 'MarianTransformer',
        'opus_mt_ru_uk': 'MarianTransformer', 'opus_mt_sv_tiv': 'MarianTransformer',
        'opus_mt_ru_es': 'MarianTransformer', 'opus_mt_sv_pag': 'MarianTransformer',
        'opus_mt_sv_gaa': 'MarianTransformer', 'opus_mt_sv_kqn': 'MarianTransformer',
        'opus_mt_sg_fr': 'MarianTransformer', 'opus_mt_sv_st': 'MarianTransformer',
        'opus_mt_sv_ase': 'MarianTransformer', 'opus_mt_rn_es': 'MarianTransformer',
        'opus_mt_sl_ru': 'MarianTransformer', 'opus_mt_sv_lu': 'MarianTransformer',
        'opus_mt_ru_eu': 'MarianTransformer', 'opus_mt_sv_no': 'MarianTransformer',
        'opus_mt_sv_sq': 'MarianTransformer', 'opus_mt_ru_da': 'MarianTransformer',
        'opus_mt_sv_ny': 'MarianTransformer', 'opus_mt_sv_kg': 'MarianTransformer',
        'opus_mt_sv_pis': 'MarianTransformer', 'opus_mt_sk_sv': 'MarianTransformer',
        'opus_mt_sv_lus': 'MarianTransformer', 'opus_mt_sl_fi': 'MarianTransformer',
        'opus_mt_sv_tn': 'MarianTransformer', 'opus_mt_srn_fr': 'MarianTransformer',
        'opus_mt_sv_lv': 'MarianTransformer', 'opus_mt_sl_uk': 'MarianTransformer',
        'opus_mt_sv_sg': 'MarianTransformer', 'opus_mt_sv_he': 'MarianTransformer',
        'opus_mt_ru_eo': 'MarianTransformer', 'opus_mt_ru_fr': 'MarianTransformer',
        'opus_mt_ru_lv': 'MarianTransformer', 'opus_mt_sv_lua': 'MarianTransformer',
        'opus_mt_ru_ar': 'MarianTransformer', 'opus_mt_sv_tll': 'MarianTransformer',
        'opus_mt_sv_lue': 'MarianTransformer', 'opus_mt_sv_bi': 'MarianTransformer',
        'opus_mt_sv_hu': 'MarianTransformer', 'opus_mt_sv_bzs': 'MarianTransformer',
        'opus_mt_sv_ru': 'MarianTransformer', 'opus_mt_ro_eo': 'MarianTransformer',
        'opus_mt_st_es': 'MarianTransformer', 'opus_mt_sv_mt': 'MarianTransformer',
        'opus_mt_sv_af': 'MarianTransformer', 'opus_mt_sv_ts': 'MarianTransformer',
        'opus_mt_ru_af': 'MarianTransformer', 'opus_mt_sv_efi': 'MarianTransformer',
        'opus_mt_sv_es': 'MarianTransformer', 'opus_mt_sk_fi': 'MarianTransformer',
        'opus_mt_rw_fr': 'MarianTransformer', 'opus_mt_run_sv': 'MarianTransformer',
        'opus_mt_sv_th': 'MarianTransformer', 'opus_mt_sv_ln': 'MarianTransformer',
        'opus_mt_sk_es': 'MarianTransformer', 'opus_mt_ru_lt': 'MarianTransformer',
        'opus_mt_sv_mfe': 'MarianTransformer', 'opus_mt_sv_cs': 'MarianTransformer',
        'opus_mt_ru_vi': 'MarianTransformer', 'opus_mt_sv_ee': 'MarianTransformer',
        'opus_mt_ru_bg': 'MarianTransformer', 'opus_mt_sv_nso': 'MarianTransformer',
        'opus_mt_sv_mh': 'MarianTransformer', 'opus_mt_sv_iso': 'MarianTransformer',
        'opus_mt_st_fi': 'MarianTransformer', 'opus_mt_sv_bg': 'MarianTransformer',
        'opus_mt_sq_sv': 'MarianTransformer', 'opus_mt_sn_sv': 'MarianTransformer',
        'opus_mt_rn_de': 'MarianTransformer', 'opus_mt_sv_pon': 'MarianTransformer',
        'opus_mt_sv_ha': 'MarianTransformer', 'opus_mt_ru_fi': 'MarianTransformer',
        'opus_mt_sv_sk': 'MarianTransformer', 'opus_mt_run_es': 'MarianTransformer',
        'opus_mt_ru_et': 'MarianTransformer', 'opus_mt_sv_swc': 'MarianTransformer',
        'opus_mt_sv_hil': 'MarianTransformer', 'opus_mt_sv_ro': 'MarianTransformer',
        'opus_mt_rnd_fr': 'MarianTransformer', 'opus_mt_sv_kwy': 'MarianTransformer',
        'opus_mt_sh_uk': 'MarianTransformer', 'opus_mt_sv_sm': 'MarianTransformer',
        'opus_mt_rw_sv': 'MarianTransformer', 'opus_mt_sv_et': 'MarianTransformer',
        'opus_mt_sv_eo': 'MarianTransformer', 'opus_mt_sv_rnd': 'MarianTransformer',
        'opus_mt_sh_eo': 'MarianTransformer', 'opus_mt_rn_ru': 'MarianTransformer',
        'opus_mt_sv_rw': 'MarianTransformer', 'opus_mt_sn_fr': 'MarianTransformer',
        'opus_mt_sv_ig': 'MarianTransformer', 'opus_mt_sv_fj': 'MarianTransformer',
        'opus_mt_ru_sl': 'MarianTransformer', 'opus_mt_sv_ho': 'MarianTransformer',
        'opus_mt_sl_sv': 'MarianTransformer', 'opus_mt_sv_pap': 'MarianTransformer',
        'opus_mt_sl_fr': 'MarianTransformer', 'opus_mt_sl_es': 'MarianTransformer',
        'opus_mt_sv_run': 'MarianTransformer', 'opus_mt_sv_el': 'MarianTransformer',
        'opus_mt_sv_gil': 'MarianTransformer', 'opus_mt_sv_crs': 'MarianTransformer',
        'opus_mt_sk_fr': 'MarianTransformer', 'opus_mt_sq_es': 'MarianTransformer',
        'opus_mt_sg_sv': 'MarianTransformer', 'opus_mt_srn_es': 'MarianTransformer',
        'opus_mt_ro_fr': 'MarianTransformer', 'opus_mt_rn_fr': 'MarianTransformer',
        'opus_mt_st_fr': 'MarianTransformer', 'opus_mt_rw_es': 'MarianTransformer',
        'opus_mt_sv_hr': 'MarianTransformer', 'opus_mt_sm_es': 'MarianTransformer',
        'opus_mt_ssp_es': 'MarianTransformer', 'opus_mt_sv_nl': 'MarianTransformer',
        'opus_mt_sv_bem': 'MarianTransformer', 'opus_mt_sem_sem': 'MarianTransformer',
        'opus_mt_sv_sv': 'MarianTransformer', 'opus_mt_st_sv': 'MarianTransformer',
        'opus_mt_sv_lg': 'MarianTransformer', 'opus_mt_sv_bcl': 'MarianTransformer',
        'opus_mt_sv_toi': 'MarianTransformer', 'opus_mt_sv_id': 'MarianTransformer',
        'opus_mt_ru_he': 'MarianTransformer', 'opus_mt_sv_ceb': 'MarianTransformer',
        'opus_mt_sv_tw': 'MarianTransformer', 'opus_mt_sv_chk': 'MarianTransformer',
        'opus_mt_sm_fr': 'MarianTransformer', 'opus_mt_sv_tvl': 'MarianTransformer',
        'opus_mt_sg_es': 'MarianTransformer', 'opus_mt_sv_ilo': 'MarianTransformer',
        'opus_mt_ro_sv': 'MarianTransformer', 'opus_mt_sg_fi': 'MarianTransformer',
        'opus_mt_ru_hy': 'MarianTransformer', 'opus_mt_ro_fi': 'MarianTransformer',
        'opus_mt_sv_tpi': 'MarianTransformer', 'opus_mt_sv_fi': 'MarianTransformer',
        'opus_mt_ru_sv': 'MarianTransformer', 'opus_mt_toi_es': 'MarianTransformer',
        'opus_mt_uk_no': 'MarianTransformer', 'opus_mt_tr_ar': 'MarianTransformer',
        'opus_mt_uk_he': 'MarianTransformer', 'opus_mt_tvl_sv': 'MarianTransformer',
        'opus_mt_sv_uk': 'MarianTransformer', 'opus_mt_tvl_fr': 'MarianTransformer',
        'opus_mt_uk_bg': 'MarianTransformer', 'opus_mt_toi_fi': 'MarianTransformer',
        'opus_mt_uk_ca': 'MarianTransformer', 'opus_mt_uk_fr': 'MarianTransformer',
        'opus_mt_tr_eo': 'MarianTransformer', 'opus_mt_tr_uk': 'MarianTransformer',
        'opus_mt_tl_es': 'MarianTransformer', 'opus_mt_tr_es': 'MarianTransformer',
        'opus_mt_uk_it': 'MarianTransformer', 'opus_mt_uk_fi': 'MarianTransformer',
        'opus_mt_tr_lt': 'MarianTransformer', 'opus_mt_swc_es': 'MarianTransformer',
        'opus_mt_sv_umb': 'MarianTransformer', 'opus_mt_tw_sv': 'MarianTransformer',
        'opus_mt_urj_urj': 'MarianTransformer', 'opus_mt_sv_yap': 'MarianTransformer',
        'opus_mt_ty_fr': 'MarianTransformer', 'opus_mt_swc_fr': 'MarianTransformer',
        'opus_mt_tl_pt': 'MarianTransformer', 'opus_mt_uk_tr': 'MarianTransformer',
        'opus_mt_tr_sv': 'MarianTransformer', 'opus_mt_tvl_fi': 'MarianTransformer',
        'opus_mt_tn_es': 'MarianTransformer', 'opus_mt_swc_fi': 'MarianTransformer',
        'opus_mt_toi_fr': 'MarianTransformer', 'opus_mt_ts_fi': 'MarianTransformer',
        'opus_mt_uk_de': 'MarianTransformer', 'opus_mt_uk_sv': 'MarianTransformer',
        'opus_mt_tw_fi': 'MarianTransformer', 'opus_mt_to_sv': 'MarianTransformer',
        'opus_mt_tll_sv': 'MarianTransformer', 'opus_mt_th_fr': 'MarianTransformer',
        'opus_mt_ty_es': 'MarianTransformer', 'opus_mt_tw_fr': 'MarianTransformer',
        'opus_mt_to_fr': 'MarianTransformer', 'opus_mt_uk_sl': 'MarianTransformer',
        'opus_mt_sv_xh': 'MarianTransformer', 'opus_mt_sv_war': 'MarianTransformer',
        'opus_mt_uk_hu': 'MarianTransformer', 'opus_mt_uk_ru': 'MarianTransformer',
        'opus_mt_tn_sv': 'MarianTransformer', 'opus_mt_tum_fr': 'MarianTransformer',
        'opus_mt_toi_sv': 'MarianTransformer', 'opus_mt_ty_sv': 'MarianTransformer',
        'opus_mt_tr_fr': 'MarianTransformer', 'opus_mt_tn_fr': 'MarianTransformer',
        'opus_mt_uk_cs': 'MarianTransformer', 'opus_mt_ts_fr': 'MarianTransformer',
        'opus_mt_swc_sv': 'MarianTransformer', 'opus_mt_to_es': 'MarianTransformer',
        'opus_mt_uk_es': 'MarianTransformer', 'opus_mt_uk_nl': 'MarianTransformer',
        'opus_mt_sv_zne': 'MarianTransformer', 'opus_mt_tvl_es': 'MarianTransformer',
        'opus_mt_uk_pt': 'MarianTransformer', 'opus_mt_tiv_fr': 'MarianTransformer',
        'opus_mt_tll_fr': 'MarianTransformer', 'opus_mt_uk_sh': 'MarianTransformer',
        'opus_mt_sv_wls': 'MarianTransformer', 'opus_mt_sv_ve': 'MarianTransformer',
        'opus_mt_tum_es': 'MarianTransformer', 'opus_mt_tll_fi': 'MarianTransformer',
        'opus_mt_tw_es': 'MarianTransformer', 'opus_mt_tiv_sv': 'MarianTransformer',
        'opus_mt_ty_fi': 'MarianTransformer', 'opus_mt_uk_pl': 'MarianTransformer',
        'opus_mt_tpi_sv': 'MarianTransformer', 'opus_mt_tr_az': 'MarianTransformer',
        'opus_mt_tll_es': 'MarianTransformer', 'opus_mt_sv_ty': 'MarianTransformer',
        'opus_mt_es_tzo': 'MarianTransformer', 'opus_mt_crs_sv': 'MarianTransformer',
        'opus_mt_zai_es': 'MarianTransformer', 'opus_mt_de_niu': 'MarianTransformer',
        'opus_mt_nso_sv': 'MarianTransformer', 'opus_mt_bg_fr': 'MarianTransformer',
        'opus_mt_lus_es': 'MarianTransformer', 'opus_mt_nl_es': 'MarianTransformer',
        'opus_mt_yo_fr': 'MarianTransformer', 'opus_mt_ilo_sv': 'MarianTransformer',
        'opus_mt_ts_es': 'MarianTransformer', 'opus_mt_fr_run': 'MarianTransformer',
        'opus_mt_es_to': 'MarianTransformer', 'opus_mt_fi_ceb': 'MarianTransformer',
        'opus_mt_ja_it': 'MarianTransformer', 'opus_mt_sn_es': 'MarianTransformer',
        'opus_mt_sv_yo': 'MarianTransformer', 'opus_mt_az_tr': 'MarianTransformer',
        'opus_mt_no_fr': 'MarianTransformer', 'opus_mt_fr_tn': 'MarianTransformer',
        'opus_mt_fr_id': 'MarianTransformer', 'opus_mt_ca_de': 'MarianTransformer',
        'opus_mt_tum_sv': 'MarianTransformer', 'opus_mt_da_ru': 'MarianTransformer',
        'opus_mt_tl_de': 'MarianTransformer', 'opus_mt_fr_eo': 'MarianTransformer',
        'opus_mt_zh_vi': 'MarianTransformer', 'opus_mt_vi_es': 'MarianTransformer',
        'opus_mt_mfe_es': 'MarianTransformer', 'opus_mt_iso_fi': 'MarianTransformer',
        'opus_mt_tzo_es': 'MarianTransformer', 'opus_mt_es_sn': 'MarianTransformer',
        'opus_mt_xh_es': 'MarianTransformer', 'opus_mt_zne_sv': 'MarianTransformer',
        'opus_mt_ts_sv': 'MarianTransformer', 'opus_mt_zh_it': 'MarianTransformer',
        'opus_mt_zh_uk': 'MarianTransformer', 'opus_mt_yo_fi': 'MarianTransformer',
        'opus_mt_war_sv': 'MarianTransformer', 'opus_mt_yo_sv': 'MarianTransformer',
        'opus_mt_es_tll': 'MarianTransformer', 'opus_mt_zh_nl': 'MarianTransformer',
        'opus_mt_wls_fr': 'MarianTransformer', 'opus_mt_vi_it': 'MarianTransformer',
        'opus_mt_zh_bg': 'MarianTransformer', 'opus_mt_xh_sv': 'MarianTransformer',
        'opus_mt_zne_es': 'MarianTransformer', 'opus_mt_zlw_zlw': 'MarianTransformer',
        'opus_mt_yap_sv': 'MarianTransformer', 'opus_mt_zh_he': 'MarianTransformer',
        'opus_mt_xh_fr': 'MarianTransformer', 'opus_mt_war_fi': 'MarianTransformer',
        'opus_mt_zh_sv': 'MarianTransformer', 'opus_mt_zls_zls': 'MarianTransformer',
        'opus_mt_zne_fi': 'MarianTransformer', 'opus_mt_ve_es': 'MarianTransformer',
        'opus_mt_vi_de': 'MarianTransformer', 'opus_mt_vi_eo': 'MarianTransformer',
        'opus_mt_wls_sv': 'MarianTransformer', 'opus_mt_war_es': 'MarianTransformer',
        'opus_mt_vi_ru': 'MarianTransformer', 'opus_mt_zh_ms': 'MarianTransformer',
        'opus_mt_zne_fr': 'MarianTransformer', 'opus_mt_yap_fr': 'MarianTransformer',
        'opus_mt_zh_de': 'MarianTransformer', 'opus_mt_yo_es': 'MarianTransformer',
        'opus_mt_vsl_es': 'MarianTransformer', 'opus_mt_zle_zle': 'MarianTransformer',
        'opus_mt_vi_fr': 'MarianTransformer', 'opus_mt_war_fr': 'MarianTransformer',
        'opus_mt_zh_fi': 'MarianTransformer', 'opus_tatoeba_he_it': 'MarianTransformer',
        'opus_tatoeba_es_zh': 'MarianTransformer', 'opus_tatoeba_af_ru': 'MarianTransformer',
        'opus_tatoeba_he_fr': 'MarianTransformer', 'opus_tatoeba_it_he': 'MarianTransformer',
        'opus_mt_cs_sv': 'MarianTransformer', 'spellcheck_drug_norvig': 'NorvigSweetingModel',
        ...
        'sbiobertresolve_hcpcs': 'SentenceEntityResolverModel', 'ner_chexpert': 'MedicalNerModel',
        'bert_token_classifier_ner_deid': 'MedicalBertForTokenClassifier',
        'sentence_detector_dl_healthcare': 'SentenceDetectorDLModel',
        'drug_normalizer': 'NormalizerModel', 't5_base_mediqa_mnli': 'T5Transformer',
        'assertion_dl': 'AssertionDLModel', 'assertion_dl_biobert': 'AssertionDLModel',
        'assertion_dl_healthcare': 'AssertionDLModel', 'assertion_dl_large': 'AssertionDLModel',
        'assertion_dl_radiology': 'AssertionDLModel', 'embeddings_clinical': 'WordEmbeddingsModel',
        'embeddings_biovec': 'WordEmbeddingsModel', 'embeddings_healthcare': 'WordEmbeddingsModel',
        'embeddings_healthcare_100d': 'WordEmbeddingsModel',
        'embeddings_icdoem': 'WordEmbeddingsModel', 'embeddings_icdoem_2ng': 'WordEmbeddingsModel',
        ...
        're_test_result_date': 'RelationExtractionModel', 'pos_clinical': 'PerceptronModel',
        'jsl_ner_wip_clinical': 'MedicalNerModel', 'ner_ade_clinical': 'MedicalNerModel',
        'ner_ade_clinicalbert': 'MedicalNerModel', 'ner_ade_healthcare': 'MedicalNerModel',
        'ner_anatomy': 'MedicalNerModel', 'ner_anatomy_biobert': 'MedicalNerModel',
        'ner_anatomy_coarse': 'MedicalNerModel', 'ner_anatomy_coarse_biobert': 'MedicalNerModel',
        'ner_bacterial_species': 'MedicalNerModel', 'ner_bionlp': 'MedicalNerModel',
        'ner_bionlp_biobert': 'MedicalNerModel', 'ner_cancer_genetics': 'MedicalNerModel',
        'ner_cellular': 'MedicalNerModel', 'ner_cellular_biobert': 'MedicalNerModel',
        'ner_chemicals': 'MedicalNerModel', 'ner_genetic_variants': 'MedicalNerModel',
        'ner_chemprot_biobert': 'MedicalNerModel', 'ner_chemprot_clinical': 'MedicalNerModel',
        'ner_clinical': 'MedicalNerModel', 'ner_clinical_biobert': 'MedicalNerModel',
        'ner_diseases': 'MedicalNerModel', 'ner_diseases_biobert': 'MedicalNerModel',
        'ner_diseases_large': 'MedicalNerModel', 'ner_drugs': 'MedicalNerModel',
        'ner_drugs_greedy': 'MedicalNerModel', 'ner_drugs_large': 'MedicalNerModel',
        'ner_events_biobert': 'MedicalNerModel', 'ner_events_clinical': 'MedicalNerModel',
        'ner_events_healthcare': 'MedicalNerModel', 'ner_financial_contract': 'MedicalNerModel',
        'ner_healthcare': 'MedicalNerModel', 'ner_human_phenotype_gene_biobert': 'MedicalNerModel',
        'ner_human_phenotype_gene_clinical': 'MedicalNerModel',
        'ner_human_phenotype_go_biobert': 'MedicalNerModel',
        'ner_human_phenotype_go_clinical': 'MedicalNerModel', 'ner_jsl': 'MedicalNerModel',
        'ner_jsl_biobert': 'MedicalNerModel', 'ner_jsl_enriched': 'MedicalNerModel',
        'ner_jsl_enriched_biobert': 'MedicalNerModel',
        'ner_measurements_clinical': 'MedicalNerModel',
        'ner_medmentions_coarse': 'MedicalNerModel', 'ner_posology': 'MedicalNerModel',
        'ner_posology_biobert': 'MedicalNerModel', 'ner_posology_greedy': 'MedicalNerModel',
        'ner_posology_healthcare': 'MedicalNerModel', 'ner_posology_large': 'MedicalNerModel',
        'ner_posology_large_biobert': 'MedicalNerModel', 'ner_posology_small': 'MedicalNerModel',
        'ner_radiology': 'MedicalNerModel', 'ner_radiology_wip_clinical': 'MedicalNerModel',
        'ner_risk_factors': 'MedicalNerModel', 'ner_risk_factors_biobert': 'MedicalNerModel',
        'ner_posology_experimental': 'MedicalNerModel',
        'jsl_rd_ner_wip_greedy_biobert': 'MedicalNerModel', 'nerdl_tumour_demo': 'MedicalNerModel',
        ...
        'ner_deid_augmented': 'MedicalNerModel', 'ner_deid_biobert': 'MedicalNerModel',
        'ner_deid_enriched': 'MedicalNerModel', 'ner_deid_enriched_biobert': 'MedicalNerModel',
        'ner_deid_large': 'MedicalNerModel', 'ner_deid_sd': 'MedicalNerModel',
        'ner_deid_sd_large': 'MedicalNerModel', 'ner_deid_synthetic': 'MedicalNerModel',
        'ner_deidentify_dl': 'MedicalNerModel', 'ner_events_admission_clinical': 'MedicalNerModel',
        'ner_deid_generic_augmented': 'MedicalNerModel',
        'ner_deid_subentity_augmented': 'MedicalNerModel', 'ner_ade_biobert': 'MedicalNerModel',
        'classifierdl_ade_clinicalbert': 'ClassifierDLModel',
        'deidentify_rb': 'DeIdentificationModel', 'deid_rules': 'DeIdentificationModel',
        ...
        'redl_ade_biobert': 'RelationExtractionDLModel',
        're_ade_clinical': 'RelationExtractionModel', 're_ade_biobert': 'RelationExtractionModel',
        'assertion_jsl': 'AssertionDLModel', 'assertion_jsl_large': 'AssertionDLModel',
        ...
        'roberta_base_biomedical': 'RoBertaEmbeddings', 'roberta_ner_diag_proc': 'MedicalNerModel',
        'robertaresolve_snomed': 'SentenceEntityResolverModel',
        'ner_covid_trials': 'MedicalNerModel', 'ner_chemd_clinical': 'MedicalNerModel',
        ...
        'w2v_cc_300d': 'WordEmbeddingsModel', 'ner_legal': 'MedicalNerModel',
        'ner_healthcare_slim': 'MedicalNerModel', 'ner_traffic': 'MedicalNerModel',
        ...
        'embeddings_sciwiki_300d': 'WordEmbeddingsModel',
        'embeddings_sciwiki_50d': 'WordEmbeddingsModel', 'ner_diag_proc': 'MedicalNerModel',
        'ner_neoplasms': 'NerDLModel', 'text_matcher': 'TextMatcher',
        'regex_matcher': 'RegexMatcher', 'date_matcher': 'DateMatcher',
        'context_parser': 'ContextualParserModel', 'spellcheck_dl': 'ContextSpellCheckerModel',
