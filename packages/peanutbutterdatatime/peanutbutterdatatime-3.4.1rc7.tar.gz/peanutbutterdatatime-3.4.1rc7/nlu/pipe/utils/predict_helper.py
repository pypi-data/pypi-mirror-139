...
def __predict__(pipe, data, output_level, positions, keep_stranger_features, metadata, multithread,
    ...
    #     pipe.components = PipeUtils.configure_component_output_levels(pipe)
    # if output_level in ['token', 'chunk', 'relation']:
    #     pipe.components = PipeUtils.configure_component_output_levels(pipe, 'document')
