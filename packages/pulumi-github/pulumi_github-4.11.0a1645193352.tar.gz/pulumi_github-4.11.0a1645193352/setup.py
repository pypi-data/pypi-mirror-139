...
VERSION = "4.11.0a1645193352"
PLUGIN_VERSION = "4.11.0-alpha.1645193352+c5582b0f"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the github resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource github {PLUGIN_VERSION}`
                """)
            else:
                raise
