...
def _default_constraining_bijector_fn():
  from tensorflow_probability.substrates.numpy.bijectors import identity as identity_bijector  # pylint:disable=g-import-not-at-top
...
#   `tensorflow_probability/substrates/numpy/internal/parameter_properties.py`
