...
['solid_backend',
 ...
 'solid_backend.media_object.migrations',
 'solid_backend.media_object.tests',
 'solid_backend.media_object.tests.conftest_files',
...
package_data = \
{'': ['*'],
 'solid_backend.media_object': ['static/media_object/css/*',
                                'static/media_object/js/*']}
