...
name = 'm9s_elastic_search'
download_url = 'https://gitlab.com/m9s/elastic_search.git'
requires = [
    'pyes',
    ]
...
setup(name=name,
    version=version,
    description='Tryton Elastic Search Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/elastic_search.git',
        },
    keywords='',
    package_dir={'trytond.modules.elastic_search': '.'},
    packages=(
        ['trytond.modules.elastic_search']
        + ['trytond.modules.elastic_search.%s' % p
