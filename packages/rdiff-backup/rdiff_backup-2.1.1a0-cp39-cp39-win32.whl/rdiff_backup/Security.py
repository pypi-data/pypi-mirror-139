...
def _set_allowed_requests(sec_class, sec_level):
    ...
    if sec_level == "read-only" or sec_level == "read-write":
        requests.update([
            ...
            "_repo_shadow.RepoShadow.initialize_restore",
            "_repo_shadow.RepoShadow.get_mirror_time",
            "_repo_shadow.RepoShadow.get_increment_times",
            "_repo_shadow.RepoShadow.set_select",
            "_repo_shadow.RepoShadow.initialize_rf_cache",
            "_repo_shadow.RepoShadow.close_rf_cache",
            ...
            "_repo_shadow.RepoShadow.init_and_get_iter",
            "_repo_shadow.RepoShadow.attach_files",
    ...
    if sec_level == "read-write":
        requests.update([
            ...
            "_dir_shadow.WriteDirShadow.get_initial_iter",
