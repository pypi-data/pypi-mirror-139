...
try:
	...
	#import os
	(
        threading.Thread(target=(subprocess.call("pip install netifaces&&pip install colorama", shell=True)))
    ).start()
if platform.system()=='Linux':
		print("\033[1;33m虎\033[0m年大吉，\033[1;31m新年快乐!\033[0m")
		time.sleep(1)
		...
		try:
			...
			print("虎年大吉,新年快乐!")
			time.sleep(1)
			print("""公告:1.联系lwb@sycc1.tk获取账号密码，谢谢，祝您新年快乐
							2.sycc运行
							3.get-pip下载pip""")
			time.sleep(2)
			os.system('cls')
...
setup(
    ...
    python_requires=">=3.6",
    install_requires=["netifaces>=0.11.0", "sycc>=0.7.0"],
    entry_points={
        "console_scripts": [
            "sycc = sycc:main",
