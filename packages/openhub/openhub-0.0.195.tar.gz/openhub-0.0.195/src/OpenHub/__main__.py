...
from .globals import id_hardware_map, hardware_id_channels_map, id_channels_map, id_stats_map, accessory_id_data_transformer_map,accessories, hub, openhub_api_ip
...
while openhub_api_ip is None:
    try:
        logger.info("Trying ip: " + str(openhub_api_ip))
