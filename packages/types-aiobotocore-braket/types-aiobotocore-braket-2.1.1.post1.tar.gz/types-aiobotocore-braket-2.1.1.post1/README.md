...
[aiobotocore.Braket 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/braket.html#Braket)
...
- Install `types-aiobotocore[braket]` with services you use in your
  environment:
