...
def showDiagram(nn,angle,weighted,phi,angleRotate,name):
    ...
    np.savetxt('/Users/jiachenlu/forSimulationOnly/highRes/'+name+'_topo',nn,fmt='%d')
    ...
    plt.tight_layout()
    plt.savefig('/Users/jiachenlu/forSimulationOnly/highRes/'+name+'.png',dpi=300)
