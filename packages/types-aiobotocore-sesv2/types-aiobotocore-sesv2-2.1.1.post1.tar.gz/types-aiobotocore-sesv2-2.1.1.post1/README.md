...
[aiobotocore.SESV2 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sesv2.html#SESV2)
...
[types-aiobotocore-sesv2 docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-sesv2](#types-aiobotocore-sesv2)
...
- Install `types-aiobotocore[sesv2]` in your environment:
...
Install `types-aiobotocore-lite[sesv2]` in your environment:
...
- Install `types-aiobotocore[sesv2]` with services you use in your environment:
...
`SESV2Client` provides annotations for `session.create_client("sesv2")`.
...
`types_aiobotocore_sesv2.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

```python
from types_aiobotocore_sesv2.literals import (
...
`types-aiobotocore-sesv2` version is the same as related `aiobotocore` version
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/)
