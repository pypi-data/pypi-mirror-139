...
class TreeItemsApi(object):
    ...
    def get_tree_items(self, **kwargs):  # noqa: E501
        """Gets treeItems  # noqa: E501

        Required Permissions: Location User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tree_items(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] group_ids:
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Abbreviation` | String | `eq, neq, like, in` | | `Active` | Boolean | `eq, neq` | | `AssetClassCode` | String | `eq, neq, like, in` | | `CategoryCode` | String | `eq, neq, like, in` | | `CategoryId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `CategoryName` | String | `eq, neq, like, in` | | `CategoryShortName` | String | `eq, neq, like, in` | | `ChildId` | Guid | `eq, neq, in` | | `ChildName` | String | `eq, neq, like, in` | | `ChildType` | GroupTypeCodes | `eq, neq, in` | | `CorporationAbbreviation` | String | `eq, neq, like, in` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, like, in` | | `Created` | DateTime | `eq, neq, in, lt, gt, leq, geq` | | `IsCollectorDependentSystem` | Boolean | `eq, neq` | | `IsPaused` | Boolean | `eq, neq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `Name` | String | `eq, neq, like, in` | | `SizeCode` | String | `eq, neq, like, in` | | `SizeId` | Int32? | `eq, neq, in, lt, gt, leq, geq` | | `SizeName` | String | `eq, neq, like, in` | | `TreeItemType` | GroupTypeCodes | `eq, neq, in` | | `TypeCode` | String | `eq, neq, like, in` | | `TypeId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `TypeName` | String | `eq, neq, like, in` |
        :param int page: Results page. 1-based (1 returns the first page, 0 is invalid).
        :param int page_limit: Number of items to return per page.
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `Abbreviation` | String | | `CategoryCode` | String | | `CategoryName` | String | | `CategoryShortName` | String | | `CorporationName` | String | | `Created` | DateTime | | `LocationName` | String | | `Name` | String | | `SizeCode` | String | | `SizeName` | String | | `TypeCode` | String | | `TypeName` | String |
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_tree_items_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_tree_items_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_tree_items_with_http_info(self, **kwargs):  # noqa: E501
        """Gets treeItems  # noqa: E501

        Required Permissions: Location User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tree_items_with_http_info(async_req=True)
        >>> result = thread.get()
