...
class HubsApi(object):
    ...
    def export_hub_overview(self, **kwargs):  # noqa: E501
        """Requests a Hub overview export  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `CorporationAbbreviation` | String | `eq, neq, like, in` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, like, in` | | `FirmwareVersion` | String | `eq, neq, like, in` | | `HardwareRevisionId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `HardwareRevisionName` | String | `eq, neq, like, in` | | `Id` | Int64 | `eq, neq, in, lt, gt, leq, geq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `Name` | String | `eq, neq, like, in` | | `PowerType` | HubPowerType? | `eq, neq, in` | | `SerialNumber` | String | `eq, neq, like, in` |
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `CorporationName` | String | | `FirmwareVersion` | String | | `HardwareRevisionId` | Int32 | | `HardwareRevisionName` | String | | `LocationName` | String | | `Name` | String | | `PowerType` | HubPowerType? | | `SerialNumber` | String |
        :param str name_search: Provide search terms to narrow result.  Searchable properties: `CorporationName`, `FirmwareVersion`, `HardwareRevisionName`, `LocationName`, `Name`, `PowerType`, `SerialNumber`.
        :return: PagedResultsModelHubOverviewResponse
    ...
    def export_hub_overview_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='PagedResultsModelHubOverviewResponse',  # noqa: E501
    ...
    def get_hub_overview(self, hub_id, **kwargs):  # noqa: E501
        """Gets an overview for a single Hub by id  # noqa: E501

        Required Permissions: Location User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hub_overview(hub_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_hub_overview_with_http_info(hub_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_hub_overview_with_http_info(hub_id, **kwargs)  # noqa: E501
            return data

    def get_hub_overview_with_http_info(self, hub_id, **kwargs):  # noqa: E501
        """Gets an overview for a single Hub by id  # noqa: E501

        Required Permissions: Location User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hub_overview_with_http_info(hub_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_hub_overview" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'hub_id' is set
        if ('hub_id' not in params or
                params['hub_id'] is None):
            raise ValueError("Missing the required parameter `hub_id` when calling `get_hub_overview`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3.0/Hubs/overview/{hubId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='HubOverviewResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_hubs_overview(self, **kwargs):  # noqa: E501
        """Gets an overview of Hubs  # noqa: E501

        Required Permissions: Location User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hubs_overview(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_hubs_overview_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_hubs_overview_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_hubs_overview_with_http_info(self, **kwargs):  # noqa: E501
        """Gets an overview of Hubs  # noqa: E501

        Required Permissions: Location User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hubs_overview_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_hubs_overview" % key
                )
            params[key] = val
        del params['kwargs']
