...
class IndicatorResponse(object):
    ...
    def __init__(self, id=None, name=None, abbreviation=None, system_sort_order=None, indicator_type=None, measure_of=None, custom_role_type=None, display_units=None, base_units=None, has_spectrum=None, meta_data=None, damage_exponent=None, location=None, hierarchy=None, alarm_definition=None, band_definition=None, baseline=None, can_have_baseline=None, is_vibration=None, custom_units=None):  # noqa: E501
        ...
        if system_sort_order is not None:
            self.system_sort_order = system_sort_order
        if indicator_type is not None:
            self.indicator_type = indicator_type
        if measure_of is not None:
        ...
        if can_have_baseline is not None:
