...
class CurrentUserResponse(object):
    ...
    def __init__(self, id=None, email=None, first_name=None, last_name=None, phone_number=None, application_role=None, accepted_eula=None, corporations=None, locations=None, profile=None):  # noqa: E501
