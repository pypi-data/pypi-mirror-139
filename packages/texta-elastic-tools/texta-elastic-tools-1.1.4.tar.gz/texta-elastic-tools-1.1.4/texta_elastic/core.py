...
from texta_elastic.settings import ES_CONNECTION_PARAMETERS, TEXTA_ANNOTATOR_KEY, TEXTA_ES_PASSWORD, TEXTA_ES_PREFIX, TEXTA_ES_URL, TEXTA_ES_USERNAME
...
class ElasticCore:
    ...
    def __init__(self, ES_URL=TEXTA_ES_URL, check_connection=True):
        self.ES_URL = ES_URL
        self.ES_PREFIX = TEXTA_ES_PREFIX
        self.ES_USERNAME = TEXTA_ES_USERNAME
        self.ES_PASSWORD = TEXTA_ES_PASSWORD
    ...
    def _check_connection(self):
        try:
            ...
            raise NotFoundError(f"Error connecting to Elasticsearch: '{self.ES_URL}'! Do you have the right URL configured?")
