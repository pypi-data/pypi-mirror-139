...
[aiobotocore.SageMakerRuntime 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sagemaker-runtime.html#SageMakerRuntime)
...
[types-aiobotocore-sagemaker-runtime docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sagemaker_runtime/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-sagemaker-runtime](#types-aiobotocore-sagemaker-runtime)
...
- Install `types-aiobotocore[sagemaker-runtime]` in your environment:
...
Install `types-aiobotocore-lite[sagemaker-runtime]` in your environment:
...
- Install `types-aiobotocore[sagemaker-runtime]` with services you use in your
  environment:
...
`types-aiobotocore-sagemaker-runtime` version is the same as related
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sagemaker_runtime/)
