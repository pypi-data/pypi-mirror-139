...
class WebsocketSession(Session):
    ...
    def onCreate(self,request=None,content=None):                
        ...
        # no timeouts
        self.request.server.websockets = WebsocketSession.websockets
    ...
    def _onClose(self):
        ...
        self.onClose(None,None) # Handle cleanups
    ...
    def onClose(self,request=None,content=None):   
        '''What to do before the connection is inevitably closed.
        
        (TODO) If `request` is not None, ignore the call.'''
        pass
