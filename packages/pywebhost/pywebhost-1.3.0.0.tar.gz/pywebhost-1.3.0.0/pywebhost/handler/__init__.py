...
class Request(StreamRequestHandler):
    ...
    def __init__(self, request, client_address, server):
        ...
        '''
        self.logger = logging.getLogger('PyWebHost')
    ...
    def parse_request(self):
        ...
        try:
            ...
            if self.headers.get('Cookie'):
                cookies = self.headers.get('Cookie').replace('%20',' ').replace(' ','') # esacpe spaces : https://tools.ietf.org/html/rfc6265#section-4.1.1
