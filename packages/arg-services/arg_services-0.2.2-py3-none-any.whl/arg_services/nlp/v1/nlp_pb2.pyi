...
class DocBinRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_attributes",b"_attributes","attributes",b"attributes","config",b"config","disabled_pipes",b"disabled_pipes","enabled_pipes",b"enabled_pipes","pipes",b"pipes"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_attributes",b"_attributes","attributes",b"attributes","config",b"config","disabled_pipes",b"disabled_pipes","embedding_levels",b"embedding_levels","enabled_pipes",b"enabled_pipes","pipes",b"pipes","texts",b"texts"]) -> None: ...
    @typing.overload
