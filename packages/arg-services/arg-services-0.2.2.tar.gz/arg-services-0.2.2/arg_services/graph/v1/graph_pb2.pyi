...
class Resource(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created",b"created","metadata",b"metadata","source",b"source","text",b"text","title",b"title","updated",b"updated"]) -> None: ...
...
class Participant(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created",b"created","metadata",b"metadata","updated",b"updated"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created",b"created","description",b"description","email",b"email","location",b"location","metadata",b"metadata","name",b"name","updated",b"updated","url",b"url","username",b"username"]) -> None: ...
...
class Reference(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["metadata",b"metadata","offset",b"offset","resource",b"resource","text",b"text"]) -> None: ...
