...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html)
...
from .literals import NodeCategoryType, StatusFilterType
...
class PanoramaClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#can_paginate)
        """
    ...
    async def create_application_instance(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#create_application_instance)
        """
    ...
    async def create_job_for_devices(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#create_job_for_devices)
        """
    ...
    async def create_node_from_template_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#create_node_from_template_job)
        """
    ...
    async def create_package(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#create_package)
        """
    ...
    async def create_package_import_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#create_package_import_job)
        """
    ...
    async def delete_device(self, *, DeviceId: str) -> DeleteDeviceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#delete_device)
        """
    ...
    async def delete_package(self, *, PackageId: str, ForceDelete: bool = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#delete_package)
        """
    ...
    async def deregister_package_version(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#deregister_package_version)
        """
    ...
    async def describe_application_instance(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_application_instance)
        """
    ...
    async def describe_application_instance_details(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_application_instance_details)
        """
    ...
    async def describe_device(self, *, DeviceId: str) -> DescribeDeviceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_device)
        """
    ...
    async def describe_device_job(self, *, JobId: str) -> DescribeDeviceJobResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_device_job)
        """
    ...
    async def describe_node(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_node)
        """
    ...
    async def describe_node_from_template_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_node_from_template_job)
        """
    ...
    async def describe_package(self, *, PackageId: str) -> DescribePackageResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_package)
        """
    ...
    async def describe_package_import_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_package_import_job)
        """
    ...
    async def describe_package_version(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#describe_package_version)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#generate_presigned_url)
        """
    ...
    async def list_application_instance_dependencies(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_application_instance_dependencies)
        """
    ...
    async def list_application_instance_node_instances(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_application_instance_node_instances)
        """
    ...
    async def list_application_instances(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_application_instances)
        """
    ...
    async def list_devices(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_devices)
        """

    async def list_devices_jobs(
        self, *, DeviceId: str = ..., NextToken: str = ..., MaxResults: int = ...
    ) -> ListDevicesJobsResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_devices_jobs)
        """
    ...
    async def list_node_from_template_jobs(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_node_from_template_jobs)
        """
    ...
    async def list_nodes(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_nodes)
        """
    ...
    async def list_package_import_jobs(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_package_import_jobs)
        """
    ...
    async def list_packages(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_packages)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#list_tags_for_resource)
        """
    ...
    async def provision_device(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#provision_device)
        """
    ...
    async def register_package_version(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#register_package_version)
        """
    ...
    async def remove_application_instance(self, *, ApplicationInstanceId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#remove_application_instance)
        """
    ...
    async def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#untag_resource)
        """
    ...
    async def update_device_metadata(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_panorama/client.html#update_device_metadata)
        """
