    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_wafwebacl_cloudfront._jsii": [
            "aws-wafwebacl-cloudfront@1.138.2.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_wafwebacl_cloudfront": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-cloudfront-origins==1.138.2",
        ...
        "aws-solutions-constructs.aws-cloudfront-apigateway-lambda==1.138.2",
        "aws-solutions-constructs.aws-cloudfront-mediastore==1.138.2",
        "aws-solutions-constructs.aws-cloudfront-s3==1.138.2",
