...
class ClassificationMultiLabelEvaluator(EvaluatorBase):
    ...
    def compute_wmAP(self, df, am):
        ...
        class_weights = {key:val / total_gt for key, val in zip(self.classnames, class_occurrence_list)}
    ...
    def eval_judgment(self):
        ...
        thre_array = np.array([self.threshold_dict[key] for key in self.classnames])
