...
setup(
    ...
    description='A python client library used to get and collect Canada immigration data in Excel.',
    ...
    keywords='Canada, Immigration, Data, Source, Excel, APIs',
    ...
    entry_points={
        'console_scripts':[
            'ds=source.datasource:main'  # ds是命令行命令， source.source:main是对应的函数所在包中的位置
        ]
    }
)