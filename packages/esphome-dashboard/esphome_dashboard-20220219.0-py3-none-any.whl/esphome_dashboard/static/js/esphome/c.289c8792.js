import{a as t,r as o,_ as e,c as s,f as i,n as r,s as a,$ as n}from"./index-7481a400.js";import"./c.005c9341.js";import"./c.350632ad.js";import{g as c}from"./c.a25cfa1d.js";import{m as l,s as p,a as m}from"./c.515f4acf.js";const h=(t,o)=>{import("./c.42c96879.js");const e=document.createElement("esphome-logs-dialog");e.configuration=t,e.target=o,document.body.append(e)},d=(t,o,e)=>{import("./c.11b723ce.js");const s=document.createElement("esphome-logs-webserial-dialog");s.configuration=e,s.port=t,s.closePortOnClose=o,document.body.append(s)};let w=class extends a{constructor(){super(...arguments),this._show="options"}render(){let t,o;return"options"===this._show?(t="How to get the logs for your device?",o=n`
        <mwc-list-item
          twoline
          hasMeta
          dialogAction="close"
