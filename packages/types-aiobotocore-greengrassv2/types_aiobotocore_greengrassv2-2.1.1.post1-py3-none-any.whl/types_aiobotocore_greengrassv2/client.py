...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html)
...
class GreengrassV2Client(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#exceptions)
        """
    ...
    async def batch_associate_client_device_with_core_device(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#batch_associate_client_device_with_core_device)
        """
    ...
    async def batch_disassociate_client_device_from_core_device(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#batch_disassociate_client_device_from_core_device)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#can_paginate)
        """
    ...
    async def cancel_deployment(self, *, deploymentId: str) -> CancelDeploymentResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#cancel_deployment)
        """
    ...
    async def create_component_version(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#create_component_version)
        """
    ...
    async def create_deployment(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#create_deployment)
        """

    async def delete_component(self, *, arn: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#delete_component)
        """

    async def delete_core_device(self, *, coreDeviceThingName: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#delete_core_device)
        """
    ...
    async def describe_component(self, *, arn: str) -> DescribeComponentResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#describe_component)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#generate_presigned_url)
        """
    ...
    async def get_component(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#get_component)
        """
    ...
    async def get_component_version_artifact(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#get_component_version_artifact)
        """
    ...
    async def get_core_device(self, *, coreDeviceThingName: str) -> GetCoreDeviceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#get_core_device)
        """
    ...
    async def get_deployment(self, *, deploymentId: str) -> GetDeploymentResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#get_deployment)
        """
    ...
    async def list_client_devices_associated_with_core_device(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_client_devices_associated_with_core_device)
        """
    ...
    async def list_component_versions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_component_versions)
        """
    ...
    async def list_components(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_components)
        """
    ...
    async def list_core_devices(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_core_devices)
        """
    ...
    async def list_deployments(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_deployments)
        """
    ...
    async def list_effective_deployments(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_effective_deployments)
        """
    ...
    async def list_installed_components(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_installed_components)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#list_tags_for_resource)
        """
    ...
    async def resolve_component_candidates(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#resolve_component_candidates)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#untag_resource)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_greengrassv2/client.html#get_paginator)
        """
