...
class CheckDatabaseResponse(google.protobuf.message.Message):
    ...
    @property
    def problems(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    def __init__(self,
        *,
...
class Progress(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["database_check",b"database_check","full_sync",b"full_sync","media_check",b"media_check","media_sync",b"media_sync","none",b"none","normal_sync",b"normal_sync","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["database_check",b"database_check","full_sync",b"full_sync","media_check",b"media_check","media_sync",b"media_sync","none",b"none","normal_sync",b"normal_sync","value",b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value",b"value"]) -> typing.Optional[typing_extensions.Literal["none","media_sync","media_check","full_sync","normal_sync","database_check"]]: ...
