...
class AVTag(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value",b"value"]) -> typing.Optional[typing_extensions.Literal["sound_or_video","tts"]]: ...
...
class TTSTag(google.protobuf.message.Message):
    ...
    lang: typing.Text = ...
    @property
    def voices(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    speed: builtins.float = ...
    @property
    def other_args(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    def __init__(self,
        *,
        field_text : typing.Text = ...,
        lang : typing.Text = ...,
...
class RenderExistingCardRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["browser",b"browser","card_id",b"card_id"]) -> None: ...
...
class RenderUncommittedCardRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["card_ord",b"card_ord","fill_empty",b"fill_empty","note",b"note","template",b"template"]) -> None: ...
...
class RenderedTemplateNode(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value",b"value"]) -> typing.Optional[typing_extensions.Literal["text","replacement"]]: ...
