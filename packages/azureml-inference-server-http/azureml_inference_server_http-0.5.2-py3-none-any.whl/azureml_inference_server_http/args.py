...
def parse_arguments():
    parser = argparse.ArgumentParser(description=f"Azure ML Inferencing HTTP server v{get_version()}", add_help=True)
    parser.add_argument("--entry_script", required=True, help="The relative or absolute path to the scoring script.")
    parser.add_argument(
        "--model_dir",
        required=False,
