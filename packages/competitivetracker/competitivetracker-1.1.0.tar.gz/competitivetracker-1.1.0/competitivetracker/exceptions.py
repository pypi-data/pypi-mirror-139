class CompetitiveTrackerException(Exception):
    pass


class CompetitiveTrackerAPIException(CompetitiveTrackerException):
    ...
    def __init__(self, response, *args, **kwargs):
        ...
        super(CompetitiveTrackerAPIException, self).__init__(message, *args, **kwargs)
