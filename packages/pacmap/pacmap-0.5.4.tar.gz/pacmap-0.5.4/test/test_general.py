...
print('Experiment has been done successfully.')
...
plt.savefig("/Users/hyhuang/Desktop/PaCMAP/pypi/test/test_output/test_fmnist_seed.png")

reducer = pacmap.PaCMAP(n_dims=2, n_neighbors=10, MN_ratio=0.5, FP_ratio=2.0)
embedding = reducer.fit_transform(fmnist, init="pca")
plt.scatter(embedding[:, 0], embedding[:, 1], s=0.5, c=labels, cmap='Spectral')
plt.savefig("/Users/hyhuang/Desktop/PaCMAP/pypi/test/test_output/test_fmnist_noseed.png")

# MNIST
mnist = np.load("/Users/hyhuang/Desktop/MNIST/mnist_images.npy", allow_pickle=True)
mnist = fmnist.reshape(mnist.shape[0], -1)
...
plt.scatter(embedding[:, 0], embedding[:, 1], s=0.5, c=labels, cmap='Spectral')
plt.savefig("/Users/hyhuang/Desktop/PaCMAP/pypi/test/test_output/test_mnist_seed.png")

reducer = pacmap.PaCMAP(n_dims=2, n_neighbors=10, MN_ratio=0.5, FP_ratio=2.0)
embedding = reducer.fit_transform(mnist, init="pca")
plt.scatter(embedding[:, 0], embedding[:, 1], s=0.5, c=labels, cmap='Spectral')
plt.savefig("/Users/hyhuang/Desktop/PaCMAP/pypi/test/test_output/test_mnist_noseed.png")
