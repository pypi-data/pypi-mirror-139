...
class NotificationStack(Stack): 
    ...
    This Stack ...
    '''
    def __init__(self, scope: Construct, construct_id: str, pinpoint_app_name: str, apns_bundle_id: str, apns_certificate_path: str, apns_private_key_path: str,  **kwargs) -> None:
