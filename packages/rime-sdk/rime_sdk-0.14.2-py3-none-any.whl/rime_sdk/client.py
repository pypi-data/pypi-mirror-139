...
class RIMEClient:
    ...
    def create_ct_instance(
        self, name: str, bin_size_seconds: int, ot_test_run_id: str, project_id: str
    ) -> RIMECTInstance:
        ...
        Args:
            ...
            ot_test_run_id: str
                ID of the offline test run that continuous tests will be based on.
            project_id: str
