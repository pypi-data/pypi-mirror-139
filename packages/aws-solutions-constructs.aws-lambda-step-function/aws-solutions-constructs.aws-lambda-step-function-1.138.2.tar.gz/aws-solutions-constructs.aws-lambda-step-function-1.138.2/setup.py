    ...
    """
{
    ...
    "packages": [
        ...
        "aws_solutions_constructs.aws_lambda_step_function._jsii"
    ],
    "package_data": {
        "aws_solutions_constructs.aws_lambda_step_function._jsii": [
            "aws-lambda-step-function@1.138.2.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_lambda_step_function": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-lambda-stepfunctions==1.138.2",
