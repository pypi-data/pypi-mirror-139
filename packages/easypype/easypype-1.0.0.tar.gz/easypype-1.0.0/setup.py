...
setup(
  ...
  description = 'Easy way of managing pipes of instructions',   # Give a short description about your library
  ...
  url = 'https://github.com/ga-felix/easypype/tree/main',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/ga-felix/easypype/archive/refs/tags/v1.0.0.tar.gz',    # I explain this later on
