...
class TestCheckCase(UnitCase):
    ...
    def test_check_and_init_class__check_false(self) -> None:
        self.smart._check_missings = False
        self.smart._check_overrides = False
        self.smart._check_typings = False
    ...
    def test_check_and_init_class__check_missings_true(self) -> None:
        self.smart._check_missings = True
        self.smart._check_overrides = False
        self.smart._check_typings = False

        self.assertRaises(ValueError, self.smart, arg2='88')

    def test_check_and_init_class__check_overrides_true(self) -> None:
        self.smart._check_missings = False
        self.smart._check_overrides = True
        self.smart._check_typings = False

        self.assertRaises(ValueError, self.smart, arg2='88')

    def test_check_and_init_class__check_typings_true(self) -> None:
        self.smart._check_missings = False
        self.smart._check_overrides = False
        self.smart._check_typings = True
