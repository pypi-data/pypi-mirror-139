...
LastEditors: zmf96
LastEditTime: 2022-02-21 10:13:27
...
class SubDomain:
    def __init__(self, paras={}):
        ...
        self.semaphore = asyncio.Semaphore(10000)  # 协程并发量  4m带宽
    ...
    async def start_brute(self):
        ...
        brute_tasks = [self.loop.create_task(
            self.brute_domain()) for _ in range(10000)] # 启动10000个协程
...
def main():
    ...
    parser.add_argument("-d", "--domain", type=str,
                        help='目标域名', default='jd.com')
    parser.add_argument("-s", "--deep", type=int, help='域名深度,默认 2', default=3)
