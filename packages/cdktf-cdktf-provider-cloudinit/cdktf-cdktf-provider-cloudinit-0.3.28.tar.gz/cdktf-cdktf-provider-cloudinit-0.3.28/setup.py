    ...
    """
{
    ...
    "license": "MPL-2.0",
    "url": "https://github.com/hashicorp/cdktf-provider-cloudinit.git",
    ...
    "project_urls": {
        "Source": "https://github.com/hashicorp/cdktf-provider-cloudinit.git"
    },
    "package_dir": {
        "": "src"
    },
    ...
    "package_data": {
        "cdktf_cdktf_provider_cloudinit._jsii": [
            "provider-cloudinit@0.3.28.jsii.tgz"
        ],
        "cdktf_cdktf_provider_cloudinit": [
            "py.typed"
        ]
