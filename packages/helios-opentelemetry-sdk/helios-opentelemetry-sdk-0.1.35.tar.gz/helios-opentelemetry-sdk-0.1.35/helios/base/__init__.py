    ...
    def extract_context_from_databricks(self):
        ...
        if notebook_params is not None:
            self.extract_context_and_create_span(
                carrier=notebook_params,
                span_name='databricks_job',
                alternative_carrier_extractor=self.extract_context_from_notebook_params)

    def extract_context_from_notebook_params(self, notebook_params):
        traceparent = notebook_params.get("traceparent")
