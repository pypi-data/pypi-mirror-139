...
# sources: unacast/operator/v1/index_job.proto, unacast/operator/v1/index_job_operator_service.proto, unacast/operator/v1/metric_operator_service.proto, unacast/operator/v1/address_component_operator_service.proto, unacast/operator/v1/dimension_operator_service.proto, unacast/operator/v1/map_operator_service.proto, unacast/operator/v1/catalog_operator_service.proto
...
class MetricOperatorServiceStub(betterproto.ServiceStub):
    async def create_metric(
        ...
        *,
        ...
        availability: "__unatype__.AvailabilityKind" = None,
    ...
    async def index_metric(
        ...
        *,
        ...
        request.is_priority = is_priority
...
class AddressComponentOperatorServiceStub(betterproto.ServiceStub):
    async def create_address_component(
        ...
        *,
        ...
        request.id_display_name = id_display_name
        request.availability = availability
...
class MapOperatorServiceStub(betterproto.ServiceStub):
    async def create_layer(
        ...
        *,
        ...
        layer_kind: "__maps_v1__.LayerKind" = None,
        display_name: str = "",
        description: str = "",
