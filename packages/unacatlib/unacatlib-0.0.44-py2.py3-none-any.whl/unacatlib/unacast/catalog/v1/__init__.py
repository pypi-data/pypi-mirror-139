...
# sources: unacast/catalog/v1/catalog.proto, unacast/catalog/v1/data_delivery.proto, unacast/catalog/v1/query_service.proto, unacast/catalog/v1/export_service.proto, unacast/catalog/v1/catalog_service.proto
...
class DataDelivery(betterproto.Message):
    ...
    data_schema: "DataSchema" = betterproto.message_field(8)
