...
class CreateDataDeliveryRequest(betterproto.Message):
    ...
    data_schema_changes: "__catalog_v1__.DataSchema" = betterproto.message_field(6)
    big_query_destination: "BigQueryDestination" = betterproto.message_field(
        11, group="destination"
    )
    file_destination: "__catalog_v1__.FileDestination" = betterproto.message_field(
...
class GetDefaultDataSchemaResponse(betterproto.Message):
    data_schema: "__catalog_v1__.DataSchema" = betterproto.message_field(1)
...
class DataDeliveryServiceStub(betterproto.ServiceStub):
    async def create_data_delivery(
        ...
        *,
        ...
        data_schema_changes: "__catalog_v1__.DataSchema" = None,
        big_query_destination: "BigQueryDestination" = None,
        file_destination: "__catalog_v1__.FileDestination" = None,
    ...
    async def delete_data_delivery(self) -> "betterproto_lib_google_protobuf.Empty":

        request = DeleteDataDeliveryRequest()
    ...
    async def get_default_data_schema(
        ...
        return await self._unary_unary(
            "/unacast.v2.catalog.DataDeliveryService/GetDefaultDataSchema",
            request,
            GetDefaultDataSchemaResponse,
        )
