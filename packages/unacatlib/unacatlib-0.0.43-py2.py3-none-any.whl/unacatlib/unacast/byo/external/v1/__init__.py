...
# sources: unacast/byo/external/v1/external_byo_service.proto
...
class CreateUsReportRequest(betterproto.Message):
    ...
    start_date: "___unatype__.Date" = betterproto.message_field(7)
    end_date: "___unatype__.Date" = betterproto.message_field(8)
...
class MetricValuesOnPois(betterproto.Message):
    report_status: "ReportStatus" = betterproto.enum_field(3)
    schema: "___v2_metric__.MetricVersion" = betterproto.message_field(1)
    values: List["___v2_metric__.MetricValue"] = betterproto.message_field(2)
...
class ExternalByoServiceStub(betterproto.ServiceStub):
    async def create_us_report(self) -> "ReportDetails":
        ...
        return await self._unary_unary(
            "/unacast.byo.external.v1.ExternalByoService/CreateUSReport",
            request,
            ReportDetails,
        )
    ...
    async def read_metric_from_report(
        ...
        *,
        ...
        return await self._unary_unary(
            "/unacast.byo.external.v1.ExternalByoService/ReadMetricFromReport",
            request,
            MetricValuesOnPois,
        )
...
from ....v2 import metric as ___v2_metric__
