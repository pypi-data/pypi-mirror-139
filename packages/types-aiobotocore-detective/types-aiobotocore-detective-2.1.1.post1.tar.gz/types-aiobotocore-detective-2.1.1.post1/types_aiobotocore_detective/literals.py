...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_detective/literals.html)

Usage::

    ```python
    from types_aiobotocore_detective.literals import MemberDisabledReasonType
...
__all__ = ("MemberDisabledReasonType", "MemberStatusType", "ServiceName")
