...
setup(
    ...
    description="Type annotations for boto3.EC2 1.21.1 service generated by mypy-boto3-builder 7.0.4",
    classifiers=[
    ...
    keywords="boto3 ec2 type-annotations boto3-stubs mypy typeshed autocomplete",
    long_description=LONG_DESCRIPTION,
    long_description_content_type="text/markdown",
    package_data={"mypy_boto3_ec2": ["py.typed", "*.pyi"]},
    python_requires=">=3.6",
    project_urls={
