...
[aiobotocore.IoTWireless 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/iotwireless.html#IoTWireless)
...
- [types-aiobotocore-iotwireless](#types-aiobotocore-iotwireless)
...
- Install `types-aiobotocore[iotwireless]` with services you use in your
  environment:
...
`types_aiobotocore_iotwireless.literals` module contains literals extracted
...
`types-aiobotocore-iotwireless` version is the same as related `aiobotocore`
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotwireless/)
