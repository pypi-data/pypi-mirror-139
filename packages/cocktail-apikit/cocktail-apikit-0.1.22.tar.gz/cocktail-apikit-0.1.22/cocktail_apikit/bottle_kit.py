...
def error_handler(error):
    ...
    # Put more details information in the returned result for 500 ERROR when application run in development/test 
    # environment or in DEBUG mode 
    ...
    def setup(self, app: Bottle = None):
        ...
        for route in app.routes:
            if hasattr(route.callback, 'enable_swagger') and not route.callback.enble_swagger:
                continue
            self.apispec.path(view=route.callback, app=app)
