...
pipelines.CodeBuildStep("Synth",
    ...
    vpc=vpc,
    subnet_selection=cdk.aws_ec2.SubnetSelection(subnet_type=ec2.SubnetType.PRIVATE),
...
class CodeBuildOptions:
    def __init__(
        self,
        *,
        build_environment: typing.Optional[_BuildEnvironment_77bc5f50] = None,
...
class CodePipelineActionFactoryResult:
    def __init__(
        ...
        *,
        ...
        :param run_orders_consumed: (experimental) How many RunOrders were consumed.
...
class _CodePipelineSourceProxy(
    ...
    def _get_action(
        ...
        :stability: experimental
        '''
        return typing.cast(_Action_22e6ab5f, jsii.invoke(self, "getAction", [output, action_name, run_order]))
