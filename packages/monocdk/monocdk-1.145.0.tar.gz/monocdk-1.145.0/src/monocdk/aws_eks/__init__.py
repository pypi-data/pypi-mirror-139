...
lt = ec2.CfnLaunchTemplate(self, "LaunchTemplate",
    launch_template_data=eks.aws_ec2.CfnLaunchTemplate.LaunchTemplateDataProperty(
...
cluster.add_nodegroup_capacity("extra-ng",
    launch_template_spec=eks.aws_eks.LaunchTemplateSpec(
        id=lt.ref,
...
cluster.add_fargate_profile("MyProfile",
    selectors=[eks.aws_eks.Selector(namespace="default")]
)
```
...
cluster.add_auto_scaling_group_capacity("spot",
    ...
    min_capacity=2,
    bootstrap_options=eks.aws_eks.BootstrapOptions(
...
eks.Cluster(self, "HelloEKS",
    version=eks.KubernetesVersion.V1_21,
    alb_controller=eks.aws_eks.AlbControllerOptions(
...
eks.Cluster(self, "HelloEKS",
    version=eks.KubernetesVersion.V1_21,
    vpc=vpc,
    vpc_subnets=[eks.aws_ec2.SubnetSelection(subnet_type=ec2.SubnetType.PRIVATE)]
)
```
...
cluster.add_auto_scaling_group_capacity("nodes",
    vpc_subnets=eks.aws_ec2.SubnetSelection(subnets=vpc.private_subnets),
    instance_type=ec2.InstanceType("t2.medium")
)
```
...
class AlbController(
    ...
    jsii_type="monocdk.aws_eks.AlbController",
):
    ...
    Example::
        ...
        from monocdk import aws_eks as eks
...
@jsii.data_type(
    jsii_type="monocdk.aws_eks.AlbControllerOptions",
    jsii_struct_bases=[],
    name_mapping={
        "version": "version",
        "policy": "policy",
...
@jsii.data_type(
    jsii_type="monocdk.aws_eks.AlbControllerProps",
...
class AlbControllerVersion(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_eks.AlbControllerVersion",
):
    ...
    def of(cls, version: builtins.str) -> "AlbControllerVersion":
        '''(experimental) Specify a custom version.
...
@jsii.enum(jsii_type="monocdk.aws_eks.AlbScheme")
...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        ...
        logging: typing.Optional[typing.Union["CfnCluster.LoggingProperty", _IResolvable_a771d0ef]] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_eks.CfnCluster.ClusterLoggingProperty",
        jsii_struct_bases=[],
    ...
    class ClusterLoggingProperty:
        def __init__(
            self,
            *,
            enabled_types: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnCluster.LoggingTypeConfigProperty", _IResolvable_a771d0ef]]]] = None,
        ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_eks.CfnCluster.LoggingProperty",
        jsii_struct_bases=[],
    ...
    class LoggingProperty:
        def __init__(
            self,
            *,
            cluster_logging: typing.Optional[typing.Union["CfnCluster.ClusterLoggingProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_eks.CfnCluster.LoggingTypeConfigProperty",
        jsii_struct_bases=[],
...
class CfnNodegroup(
    ...
    def __init__(
        ...
        *,
        ...
        update_config: typing.Optional[typing.Union["CfnNodegroup.UpdateConfigProperty", _IResolvable_a771d0ef]] = None,
        version: typing.Optional[builtins.str] = None,
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_eks.CfnNodegroup.UpdateConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
...
class ClusterAttributes:
    def __init__(
        ...
        *,
        ...
        kubectl_lambda_role: typing.Optional[_IRole_59af6f50] = None,
        ...
        on_event_layer: typing.Optional[_ILayerVersion_b2b86380] = None,
        ...
        :param cluster_handler_security_group_id: (experimental) A security group id to associate with the Cluster Handler's Lambdas. The Cluster Handler's Lambdas are responsible for calling AWS's EKS API. Default: - No security group.
    ...
    def cluster_handler_security_group_id(self) -> typing.Optional[builtins.str]:
        '''(experimental) A security group id to associate with the Cluster Handler's Lambdas.
    ...
    @builtins.property
    def kubectl_lambda_role(self) -> typing.Optional[_IRole_59af6f50]:
    ...
    @builtins.property
    def on_event_layer(self) -> typing.Optional[_ILayerVersion_b2b86380]:
...
@jsii.enum(jsii_type="monocdk.aws_eks.ClusterLoggingTypes")
...
class HelmChart(
    ...
    def __init__(
        ...
        *,
        ...
        chart_asset: typing.Optional[_Asset_d07e8c00] = None,
...
class HelmChartOptions:
    ...
    @builtins.property
    def chart_asset(self) -> typing.Optional[_Asset_d07e8c00]:
...
class ICluster(_IResource_8c1dbbbd, _IConnectable_c1c0e72c, typing_extensions.Protocol):
    ...
    def cluster_handler_security_group(
        self,
    ) -> typing.Optional[_ISecurityGroup_cdbba9d3]:
...
class _IClusterProxy(
    ...
    def cluster_handler_security_group(
        ...
        :attribute: true
        '''
        return typing.cast(typing.Optional[_ISecurityGroup_cdbba9d3], jsii.get(self, "clusterHandlerSecurityGroup"))
    ...
    def kubectl_lambda_role(self) -> typing.Optional[_IRole_59af6f50]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_IRole_59af6f50], jsii.get(self, "kubectlLambdaRole"))
    ...
    def on_event_layer(self) -> typing.Optional[_ILayerVersion_b2b86380]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_ILayerVersion_b2b86380], jsii.get(self, "onEventLayer"))
...
@jsii.interface(jsii_type="monocdk.aws_eks.IKubectlProvider")
class IKubectlProvider(_IConstruct_5a0f9c5e, typing_extensions.Protocol):
...
class _IKubectlProviderProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk.aws_eks.IKubectlProvider"
    ...
    def handler_role(self) -> _IRole_59af6f50:
        ...
        :stability: experimental
        '''
        return typing.cast(_IRole_59af6f50, jsii.get(self, "handlerRole"))
...
class KubectlProvider(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_eks.KubectlProvider",
):
    ...
    def from_kubectl_provider_attributes(
        ...
        *,
        ...
        :param function_arn: (experimental) The kubectl provider lambda arn.
        :param handler_role: (experimental) The IAM execution role of the handler. This role must be able to assume kubectlRoleArn
        :param kubectl_role_arn: (experimental) The IAM role to assume in order to perform kubectl operations against this cluster.
...
@jsii.data_type(
    jsii_type="monocdk.aws_eks.KubectlProviderAttributes",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk.aws_eks.KubectlProviderProps",
    jsii_struct_bases=[],
    name_mapping={"cluster": "cluster"},
)
...
@jsii.enum(jsii_type="monocdk.aws_eks.TaintEffect")
...
@jsii.data_type(
    jsii_type="monocdk.aws_eks.TaintSpec",
    jsii_struct_bases=[],
    name_mapping={"effect": "effect", "key": "key", "value": "value"},
)
class TaintSpec:
...
class Cluster(
    ...
    def __init__(
        ...
        *,
        ...
        cluster_handler_security_group: typing.Optional[_ISecurityGroup_cdbba9d3] = None,
        ...
        :param kubectl_lambda_role: (experimental) The IAM role to pass to the Kubectl Lambda Handler. Default: - Default Lambda IAM Execution Role
        ...
        :param cluster_handler_security_group: (experimental) A security group to associate with the Cluster Handler's Lambdas. The Cluster Handler's Lambdas are responsible for calling AWS's EKS API. Requires ``placeClusterHandlerInVpc`` to be set to true. Default: - No security group.
...
class ClusterProps(ClusterOptions):
    ...
    @builtins.property
    def kubectl_lambda_role(self) -> typing.Optional[_IRole_59af6f50]:
        '''(experimental) The IAM role to pass to the Kubectl Lambda Handler.
...
@jsii.data_type(
    jsii_type="monocdk.aws_eks.IngressLoadBalancerAddressOptions",
