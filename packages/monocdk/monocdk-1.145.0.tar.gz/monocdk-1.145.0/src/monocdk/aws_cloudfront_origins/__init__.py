...
cloudfront.Distribution(self, "myDist",
    default_behavior=ec2.aws_cloudfront.BehaviorOptions(origin=origins.LoadBalancerV2Origin(lb))
)
```
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            from monocdk import aws_cloudfront_origins as cloudfront_origins
