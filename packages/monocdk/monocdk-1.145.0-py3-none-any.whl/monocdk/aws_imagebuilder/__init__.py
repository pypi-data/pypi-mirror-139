...
class CfnInfrastructureConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        description: typing.Optional[builtins.str] = None,
        instance_metadata_options: typing.Optional[typing.Union["CfnInfrastructureConfiguration.InstanceMetadataOptionsProperty", _IResolvable_a771d0ef]] = None,
        instance_types: typing.Optional[typing.Sequence[builtins.str]] = None,
        key_pair: typing.Optional[builtins.str] = None,
        logging: typing.Optional[typing.Union["CfnInfrastructureConfiguration.LoggingProperty", _IResolvable_a771d0ef]] = None,
