...
def dataset_object_from_filenames(sorted_table: astropy.table.Table,
    ...
    ----------
    sorted_filenames
        The filenames to process into a `dkist.Dataset`, in dataset index
        order.

    sorted_headers
        The headers for filenames, in the same order as filenames.
    ...
    ds_wcs = TransformBuilder(sorted_headers)
