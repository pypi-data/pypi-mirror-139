...
__all__ = [
    ...
    "spatial_model_from_quantity",
    "spatial_model_from_header",
]


def spatial_model_from_quantity(
    crpix1, crpix2, cdelt1, cdelt2, pc, crval1, crval2, lon_pole, projection="TAN"
):
    """
    ...
    rotu = AffineTransformation2D(pc, translation=(0, 0) * pc.unit)
...
def spatial_model_from_header(header):
    ...
    return np.mean(u.Quantity([cdelt1, cdelt2])).to_value(u.arcsec/u.pix), spatial_model_from_quantity(
        crpix1, crpix2, cdelt1, cdelt2, pc, crval1, crval2, lonpole * u.deg, projection=latproj
    )
...
class TransformBuilder:
    ...
    def make_stokes(self):
        ...
        self._transforms.append(
            generate_lookup_table([0, 1, 2, 3] * u.one, interpolation="nearest")
        )
        self._i += 1
    ...
    def make_spatial(self):
        ...
        obstime = Time(self.header["DATE-BEG"])
        axes_types = [
