...
class UsersApi(object):
    ...
    def id20_users_get(
        ...
        **kwargs
        ...
        <span style='font-size: 17px;'>Summary:</span>Return Type: <b>ODataUserList</b><br/>For more information about OData responses <a href='https://www.odata.org/getting-started/understand-odata-in-6-steps/'>link</a>.<br/><br/>  # noqa: E501
    ...
    def id20_users_get_by_external_id_external_idexternal_id_get(
        ...
        **kwargs
        ...
        """Gets the specified User by their key  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Gets the specified User by their key.<br/>Return Type: <b>User</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_users_post(
        ...
        **kwargs
        ...
        <span style='font-size: 17px;'>Summary:</span>Return Type: <b>User</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Args:
            user_create (UserCreate): User to be created
    ...
    def id20_users_put(
        ...
        **kwargs
        ...
        """Gets or creates the user based on the external identity. Only usable by master users.   User.ExternalIdentity is required for this call.  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Gets or creates the user based on the external identity. Only usable by master users.   User.ExternalIdentity is required for this call..<br/>Return Type: <b>User</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
