...
class MembersApi(object):
    ...
    def id20_tenants_tenant_id_members_post(
        ...
        **kwargs
        ...
        """Creates a new Team member adding an existing user to the tenant  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Creates a new Team member adding an existing user to the tenant.<br/>The ability to add users to a limited by tenant role.<br/>Return Type: <b>TenantUser</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_tenants_tenant_id_members_user_id_delete(
        ...
        **kwargs
        ...
        """Revokes a user from this Tenant. Requires the Administrator Tenant Role  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Revokes a user from this Tenant. Requires the Administrator Tenant Role.<br/>Return Type: <b></b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_tenants_tenant_id_members_user_id_get(
        ...
        **kwargs
        ...
        """Gets the specified Tenant Member by their userId  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Gets the specified Tenant Member by their userId.<br/>Return Type: <b>TenantUser</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_tenants_tenant_id_members_user_id_patch(
        ...
        **kwargs
        ...
        """Amend an existing team member's team details  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Amend an existing team member's team details.<br/>Editing users requires Admin rights on the tenant.<br/>Return Type: <b>TenantUser</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
