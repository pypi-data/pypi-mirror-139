...
class SchedulesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.schedules_get_schedule_by_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'schedules_get_schedule_by_tenantid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def schedules_get_schedule_by_tenantid(
        self,
        asset_model_id,
        schedule_name,
        tenant_id,
        ...
        **kwargs
        ...
        """Get Schedules schedule by tenantid  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Return Type: <b>Schedule</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.schedules_get_schedule_by_tenantid(asset_model_id, schedule_name, tenant_id, region="UK", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['region'] = \
            region
        return self.schedules_get_schedule_by_tenantid_endpoint.call_with_http_info(**kwargs)
