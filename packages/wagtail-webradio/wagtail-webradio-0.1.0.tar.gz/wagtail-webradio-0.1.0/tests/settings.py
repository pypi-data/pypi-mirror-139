...
# Disable validation during tests by default since it requires mocking urlopen
# to prevent network access and to have fake data - generated by factories.
WEBRADIO_VALIDATE_PODCAST_URL = False
