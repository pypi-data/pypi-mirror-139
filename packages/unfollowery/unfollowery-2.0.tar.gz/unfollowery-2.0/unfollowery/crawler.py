...
class Profile:
    ...
    * Unfollowers - The people, who have unfollowed the user.
    ...
    Args:
        ...
        is_private (bool): True if the user's profile status is private
                           [Public/Private]
    ...
    def __init__(self,
        ...
        Params:
            username (str):
                The user's username
            is_private (bool):
                True if the user's profile status is private.
                [Public/Private]
            password (str):
                The user's password
                [If the user's profile is private]
        ...
        self.password = password if is_private else None
