...
_CLEARGEOFENCEREQUEST = _descriptor.Descriptor(
  name='ClearGeofenceRequest',
  full_name='mavsdk.rpc.geofence.ClearGeofenceRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_CLEARGEOFENCERESPONSE = _descriptor.Descriptor(
  name='ClearGeofenceResponse',
  full_name='mavsdk.rpc.geofence.ClearGeofenceResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='geofence_result', full_name='mavsdk.rpc.geofence.ClearGeofenceResponse.geofence_result', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLEARGEOFENCERESPONSE.fields_by_name['geofence_result'].message_type = _GEOFENCERESULT
...
DESCRIPTOR.message_types_by_name['ClearGeofenceRequest'] = _CLEARGEOFENCEREQUEST
DESCRIPTOR.message_types_by_name['ClearGeofenceResponse'] = _CLEARGEOFENCERESPONSE
...
_GEOFENCESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ClearGeofence',
    full_name='mavsdk.rpc.geofence.GeofenceService.ClearGeofence',
    index=1,
    containing_service=None,
    input_type=_CLEARGEOFENCEREQUEST,
    output_type=_CLEARGEOFENCERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
