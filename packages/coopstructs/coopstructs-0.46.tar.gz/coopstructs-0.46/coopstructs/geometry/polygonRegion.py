...
from coopstructs.geometry.line import Line
...
class PolygonRegion:
    ...
    def add_points_between_points(self, points: Dict[Vector2, Tuple[int, int]]):
        for point, between_idxs in points.items():
...
if __name__ == "__main__":
    ...
    poly2 = poly.with_additional_point(new, between_idxs=bnds[0])
    print(poly2)
