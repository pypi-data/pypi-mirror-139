...
VERSION = "0.2.3a1645193277"
PLUGIN_VERSION = "0.2.3-alpha.1645193277+9172f236"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the libvirt resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource libvirt {PLUGIN_VERSION}`
                """)
            else:
                raise
