...
class ConfigurationItem(object):
    ...
    def __init__(self, created_at=None, created_by=None, last_modified_at=None, last_modified_by=None, description=None, key=None, value=None, type=None, value_type=None, is_secret=None, ref=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type value: str
        :param type:  Defines how the value is presented.  If it is secret, the value will be hidden.  If it is text, the value will be in plain-text. (required)
        :type type: str
        :param value_type:  The type of the configuration item's value (required)
        :type value_type: str
        :param is_secret:  Defines whether or not the value is a secret.  This field will eventually replace the Type field of this class. (required)
        :type is_secret: bool
    ...
    @property
    def type(self):
        """Gets the type of this ConfigurationItem.  # noqa: E501

        Defines how the value is presented.  If it is secret, the value will be hidden.  If it is text, the value will be in plain-text.  # noqa: E501

        :return: The type of this ConfigurationItem.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this ConfigurationItem.  # noqa: E501
        :type type: str
        """
    ...
    def is_secret(self):
        ...
        Defines whether or not the value is a secret.  This field will eventually replace the Type field of this class.  # noqa: E501
