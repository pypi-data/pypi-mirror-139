...
class CreateConfigurationItem(object):
    ...
    def __init__(self, key=None, value=None, value_type=None, type=None, is_secret=None, description=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type value: str
        :param value_type:  The type (text, number, boolean, textCollection, numberCollection) of the new configuration item's value
        :type value_type: str
        :param type:  The type (text or secret) of the new configuration item
        :type type: str
        :param is_secret:  Defines whether or not the value is a secret
        :type is_secret: bool
    ...
    def value_type(self):
        ...
        The type (text, number, boolean, textCollection, numberCollection) of the new configuration item's value  # noqa: E501
