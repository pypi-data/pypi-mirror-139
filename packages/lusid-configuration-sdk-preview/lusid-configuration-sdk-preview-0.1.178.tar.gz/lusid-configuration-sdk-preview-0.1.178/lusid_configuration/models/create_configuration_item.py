...
class CreateConfigurationItem(object):
    ...
    def __init__(self, key=None, value=None, value_type=None, type=None, is_secret=None, description=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type value: str
        :param value_type:  The type of the new configuration item's value
        :type value_type: str
        :param type:  The type (text or secret) of the new configuration item
        :type type: str
        :param is_secret:  Defines whether or not the value is a secret.  This field will eventually replace the Type field of this class.
        :type is_secret: bool
    ...
    def value_type(self):
        ...
        The type of the new configuration item's value  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this CreateConfigurationItem.  # noqa: E501

        The type (text or secret) of the new configuration item  # noqa: E501

        :return: The type of this CreateConfigurationItem.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CreateConfigurationItem.

        The type (text or secret) of the new configuration item  # noqa: E501

        :param type: The type of this CreateConfigurationItem.  # noqa: E501
        :type type: str
        """
