...
[aiobotocore.STS 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sts.html#STS)
...
Install `types-aiobotocore-lite[sts]` in your environment:
...
- Install `types-aiobotocore[sts]` with services you use in your environment:
...
`types-aiobotocore-sts` version is the same as related `aiobotocore` version
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/)
