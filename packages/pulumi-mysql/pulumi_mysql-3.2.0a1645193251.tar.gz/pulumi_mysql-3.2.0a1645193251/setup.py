...
VERSION = "3.2.0a1645193251"
PLUGIN_VERSION = "3.2.0-alpha.1645193251+3f7c78c0"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the mysql resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource mysql {PLUGIN_VERSION}`
                """)
            else:
                raise
