...
['xpresso',
 'xpresso._utils',
 'xpresso.binders',
 'xpresso.binders._body',
 'xpresso.binders._body.extractors',
 'xpresso.binders._body.openapi',
 'xpresso.binders._parameters',
 'xpresso.binders._parameters.extractors',
 'xpresso.binders._parameters.openapi',
 'xpresso.binders._utils',
...
install_requires = \
['anyio>=3,<4', 'di>=0.58.1,<0.59.0', 'pydantic>=1,<2', 'starlette>=0.16.0,<1']
