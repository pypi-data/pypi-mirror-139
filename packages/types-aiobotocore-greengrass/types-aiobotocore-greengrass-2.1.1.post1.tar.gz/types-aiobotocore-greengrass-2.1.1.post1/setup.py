...
setup(
    ...
    description="Type annotations for aiobotocore.Greengrass 2.1.1 service generated with mypy-boto3-builder 7.1.1",
    classifiers=[
    ...
    keywords="aiobotocore greengrass type-annotations boto3-stubs mypy typeshed autocomplete",
