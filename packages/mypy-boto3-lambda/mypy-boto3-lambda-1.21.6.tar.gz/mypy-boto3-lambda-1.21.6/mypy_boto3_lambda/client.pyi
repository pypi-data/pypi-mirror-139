...
class LambdaClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_lambda/client.html#exceptions)
        """
    ...
    def remove_permission(
        ...
        """
    def tag_resource(self, *, Resource: str, Tags: Mapping[str, str]) -> None:
        """
        ...
        """
    def untag_resource(self, *, Resource: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def get_paginator(self, operation_name: Literal["list_aliases"]) -> ListAliasesPaginator:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_lambda/client.html#get_paginator)
        """
    @overload
    def get_paginator(
    ...
    def get_waiter(self, waiter_name: Literal["function_active"]) -> FunctionActiveWaiter:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_lambda/client.html#get_waiter)
        """
    @overload
