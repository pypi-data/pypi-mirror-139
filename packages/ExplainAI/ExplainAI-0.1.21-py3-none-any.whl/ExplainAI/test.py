...
#
# #------------1
# from ExplainAI.explainers.pi.pi import pi_trans,pi_plot
# p = pi_trans(model=m, feature_names=f, preserve=False)
# print(p)
# pi_plot(p)
# # #
#------------
# from ExplainAI.explainers.mfi.mfi import mse_feature_importance,mse_feature_importance_plot
# mfii = mse_feature_importance(model=m, data=d, target="SWC",preserve=False)
# # print(mfii)
# mse_feature_importance_plot(mfii)#,top=20
...
# # #------------1
from ExplainAI.explainers.ale.ale import ale_plot
import matplotlib.pyplot as plt
from ExplainAI.explainers.ale.ale_output import ale_output,ale_plot_total
...
#
# # #------------1
# from ExplainAI.explainers.ice import ice
...
# print(out)
#------------1
from ExplainAI.explainers.pdp import pdp
