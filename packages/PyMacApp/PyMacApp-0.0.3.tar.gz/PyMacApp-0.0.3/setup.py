...
setuptools.setup(
    ...
    description="Tools for creating MacOS desktop apps and installers, including signing and notorizing.",
    ...
    package_dir={"": "pymacapp"},
    packages=setuptools.find_packages(where="pymacapp"),
    python_requires=">=3.9",
