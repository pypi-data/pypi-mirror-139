...
class WellTopSurfaceIngestion(WellsBaseModel):
    ...
    base_measured_depth: Optional[float] = Field(
        ...
        description="The measured depth of the base of the lithostratigraphic unit, if available. If not, the base will be taken to be the top surface of the next unit",
    )
...
class WellTopsFilter(WellsBaseModel):
    ...
    wellbore_ids: List[Identifier] = Field(..., alias="wellboreIds")
...
class WellFilterAggregatesEnum(Enum):
    count = "count"
...
class WellTopFilter(WellsBaseModel):
    ...
    exists: Optional[bool] = Field(
        True,
        description="Set to false, to filter on wellbores that do not pass through specified surfaces. If no surfaces are specified then only wellbores that are not assosiated with any surface are returned",
    )
...
class ContainsAllOrAnyMeasurementType(WellsBaseModel):
    ...
    contains_all: Optional[List[str]] = Field(None, alias="containsAll")
    contains_any: Optional[List[str]] = Field(None, alias="containsAny")
...
class DoglegSeverityUnit(WellsBaseModel):
    ...
    distance_interval: Optional[float] = Field(1, alias="distanceInterval")
...
class SequenceExternalIdItems(WellsBaseModel):
    ...
    items: List[SequenceExternalId]
    ignore_unknown_ids: Optional[bool] = Field(False, alias="ignoreUnknownIds")
...
class WellIngestion(WellsBaseModel):
    ...
    water_depth: Optional[Distance] = Field(None, alias="waterDepth")
...
class Npt(WellsBaseModel):
    ...
    measured_depth: Optional[Distance] = Field(None, alias="measuredDepth")
...
class Nds(WellsBaseModel):
    ...
    hole_start: Distance = Field(..., alias="holeStart")
    hole_end: Distance = Field(..., alias="holeEnd")
...
class Trajectory(WellsBaseModel):
    ...
    wellbore_matching_id: str = Field(
        ..., alias="wellboreMatchingId", description="The matching id of the connected wellbore."
    )
    type: Optional[str] = None
...
class WellTopsIngestion(WellsBaseModel):
    ...
    wellbore_asset_external_id: str = Field(
        ...,
        alias="wellboreAssetExternalId",
        description="The CDF asset external id of the wellbore containing these tops.\n",
    )
    source: SequenceSource
    measured_depth_unit: DistanceUnitEnum = Field(..., alias="measuredDepthUnit")
...
class WellTopSurface(WellsBaseModel):
    ...
    age: Optional[str] = Field(None, example="Middle to Late Eocene")
...
class CasingAssembly(WellsBaseModel):
    ...
    min_inside_diameter: Distance = Field(..., alias="minInsideDiameter")
    min_outside_diameter: Distance = Field(..., alias="minOutsideDiameter")
    max_outside_diameter: Distance = Field(..., alias="maxOutsideDiameter")
    original_measured_depth_top: Distance = Field(..., alias="originalMeasuredDepthTop")
    original_measured_depth_base: Distance = Field(..., alias="originalMeasuredDepthBase")
    type: Optional[str] = None
...
class CasingSchematic(WellsBaseModel):
    ...
    wellbore_asset_external_id: str = Field(..., alias="wellboreAssetExternalId")
    wellbore_matching_id: str = Field(
        ..., alias="wellboreMatchingId", description="The matching id of the wellbore related to CastingSchematic."
    )
    casing_assemblies: List[CasingAssembly] = Field(..., alias="casingAssemblies")
    source: SequenceSource
    phase: str
...
class DeleteCasings(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    items: List[SequenceSource]
...
class PolygonFilter(WellsBaseModel):
    ...
    geometry_type: Optional[GeometryTypeEnum] = Field(None, alias="geometryType")
...
class DepthMeasurementDataRequest(CursorAndLimit):
    class Config:
        allow_population_by_field_name = True
...
class DeleteSources(WellsBaseModel):
    ...
    recursive: Optional[bool] = Field(
        False,
        description="If set to true, it will delete all data under the source.\nIf set to false, it will fail if one of the sources has any wells.",
    )
...
class DepthMeasurementIngestionItems(WellsBaseModel):
    ...
    items: List[DepthMeasurementIngestion]
...
class TrajectoryInterpolationRequestItems(WellsBaseModel):
    ...
    ignore_unknown_measured_depths: Optional[bool] = Field(None, alias="ignoreUnknownMeasuredDepths")
...
class CasingIngestionItems(WellsBaseModel):
    ...
    items: List[CasingSchematicIngestion]
...
class WellFilterRequest(CursorAndLimit):
    ...
    aggregates: Optional[List[WellFilterAggregatesEnum]] = None
...
class Well(WellsBaseModel):
    ...
    license: Optional[str] = Field(None, description="Well license")
    wellhead: Wellhead
    water_depth: Distance = Field(..., alias="waterDepth")
...
class WellItems(WellsBaseModel):
    ...
    items: List[Well]
    wells_count: Optional[int] = Field(None, alias="wellsCount")
    wellbores_count: Optional[int] = Field(None, alias="wellboresCount")
    next_cursor: Optional[str] = Field(None, alias="nextCursor")
