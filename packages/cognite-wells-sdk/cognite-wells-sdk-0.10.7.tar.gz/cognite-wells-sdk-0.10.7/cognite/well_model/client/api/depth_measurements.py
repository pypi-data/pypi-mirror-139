...
class DepthMeasurementsAPI(BaseAPI):
    def __init__(self, client: APIClient):
        ...
        def data(
            ...
            return self.list_data(
                ...
                column_external_ids=[x.column_external_id for x in this.columns],
    ...
    def list_data(
        ...
        NB! For now it is not supported to filter on both measurement types
        and column external ids in the same query.
