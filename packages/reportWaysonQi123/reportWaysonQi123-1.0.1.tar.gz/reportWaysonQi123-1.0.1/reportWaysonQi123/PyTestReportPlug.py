...
from reportWaysonQi123.api import make_report
...
def pytest_addoption(parser):
    ...
    group.addoption('--pytest_title', action='store', dest='pytest_title', metavar='path', default="GLR Automation Test Report",
                    help='given title for report.')
    group.addoption('--pytest_desc', action='store', dest='pytest_desc', metavar='path', default="This is the GUI automation test for the GLR project-Wayson Qi",
