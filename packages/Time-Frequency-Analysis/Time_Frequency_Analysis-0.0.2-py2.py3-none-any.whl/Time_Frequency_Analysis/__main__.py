...
#For NSGT_scale : NSGT_scale  python __main__.py --front_end NSGT_SCALE_FRAMES -p "{ ksi_s : 44100 , min_scl : 128 , ovrlp_fact : 0.5 , middle_window : np.hanning , matrix_form : 0 , multiproc : 1 }" --plot_spectrograms True
