...
`,s=document.createElement("template");s.innerHTML=`<style>${n.toString().replace(":host","html")}</style>`,document.head.appendChild(s.content)},85408:(e,t,o)=>{var r=o(89229);o(85466),o(37365);const i=r.iv`
  :host {
    top: 16px;
    right: 16px;
...
`,a=document.createElement("template");a.innerHTML=`<style>${i.toString().replace(":host","html")}</style>`,document.head.appendChild(a.content)},22726:(e,t,o)=>{class r extends HTMLElement{static get version(){return"21.0.2"}}customElements.define("vaadin-material-styles",r)},1335:(e,t,o)=>{o.d(t,{G:()=>d});var r=o(28426),i=o(52521),a=o(87529),n=o(20723),s=o(4358),l=o(59898);class d extends((0,s.T)((0,l.U)(r.H3))){static get template(){return r.dy`
      <style>
        :host {
          z-index: 200;
          position: fixed;
...
//# sourceMappingURL=f084c1bb.js.map