...
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[38227],{14114:(e,r,t)=>{t.d(r,{P:()=>i});const i=e=>(r,t)=>{if(r.constructor._observers){if(!r.constructor.hasOwnProperty("_observers")){const e=r.constructor._observers;r.constructor._observers=new Map,e.forEach(((e,t)=>r.constructor._observers.set(t,e)))}}else{r.constructor._observers=new Map;const e=r.updated;r.updated=function(r){e.call(this,r),r.forEach(((e,r)=>{const t=this.constructor._observers.get(r);void 0!==t&&t.call(this,this[r],e)}))}}r.constructor._observers.set(t,e)}},62744:(e,r,t)=>{var i=t(87480),n=t(72367),s=t(38103),a=t(37500),o=t(228),l=t(48399),c=t(47501);class d extends a.oi{constructor(){super(...arguments),this.indeterminate=!1,this.progress=0,this.buffer=1,this.reverse=!1,this.closed=!1,this.stylePrimaryHalf="",this.stylePrimaryFull="",this.styleSecondaryQuarter="",this.styleSecondaryHalf="",this.styleSecondaryFull="",this.animationReady=!0,this.closedAnimationOff=!1,this.resizeObserver=null}connectedCallback(){super.connectedCallback(),this.rootEl&&this.attachResizeObserver()}render(){const e={"mdc-linear-progress--closed":this.closed,"mdc-linear-progress--closed-animation-off":this.closedAnimationOff,"mdc-linear-progress--indeterminate":this.indeterminate,"mdc-linear-progress--animation-ready":this.animationReady},r={"--mdc-linear-progress-primary-half":this.stylePrimaryHalf,"--mdc-linear-progress-primary-half-neg":""!==this.stylePrimaryHalf?`-${this.stylePrimaryHalf}`:"","--mdc-linear-progress-primary-full":this.stylePrimaryFull,"--mdc-linear-progress-primary-full-neg":""!==this.stylePrimaryFull?`-${this.stylePrimaryFull}`:"","--mdc-linear-progress-secondary-quarter":this.styleSecondaryQuarter,"--mdc-linear-progress-secondary-quarter-neg":""!==this.styleSecondaryQuarter?`-${this.styleSecondaryQuarter}`:"","--mdc-linear-progress-secondary-half":this.styleSecondaryHalf,"--mdc-linear-progress-secondary-half-neg":""!==this.styleSecondaryHalf?`-${this.styleSecondaryHalf}`:"","--mdc-linear-progress-secondary-full":this.styleSecondaryFull,"--mdc-linear-progress-secondary-full-neg":""!==this.styleSecondaryFull?`-${this.styleSecondaryFull}`:""},t={"flex-basis":this.indeterminate?"100%":100*this.buffer+"%"},i={transform:this.indeterminate?"scaleX(1)":`scaleX(${this.progress})`};return a.dy`
  ...
  <ha-icon-button
    ...
    dir=${(0,a.Zu)(e)}
  ></ha-icon-button>
`;!function(e,r,t,i){var n=o();if(i)for(var s=0;s<i.length;s++)n=i[s](n);var a=r((function(e){n.initializeInstanceElements(e,m.elements)}),t),m=n.decorateClass(function(e){for(var r=[],t=function(e){return"method"===e.kind&&e.key===s.key&&e.placement===s.placement},i=0;i<e.length;i++){var n,s=e[i];if("method"===s.kind&&(n=r.find(t)))if(p(s.descriptor)||p(n.descriptor)){if(d(s)||d(n))throw new ReferenceError("Duplicated methods ("+s.key+") can't be decorated.");n.descriptor=s.descriptor}else{if(d(s)){if(d(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+s.key+").");n.decorators=s.decorators}c(s,n)}else r.push(s)}return r}(a.d.map(l)),e);n.initializeClassElements(a.F,m.elements),n.runClassFinishers(a.F,m.finishers)}([(0,s.Mo)("ha-dialog")],(function(e,r){class t extends r{constructor(...r){super(...r),e(this)}}return{F:t,d:[{kind:"method",key:"scrollToPos",value:function(e,r){var t;null===(t=this.contentElement)||void 0===t||t.scrollTo(e,r)}},{kind:"method",key:"renderHeading",value:function(){return n.dy`<slot name="heading"> ${h(g(t.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"get",static:!0,key:"styles",value:function(){return[i.V.styles,n.iv`
        .mdc-dialog {
    ...
    `:i.dy``}},{kind:"method",key:"_fetchData",value:async function(){if(!this.hass)return;(await(0,o.OV)(this.hass,this.entry_id)).controller.is_heal_network_active&&(this._status="started",this._subscribed=(0,o.EW)(this.hass,this.entry_id,this._handleMessage.bind(this)))}},{kind:"method",key:"_startHeal",value:function(){this.hass&&((0,o.OF)(this.hass,this.entry_id),this._status="started",this._subscribed=(0,o.EW)(this.hass,this.entry_id,this._handleMessage.bind(this)))}},{kind:"method",key:"_stopHeal",value:function(){this.hass&&((0,o.Ir)(this.hass,this.entry_id),this._unsubscribe(),this._status="cancelled")}},{kind:"method",key:"_handleMessage",value:function(e){if("heal network progress"===e.event){let r=0,t=0;for(const i of Object.values(e.heal_node_status))"pending"===i&&t++,["skipped","failed","done"].includes(i)&&r++;this._progress_total=Object.keys(e.heal_node_status).length,this._progress_finished=r/this._progress_total,this._progress_in_progress=t/this._progress_total}"heal network done"===e.event&&(this._unsubscribe(),this._status="finished")}},{kind:"method",key:"_unsubscribe",value:function(){this._subscribed&&(this._subscribed.then((e=>e())),this._subscribed=void 0)}},{kind:"get",static:!0,key:"styles",value:function(){return[l.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=10182a66.js.map