/*! For license information please see 1c6fe301.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[81838],{21157:(e,t,i)=>{i(94604);const l=i(50856).d`
...
`;l.setAttribute("style","display: none;"),document.head.appendChild(l.content)},75717:(e,t,i)=>{i.d(t,{hI:()=>l,Ry:()=>n});const l="number",n=(e,t,i,l)=>{e.callService("alarm_control_panel",`alarm_${i}`,{entity_id:t,code:l})}},81838:(e,t,i)=>{i.r(t);i(53918),i(21157),i(30879);var l=i(50856),n=i(28426),a=i(47181),o=i(75717),s=i(1265);class d extends((0,s.Z)(n.H3)){static get template(){return l.d`
