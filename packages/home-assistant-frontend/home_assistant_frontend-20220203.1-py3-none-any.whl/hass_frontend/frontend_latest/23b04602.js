...
`;!function(e,t,r,i){var n=a();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var s=t((function(e){n.initializeInstanceElements(e,f.elements)}),r),f=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(p(o.descriptor)||p(n.descriptor)){if(d(o)||d(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(d(o)){if(d(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}c(o,n)}else t.push(o)}return t}(s.d.map(l)),e);n.initializeClassElements(s.F,f.elements),n.runClassFinishers(s.F,f.finishers)}([(0,o.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"method",key:"scrollToPos",value:function(e,t){var r;null===(r=this.contentElement)||void 0===r||r.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return n.dy`<slot name="heading"> ${m(y(r.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"get",static:!0,key:"styles",value:function(){return[i.V.styles,n.iv`
      ...
      <ha-dialog open @closed=${this.closeDialog} hideActions .heading=${n}>
        ...
        ${this.isCustomIntegration?i.dy`<ha-alert alert-type="warning">
        ...
        <div class="contents">
          <p>
            ...
            ${t?i.dy`
                  ...
                  ${this._manifest&&r?i.dy`
                        (<a
                          href=${this._manifest.is_built_in?(0,d.R)(this.hass,`/integrations/${this._manifest.domain}`):this._manifest.documentation}
                          target="_blank"
                          rel="noreferrer"
                          >documentation</a
                        >${this._manifest.is_built_in||this._manifest.issue_tracker?i.dy`,
                              <a
            ...
            ${e.count>0?i.dy`
                  First occurred:
                  ${(0,f.Q)(e.first_occurred,this.hass.locale)}
                  (${e.count} occurrences) <br />
                `:""}
            Last logged:
            ${(0,f.Q)(e.timestamp,this.hass.locale)}
          </p>
          ${e.message.length>1?i.dy`
                <ul>
                  ${e.message.map((e=>i.dy` <li>${e}</li> `))}
                </ul>
              `:e.message[0]}
          ${e.exception?i.dy` <pre>${e.exception}</pre> `:i.dy``}
        </div>
      </ha-dialog>
    `}},{kind:"get",key:"isCustomIntegration",value:function(){return this._manifest?!this._manifest.is_built_in:(0,l.bm)(this._params.item)}},{kind:"method",key:"_fetchManifest",value:async function(e){try{this._manifest=await(0,a.t4)(this.hass,e)}catch(e){}}},{kind:"method",key:"_copyLog",value:async function(){var e;let t=(null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".contents")).innerText;this.isCustomIntegration&&(t=this.hass.localize("ui.panel.config.logs.error_from_custom_integration")+"\n\n"+t),await(0,s.v)(t),(0,p.C)(this,{message:this.hass.localize("ui.common.copied_clipboard")})}},{kind:"get",static:!0,key:"styles",value:function(){return[c.yu,i.iv`
        ha-dialog {
      ...
      `]}}]}}),i.oi);customElements.define("dialog-system-log-detail",A)}))},27322:(e,t,r)=>{r.d(t,{R:()=>i});const i=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`}}]);
//# sourceMappingURL=23b04602.js.map