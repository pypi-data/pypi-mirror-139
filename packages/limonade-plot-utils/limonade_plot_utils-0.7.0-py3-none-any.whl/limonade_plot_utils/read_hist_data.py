...
import vissy.histo_utils as hut


def histoplot(data_in, errplot='x', style=None):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--plotstyle', metavar='plot', type=str, default='',
    ...
    print(args)
    histoplot(args.file, style=args.plotstyle, errplot=args.errorplot)
