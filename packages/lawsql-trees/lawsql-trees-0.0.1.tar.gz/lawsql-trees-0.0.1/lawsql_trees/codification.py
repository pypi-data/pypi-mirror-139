...
class CodificationItem:
    ...
    @property
    def fetch_complete_data_from_file(self) -> Union[NoReturn, dict]:
        ...
        format_units(raw_data["units"])
        return raw_data

    @property
    def statutes_from_histories(self) -> Union[set[str], NoReturn]:
    ...
    @property
    def statutes_in_sync(self) -> Union[bool, NoReturn]:
    ...
    @property
    def get_history_lists(self) -> Union[list[list[dict]], NoReturn]:
    ...
    @property
    def get_histories(self) -> Union[list[dict], NoReturn]:
...
def get_codifications(author: str = "mv3", q: Optional[str] = None):
