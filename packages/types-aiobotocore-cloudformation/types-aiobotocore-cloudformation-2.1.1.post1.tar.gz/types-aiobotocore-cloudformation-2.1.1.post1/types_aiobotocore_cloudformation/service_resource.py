...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html)
...
from .literals import CapabilityType, OnFailureType, ResourceStatusType, StackStatusType
...
class ServiceResourceStacksCollection(ResourceCollection):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#serviceresourcestackscollection)
    """
...
class StackEventsCollection(ResourceCollection):
    async def all(self) -> "StackEventsCollection":
        """
        Get all items from the collection, optionally with a custom page size and item count limit.
        """
    ...
    async def limit(self, count: int) -> "StackEventsCollection":
        """
        Return at most this many Events.
        """

    async def page_size(self, count: int) -> "StackEventsCollection":
        """
        Fetch at most this many Events per service request.
        """

    async def pages(self) -> Iterator[List["Event"]]:
        """
        A generator which yields pages of Events.
        """

    async def __iter__(self) -> Iterator["Event"]:
        """
...
class StackResourceSummariesCollection(ResourceCollection):
    async def all(self) -> "StackResourceSummariesCollection":
        """
        Get all items from the collection, optionally with a custom page size and item count limit.
        """
    ...
    async def limit(self, count: int) -> "StackResourceSummariesCollection":
        """
        Return at most this many StackResourceSummarys.
        """

    async def page_size(self, count: int) -> "StackResourceSummariesCollection":
        """
        Fetch at most this many StackResourceSummarys per service request.
        """

    async def pages(self) -> Iterator[List["StackResourceSummary"]]:
        """
        A generator which yields pages of StackResourceSummarys.
        """

    async def __iter__(self) -> Iterator["StackResourceSummary"]:
        """
...
class Event(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#event)
    """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#eventget_available_subresources-method)
        """
...
class Stack(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stack)
    """
    ...
    async def Resource(self, logical_id: str) -> "_StackResource":
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresource-method)
        """

    async def cancel_update(self, *, ClientRequestToken: str = ...) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackcancel_update-method)
        """
    ...
    async def delete(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackdelete-method)
        """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackget_available_subresources-method)
        """
    ...
    async def load(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackload-method)
        """
    ...
    async def reload(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackreload-method)
        """
    ...
    async def update(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackupdate-method)
        """
...
class StackResource(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresource)
    """
    ...
    async def Stack(self) -> _Stack:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresourcestack-method)
        """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresourceget_available_subresources-method)
        """
    ...
    async def load(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresourceload-method)
        """
    ...
    async def reload(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresourcereload-method)
        """
...
class StackResourceSummary(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresourcesummary)
    """
    ...
    async def Resource(self) -> _StackResource:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresourcesummaryresource-method)
        """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#stackresourcesummaryget_available_subresources-method)
        """
...
class CloudFormationServiceResource(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html)
    """
    ...
    async def Event(self, id: str) -> _Event:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudformation.html#CloudFormation.ServiceResource.Event)
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#cloudformationserviceresourceevent-method)
        """
    ...
    async def Stack(self, name: str) -> _Stack:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudformation.html#CloudFormation.ServiceResource.Stack)
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#cloudformationserviceresourcestack-method)
        """
    ...
    async def StackResource(self, stack_name: str, logical_id: str) -> _StackResource:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudformation.html#CloudFormation.ServiceResource.StackResource)
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#cloudformationserviceresourcestackresource-method)
        """
    ...
    async def StackResourceSummary(self, stack_name: str, logical_id: str) -> _StackResourceSummary:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudformation.html#CloudFormation.ServiceResource.StackResourceSummary)
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#cloudformationserviceresourcestackresourcesummary-method)
        """
    ...
    async def create_stack(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#cloudformationserviceresourcecreate_stack-method)
        """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/service_resource.html#cloudformationserviceresourceget_available_subresources-method)
        """
