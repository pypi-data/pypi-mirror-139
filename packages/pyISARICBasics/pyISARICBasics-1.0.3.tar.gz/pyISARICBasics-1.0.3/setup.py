...
setup(
    ...
    description='A python package for SQLite database creation and some basic data processing',  # Optional
    ...
    # project.
    author='Kyle G Young',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='kyle.young1@uq.net.au',  # Optional
