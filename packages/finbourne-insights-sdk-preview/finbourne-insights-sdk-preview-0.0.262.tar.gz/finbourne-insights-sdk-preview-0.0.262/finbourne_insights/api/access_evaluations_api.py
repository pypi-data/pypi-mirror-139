...
class AccessEvaluationsApi(object):
    ...
    def get_access_evaluation_log(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetAccessEvaluationLog: Get the log for a specific access evaluation.  # noqa: E501
    ...
    def get_access_evaluation_log_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `id` when calling `get_access_evaluation_log`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
    ...
    def list_access_evaluation_logs(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ListAccessEvaluationLogs: List the logs for access evaluations.  # noqa: E501
    ...
    def list_access_evaluation_logs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `list_access_evaluation_logs`, must be a value greater than or equal to `0`")  # noqa: E501
