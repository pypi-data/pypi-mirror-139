...
class AccessControlledResource(object):
    ...
    def __init__(self, application=None, name=None, description=None, actions=None, identifier_parts=None, links=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type actions: list[finbourne_insights.AccessControlledAction]
        :param identifier_parts: 
        :type identifier_parts: list[finbourne_insights.IdentifierPartSchema]
        :param links: 
    ...
    def actions(self):
        ...
        :rtype: list[finbourne_insights.AccessControlledAction]
        """
    ...
    def identifier_parts(self):
        ...
        :rtype: list[finbourne_insights.IdentifierPartSchema]
        """
