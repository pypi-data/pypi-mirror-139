...
@LastEditTime: 2022-02-16 17:04:30
...
from seven_cloudapp_frame.models.db_models.act.act_info_ex_model import *
        ...
        if page_dict_list:
            ...
            for item in page_dict_list:
                ...
                if item["end_date"] == "1900-01-01 00:00:00":
                    item["end_date"] = ""
                item["online_url"] = self.get_online_url(act_id, app_id) + "," + str(item["id"])
