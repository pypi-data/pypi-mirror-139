...
@LastEditTime: 2022-02-22 14:15:05
...
class PrizeListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        field = "id,prize_name,prize_title,prize_pic,prize_type,tag_id,prize_detail_json,prize_price,yfs_grade,yfs_key_name,sale_status,surplus,prize_total,probability,first_open_threshold,last_open_threshold"
...
class UserPrizeListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        params = [user_id, act_id]
        order_by = "id desc"
        field = "id,prize_id,prize_name,prize_title,prize_pic,prize_status,tag_id,yfs_grade,yfs_key_name,sale_status,is_open_buy_back,buy_back_integral,automatic_buy_back_days,automatic_buy_back_end_date,create_date"
