...
:LastEditTime: 2022-02-17 10:45:08
...
from seven_cloudapp_frame.models.business_base_model import *
from seven_cloudapp_frame.models.db_models.act.act_module_ex_model import *
from seven_cloudapp_frame.models.db_models.act.act_prize_ex_model import *
from seven_cloudapp_frame.models.db_models.prize.prize_roster_ex_model import *
from seven_cloudapp_frame.models.db_models.act.act_prize_senior_config_model import *
...
class PrizeListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        # prize_lottery_count = act_prize_ex_model.get_total("module_id=%s and is_del=0 and is_release=1 and yfs_type=1 and surplus>0 and probability>0", params=module_id)
