...
from db.dals.device_dal import MachinePortal
from db.models.device import get_device_info
from db.models.device import HandleName
# from db.models.device import Device
from fastapi import APIRouter, Depends
from dependencies import get_device_dal
