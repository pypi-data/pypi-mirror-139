...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html)
...
class LookoutMetricsClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#exceptions)
        """
    ...
    async def activate_anomaly_detector(self, *, AnomalyDetectorArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#activate_anomaly_detector)
        """
    ...
    async def back_test_anomaly_detector(self, *, AnomalyDetectorArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#back_test_anomaly_detector)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#can_paginate)
        """
    ...
    async def create_alert(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#create_alert)
        """
    ...
    async def create_anomaly_detector(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#create_anomaly_detector)
        """
    ...
    async def create_metric_set(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#create_metric_set)
        """
    ...
    async def delete_alert(self, *, AlertArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#delete_alert)
        """
    ...
    async def delete_anomaly_detector(self, *, AnomalyDetectorArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#delete_anomaly_detector)
        """
    ...
    async def describe_alert(self, *, AlertArn: str) -> DescribeAlertResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#describe_alert)
        """
    ...
    async def describe_anomaly_detection_executions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#describe_anomaly_detection_executions)
        """
    ...
    async def describe_anomaly_detector(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#describe_anomaly_detector)
        """
    ...
    async def describe_metric_set(self, *, MetricSetArn: str) -> DescribeMetricSetResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#describe_metric_set)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#generate_presigned_url)
        """
    ...
    async def get_anomaly_group(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#get_anomaly_group)
        """
    ...
    async def get_feedback(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#get_feedback)
        """
    ...
    async def get_sample_data(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#get_sample_data)
        """
    ...
    async def list_alerts(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#list_alerts)
        """
    ...
    async def list_anomaly_detectors(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#list_anomaly_detectors)
        """
    ...
    async def list_anomaly_group_summaries(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#list_anomaly_group_summaries)
        """
    ...
    async def list_anomaly_group_time_series(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#list_anomaly_group_time_series)
        """
    ...
    async def list_metric_sets(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#list_metric_sets)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#list_tags_for_resource)
        """
    ...
    async def put_feedback(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#put_feedback)
        """
    ...
    async def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#untag_resource)
        """
    ...
    async def update_anomaly_detector(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#update_anomaly_detector)
        """
    ...
    async def update_metric_set(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#update_metric_set)
        """
