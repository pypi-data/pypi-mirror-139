...
while os.path.basename(current_path) != "Internal":
...
del sys.modules["Internal.Runtime.CompilerServices"]
from clr import AddReference
AddReference("Internal.Runtime.CompilerServices")
from Internal.Runtime.CompilerServices import *
