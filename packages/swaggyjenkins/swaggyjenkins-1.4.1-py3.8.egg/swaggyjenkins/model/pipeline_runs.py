...
def lazy_import():
    ...
    globals()['PipelineRun'] = PipelineRun


class PipelineRuns(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PipelineRuns - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PipelineRun]):  # noqa: E501

        Keyword Args:
            value ([PipelineRun]):  # noqa: E501
