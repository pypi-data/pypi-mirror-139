...
from swaggyjenkins import rest
from swaggyjenkins.configuration import Configuration
from swaggyjenkins.exceptions import ApiTypeError, ApiValueError, ApiException
from swaggyjenkins.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BaseApi()
        api_instance.get_crumb  # this is an instance of the class Endpoint
        api_instance.get_crumb()  # this invokes api_instance.get_crumb.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_crumb.callable or self.callable in this class
