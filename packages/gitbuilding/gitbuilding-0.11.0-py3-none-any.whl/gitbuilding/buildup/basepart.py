...
class Part:
    ...
    def get_part_data(self, doc):
        ...
        """
        link_obj = self._original_link_obj
...
class ProductSchema(Schema):
    ...
    """
    partno = _LaxStrFeild(data_key='PartNo')
    link = fields.Str(data_key='Link')

    @post_load
    def _make_object(self, data, **_): #pylint: disable=no-self-use
...
class _ProductsField(fields.Dict):
    ...
    def _validate_all(self, products): #pylint: disable=no-self-use
    ...
    def _deserialize(self, value, attr, data, **kwargs):
        ...
        return self._validate_all(products)
...
class PartDataSchema(Schema):
    ...
    description = fields.Str(data_key='Description', missing=None, allow_none=True)
    specs = fields.Dict(missing=None,
                        allow_none=True,
                        keys=fields.Str(),
                        values=_LaxStrFeild(),
                        data_key='Specs')
    suppliers = _SuppliersField(data_key='Suppliers', missing=None, allow_none=True)

    @post_load
    def _make_part_data(self, data, **_): #pylint: disable=no-self-use
