...
# In[2]:
from src.cassandra.model.nestedModel import nestedModel, nestedModelPredictor
...
csv_data = create_dataset('D:/workspace_cassandra/mmm/spedire/dataset-spedire-20-02-22.csv',
                          subset_columns=['ordine_data', 'revenue', 'transazioni', 'google_search_spent',
                                          ...
                                          'google_organico', 'referral', 'email_sessioni', 'Offerte'])
...
organic = ['Offerte', 'jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec', 'mon', 'tue',
           'wed', 'thu', 'fri', 'sat', 'sun', 'festivo', 'bing_organico', 'google_organico', 'referral', 'email_sessioni']
...
general_numeric = ['bing_organico','google_organico', 'referral', 'email_sessioni']
...
new_df, nested_model, result_predictor, model_predictor = nestedModel(df, X_predictor_columns, y_predictor_columns, all_features, 'revenue')

show_prediction_vs_actual_graph(new_df, 'ordine_data', 'revenue', 'prediction')
