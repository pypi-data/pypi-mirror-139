...
[boto3.Budgets 1.21.3](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/budgets.html#Budgets)
...
Install `boto3-stubs-lite[budgets]` in your environment:
...
- Install `boto3-stubs[budgets]` with services you use in your environment:
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_budgets/)
