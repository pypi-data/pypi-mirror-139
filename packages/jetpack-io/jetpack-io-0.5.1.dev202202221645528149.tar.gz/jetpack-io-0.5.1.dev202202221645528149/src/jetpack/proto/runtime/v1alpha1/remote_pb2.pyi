...
class Task(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"encoded_args",b"encoded_args",u"hostname",b"hostname",u"namespace",b"namespace",u"qualified_symbol",b"qualified_symbol",u"target_time",b"target_time",u"task_id",b"task_id"]) -> None: ...
global___Task = Task
...
class SetCronJobsRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    NAMESPACE_FIELD_NUMBER: builtins.int
    HOSTNAME_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"app_id",b"app_id",u"cron_jobs",b"cron_jobs",u"hostname",b"hostname",u"namespace",b"namespace"]) -> None: ...
global___SetCronJobsRequest = SetCronJobsRequest

class SetCronJobsResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    def __init__(self,
        ) -> None: ...
global___SetCronJobsResponse = SetCronJobsResponse
...
class CronJob(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"interval",b"interval",u"qualified_symbol",b"qualified_symbol",u"target_day_of_week",b"target_day_of_week",u"target_time",b"target_time",u"unit",b"unit"]) -> None: ...
