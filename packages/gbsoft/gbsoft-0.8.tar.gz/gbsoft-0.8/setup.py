...
setup(
  ...
  keywords = ['ARDUINO', 'OPENCV-PYTHON', 'OPENCV-ARDUINO','FACE-DETECTOR','HAND-DETECTOR','FACEMESHDETECTOR','POSEDETECTOR','SERIALMODULE'],   # Keywords that define your package best
