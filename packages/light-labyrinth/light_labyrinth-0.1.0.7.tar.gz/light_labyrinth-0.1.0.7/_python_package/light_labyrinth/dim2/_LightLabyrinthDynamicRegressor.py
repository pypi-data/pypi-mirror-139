from .._bare_model import LightLabyrinthDynamic
...
class LightLabyrinthDynamicRegressor(LightLabyrinthDynamic): 
    """A 2-dimensional Light Labyrinth model trained with dynamic "one node at a time" algorithm.
        ...
        activation : `light_labyrinth.hyperparams.activation.ReflectiveIndexCalculator`, default=`light_labyrinth.hyperparams.activation.ReflectiveIndexCalculator.sigmoid_dotproduct`
            Activation function applied to each node's output.

            -`sigmoid_dotproduct` - logistic function over dot product of weights and input light for a given node.
