from ..dim3 import LightLabyrinth3DRandomClassifier
...
class RandomMaze3DClassifier:
    """A 3-dimensional Random Maze Classifier is an ensemble model made of several
        ...
        is trained on a seperate bootstrap sample drawn from the training data.
        ...
        This model is meant for multiclass classification. 
        ...
        verbose : int, default=0
            Controls the verbosity of the undelying `sklearn.ensemble.BaggingClassifier`
    ...
    def fit(self, X, y, epochs, batch_size=1.0, stop_change=1e-4, n_iter_check=0, epoch_check=1, X_val=None, y_val=None, verbosity=LightLabyrinthVerbosityLevel.Nothing):
        ...
        self._wrapper = SklearnClassifierWrapperModel(self._base_estimator, epochs, batch_size, stop_change, n_iter_check, epoch_check, X_val, y_val, verbosity)
        self._clf = BaggingClassifier(base_estimator = self._wrapper, 
