...
from .._tools import _MultioutputScaler

class LightLabyrinth3DRandomMultioutputRegressor(RandomLightLabyrinth3D):
    """A random multioutput Light Labyrinth model.
        ...
        depth : int
            Depth of the LightLabyrinth given by the nubmer of target values.
        ...
        light_labyrinth.multioutput.LightLabyrinth3DRandomMultilabelClassifier : random 3-dimensional Light Labyrinth classifier for multilabel classificatoin.
