...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sdb/literals.html)
...
__all__ = ("ListDomainsPaginatorName", "SelectPaginatorName", "ServiceName", "PaginatorName")
...
PaginatorName = Literal["list_domains", "select"]
