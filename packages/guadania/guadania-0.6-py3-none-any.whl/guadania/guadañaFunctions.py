...
def alerts(prismasession: prisma.PrismaSession, framework = None, basic: bool = True, timeType: str = 'relative', timeAmount: str = '3000',
            timeUnit: prisma.TimeUnit = prisma.TimeUnit.DAY,
           detailed: bool = False, sortBy: str = None, offset: int = 0,
           alertId: str = None, alertStatus: prisma.AlertStatus = prisma.AlertStatus.OPEN, cloudAccount: str = None, cloudAccountId: str = None,
    ...
    :param prismaSession: datos de la sesión con el tenant (url, token).
    :param framework: Si queremos filtrar por framework. También trae datos de las políticas asociadas a esas alertas.
    :param basic: Si queremos sólo los datos de alertas más básicos.
    ...
    columns_base = ['id','status','alertTime','resource.resourceType','resource.cloudType','resource.account','policy.policyId']
    ...
    while(looping):
        res = prisma.list_alerts_v2(prismasession, timeType=timeType, timeAmount=timeAmount,
                                             timeUnit=timeUnit, detailed=detailed,
                                             sortBy=sortBy, offset=offset, limit=10000,
                                             ...
                                             policyComplianceStandard=framework,
    ...
    if(framework == None):
        ...
        policies = list_policies(prismaSession=prismasession, framework=framework)[['policyId', 'name', 'description', 'severity']]
