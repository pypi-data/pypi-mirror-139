...
class ProjectFlow(object):
    ...
    def add_task(self, function, project=None, parent=None, type='task', run=1, skip_if_dir_exists=0, **kwargs):
        ...
        task = Task(function, self, parent=parent, type=type, run=run, skip_if_dir_exists=skip_if_dir_exists, **kwargs)
