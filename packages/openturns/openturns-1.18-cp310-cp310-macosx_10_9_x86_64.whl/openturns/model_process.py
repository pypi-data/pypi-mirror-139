...
def SpectralGaussianProcess_AdaptGrid(grid):
    return _model_process.SpectralGaussianProcess_AdaptGrid(grid)
...
class ConditionedGaussianProcess(GaussianProcess):
    ...
    def setMesh(self, *args):
        ...
        mesh : :class:`~openturns.Mesh`
            Mesh over which the domain :math:`\cD` is discretized.
        """
        return _model_process.ConditionedGaussianProcess_setMesh(self, *args)
    ...
    def setTimeGrid(self, *args):
        ...
        timeGrid : :class:`~openturns.RegularGrid`
            ...
            instants).
        """
        return _model_process.ConditionedGaussianProcess_setTimeGrid(self, *args)
