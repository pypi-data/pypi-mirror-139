...
def MetaModelAlgorithm_BuildDistribution(inputSample):
    r"""
    Recover the distribution, with metamodel performance in mind.
...
# Register LinearModelTest in _metamodel:
...
class VisualTest(object):
    ...
    def DrawPairs(sample):
        ...
        >>> View(clouds).show()
        """
        return _metamodel.VisualTest_DrawPairs(sample)

    @staticmethod
    def DrawPairsMarginals(sample, distribution):
        r"""
        ...
        >>> View(clouds).show()
        """
        return _metamodel.VisualTest_DrawPairsMarginals(sample, distribution)
    ...
    def DrawLinearModel(*args):
        ...
        """
        return _metamodel.VisualTest_DrawLinearModel(*args)
    ...
    def DrawLinearModelResidual(*args):
        ...
        >>> View(drawLinearModelVTest2).show()
        """
        return _metamodel.VisualTest_DrawLinearModelResidual(*args)

    @staticmethod
    def DrawParallelCoordinates(inputSample, outputSample, minValue, maxValue, color, quantileScale=True):
        r"""
        ...
        *Ymax* in the quantile based scale of :math:`Y` or in its specific scale. In
        ...
        >>> View(parplot).show()
        """
        return _metamodel.VisualTest_DrawParallelCoordinates(inputSample, outputSample, minValue, maxValue, color, quantileScale)
...
# Register VisualTest in _metamodel:
...
def VisualTest_DrawPairs(sample):
    r"""
    Draw 2-d projections of a multivariate sample.
...
def VisualTest_DrawPairsMarginals(sample, distribution):
    r"""
    Draw 2-d projections of a multivariate sample plus marginals.
...
def VisualTest_DrawParallelCoordinates(inputSample, outputSample, minValue, maxValue, color, quantileScale=True):
    r"""
    Draw a parallel coordinates plot.
