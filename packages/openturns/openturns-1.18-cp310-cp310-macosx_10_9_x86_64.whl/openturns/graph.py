...
class DrawableImplementation(openturns.common.PersistentObject):
    ...
    def clean(self):
        r"""Clean all the temporary data created by :meth:`draw` method."""
...
def DrawableImplementation_ConvertFromName(name):
    r"""
    Convert a color name to a valid hexadecimal code.
...
def DrawableImplementation_ConvertToRGB(key):
    r"""
    Convert an hexadecimal code into an RGB triplet.
...
def DrawableImplementation_ConvertToRGBA(key):
    r"""
    Convert an hexadecimal code into an RGBA quadruplet.
...
def DrawableImplementation_ConvertFromHSVIntoRGB(hue, saturation, value):
    r"""
    Convert an HSV triplet into an RGB triplet.
...
def DrawableImplementation_ConvertFromRGBIntoHSV(*args):
    r"""
    Convert an RGB triplet to HSV triplet.
...
def DrawableImplementation_ConvertFromHSV(hue, saturation, value):
    r"""
    Convert an HSV triplet to a valid hexadecimal code.
...
def DrawableImplementation_ConvertFromHSVA(hue, saturation, value, alpha):
    r"""
    Convert an HSVA quadruplet to a valid hexadecimal code.
...
def DrawableImplementation_BuildDefaultPalette(size):
    r"""
    Build default palette.
...
def DrawableImplementation_BuildRainbowPalette(size):
    r"""
    Build rainbow palette.
...
def DrawableImplementation_BuildTableauPalette(size):
    r"""
    Build tableau palette.
...
def Drawable_ConvertFromName(name):
    r"""
    Convert a color name to a valid hexadecimal code.
...
def Drawable_ConvertToRGBA(key):
    r"""
    Convert an hexadecimal code into an RGBA quadruplet.
...
def Drawable_ConvertFromHSVIntoRGB(hue, saturation, value):
    r"""
    Convert an HSV triplet into an RGB triplet.
...
def Drawable_ConvertFromRGBIntoHSV(*args):
    r"""
    Convert an RGB triplet to HSV triplet.
...
def Drawable_ConvertFromHSV(hue, saturation, value):
    r"""
    Convert an HSV triplet to a valid hexadecimal code.
...
def Drawable_ConvertFromHSVA(hue, saturation, value, alpha):
    r"""
    Convert an HSVA quadruplet to a valid hexadecimal code.
...
def Drawable_BuildDefaultPalette(size):
    r"""
    Build default palette.
...
def Drawable_BuildRainbowPalette(size):
    r"""
    Build rainbow palette.
...
def Drawable_BuildTableauPalette(size):
    r"""
    Build tableau palette.
...
def GraphImplementation_IsValidLegendPosition(position):
    r"""
    Test if the proposed legend position is valid or not.
...
def Graph_IsValidLegendPosition(position):
    r"""
    Test if the proposed legend position is valid or not.
...
def Pie_IsValidColorPalette(palette):
    r"""
    Test the validity of a color palette.
...
def Text_IsValidTextPosition(textPosition):
    return _graph.Text_IsValidTextPosition(textPosition)
