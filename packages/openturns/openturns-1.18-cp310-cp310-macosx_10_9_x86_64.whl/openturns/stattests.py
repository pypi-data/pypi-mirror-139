...
class FittingTest(object):
    ...
    def BestModelAIC(*args):
        ...
        """
        return _stattests.FittingTest_BestModelAIC(*args)
    ...
    def BestModelAICC(*args):
        ...
        Normal(mu = -0.0944924, sigma = 0.989808)
        """
        return _stattests.FittingTest_BestModelAICC(*args)
    ...
    def BestModelLilliefors(sample, factoryCollection):
        ...
        Normal(mu = -0.0944924, sigma = 0.989808)
        """
        return _stattests.FittingTest_BestModelLilliefors(sample, factoryCollection)
    ...
    def BestModelKolmogorov(sample, distributionCollection):
        ...
        Normal(mu = 0, sigma = 1)
        """
        return _stattests.FittingTest_BestModelKolmogorov(sample, distributionCollection)
    ...
    def AIC(*args):
        ...
        2.917389...
        """
        return _stattests.FittingTest_AIC(*args)
    ...
    def AICC(*args):
        ...
        2.932204...
        """
        return _stattests.FittingTest_AICC(*args)
    ...
    def Kolmogorov(sample, distribution, level=0.05):
        ...
        """
        return _stattests.FittingTest_Kolmogorov(sample, distribution, level)
    ...
    def Lilliefors(sample, factory, level=0.05):
        ...
        """
        return _stattests.FittingTest_Lilliefors(sample, factory, level)
...
def FittingTest_BestModelAIC(*args):
    r"""
    Select the best model according to the Akaike information criterion.
...
def FittingTest_BestModelAICC(*args):
    r"""
    Select the best model according to the Akaike information criterion with correction.
...
def FittingTest_BestModelLilliefors(sample, factoryCollection):
    r"""
    Select the best model according to the Lilliefors goodness-of-fit test.
...
def FittingTest_BestModelKolmogorov(sample, distributionCollection):
    r"""
    Select the best model according to the Kolmogorov goodness-of-fit test.
...
def FittingTest_Kolmogorov(sample, distribution, level=0.05):
    r"""
    Perform a Kolmogorov goodness-of-fit test for 1-d continuous distributions.
...
def FittingTest_Lilliefors(sample, factory, level=0.05):
    r"""
    Perform a Lilliefors goodness-of-fit test for 1-d continuous distributions.
