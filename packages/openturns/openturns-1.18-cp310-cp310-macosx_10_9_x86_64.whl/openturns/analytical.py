...
class MultiFORM(FORM):
    ...
    def setMaximumNumberOfDesignPoints(self, numberOfDesignPoints):
        return _analytical.MultiFORM_setMaximumNumberOfDesignPoints(self, numberOfDesignPoints)

    def getMaximumNumberOfDesignPoints(self):
        return _analytical.MultiFORM_getMaximumNumberOfDesignPoints(self)
