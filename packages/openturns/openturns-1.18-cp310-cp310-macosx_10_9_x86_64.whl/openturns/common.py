...
class task_arena(object):
    ...
    def __init__(self, arg2):
        _common.task_arena_swiginit(self, _common.new_task_arena(arg2))
    __swig_destroy__ = _common.delete_task_arena

# Register task_arena in _common:
_common.task_arena_swigregister(task_arena)
...
def TBB_SetThreadsNumber(threadsNumber):
    r"""
    Accessor to the maximum number of TBB threads.
...
def ResourceMap_FindKeys(substr):
    r"""
    Find keys matching a pattern.
