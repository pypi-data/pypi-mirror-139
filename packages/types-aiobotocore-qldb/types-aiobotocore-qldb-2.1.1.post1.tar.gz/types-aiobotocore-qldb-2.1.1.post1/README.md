...
[aiobotocore.QLDB 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/qldb.html#QLDB)
...
[types-aiobotocore-qldb docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_qldb/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-qldb](#types-aiobotocore-qldb)
...
- Install `types-aiobotocore[qldb]` in your environment:
...
Install `types-aiobotocore-lite[qldb]` in your environment:
...
- Install `types-aiobotocore[qldb]` with services you use in your environment:
...
`QLDBClient` provides annotations for `session.create_client("qldb")`.

```python
from aiobotocore.session import get_session

from types_aiobotocore_qldb import QLDBClient
...
`types-aiobotocore-qldb` version is the same as related `aiobotocore` version
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_qldb/)
