...
class IOrgUnits(BaseEndpoint):
    ...
    def updateWithItem (self, orgUnitItem ):
        ...
        __data__ = __ItemValueSerDer__(__OrgUnitSerDer__()).encode(orgUnitItem)
    ...
    def createWithItem (self, orgUnitItem ):
