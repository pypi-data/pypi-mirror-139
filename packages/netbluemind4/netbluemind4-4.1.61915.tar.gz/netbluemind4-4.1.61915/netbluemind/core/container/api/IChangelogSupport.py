...
IChangelogSupport_VERSION = "4.1.61915"
...
class IChangelogSupport(BaseEndpoint):
    ...
    def getVersion (self):
        ...
        response = requests.get( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IChangelogSupport_VERSION}, data = __encoded__);
    ...
    def filteredChangesetById (self, since , filter ):
        ...
        response = requests.post( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IChangelogSupport_VERSION}, data = __encoded__);
