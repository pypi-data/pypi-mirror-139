...
class IVEvent(BaseEndpoint):
    ...
    def exportAll (self):
        ...
        response = requests.get( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IVEvent_VERSION}, data = __encoded__);
    ...
    def importIcs (self, ics ):
        ...
        response = requests.put( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IVEvent_VERSION}, data = __encoded__);
