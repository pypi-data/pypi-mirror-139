...
IMailDeliveryMgmt_VERSION = "4.1.61915"
...
class IMailDeliveryMgmt(BaseEndpoint):
    ...
    def repair (self):
        ...
        response = requests.post( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IMailDeliveryMgmt_VERSION}, data = __encoded__);
