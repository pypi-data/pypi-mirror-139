...
IReadOnlyMailboxFolders_VERSION = "4.1.61915"
...
class IReadOnlyMailboxFolders(BaseEndpoint):
    ...
    def all (self):
        ...
        response = requests.get( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IReadOnlyMailboxFolders_VERSION}, data = __encoded__);
    ...
    def filteredChangesetById (self, since , arg1 ):
        ...
        response = requests.post( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IReadOnlyMailboxFolders_VERSION}, data = __encoded__);
