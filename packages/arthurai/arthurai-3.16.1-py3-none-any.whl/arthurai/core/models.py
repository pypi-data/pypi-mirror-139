...
class ArthurModel(ArthurBaseJsonDataclass):
    ...
    def save(self) -> str:
        ...
        :raise: MethodNotApplicableError: the model has already been saved
    ...
    def explain_inference(self, partner_inference_id: str, algorithm: str = 'lime', page: int = 1, page_size: int = 500, 
        n_samples: int = None, sort: str = None) -> Dict[str, Any]:
        """Returns An on-demand inference explanation
...
class ArthurModelGroup(ArthurBaseJsonDataclass):
    ...
    def archive(self) -> None:
        ...
        :return: None
        :raise Exception: the model group has no ID or the model group archive request was not accepted
        """
