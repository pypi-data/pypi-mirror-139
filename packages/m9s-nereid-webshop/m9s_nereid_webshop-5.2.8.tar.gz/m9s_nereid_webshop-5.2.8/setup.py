...
MODULE2PREFIX = {
    ...
    'nereid_wishlist': 'm9s',
    'sale_channel': 'm9s',
    'sale_channel_pricelist': 'm9s',
    'stock_package_rate': 'm9s',
    }
...
name = 'm9s_nereid_webshop'
download_url = 'https://gitlab.com/m9s/nereid_webshop.git'
local_version = []
...
tests_require = [
    'cssutils',
    'pycountry',
    get_require_version('m9s-nereid-catalog-variants'),
...
setup(name=name,
    version=version,
    description='Tryton Nereid Webshop Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/nereid_webshop.git',
        },
    keywords='',
    package_dir={'trytond.modules.nereid_webshop': '.'},
    packages=(
        ['trytond.modules.nereid_webshop'] +
        ['trytond.modules.nereid_webshop.%s' % p for p in find_packages()]
        ),
    package_data={
