...
[aiobotocore.LexRuntimeService 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lex-runtime.html#LexRuntimeService)
...
[types-aiobotocore-lex-runtime docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lex_runtime/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-lex-runtime](#types-aiobotocore-lex-runtime)
...
- Install `types-aiobotocore[lex-runtime]` in your environment:
...
Install `types-aiobotocore-lite[lex-runtime]` in your environment:
...
- Install `types-aiobotocore[lex-runtime]` with services you use in your
  environment:
...
`session.create_client("lex-runtime")`.
...
`types-aiobotocore-lex-runtime` version is the same as related `aiobotocore`
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lex_runtime/)
