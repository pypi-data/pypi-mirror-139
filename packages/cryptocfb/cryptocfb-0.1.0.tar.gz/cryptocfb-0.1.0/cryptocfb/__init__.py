...
class CryptoCFB:
    ...
    ----------
    key : bytes
        The key for AES-128 CFB mode.
        It must be 16 bytes.
    iv : bytes
        The initialization vector for AES-128 CFB mode.
        It must be 16 bytes.
    ...
    Notes
    -----
    This class can encrypt or decrypt large data part by part.
    ...
    def crypt_inplace(self, buf, is_encrypt=True):
        ...
        ----------
        buf : bytearray
            The buffer to encrypt or decrypt.
            It can be the whole data or a part of the data.
            If not the last part of the data, size of buf must be multiple of 16.
        is_encrypt : bool, optional
