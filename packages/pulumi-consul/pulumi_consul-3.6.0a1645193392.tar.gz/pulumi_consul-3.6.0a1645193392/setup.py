...
VERSION = "3.6.0a1645193392"
PLUGIN_VERSION = "3.6.0-alpha.1645193392+df8fad50"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul {PLUGIN_VERSION}`
                """)
            else:
                raise
...
def readme():
    try:
        ...
        return "consul Pulumi Package - Development Version"
