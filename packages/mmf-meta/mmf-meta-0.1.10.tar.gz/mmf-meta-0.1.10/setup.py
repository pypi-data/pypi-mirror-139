...
extras_require = \
{'XlsxWriter:python_version >= "3.7" and python_version < "4.0"': ['pandas>=0.25.0,<0.26.0'],
 'XlsxWriter:python_version >= "3.8" and python_version < "4.0"': ['pandas>=1.4.0,<2.0.0'],
 'openpyxl:python_version >= "3.7" and python_version < "4.0"': ['pandas>=0.25.0,<0.26.0'],
 'openpyxl:python_version >= "3.8" and python_version < "4.0"': ['pandas>=1.4.0,<2.0.0'],
 'pandas:python_version >= "3.7" and python_version < "4.0"': ['pandas>=0.25.0,<0.26.0'],
 'pandas:python_version >= "3.8" and python_version < "4.0"': ['pandas>=1.4.0,<2.0.0'],
 'xlrd:python_version >= "3.7" and python_version < "4.0"': ['pandas>=0.25.0,<0.26.0'],
 'xlrd:python_version >= "3.8" and python_version < "4.0"': ['pandas>=1.4.0,<2.0.0']}
