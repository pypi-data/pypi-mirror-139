...
setup(
    ...
    description="Type annotations for aiobotocore.SnowDeviceManagement 2.1.1 service generated with mypy-boto3-builder 7.1.1",
    classifiers=[
    ...
    keywords="aiobotocore snow-device-management type-annotations boto3-stubs mypy typeshed autocomplete",
