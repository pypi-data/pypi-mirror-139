...
MX_MOTION_CMD_TYPE_GRIPPEROPENCLOSE = 18
...
MX_MOTION_CMD_TYPE_SETVELTIMEOUT = 24
...
MX_MOTION_CMD_TYPE_GRIPPERRANGE = 31
MX_MOTION_CMD_TYPE_GRIPPERPOS = 32
...
MX_ST_HOMING_JOINTS_OUT_OF_RANGE = 1032
MX_ST_START_CONF_MISMATCH = 1033
...
MX_ST_NO_VBOX = 1041
MX_ST_EXT_TOOL_SIM_MUST_DEACTIVATED = 1042
...
MX_ST_TORQUE_LIMIT_STATUS = 3028
MX_ST_TORQUE_LIMIT_ERROR = 3029
...
robot_status_code_info = {
    ...
    RobotStatusCodeInfo(MX_ST_EXT_TOOL_SIM_MUST_DEACTIVATED, "MX_ST_EXT_TOOL_SIM_MUST_DEACTIVATED", is_error=True),
    MX_ST_CMD_FAILED:
    ...
    RobotStatusCodeInfo(MX_ST_GET_GRIPPER_RANGE, "MX_ST_GET_GRIPPER_RANGE", is_error=False),
    ...
    RobotStatusCodeInfo(MX_ST_RT_GRIPPER_POS, "MX_ST_RT_GRIPPER_POS", is_error=False),
    MX_ST_RT_GRIPPER_VEL:
    RobotStatusCodeInfo(MX_ST_RT_GRIPPER_VEL, "MX_ST_RT_GRIPPER_VEL", is_error=False),
    ...
    RobotStatusCodeInfo(MX_ST_TORQUE_LIMIT_STATUS, "MX_ST_TORQUE_LIMIT_STATUS", is_error=False),
    MX_ST_TORQUE_LIMIT_ERROR:
    RobotStatusCodeInfo(MX_ST_TORQUE_LIMIT_ERROR, "MX_ST_TORQUE_LIMIT_ERROR", is_error=True),
...
MX_EXT_TOOL_NONE = 0
MX_EXT_TOOL_CURRENT = 1
MX_EXT_TOOL_MEGP25_SHORT = 10
MX_EXT_TOOL_MEGP25_LONG = 11
MX_EXT_TOOL_VBOX_2VALVES = 20
