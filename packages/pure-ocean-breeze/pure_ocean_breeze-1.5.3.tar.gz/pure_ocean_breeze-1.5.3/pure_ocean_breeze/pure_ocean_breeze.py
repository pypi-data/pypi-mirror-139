...
class pure_moonnight():
    ...
    def __init__(self, factors, groups_num, neutralize=False, boxcox=False,by10=False, y2=False, plt=True, plotly=False,
        ...
        self.shen.prerpare()
        self.shen.run(groups_num=groups_num,neutralize=neutralize,boxcox=boxcox,y2=y2,plt=plt,plotly=plotly,filename=filename,time_start=time_start,time_end=time_end,print_comments=print_comments)
