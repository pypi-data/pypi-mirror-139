...
class TestInferQuantization(unittest.TestCase):
    ...
    def test_infer_quantization_under(self):
        prices = list(map(Decimal, ['0.033255736614566012637179913540',
    ...
    def test_infer_quantization_under3(self):
        prices = [Decimal('0.7728273890026662544920591986'),
    ...
    def test_auto_quantize(self):
        self.assertEqual(Decimal('1135.11'),
                         number.auto_quantize(Decimal('1135.109998'), 0.01))
        self.assertEqual(Decimal('1135.11'),
                         number.auto_quantize(Decimal('1135.109998'), 0.02))
        self.assertEqual(Decimal('1135.1024'),
                         number.auto_quantize(Decimal('1135.102399'), 0.01))
        self.assertEqual(Decimal('1135.102399'),
                         number.auto_quantize(Decimal('1135.102399'), 0.001))
        self.assertEqual(Decimal('-1135.11'),
                         number.auto_quantize(Decimal('-1135.109998'), 0.01))
