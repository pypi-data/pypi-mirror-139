...
def gpencil_export_pdf(
        ...
        sort_method: typing.Union[int, str] = '',
        use_fill: bool = True,
        selected_object_type: typing.Union[int, str] = 'SELECTED',
        stroke_sample: float = 0.0,
        use_normalized_thickness: bool = False,
        frame_mode: typing.Union[int, str] = 'ACTIVE'):
    ...
    :type selected_object_type: typing.Union[int, str]
    ...
    :type frame_mode: typing.Union[int, str]
    '''
...
def obj_export(filepath: str = "",
               ...
               forward_axis: typing.Union[int, str] = 'NEGATIVE_Z_FORWARD',
               up_axis: typing.Union[int, str] = 'Y_UP',
               scaling_factor: float = 1.0,
               export_eval_mode: typing.Union[int, str] = 'DAG_EVAL_VIEWPORT',
    ...
    :type end_frame: int
    :param forward_axis: Forward Axis * X_FORWARD X -- Positive X axis. * Y_FORWARD Y -- Positive Y axis. * Z_FORWARD Z -- Positive Z axis. * NEGATIVE_X_FORWARD -X -- Negative X axis. * NEGATIVE_Y_FORWARD -Y -- Negative Y axis. * NEGATIVE_Z_FORWARD -Z -- Negative Z axis.
    :type forward_axis: typing.Union[int, str]
    :param up_axis: Up Axis * X_UP X -- Positive X axis. * Y_UP Y -- Positive Y axis. * Z_UP Z -- Positive Z axis. * NEGATIVE_X_UP -X -- Negative X axis. * NEGATIVE_Y_UP -Y -- Negative Y axis. * NEGATIVE_Z_UP -Z -- Negative Z axis.
    :type up_axis: typing.Union[int, str]
    ...
    :type export_eval_mode: typing.Union[int, str]
...
def operator_cheat_sheet():
    ''' List all the operators in a text-block, useful for scripting :file: startup/bl_operators/wm.py\:2012 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2012> _
...
def properties_edit(
        data_path: str = "",
        property_name: str = "",
        property_type: typing.Union[int, str] = 'FLOAT',
    ...
    :type property_type: typing.Union[int, str]
...
def toolbar():
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __. :file: startup/bl_operators/wm.py\:2198 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2198> _
...
def toolbar_fallback_pie():
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __. :file: startup/bl_operators/wm.py\:2222 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2222> _
...
def toolbar_prompt():
    ''' Leader key like functionality for accessing tools :file: startup/bl_operators/wm.py\:2322 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2322> _
...
def xr_navigation_fly(mode: typing.Union[int, str] = 'VIEWER_FORWARD',
