...
class AssertionInfoClass(DictWrapper):
    ...
    def __init__(self,
        ...
        assertionLogic: Union[None, str]=None,
        ...
        self.assertionLogic = assertionLogic
    ...
    def _restore_defaults(self) -> None:
        ...
        self.assertionLogic = self.RECORD_SCHEMA.fields_dict["assertionLogic"].default
    ...
    @property
    def assertionLogic(self) -> Union[None, str]:
        # No docs available.
        return self._inner_dict.get('assertionLogic')  # type: ignore
    
    @assertionLogic.setter
    def assertionLogic(self, value: Union[None, str]) -> None:
        # No docs available.
        self._inner_dict['assertionLogic'] = value
    
    
    @property
    def parameters(self) -> Union[None, Dict[str, str]]:
        """Getter: Parameters required for the assertion. e.g. min_value, max_value, value, columns"""
        return self._inner_dict.get('parameters')  # type: ignore
    
    @parameters.setter
    def parameters(self, value: Union[None, Dict[str, str]]) -> None:
        """Setter: Parameters required for the assertion. e.g. min_value, max_value, value, columns"""
...
class AssertionResultClass(DictWrapper):
    ...
    def runtimeContext(self) -> Union[None, Dict[str, str]]:
        """Getter: Runtime context for the evaluation"""
    ...
    def runtimeContext(self, value: Union[None, Dict[str, str]]) -> None:
        """Setter: Runtime context for the evaluation"""
...
class DatasetAssertionInfoClass(DictWrapper):
    ...
    def __init__(self,
        ...
        columnAssertion: Union[None, "DatasetColumnAssertionClass"]=None,
        rowsAssertion: Union[None, "DatasetRowsAssertionClass"]=None,
        schemaAssertion: Union[None, "DatasetSchemaAssertionClass"]=None,
        fields: Union[None, List[str]]=None,
        datasets: Union[None, List[str]]=None,
    ):
        super().__init__()
        
        self.scope = scope
        self.columnAssertion = columnAssertion
        self.rowsAssertion = rowsAssertion
    ...
    def _restore_defaults(self) -> None:
        ...
        self.columnAssertion = self.RECORD_SCHEMA.fields_dict["columnAssertion"].default
        self.rowsAssertion = self.RECORD_SCHEMA.fields_dict["rowsAssertion"].default
        ...
        self.datasets = self.RECORD_SCHEMA.fields_dict["datasets"].default
    ...
    @property
    def columnAssertion(self) -> Union[None, "DatasetColumnAssertionClass"]:
        """Getter: Assertion details when scope is DATASET_COLUMN"""
        return self._inner_dict.get('columnAssertion')  # type: ignore
    
    @columnAssertion.setter
    def columnAssertion(self, value: Union[None, "DatasetColumnAssertionClass"]) -> None:
        """Setter: Assertion details when scope is DATASET_COLUMN"""
        self._inner_dict['columnAssertion'] = value
    
    
    @property
    def rowsAssertion(self) -> Union[None, "DatasetRowsAssertionClass"]:
        """Getter: Assertion details when scope is DATASET_ROWS"""
        return self._inner_dict.get('rowsAssertion')  # type: ignore
    
    @rowsAssertion.setter
    def rowsAssertion(self, value: Union[None, "DatasetRowsAssertionClass"]) -> None:
        """Setter: Assertion details when scope is DATASET_ROWS"""
        self._inner_dict['rowsAssertion'] = value
    
    
    @property
    def schemaAssertion(self) -> Union[None, "DatasetSchemaAssertionClass"]:
        """Getter: Assertion details when scope is DATASET_SCHEMA"""
        return self._inner_dict.get('schemaAssertion')  # type: ignore
    
    @schemaAssertion.setter
    def schemaAssertion(self, value: Union[None, "DatasetSchemaAssertionClass"]) -> None:
        """Setter: Assertion details when scope is DATASET_SCHEMA"""
    ...
    @property
    def datasets(self) -> Union[None, List[str]]:
        """Getter: One or more datasets that are targeted by this assertion"""
        return self._inner_dict.get('datasets')  # type: ignore
    
    @datasets.setter
    def datasets(self, value: Union[None, List[str]]) -> None:
        """Setter: One or more datasets that are targeted by this assertion"""
...
class DatasetColumnAssertionClass(DictWrapper):
    """Assertion on column of a dataset"""
    
    RECORD_SCHEMA = get_schema_type("com.linkedin.pegasus2avro.assertion.DatasetColumnAssertion")
    def __init__(self,
        stdOperator: Union[str, "AssertionStdOperatorClass"],
        stdAggFunc: Union[str, "DatasetColumnStdAggFuncClass"],
        nativeOperator: Union[None, str]=None,
        nativeAggFunc: Union[None, str]=None,
    ):
        super().__init__()
        
        self.stdOperator = stdOperator
        self.nativeOperator = nativeOperator
        self.stdAggFunc = stdAggFunc
        self.nativeAggFunc = nativeAggFunc
    
    @classmethod
    def construct_with_defaults(cls) -> "DatasetColumnAssertionClass":
        self = cls.construct({})
        self._restore_defaults()
    ...
    def _restore_defaults(self) -> None:
        self.stdOperator = AssertionStdOperatorClass.BETWEEN
        self.nativeOperator = self.RECORD_SCHEMA.fields_dict["nativeOperator"].default
        self.stdAggFunc = DatasetColumnStdAggFuncClass.IDENTITY
        self.nativeAggFunc = self.RECORD_SCHEMA.fields_dict["nativeAggFunc"].default
    
    
    @property
    def stdOperator(self) -> Union[str, "AssertionStdOperatorClass"]:
        """Getter: Standardized assertion operator"""
        return self._inner_dict.get('stdOperator')  # type: ignore
    
    @stdOperator.setter
    def stdOperator(self, value: Union[str, "AssertionStdOperatorClass"]) -> None:
        """Setter: Standardized assertion operator"""
        self._inner_dict['stdOperator'] = value
    
    
    @property
    def nativeOperator(self) -> Union[None, str]:
        """Getter: Native assertion operator"""
        return self._inner_dict.get('nativeOperator')  # type: ignore
    
    @nativeOperator.setter
    def nativeOperator(self, value: Union[None, str]) -> None:
        """Setter: Native assertion operator"""
        self._inner_dict['nativeOperator'] = value
    
    
    @property
    def stdAggFunc(self) -> Union[str, "DatasetColumnStdAggFuncClass"]:
        """Getter: Standardized aggrgation function applied on column values"""
        return self._inner_dict.get('stdAggFunc')  # type: ignore
    
    @stdAggFunc.setter
    def stdAggFunc(self, value: Union[str, "DatasetColumnStdAggFuncClass"]) -> None:
        """Setter: Standardized aggrgation function applied on column values"""
        self._inner_dict['stdAggFunc'] = value
    
    
    @property
    def nativeAggFunc(self) -> Union[None, str]:
        """Getter: Native aggrgation function applied on column values"""
        return self._inner_dict.get('nativeAggFunc')  # type: ignore
    
    @nativeAggFunc.setter
    def nativeAggFunc(self, value: Union[None, str]) -> None:
        """Setter: Native aggrgation function applied on column values"""
        self._inner_dict['nativeAggFunc'] = value
    
    
class DatasetColumnStdAggFuncClass(object):
    # No docs available.
...
class DatasetRowsAssertionClass(DictWrapper):
    """Assertion on rows of a dataset"""
    
    RECORD_SCHEMA = get_schema_type("com.linkedin.pegasus2avro.assertion.DatasetRowsAssertion")
    def __init__(self,
        stdOperator: Union[str, "AssertionStdOperatorClass"],
        stdAggFunc: Union[str, "DatasetRowsStdAggFuncClass"],
        nativeOperator: Union[None, str]=None,
        nativeAggFunc: Union[None, str]=None,
    ):
        super().__init__()
    ...
    @classmethod
    def construct_with_defaults(cls) -> "DatasetRowsAssertionClass":
        self = cls.construct({})
        self._restore_defaults()
    ...
    def _restore_defaults(self) -> None:
        self.stdOperator = AssertionStdOperatorClass.BETWEEN
        self.nativeOperator = self.RECORD_SCHEMA.fields_dict["nativeOperator"].default
        self.stdAggFunc = DatasetRowsStdAggFuncClass.ROW_COUNT
        self.nativeAggFunc = self.RECORD_SCHEMA.fields_dict["nativeAggFunc"].default
    ...
    @property
    def stdAggFunc(self) -> Union[str, "DatasetRowsStdAggFuncClass"]:
        """Getter: Standardized aggrgation function applied on rows"""
        return self._inner_dict.get('stdAggFunc')  # type: ignore
    
    @stdAggFunc.setter
    def stdAggFunc(self, value: Union[str, "DatasetRowsStdAggFuncClass"]) -> None:
        """Setter: Standardized aggrgation function applied on rows"""
        self._inner_dict['stdAggFunc'] = value
    
    
    @property
    def nativeAggFunc(self) -> Union[None, str]:
        """Getter: Native aggrgation function applied on rows"""
        return self._inner_dict.get('nativeAggFunc')  # type: ignore
    
    @nativeAggFunc.setter
    def nativeAggFunc(self, value: Union[None, str]) -> None:
        """Setter: Native aggrgation function applied on rows"""
        self._inner_dict['nativeAggFunc'] = value
    
    
class DatasetRowsStdAggFuncClass(object):
    # No docs available.
...
class DatasetSchemaAssertionClass(DictWrapper):
    """Assertion on schema of a dataset"""
    
    RECORD_SCHEMA = get_schema_type("com.linkedin.pegasus2avro.assertion.DatasetSchemaAssertion")
    def __init__(self,
        stdOperator: Union[str, "AssertionStdOperatorClass"],
        stdAggFunc: Union[str, "DatasetSchemaStdAggFuncClass"],
        nativeOperator: Union[None, str]=None,
        nativeAggFunc: Union[None, str]=None,
    ):
        super().__init__()
    ...
    @classmethod
    def construct_with_defaults(cls) -> "DatasetSchemaAssertionClass":
        self = cls.construct({})
        self._restore_defaults()
    ...
    def _restore_defaults(self) -> None:
        self.stdOperator = AssertionStdOperatorClass.BETWEEN
        self.nativeOperator = self.RECORD_SCHEMA.fields_dict["nativeOperator"].default
        self.stdAggFunc = DatasetSchemaStdAggFuncClass.COLUMNS
        self.nativeAggFunc = self.RECORD_SCHEMA.fields_dict["nativeAggFunc"].default
    ...
    @property
    def stdAggFunc(self) -> Union[str, "DatasetSchemaStdAggFuncClass"]:
        """Getter: Standardized aggrgation function applied on rows"""
        return self._inner_dict.get('stdAggFunc')  # type: ignore
    
    @stdAggFunc.setter
    def stdAggFunc(self, value: Union[str, "DatasetSchemaStdAggFuncClass"]) -> None:
        """Setter: Standardized aggrgation function applied on rows"""
        self._inner_dict['stdAggFunc'] = value
...
class DatasetSchemaStdAggFuncClass(object):
    # No docs available.
...
class OperationClass(DictWrapper):
    ...
    def lastUpdatedTimestamp(self) -> int:
        """Getter: When the entity was last updated."""
    ...
    def lastUpdatedTimestamp(self, value: int) -> None:
        """Setter: When the entity was last updated."""
...
__SCHEMA_TYPES = {
    ...
    'com.linkedin.pegasus2avro.assertion.DatasetColumnAssertion': DatasetColumnAssertionClass,
    'com.linkedin.pegasus2avro.assertion.DatasetColumnStdAggFunc': DatasetColumnStdAggFuncClass,
    'com.linkedin.pegasus2avro.assertion.DatasetRowsAssertion': DatasetRowsAssertionClass,
    'com.linkedin.pegasus2avro.assertion.DatasetRowsStdAggFunc': DatasetRowsStdAggFuncClass,
    'com.linkedin.pegasus2avro.assertion.DatasetSchemaAssertion': DatasetSchemaAssertionClass,
    'com.linkedin.pegasus2avro.assertion.DatasetSchemaStdAggFunc': DatasetSchemaStdAggFuncClass,
