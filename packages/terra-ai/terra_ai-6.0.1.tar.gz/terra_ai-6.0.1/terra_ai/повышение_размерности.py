...
from tensorflow.keras.layers import Add, BatchNormalization, Conv2D, Dense, Flatten, Input, LeakyReLU, PReLU, Lambda, MaxPooling2D #Импортируем слои
from tensorflow.keras.models import Model, Sequential  #Импортируем метод создания модели
...
def генератор_данных_DIV2K():
  ...
  class DIV2K:
      def __init__(self,
                  ...
                  images_dir='повышение_размерности/images', #Директория для хранения тестовой и обучающей выборки
                  caches_dir='повышение_размерности/caches'): #Директория для хранения кэша 
