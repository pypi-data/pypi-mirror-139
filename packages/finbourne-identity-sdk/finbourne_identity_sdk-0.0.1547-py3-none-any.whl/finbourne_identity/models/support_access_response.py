...
class SupportAccessResponse(object):
    ...
    def __init__(self, id=None, duration=None, description=None, created_at=None, expiry=None, created_by=None, terminated=None, terminated_at=None, terminated_by=None, local_vars_configuration=None):  # noqa: E501
