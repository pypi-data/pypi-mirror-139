...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_elastic_inference/literals.html)
...
__all__ = ("DescribeAcceleratorsPaginatorName", "LocationTypeType", "ServiceName", "PaginatorName")
...
PaginatorName = Literal["describe_accelerators"]
