...
VERSION = "3.4.0a1645193184"
PLUGIN_VERSION = "3.4.0-alpha.1645193184+651fd907"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the postgresql resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource postgresql {PLUGIN_VERSION}`
                """)
            else:
                raise
