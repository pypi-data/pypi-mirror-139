...
class Template:
    ...
    def render(self, context: dict = None, request: HttpRequest = None, to: str = 'xml', **kwargs):
        ...
        # return json.dumps(self.template.root_element.render(context).serialize(output=output))
