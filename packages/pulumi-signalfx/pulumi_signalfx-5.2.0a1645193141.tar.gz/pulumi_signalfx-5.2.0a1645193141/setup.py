...
VERSION = "5.2.0a1645193141"
PLUGIN_VERSION = "5.2.0-alpha.1645193141+afecc06d"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the signalfx resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource signalfx {PLUGIN_VERSION}`
                """)
            else:
                raise
