...
const limeDocumentListCss = ".accordion-content{max-height:25rem}limel-list{--lime-primary-color:#f49132}";
...
const templateListCss = ".accordion-content{max-height:25rem}limel-list{--lime-primary-color:#f49132}";
