...
[aiobotocore.TranscribeService 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/transcribe.html#TranscribeService)
...
[types-aiobotocore-transcribe docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_transcribe/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-transcribe](#types-aiobotocore-transcribe)
...
- Install `types-aiobotocore[transcribe]` in your environment:
...
Install `types-aiobotocore-lite[transcribe]` in your environment:
...
- Install `types-aiobotocore[transcribe]` with services you use in your
  environment:
...
`session.create_client("transcribe")`.
...
`types_aiobotocore_transcribe.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

```python
from types_aiobotocore_transcribe.literals import (
    BaseModelNameType,
    CLMLanguageCodeType,
...
`types-aiobotocore-transcribe` version is the same as related `aiobotocore`
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_transcribe/)
