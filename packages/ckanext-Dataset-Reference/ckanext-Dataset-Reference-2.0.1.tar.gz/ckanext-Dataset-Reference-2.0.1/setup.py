...
setup(
    name='''ckanext-Dataset-Reference''',
    ...
    url='https://github.com/TIBHannover/ckanext-Dataset-Reference',
    ...
    entry_points='''
        [ckan.plugins]
        dataset_reference=ckanext.dataset_reference.plugin:DatasetReferencePlugin
