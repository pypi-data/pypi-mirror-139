...
`,x=({columns:e,data:t,pageSize:a,totalCount:l=t.length,initialPageIndex:r,initialSortBy:x=[],loading:y=!1,withPagination:k=!0,emptyWrapperType:f=o.Default,noDataText:Z,showRowCount:w=!0,serverPagination:v=!1,onServerPagination:P=(()=>{}),...S})=>{const $={pageSize:null!=a?a:10,pageIndex:null!=r?r:0,sortBy:x},{getTableProps:C,getTableBodyProps:I,headerGroups:N,page:E,rows:T,prepareRow:B,pageCount:A,gotoPage:z,state:{pageIndex:D,pageSize:R,sortBy:_}}=(0,d.useTable)({columns:e,data:t,initialState:$,manualPagination:v,manualSortBy:v,pageCount:Math.ceil(l/$.pageSize)},d.useFilters,d.useSortBy,d.usePagination);(0,i.useEffect)((()=>{v&&D!==$.pageIndex&&P({pageIndex:D})}),[D]),(0,i.useEffect)((()=>{v&&!n()(_,$.sortBy)&&P({pageIndex:0,sortBy:_})}),[_]);const G=k?E:T;let L;switch(f){case o.Small:L=({children:e})=>(0,u.tZ)(i.Fragment,null,e);break;case o.Default:default:L=({children:e})=>(0,u.tZ)(h,null,e)}const U=!y&&0===G.length,K=A>1&&k;return(0,u.tZ)(i.Fragment,null,(0,u.tZ)(m,S,(0,u.tZ)(g.Z,{getTableProps:C,getTableBodyProps:I,prepareRow:B,headerGroups:N,rows:G,columns:e,loading:y}),U&&(0,u.tZ)(L,null,Z?(0,u.tZ)(c.HY,{image:c.HY.PRESENTED_IMAGE_SIMPLE,description:Z}):(0,u.tZ)(c.HY,{image:c.HY.PRESENTED_IMAGE_SIMPLE}))),K&&(0,u.tZ)(b,{className:"pagination-container",isPaginationSticky:S.isPaginationSticky},(0,u.tZ)(p.Z,{totalPages:A||0,currentPage:A?D+1:0,onChange:e=>z(e-1),hideFirstAndLastPageLinks:!0}),w&&(0,u.tZ)("div",{className:"row-count-container"},!y&&(0,s.t)("%s-%s of %s",R*D+(E.length&&1),R*D+E.length,l))))},y=i.memo(x)},76962:(e,t,a)=>{a.d(t,{u:()=>o.u,Z:()=>o.Z});var o=a(46977)}}]);