"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[5656],{73995:(e,t,a)=>{a.d(t,{Z:()=>v});var n=a(67294),s=a(51995),l=a(31069),i=a(61988),o=a(15926),r=a.n(o),d=a(4715),c=a(37921),u=a(49238),m=a(40277),p=a(14114),h=a(11965);const b=s.iK.div`
...
`,Z=({backend:e,databaseName:t})=>(0,h.tZ)(g,null,(0,h.tZ)(c.Z,{className:"backend"},e),(0,h.tZ)("span",{className:"name",title:t},t));function v({db:e,formMode:t=!1,getDbList:a,handleError:s,isDatabaseSelectEnabled:o=!0,onDbChange:c,onSchemaChange:g,onSchemasLoad:v,readOnly:f=!1,schema:y,sqlLabMode:w=!1}){const[S,x]=(0,n.useState)(!1),[_,C]=(0,n.useState)([]),[k,$]=(0,n.useState)(e?{label:(0,h.tZ)(Z,{backend:e.backend,databaseName:e.database_name}),value:e.id,...e}:void 0),[D,N]=(0,n.useState)(y?{label:y,value:y}:void 0),[T,E]=(0,n.useState)(0),{addSuccessToast:L}=(0,p.e)(),z=(0,n.useMemo)((()=>async(e,n,o)=>{const d=`/api/v1/database/?q=${r().encode({order_columns:"database_name",order_direction:"asc",page:n,page_size:o,...t||!w?{filters:[{col:"database_name",opr:"ct",value:e}]}:{filters:[{col:"database_name",opr:"ct",value:e},{col:"expose_in_sqllab",opr:"eq",value:!0}]}})}`;return l.Z.get({endpoint:d}).then((({json:e})=>{const{result:t}=e;a&&a(t),0===t.length&&s((0,i.t)("It seems you don't have access to any database"));const n=t.map((e=>({label:(0,h.tZ)(Z,{backend:e.backend,databaseName:e.database_name}),value:e.id,id:e.id,database_name:e.database_name,backend:e.backend,allow_multi_schema_metadata_fetch:e.allow_multi_schema_metadata_fetch})));return{data:n,totalCount:n.length}}))}),[t,a,s,w]);function M(e,t){return(0,h.tZ)("div",{className:"section"},(0,h.tZ)("span",{className:"select"},e),(0,h.tZ)("span",{className:"refresh"},t))}return(0,n.useEffect)((()=>{if(k){x(!0);const e=r().encode({force:T>0}),t=`/api/v1/database/${k.value}/schemas/?q=${e}`;l.Z.get({endpoint:t}).then((({json:e})=>{const t=e.result.map((e=>({value:e,label:e,title:e})));v&&v(t),C(t),x(!1),T>0&&L("List refreshed")})).catch((()=>{x(!1),s((0,i.t)("There was an error loading the schemas"))}))}}),[k,v,T]),(0,h.tZ)(b,null,M((0,h.tZ)(d.P,{ariaLabel:(0,i.t)("Select database or type database name"),optionFilterProps:["database_name","value"],header:(0,h.tZ)(u.lX,null,(0,i.t)("Database")),lazyLoading:!1,onChange:function(e,t){$(t),N(void 0),c&&c(t),g&&g(void 0)},value:k,placeholder:(0,i.t)("Select database or type database name"),disabled:!o||f,options:z}),null),function(){const e=!t&&!f&&(0,h.tZ)(m.Z,{onClick:()=>E(T+1),tooltipContent:(0,i.t)("Force refresh schema list")});return M((0,h.tZ)(d.P,{ariaLabel:(0,i.t)("Select schema or type schema name"),disabled:f,header:(0,h.tZ)(u.lX,null,(0,i.t)("Schema")),labelInValue:!0,lazyLoading:!1,loading:S,name:"select-schema",placeholder:(0,i.t)("Select schema or type schema name"),onChange:e=>function(e){N(e),g&&g(e.value)}(e),options:_,showSearch:!0,value:D}),e)}())}},27989:(e,t,a)=>{a.d(t,{Z:()=>p});var n=a(67294),s=a(51995),l=a(61988),i=a(35932),o=a(74069),r=a(82191),d=a(34858),c=a(11965);const u=s.iK.div`
  display: block;
...
`,p=({resourceName:e,resourceLabel:t,passwordsNeededMessage:a,confirmOverwriteMessage:s,addDangerToast:p,onModelImport:h,show:b,onHide:g,passwordFields:Z=[],setPasswordFields:v=(()=>{})})=>{const[f,y]=(0,n.useState)(!0),[w,S]=(0,n.useState)({}),[x,_]=(0,n.useState)(!1),[C,k]=(0,n.useState)(!1),[$,D]=(0,n.useState)([]),[N,T]=(0,n.useState)(!1),E=()=>{D([]),v([]),S({}),_(!1),k(!1),T(!1)},{state:{alreadyExists:L,passwordsNeeded:z},importResource:M}=(0,d.PW)(e,t,(e=>{E(),p(e)}));(0,n.useEffect)((()=>{v(z),z.length>0&&T(!1)}),[z,v]),(0,n.useEffect)((()=>{_(L.length>0),L.length>0&&T(!1)}),[L,_]);return f&&b&&y(!1),(0,c.tZ)(o.Z,{name:"model",className:"import-model-modal",disablePrimaryButton:0===$.length||x&&!C||N,onHandledPrimaryAction:()=>{var e;(null==(e=$[0])?void 0:e.originFileObj)instanceof File&&(T(!0),M($[0].originFileObj,w,C).then((e=>{e&&(E(),h())})))},onHide:()=>{y(!0),g(),E()},primaryButtonName:x?(0,l.t)("Overwrite"):(0,l.t)("Import"),primaryButtonType:x?"danger":"primary",width:"750px",show:b,title:(0,c.tZ)("h4",null,(0,l.t)("Import %s",t))},(0,c.tZ)(m,null,(0,c.tZ)(r.gq,{name:"modelFile",id:"modelFile",accept:".yaml,.json,.yml,.zip",fileList:$,onChange:e=>{D([{...e.file,status:"done"}])},onRemove:e=>(D($.filter((t=>t.uid!==e.uid))),!1),customRequest:()=>{}},(0,c.tZ)(i.Z,{loading:N},"Select file"))),0===Z.length?null:(0,c.tZ)(n.Fragment,null,(0,c.tZ)("h5",null,"Database passwords"),(0,c.tZ)(u,null,a),Z.map((e=>(0,c.tZ)(m,{key:`password-for-${e}`},(0,c.tZ)("div",{className:"control-label"},e,(0,c.tZ)("span",{className:"required"},"*")),(0,c.tZ)("input",{name:`password-${e}`,autoComplete:`password-${e}`,type:"password",value:w[e],onChange:t=>S({...w,[e]:t.target.value})}))))),x?(0,c.tZ)(n.Fragment,null,(0,c.tZ)(m,null,(0,c.tZ)("div",{className:"confirm-overwrite"},s),(0,c.tZ)("div",{className:"control-label"},(0,l.t)('Type "%s" to confirm',(0,l.t)("OVERWRITE"))),(0,c.tZ)("input",{id:"overwrite",type:"text",onChange:e=>{var t,a;const n=null!=(t=null==(a=e.currentTarget)?void 0:a.value)?t:"";k(n.toUpperCase()===(0,l.t)("OVERWRITE"))}}))):null)}},40277:(e,t,a)=>{a.d(t,{Z:()=>o});var n=a(67294),s=a(58593),l=a(70163),i=a(11965);const o=({onClick:e,tooltipContent:t})=>{const a=(0,n.forwardRef)(((e,t)=>(0,i.tZ)(l.Z.Refresh,e)));return(0,i.tZ)(s.u,{title:t},(0,i.tZ)(a,{role:"button",onClick:e,css:e=>({cursor:"pointer",color:e.colors.grayscale.base,"&:hover":{color:e.colors.primary.base}})}))}},17982:(e,t,a)=>{a.d(t,{Z:()=>f});var n=a(67294),s=a(51995),l=a(31069),i=a(61988),o=a(4715),r=a(49238),d=a(70163),c=a(73995),u=a(40277),m=a(79789),p=a(86057),h=a(14114),b=a(11965);const g=s.iK.div`
