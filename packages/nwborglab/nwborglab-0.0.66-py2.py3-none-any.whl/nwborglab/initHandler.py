 ...
 \\:\\  \\     \\/__\\:\\/:/   / \\:\\~\\:\\/:/  /
  \\:\\  \\         \\::/  /    \\:\\ \\::/  / 
   \\:\\  \\        /:/  /      \\:\\/:/  /  
    ...
    if len(args) > 0:
        print('attempting nwborglab initialization from file ' + args[0])
        ...
        session_skeleton_sapofto = SAPOFTO.SAPOFTO('SESSION_SKELETONS',nwbfile_in.get_scratch('nwborglab_session_skeleton'))
        #session_skeleton_sapofto = nwbfile_in.get_scratch('nwborglab_session_source_code')
        
        SAPOFTO.recursiveFolderWrite(sensors_sapofto, os.getcwd(), safe_mode=True)
        overview_sapofto.writeToFile(os.getcwd())
        session_skeleton_sapofto.writeToFile(os.getcwd())
        return
