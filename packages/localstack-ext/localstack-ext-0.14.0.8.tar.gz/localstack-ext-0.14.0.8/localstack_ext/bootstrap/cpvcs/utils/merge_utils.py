...
class CPVCSMergeManager(SubtypesInstanceManager):
 @dlkFK
 def _is_special_case(obj)->dlkFv:
  return dlkFy(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:dlkFz,to_state_files):
  raise dlkFa("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:dlkFz,from_state_files:dlkFz,to_state_files:dlkFz):
  raise dlkFa("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:dlkFz)->Dict[dlkFz,dlkFz]:
