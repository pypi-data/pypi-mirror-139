...
class CPVCSMergeManager(SubtypesInstanceManager):
 @XbYfW
 def _is_special_case(obj)->XbYfq:
  return XbYfs(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:XbYfH,to_state_files):
  raise XbYfn("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:XbYfH,from_state_files:XbYfH,to_state_files:XbYfH):
  raise XbYfn("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:XbYfH)->Dict[XbYfH,XbYfH]:
