...
class CPVCSMergeManager(SubtypesInstanceManager):
 @yzJTI
 def _is_special_case(obj)->yzJTd:
  return yzJTG(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:yzJTK,to_state_files):
  raise yzJTi("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:yzJTK,from_state_files:yzJTK,to_state_files:yzJTK):
  raise yzJTi("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:yzJTK)->Dict[yzJTK,yzJTK]:
