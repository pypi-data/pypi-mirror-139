  ...
  try:
   if not self._check_if_available():
    try:
     ...
     if ngVxG(e,PackageInstallationException):
      raise
     else:
      suffix=(f" ({self.log_package_name})." if self.log_package_name is not ngVxE else ".")
   ...
   if raise_on_error:
    ...
    if self.logger.isEnabledFor(logging.DEBUG):
     ...
     self.logger.error(e)
 def _check_if_available(self)->ngVxD:
  raise ngVxq
 def _prepare_installation(self)->ngVxE:
  pass
 def _install_package(self)->ngVxE:
  raise ngVxq
 def _post_process(self)->ngVxE:
  pass
 def _verify_installation(self)->ngVxE:
  if not self._check_if_available():
   package_info=(f" of {self.log_package_name}" if self.log_package_name is not ngVxE else "")
...
class MultiPackageInstaller(PackageInstaller):
 def __init__(self,log_package_name:Optional[ngVxL],package_installers:Union[PackageInstaller,List[PackageInstaller]]):
  ngVxH(MultiPackageInstaller,self).__init__(log_package_name=log_package_name)
  self.package_installers=(package_installers if ngVxG(package_installers,List)else[package_installers])
 def install(self,raise_on_error:ngVxD=ngVxf):
...
class OSSpecificPackageInstaller(MultiPackageInstaller):
 def __init__(self,debian_installers:PackageInstaller,redhat_installers:PackageInstaller):
  ...
  ngVxH(OSSpecificPackageInstaller,self).__init__(log_package_name=self.__class__.__name__,package_installers=package_installers)
 def install(self,raise_on_error:ngVxD=ngVxf):
  try:
   if not in_docker():
    ...
    ngVxH(OSSpecificPackageInstaller,self).install(raise_on_error=raise_on_error)
  except PackageInstallationException as e:
   if raise_on_error:
    raise
   else:
...
class DebianPackageInstaller(PackageInstaller,ABC):
 def __init__(self,package_name:ngVxL):
  ngVxH(DebianPackageInstaller,self).__init__(log_package_name=package_name)
 def _install_os_packages(self,packages:Union[ngVxL,List[ngVxL]]):
  packages=packages if ngVxG(packages,List)else[packages]
  with INSTALL_LOCK:
   run(["apt-get","update"])
   run(["apt-get","install","-y","--no-install-recommends"]+packages)
class RedHatPackageInstaller(PackageInstaller,ABC):
 def __init__(self,package_name:ngVxL):
  ngVxH(RedHatPackageInstaller,self).__init__(log_package_name=package_name)
 def _install_os_packages(self,packages:Union[ngVxL,List[ngVxL]]):
  packages=packages if ngVxG(packages,List)else[packages]
  with INSTALL_LOCK:
...
class DebianPostgres11Installer(DebianPackageInstaller):
 def __init__(self):
  ngVxH(DebianPostgres11Installer,self).__init__("postgres11")
 def _check_if_available(self)->ngVxD:
...
class RedHatPostgres11Installer(RedHatPackageInstaller):
 def __init__(self):
  ngVxH(RedHatPostgres11Installer,self).__init__("postgres11")
 def _check_if_available(self)->ngVxD:
  return is_command_available("psql")
 def _prepare_installation(self)->ngVxE:
...
class DebianPlPythonInstaller(DebianPackageInstaller):
 def __init__(self):
  ngVxH(DebianPlPythonInstaller,self).__init__("plpython3")
 def _check_if_available(self)->ngVxD:
...
class RedHatPlPythonInstaller(RedHatPackageInstaller):
 def __init__(self):
  ngVxH(RedHatPlPythonInstaller,self).__init__("plpython3")
 def _check_if_available(self)->ngVxD:
...
class DebianMariaDBInstaller(DebianPackageInstaller):
 def __init__(self):
  ngVxH(DebianMariaDBInstaller,self).__init__("MariaDB")
 def _check_if_available(self)->ngVxD:
...
class RedHatMariaDBInstaller(RedHatPackageInstaller):
 def __init__(self):
  ngVxH(RedHatMariaDBInstaller,self).__init__("MariaDB")
 def _check_if_available(self)->ngVxD:
  return is_command_available("mysqld")
 def _install_package(self)->ngVxE:
...
class DebianTimescaleDBInstaller(DebianPackageInstaller):
 def __init__(self):
  ngVxH(DebianTimescaleDBInstaller,self).__init__("timescaledb")
 def _check_if_available(self)->ngVxD:
...
class RedHatTimescaleDBInstaller(RedHatPackageInstaller):
 def __init__(self):
  ngVxH(RedHatTimescaleDBInstaller,self).__init__("timescaledb")
 def _check_if_available(self)->ngVxD:
...
class DebianRedisInstaller(DebianPackageInstaller):
 def __init__(self):
  ngVxH(DebianRedisInstaller,self).__init__("Redis")
 def _check_if_available(self)->ngVxD:
...
class RedHatRedisInstaller(RedHatPackageInstaller):
 def __init__(self):
  ngVxH(RedHatRedisInstaller,self).__init__("Redis")
 def _check_if_available(self)->ngVxD:
  return is_command_available("redis-server")
 def _install_package(self)->ngVxE:
...
class DebianMosquittoInstaller(DebianPackageInstaller):
 def __init__(self):
  ngVxH(DebianMosquittoInstaller,self).__init__("Mosquitto")
 def _check_if_available(self)->ngVxD:
...
class RedHatMosquittoInstaller(RedHatPackageInstaller):
 def __init__(self):
  ngVxH(RedHatMosquittoInstaller,self).__init__("Mosquitto")
 def _check_if_available(self)->ngVxD:
  return is_command_available("mosquitto")
 def _install_package(self)->ngVxE:
