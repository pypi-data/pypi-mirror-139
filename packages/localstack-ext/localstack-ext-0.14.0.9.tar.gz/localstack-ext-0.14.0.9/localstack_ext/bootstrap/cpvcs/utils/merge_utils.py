...
class CPVCSMergeManager(SubtypesInstanceManager):
 @UcXsy
 def _is_special_case(obj)->UcXsf:
  return UcXsw(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:UcXsb,to_state_files):
  raise UcXsm("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:UcXsb,from_state_files:UcXsb,to_state_files:UcXsb):
  raise UcXsm("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:UcXsb)->Dict[UcXsb,UcXsb]:
