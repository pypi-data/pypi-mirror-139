...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html)
...
class LakeFormationClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#exceptions)
        """
    ...
    async def add_lf_tags_to_resource(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#add_lf_tags_to_resource)
        """
    ...
    async def batch_grant_permissions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#batch_grant_permissions)
        """
    ...
    async def batch_revoke_permissions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#batch_revoke_permissions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#can_paginate)
        """
    ...
    async def cancel_transaction(self, *, TransactionId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#cancel_transaction)
        """
    ...
    async def commit_transaction(self, *, TransactionId: str) -> CommitTransactionResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#commit_transaction)
        """
    ...
    async def create_data_cells_filter(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#create_data_cells_filter)
        """
    ...
    async def create_lf_tag(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#create_lf_tag)
        """
    ...
    async def delete_data_cells_filter(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#delete_data_cells_filter)
        """
    ...
    async def delete_lf_tag(self, *, TagKey: str, CatalogId: str = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#delete_lf_tag)
        """
    ...
    async def delete_objects_on_cancel(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#delete_objects_on_cancel)
        """
    ...
    async def deregister_resource(self, *, ResourceArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#deregister_resource)
        """
    ...
    async def describe_resource(self, *, ResourceArn: str) -> DescribeResourceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#describe_resource)
        """
    ...
    async def describe_transaction(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#describe_transaction)
        """
    ...
    async def extend_transaction(self, *, TransactionId: str = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#extend_transaction)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#generate_presigned_url)
        """
    ...
    async def get_data_lake_settings(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_data_lake_settings)
        """
    ...
    async def get_effective_permissions_for_path(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_effective_permissions_for_path)
        """
    ...
    async def get_lf_tag(self, *, TagKey: str, CatalogId: str = ...) -> GetLFTagResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_lf_tag)
        """
    ...
    async def get_query_state(self, *, QueryId: str) -> GetQueryStateResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_query_state)
        """
    ...
    async def get_query_statistics(self, *, QueryId: str) -> GetQueryStatisticsResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_query_statistics)
        """
    ...
    async def get_resource_lf_tags(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_resource_lf_tags)
        """
    ...
    async def get_table_objects(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_table_objects)
        """
    ...
    async def get_work_unit_results(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_work_unit_results)
        """
    ...
    async def get_work_units(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_work_units)
        """
    ...
    async def grant_permissions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#grant_permissions)
        """
    ...
    async def list_data_cells_filter(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#list_data_cells_filter)
        """
    ...
    async def list_lf_tags(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#list_lf_tags)
        """
    ...
    async def list_permissions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#list_permissions)
        """
    ...
    async def list_resources(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#list_resources)
        """
    ...
    async def list_table_storage_optimizers(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#list_table_storage_optimizers)
        """
    ...
    async def list_transactions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#list_transactions)
        """
    ...
    async def put_data_lake_settings(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#put_data_lake_settings)
        """
    ...
    async def register_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#register_resource)
        """
    ...
    async def remove_lf_tags_from_resource(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#remove_lf_tags_from_resource)
        """
    ...
    async def revoke_permissions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#revoke_permissions)
        """
    ...
    async def search_databases_by_lf_tags(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#search_databases_by_lf_tags)
        """
    ...
    async def search_tables_by_lf_tags(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#search_tables_by_lf_tags)
        """
    ...
    async def start_query_planning(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#start_query_planning)
        """
    ...
    async def start_transaction(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#start_transaction)
        """
    ...
    async def update_lf_tag(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#update_lf_tag)
        """
    ...
    async def update_resource(self, *, RoleArn: str, ResourceArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#update_resource)
        """
    ...
    async def update_table_objects(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#update_table_objects)
        """
    ...
    async def update_table_storage_optimizer(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#update_table_storage_optimizer)
        """
    ...
    def get_paginator(self, operation_name: Literal["get_work_units"]) -> GetWorkUnitsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client.html#get_paginator)
        """
