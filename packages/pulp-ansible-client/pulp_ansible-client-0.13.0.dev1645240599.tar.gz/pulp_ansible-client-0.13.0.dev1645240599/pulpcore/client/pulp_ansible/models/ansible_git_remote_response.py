...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, ca_cert=None, total_timeout=None, sock_connect_timeout=None, headers=None, rate_limit=None, connect_timeout=None, pulp_href=None, pulp_last_updated=None, pulp_created=None, proxy_url=None, pulp_labels=None, sock_read_timeout=None, client_cert=None, max_retries=None, download_concurrency=None, name=None, url=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
