...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, ca_cert=None, total_timeout=None, sock_connect_timeout=None, client_key=None, headers=None, rate_limit=None, connect_timeout=None, proxy_url=None, username=None, pulp_labels=None, sock_read_timeout=None, client_cert=None, max_retries=None, proxy_password=None, download_concurrency=None, password=None, name=None, url=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
