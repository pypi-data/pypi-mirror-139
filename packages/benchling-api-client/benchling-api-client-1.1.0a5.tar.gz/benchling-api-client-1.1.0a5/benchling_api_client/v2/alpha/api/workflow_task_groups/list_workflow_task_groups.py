...
def _get_kwargs(
    *,
    ...
    node_config_id: Union[Unset, str] = UNSET,
    flowchart_task_group_id: Union[Unset, str] = UNSET,
    ...
    if not isinstance(node_config_id, Unset) and node_config_id is not None:
        params["nodeConfigId"] = node_config_id
    if not isinstance(flowchart_task_group_id, Unset) and flowchart_task_group_id is not None:
        params["flowchartTaskGroupId"] = flowchart_task_group_id
...
def sync_detailed(
    *,
    ...
    kwargs = _get_kwargs(
        ...
        flowchart_task_group_id=flowchart_task_group_id,
        folder_id=folder_id,
