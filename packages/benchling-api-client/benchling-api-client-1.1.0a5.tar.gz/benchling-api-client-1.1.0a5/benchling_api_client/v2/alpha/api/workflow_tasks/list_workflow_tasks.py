...
def _get_kwargs(
    *,
    ...
    flowchart_workflow_task_group_ids: Union[Unset, str] = UNSET,
    ...
    modified_at: Union[Unset, datetime.date] = UNSET,
    next_token: Union[Unset, str] = UNSET,
    page_size: Union[Unset, int] = 50,
    display_ids: Union[Unset, str] = UNSET,
    archive_reason: Union[Unset, str] = UNSET,
    flowchart_task_id: Union[Unset, str] = UNSET,
    source_task_idsany_of: Union[Unset, str] = UNSET,
    source_task_idsall_of: Union[Unset, str] = UNSET,
    source_output_idsany_of: Union[Unset, str] = UNSET,
    source_output_idsall_of: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    ...
    if (
        not isinstance(flowchart_workflow_task_group_ids, Unset)
        and flowchart_workflow_task_group_ids is not None
    ):
        params["flowchartWorkflowTaskGroupIds"] = flowchart_workflow_task_group_ids
    ...
    if not isinstance(json_modified_at, Unset) and json_modified_at is not None:
    ...
    if not isinstance(flowchart_task_id, Unset) and flowchart_task_id is not None:
        params["flowchartTaskId"] = flowchart_task_id
    if not isinstance(source_task_idsany_of, Unset) and source_task_idsany_of is not None:
        params["sourceTaskIds.anyOf"] = source_task_idsany_of
    if not isinstance(source_task_idsall_of, Unset) and source_task_idsall_of is not None:
        params["sourceTaskIds.allOf"] = source_task_idsall_of
    if not isinstance(source_output_idsany_of, Unset) and source_output_idsany_of is not None:
        params["sourceOutputIds.anyOf"] = source_output_idsany_of
    if not isinstance(source_output_idsall_of, Unset) and source_output_idsall_of is not None:
        params["sourceOutputIds.allOf"] = source_output_idsall_of
...
def _parse_response(*, response: httpx.Response) -> Optional[BadRequestError]:
...
def _build_response(*, response: httpx.Response) -> Response[BadRequestError]:
    return Response(
...
def sync_detailed(
    *,
    ...
    kwargs = _get_kwargs(
        ...
        flowchart_workflow_task_group_ids=flowchart_workflow_task_group_ids,
        ...
        flowchart_task_id=flowchart_task_id,
        source_task_idsany_of=source_task_idsany_of,
        source_task_idsall_of=source_task_idsall_of,
        source_output_idsany_of=source_output_idsany_of,
        source_output_idsall_of=source_output_idsall_of,
    )
