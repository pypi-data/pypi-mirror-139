...
) -> Optional[Union[BenchlingAppConfigurationPaginatedList, ForbiddenError, NotFoundError]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[BenchlingAppConfigurationPaginatedList, ForbiddenError, NotFoundError]]:
    return Response(
