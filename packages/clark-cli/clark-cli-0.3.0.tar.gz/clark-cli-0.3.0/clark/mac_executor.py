...
class MacScriptExecutor(ScriptExecutor):
  ...
  IRRELEVANT_CONTAIN_PATHS = ['/dev/tty', '/dev/fd', '__pycache__', '/dev/dtracehelper', '/site-packages', '/Library/']
  IRRELEVANT_BASEPATHS = ['/usr/', '/lib/', '/etc/', '/lib64/', '/proc/', '/Applications', '/var/']
