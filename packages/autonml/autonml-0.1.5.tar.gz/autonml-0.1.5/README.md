...
Keep in mind, additional D3M primitives must be installed for proper functioning of the AutonML pipeline. To do this, we provide an installation script `install.sh` available [here](https://gitlab.com/sray/cmu-ta2/-/tree/dev).
