...
setup(
    ...
    description="Type annotations for aiobotocore.QLDBSession 2.1.1 service generated with mypy-boto3-builder 7.1.1",
    classifiers=[
    ...
    keywords="aiobotocore qldb-session type-annotations boto3-stubs mypy typeshed autocomplete",
    long_description=LONG_DESCRIPTION,
    long_description_content_type="text/markdown",
    package_data={"types_aiobotocore_qldb_session": ["py.typed", "*.pyi"]},
    python_requires=">=3.6",
    project_urls={
