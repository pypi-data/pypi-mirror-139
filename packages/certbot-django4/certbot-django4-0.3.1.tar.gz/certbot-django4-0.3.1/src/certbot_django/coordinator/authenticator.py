...
class Authenticator(common.Plugin):
    ...
    long_description = "Authenticate by connecting to a Django application that has" "certbot_django.server installed."

    @classmethod
    def add_parser_arguments(cls, add):
        add("username", help="Username for authenticating with Django server.")
        add("key-directory", help="Directory to store generated public / private keys or to read previously generated keys from.")
        add("public-ip-logging-ok", action="store_true", help="Automatically allows public IP logging (default: Ask)")

    def prepare(self):
        pass

    def more_info(self):
        return "Authenticate by connecting to a Django application that has" "certbot_django.server installed."
    ...
    def _verify_ip_logging_ok(self):
        if not self.conf("public-ip-logging-ok"):
            ...
            msg = (
                "NOTE: The IP of this machine will be publicly logged as "
