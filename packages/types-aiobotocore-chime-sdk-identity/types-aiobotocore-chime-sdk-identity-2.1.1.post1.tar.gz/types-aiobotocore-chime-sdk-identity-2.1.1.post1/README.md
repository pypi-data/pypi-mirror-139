...
[aiobotocore.ChimeSDKIdentity 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/chime-sdk-identity.html#ChimeSDKIdentity)
...
- Install `types-aiobotocore[chime-sdk-identity]` with services you use in your
  environment:
