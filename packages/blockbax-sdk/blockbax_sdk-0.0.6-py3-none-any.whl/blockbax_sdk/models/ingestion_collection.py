...
class IngestionCollection:
    ...
    def create_series_to_send(
        ...
        if ingestion_ids:
            ingestions_to_send = (self.__ingestions[ingestion_id] for ingestion_id in ingestion_ids if ingestion_id in self.__ingestions)
        else:
            ingestions_to_send = (ingestion for _, ingestion in self.__ingestions.items())
