...
class Client:
    ...
    @ignore_unexpected_kwargs
    def search_exchange_store_files(self, pattern: str) -> FileSearchResults:
        """

        """
        req_ = dict(pattern=pattern)
        res_ = self._request('search_exchange_store_files', req_)
        return FileSearchResults.load(res_)
    ...
    @ignore_unexpected_kwargs
    def create_dataset_from_exchange_store(self, filepath: str) -> str:
        """

        """
        req_ = dict(filepath=filepath)
        res_ = self._request('create_dataset_from_exchange_store', req_)
        return res_
