...
class TestCliServiceRegistry(BaseCliTestCase):
    def setUpCLI(self):
        self.useServiceRegistry(TEST_SERVICE_REGISTRY)
    ...
    def test_service_registry(self):
        ...
        service_config = self.getConfig("data_connect", json_output=True)
    ...
    def test_service_registry_existing_config(self):
        ...
        self.setConfig("data_connect.auth.url", TEST_AUTH_PARAMS["prod"]["url"])
        self.setConfig(
