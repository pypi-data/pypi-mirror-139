...
PROGRESS_ENQUEUEING_INDEX = 2627
PROGRESS_COMPLETED = 2628
...
SCHEDULER_FREEING_MEMORY_CRITICAL = 2718                       #: [Scheduler] La memoria disponibile del sistema è estremamente bassa; ricompatto la memoria heap
...
DOC_INTEGRATIVO = 6020                                         #: Documento integrativo
...
EDI_DOCUMENT_EXISTS_IO_ERROR = 6611
EDI_DOCUMENT_EXISTS_INT_ERROR = 6612
EDI_DOCUMENT_NOT_FOUND = 6613                                  #: Documento elettronico non trovato
...
CMD_PING = 0
IN_TEST_CONNECTION = 'TEST_CONNECTION'
...
OUT_TOTAL_SWAP = 'TOTAL_SWAP'
OUT_AVAILABLE_SWAP = 'AVAILABLE_SWAP'
OUT_USED_MEMORY = 'USED_MEMORY'
OUT_PROCESS_MEMORY = 'PROCESS_MEMORY'
OUT_IP = 'IP'
