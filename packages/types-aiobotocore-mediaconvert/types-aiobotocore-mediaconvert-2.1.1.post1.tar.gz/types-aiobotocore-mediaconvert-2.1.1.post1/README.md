...
[aiobotocore.MediaConvert 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mediaconvert.html#MediaConvert)
...
[types-aiobotocore-mediaconvert docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediaconvert/)
...
`types_aiobotocore_mediaconvert.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

```python
from types_aiobotocore_mediaconvert.literals import (
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediaconvert/)
