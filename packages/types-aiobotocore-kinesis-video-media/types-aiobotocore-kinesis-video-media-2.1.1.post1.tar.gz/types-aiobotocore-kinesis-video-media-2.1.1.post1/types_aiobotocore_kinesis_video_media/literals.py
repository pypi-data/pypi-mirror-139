...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_kinesis_video_media/literals.html)
...
__all__ = ("StartSelectorTypeType", "ServiceName")
