...
def print_info() -> None:
    ...
    """
    print(
        "Type annotations for aiobotocore.CodeStarNotifications 2.1.1\n"
        "Version:         2.1.1.post1\n"
        "Builder version: 7.1.1\n"
        "Docs:            https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_notifications//\n"
