...
def versioning_style(
    ...
    try:
        ...
        unshallow_repository = True
       
        if flow_context.ci_provider == CIProvider.CODEFRESH:
            unshallow_repository = False
        elif flow_context.ci_provider == CIProvider.AWS_CODEBUILD:
            unshallow_repository = False

        git_adapter = GitAdapter(
            repository_dir=repository_dir,
            unshallow_repository=unshallow_repository
        )
