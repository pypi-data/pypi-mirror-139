...
class SourceCodeScanner(object):
    ...
    def __init__(self, source_code_dir, ci_provider_name):
        ...
        self.__ci_provider_name = ci_provider_name
    ...
    def __create_container(self):
        ...
        if self.__ci_provider_name == CIProvider.BITBUCKET.name:
            test_source_dir = '/opt/atlassian/pipelines/agent/build'
        elif self.container_source_dir != '/code':
            test_source_dir = self.container_source_dir
        else:
            test_source_dir = '/code'
        ...
        local_test = {
            ...
            'container_source_dir' : test_source_dir,
            'ci': self.__ci_provider_name
        }
        LOGGER.debug('Container payload: '.format(local_test))
