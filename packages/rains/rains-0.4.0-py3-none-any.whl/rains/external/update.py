...
def function_update():
  dos_result = subprocess.Popen(['pip', 'install', f'{__name__}=='], stderr=subprocess.PIPE)
  ...
  if newest_version > __version__:
    ...
    dos_result = subprocess.Popen(['pip', 'install', '--upgrade', __name__], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
