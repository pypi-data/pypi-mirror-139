...
def print_info() -> None:
    ...
    """
    print(
        "Type annotations for aiobotocore.MarketplaceEntitlementService 2.1.1\n"
        "Version:         2.1.1.post1\n"
        "Builder version: 7.1.1\n"
        "Docs:            https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_entitlement//\n"
