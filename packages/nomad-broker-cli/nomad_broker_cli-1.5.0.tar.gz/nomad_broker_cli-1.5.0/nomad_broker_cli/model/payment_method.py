...
class PaymentMethod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Payment method, must be wechatpay or alipay., must be one of ["wechatpay", "alipay", ]  # noqa: E501

        Keyword Args:
            value (str): Payment method, must be wechatpay or alipay., must be one of ["wechatpay", "alipay", ]  # noqa: E501
