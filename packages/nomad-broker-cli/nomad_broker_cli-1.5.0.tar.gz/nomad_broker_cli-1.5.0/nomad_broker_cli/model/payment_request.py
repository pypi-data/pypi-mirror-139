...
class PaymentRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'products': ([PaymentProduct],),  # noqa: E501
            'discount_cost_price': (int,),  # noqa: E501
            'discount_invoice_id': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'discount_cost_price': 'discountCostPrice',  # noqa: E501
        'discount_invoice_id': 'discountInvoiceId',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, payment_method, payment_type, order_ref, total, currency, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            total (int): Order total amount, which uses the base unit of current currency
        ...
        Keyword Args:
            ...
            products ([PaymentProduct]): All products data for current order, used when the order includes discounts. [optional]  # noqa: E501
            discount_cost_price (int): When the original order price is not equal to the payment amount, the discount will not be enjoyed. This field is mainly used to prevent the same invoice from being paid multiple times to enjoy multiple discounts.. [optional]  # noqa: E501
            discount_invoice_id (int): Merchant invoice ID. [optional]  # noqa: E501
