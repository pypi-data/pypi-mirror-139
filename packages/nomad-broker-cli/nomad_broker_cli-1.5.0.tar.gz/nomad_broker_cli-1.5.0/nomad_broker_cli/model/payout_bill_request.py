...
class PayoutBillRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, operation, transaction_id, *args, **kwargs):  # noqa: E501
        """PayoutBillRequest - a model defined in OpenAPI

        Args:
            operation (str): Abroad payout bill operations, available: GetAvailableAbroadAmounts
            transaction_id (str): Payment company transaction number
