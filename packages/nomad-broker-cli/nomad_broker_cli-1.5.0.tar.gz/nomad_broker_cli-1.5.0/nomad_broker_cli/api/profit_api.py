    ...
    def __init__(self, api_client=None):
        ...
        def __get_profit_sharing(
            ...
            **kwargs
            ...
            >>> thread = api.get_profit_sharing(merchant, out_order_no, transaction_id, async_req=True)
            >>> result = thread.get()

            Args:
                merchant (str): Merchant name to payment company, e.g. wechat.prod
                out_order_no (str): The profit sharing number of the merchant, shall be unique within merchant system
