...
from nomad_broker_cli import rest
from nomad_broker_cli.configuration import Configuration
from nomad_broker_cli.exceptions import ApiTypeError, ApiValueError, ApiException
from nomad_broker_cli.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CustomsApi()
        api_instance.get_customs_payment  # this is an instance of the class Endpoint
        api_instance.get_customs_payment()  # this invokes api_instance.get_customs_payment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_customs_payment.callable or self.callable in this class
