...
class HoldingExtractor_DB:
    ...
    def _load_portfolio_weight(self,jjdm,fund_name,date_list):
...
if __name__ == '__main__':
    ...
    data=HoldingExtractor_DB()._load_portfolio_weight(jjdm='P04365',fund_name='同犇1期',
    ...
    # HoldingAnalysor('新方程泓澄精选', start_date='20150831', end_date='20210630').get_construct_result()