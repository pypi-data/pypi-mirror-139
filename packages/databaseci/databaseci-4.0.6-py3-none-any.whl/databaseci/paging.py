...
def get_page(
    ...
    **kwargs,
    ...
    query, page_params = paging_wrapped_query(
        query, ordering, bookmark, per_page, backwards
    )
    ...
    results.paging = Paging(results, per_page, ordering, bookmark, backwards, d)
...
def paging_wrapped_query(query, ordering, bookmark, per_page, backwards):
...
class Paging:
    def __init__(self, results, per_page, ordering, bookmark, backwards, d):
        ...
        self.names = [_.name for _ in self.d]
