...
class S3OdooBucketInfo(object):
    ...
    def get_key(self, *file_paths):
        ...
        :param file_paths: un tableau de 1 ou n constituant le chemain sous first-dir du fichier dans le bucket, supprime les valeur <False>
...
class S3Odoo(object):
    def __init__(self, connection, bucket):
        ...
        _logger.info("Creating S3 Impl from %s info", connection)
    ...
    def from_env(db_name=None):
        ...
        use_main_dir = bool(os.environ.get("S3_FILESTORE_SUB_DIR", os.environ.get("ODOO_S3_FILESTORE_SUB_DIR")))
        ...
        access_key = os.environ.get("S3_FILESTORE_ACCESS_KEY", os.environ.get("ODOO_S3_ACCESS_KEY"))
        secret = os.environ.get("S3_FILESTORE_SECRET_KEY", os.environ.get("ODOO_S3_SECRET_KEY"))
        region = os.environ.get("S3_FILESTORE_REGION", os.environ.get("ODOO_S3_REGION"))
        host = os.environ.get("S3_FILESTORE_HOST", os.environ.get("ODOO_S3_HOST"))
        bucket_name = os.environ.get("S3_FILESTORE_BUCKET", os.environ.get("ODOO_S3_BUCKET"))
