...
# this is a copy of https://github.com/bonlime/keras-deeplab-v3-plus
# with only minor changes
# MIT licence https://github.com/bonlime/keras-deeplab-v3-plus/blob/master/LICENSE
