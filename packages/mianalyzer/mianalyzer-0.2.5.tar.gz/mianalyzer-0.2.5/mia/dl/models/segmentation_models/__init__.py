...
# this is a clone from https://github.com/qubvel/segmentation_models
# with minor changes
# licence MIT, https://github.com/qubvel/segmentation_models/blob/master/LICENSE
...
def set_framework(name):
    ...
    if name == _KERAS_FRAMEWORK_NAME:
        import keras
        import dl.models.efficientnet.keras  # init custom objects
    elif name == _TF_KERAS_FRAMEWORK_NAME:
        from tensorflow import keras
        import dl.models.efficientnet.tfkeras  # init custom objects
    else:
