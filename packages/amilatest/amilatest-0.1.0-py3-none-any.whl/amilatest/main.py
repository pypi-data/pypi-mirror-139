...
class Analyzer:
    ...
    def __init__(self, path_to_requirements: str, json_output=True) -> None:
        self._path_to_requirements = path_to_requirements
        self._table = []
        self.json_output = json_output

    def _get_file_lines_length(self) -> int:
        with open(self._path_to_requirements, "r") as f:
            ...
            with alive_bar(self._get_file_lines_length()) as bar:
                for req in requirements.parse(fd):
                    ...
                    if newer_versions:
                        ...
                        if newer_versions[0] > current_version:
