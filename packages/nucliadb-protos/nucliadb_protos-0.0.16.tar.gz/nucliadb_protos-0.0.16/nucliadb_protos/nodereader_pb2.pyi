...
class DocumentSearchRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["body",b"body","faceted",b"faceted","fields",b"fields","filter",b"filter","id",b"id","order",b"order","page_number",b"page_number","result_per_page",b"result_per_page","timestamps",b"timestamps"]) -> None: ...
...
class ParagraphSearchRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["faceted",b"faceted","filter",b"filter","order",b"order","timestamps",b"timestamps"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["body",b"body","faceted",b"faceted","fields",b"fields","filter",b"filter","id",b"id","order",b"order","page_number",b"page_number","result_per_page",b"result_per_page","timestamps",b"timestamps","uuid",b"uuid"]) -> None: ...
...
class VectorSearchRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["id",b"id","tags",b"tags","vector",b"vector"]) -> None: ...
...
class SearchRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["faceted",b"faceted","filter",b"filter","order",b"order","timestamps",b"timestamps"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["body",b"body","faceted",b"faceted","fields",b"fields","filter",b"filter","order",b"order","page_number",b"page_number","result_per_page",b"result_per_page","shard",b"shard","timestamps",b"timestamps","vector",b"vector"]) -> None: ...
