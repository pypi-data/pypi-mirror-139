...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html)
...
class CloudWatchEvidentlyClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#exceptions)
        """
    ...
    async def batch_evaluate_feature(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#batch_evaluate_feature)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#can_paginate)
        """
    ...
    async def create_experiment(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#create_experiment)
        """
    ...
    async def create_feature(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#create_feature)
        """
    ...
    async def create_launch(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#create_launch)
        """
    ...
    async def create_project(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#create_project)
        """
    ...
    async def delete_experiment(self, *, experiment: str, project: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#delete_experiment)
        """
    ...
    async def delete_feature(self, *, feature: str, project: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#delete_feature)
        """
    ...
    async def delete_launch(self, *, launch: str, project: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#delete_launch)
        """
    ...
    async def delete_project(self, *, project: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#delete_project)
        """
    ...
    async def evaluate_feature(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#evaluate_feature)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#generate_presigned_url)
        """
    ...
    async def get_experiment(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#get_experiment)
        """
    ...
    async def get_experiment_results(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#get_experiment_results)
        """
    ...
    async def get_feature(self, *, feature: str, project: str) -> GetFeatureResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#get_feature)
        """
    ...
    async def get_launch(self, *, launch: str, project: str) -> GetLaunchResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#get_launch)
        """
    ...
    async def get_project(self, *, project: str) -> GetProjectResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#get_project)
        """
    ...
    async def list_experiments(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#list_experiments)
        """
    ...
    async def list_features(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#list_features)
        """
    ...
    async def list_launches(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#list_launches)
        """
    ...
    async def list_projects(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#list_projects)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#list_tags_for_resource)
        """
    ...
    async def put_project_events(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#put_project_events)
        """
    ...
    async def start_experiment(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#start_experiment)
        """
    ...
    async def start_launch(self, *, launch: str, project: str) -> StartLaunchResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#start_launch)
        """
    ...
    async def stop_experiment(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#stop_experiment)
        """
    ...
    async def stop_launch(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#stop_launch)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#untag_resource)
        """
    ...
    async def update_experiment(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#update_experiment)
        """
    ...
    async def update_feature(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#update_feature)
        """
    ...
    async def update_launch(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#update_launch)
        """
    ...
    async def update_project(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#update_project)
        """
    ...
    async def update_project_data_delivery(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#update_project_data_delivery)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_evidently/client.html#get_paginator)
        """
