...
[aiobotocore.AutoScaling 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling.html#AutoScaling)
...
[types-aiobotocore-autoscaling docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_autoscaling/)
...
Install `types-aiobotocore-lite[autoscaling]` in your environment:
...
`types_aiobotocore_autoscaling.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

```python
from types_aiobotocore_autoscaling.literals import (
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_autoscaling/)
