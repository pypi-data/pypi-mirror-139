...
[aiobotocore.CloudSearchDomain 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudsearchdomain.html#CloudSearchDomain)
...
[types-aiobotocore-cloudsearchdomain docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudsearchdomain/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-cloudsearchdomain](#types-aiobotocore-cloudsearchdomain)
...
- Install `types-aiobotocore[cloudsearchdomain]` in your environment:
...
Install `types-aiobotocore-lite[cloudsearchdomain]` in your environment:
...
- Install `types-aiobotocore[cloudsearchdomain]` with services you use in your
  environment:
...
`session.create_client("cloudsearchdomain")`.

```python
from aiobotocore.session import get_session

from types_aiobotocore_cloudsearchdomain import CloudSearchDomainClient
...
`types-aiobotocore-cloudsearchdomain` version is the same as related
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudsearchdomain/)
