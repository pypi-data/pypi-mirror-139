...
def main():
    ...
    if not args.no_greeting:
        ...
        print('  1.    Open https://nanamilang.jedi2light.moe/ in your Web Browser')
        print('  2.              Press on the "NanamiLang Package Registry" button')
        print('  3. Copy && run NanamiLang PKG Manager cURL installation one-liner')
        print('  4. In your Terminal then type "nanamilang-pkg.sh populate stdlib"')
        ...
        print('  (stdlib/doc  ...)   ;; get documentation of a function or a macro')
