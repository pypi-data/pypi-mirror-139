...
class BuiltinFunctions:
    ...
    def print_func(args: List[datatypes.Base]) -> datatypes.Nil:
        """
        ...
        print(*[x.format() for x in args])  # <----------------------------- takes no care about truncating right now
    ...
    @meta({'spec': [[Spec.ArityAtLeastOne],
           ...
           'name': '>',
           'forms': ['(> n1 n2 ... nX)'],
           'docstring': 'Returns false once current is less than next'})
    ...
    @meta({'spec': [[Spec.ArityAtLeastOne],
           ...
           'name': '<',
           'forms': ['(< n1 n2 ... nX)'],
           'docstring': 'Returns false once current is greater than next'})
    ...
    @meta({'spec': [[Spec.ArityIs, 2],
           ...
           'name': '>=',
           'forms': ['(>= n1 n2 ... nX)'],
           'docstring': 'Returns false once current is less-than-equal next'})
    ...
    @meta({'spec': [[Spec.ArityAtLeastOne],
           ...
           'name': '<=',
           'forms': ['(<= n1 n2 ... nX)'],
           'docstring': 'Returns false once current is greater-than-equal next'})
    ...
    def reduce_func(args: List[datatypes.Base]) -> datatypes.Base or datatypes.NException:
        ...
        :param args: incoming 'reduce' function arguments (collection and (maybe anonymous) function)
        :return: datatypes.Base
        """
