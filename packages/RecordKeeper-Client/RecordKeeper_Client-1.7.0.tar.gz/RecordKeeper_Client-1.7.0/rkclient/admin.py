...
class RKAdmin(RKClient):
    ...
    def get_pems(self,
        ...
        :param filters: contains dict of key:value pairs, which all have to be contained in PEM fields to be returned.
                ID, Emitter and Predecessor should be hex values of UUID (without dashes).
    ...
    def get_artifacts(self,
        ...
        """
        :param source: from which db to return artifacts, 'sqldb' or 'graphdb'. Warning: 'graphdb' doesn't return Artifacts with properties.
        :param page_index:
        :param page_size:
        :param sort_field:
        :param sort_order:
