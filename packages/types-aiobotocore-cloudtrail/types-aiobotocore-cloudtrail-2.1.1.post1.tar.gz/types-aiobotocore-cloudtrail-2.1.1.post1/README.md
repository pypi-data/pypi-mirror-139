...
[aiobotocore.CloudTrail 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudtrail.html#CloudTrail)
...
[types-aiobotocore-cloudtrail docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudtrail/)
...
`types_aiobotocore_cloudtrail.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

```python
from types_aiobotocore_cloudtrail.literals import (
    EventCategoryType,
    InsightTypeType,
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudtrail/)
