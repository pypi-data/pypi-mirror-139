...
AS_VAR_SET_IF([SAGE_ENABLE_argcomplete], [], [AS_VAR_SET([SAGE_ENABLE_argcomplete], [yes])])
...
AC_SUBST(SAGE_ENABLE_ipympl, [if_installed])
SAGE_SPKG_ENABLE([ipympl], [optional], [ipympl: Matplotlib Jupyter Extension])
...
AC_SUBST(SAGE_ENABLE_jupyter_packaging, [if_installed])
SAGE_SPKG_ENABLE([jupyter_packaging], [optional], [jupyter_packaging: Jupyter Packaging Utilities])
...
SAGE_SPKG_ENABLE([mathics], [optional], [Mathics3: A general-purpose computer algebra system.])
...
SAGE_SPKG_ENABLE([sagemath_categories], [experimental], [=========================================================================])
...
SAGE_SPKG_ENABLE([sagemath_objects], [experimental], [============================================================================================================])
