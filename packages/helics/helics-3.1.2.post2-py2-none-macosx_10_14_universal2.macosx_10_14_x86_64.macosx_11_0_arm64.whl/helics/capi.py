...
class HelicsFilter(_HelicsCHandle):
    ...
    def add_destination_target(self, destination     ):
        """
    ...
    def add_source_target(self, source     ):
        """
    ...
    def remove_destination_target(self, destination     ):
        """remove a destination target from a cloning filter."""
        helicsFilterRemoveTarget(self, destination)

    def add_delivery_endpoint(self, delivery_endpoint     ):
        """
    ...
    def remove_delivery_endpoint(self, delivery_endpoint     ):
        """
...
class HelicsCore(_HelicsCHandle):
    ...
    def wait_for_disconnect(self, ms_to_wait      = -1)        :
    ...
    def register_filter(self, kind                  , name      = "")                :
        """
    ...
    def register_cloning_filter(self, delivery_endpoint     )                       :
        """
    ...
    def global_error(self, error_code     , error_string     ):
        """
...
class HelicsBroker(_HelicsCHandle):
    ...
    def data_link(self, source     , target     ):
        """
    ...
    def add_source_filter_to_endpoint(self, filter     , target     ):
        """
    ...
    def add_destination_filter_to_endpoint(self, filter     , target     ):
        """
    ...
    def query(self, target     , query     , mode                       = HelicsSequencingMode.FAST)            :
        """
...
class HelicsEndpoint(_HelicsCHandle):
    ...
    def send_data(self, data                             , destination      = None, time=None):
...
class HelicsFederateInfo(_HelicsCHandle):
    ...
    @broker_init.setter
    def broker_init(self, broker_init     ):
    ...
    @local_port.setter
    def local_port(self, broker_port     ):
...
class HelicsFederate(_HelicsCHandle):
    ...
    def enter_executing_mode(self, iterate                         = HelicsIterationRequest.NO_ITERATION):
        """
    ...
    def enter_executing_mode_async(self, iterate                         = HelicsIterationRequest.NO_ITERATION):
        """
        Enter the normal execution mode.
    ...
    def request_time_advance(self, time_delta            )              :
        """
        Request a time advancement to the next allowed time.
    ...
    def request_time_iterative(self, time       , iterate                        )                                            :
        """
    ...
    def request_time_async(self, time            ):
        """
    ...
    def request_time_iterative_async(self, time       , iterate                        ):
        """
    ...
    def register_filter(self, kind                  , filter_name     )                :
        """
    ...
    def register_global_filter(self, kind                  , filter_name     )                :
        """
        Define a filter interface.
    ...
    def local_error(self, error_code     , error_string     ):
        """
...
class HelicsValueFederate(HelicsFederate):
    ...
    def register_publication(self, name     , kind                            , units      = "")                     :
        """
    ...
    def register_global_publication(self, name     , kind                            , units      = "")                     :
        """
        Register a publication
    ...
    def register_from_publication_json(self, data                  ):
        """
    ...
    def get_publication_by_index(self, index     )                     :
        """
    ...
    def register_input(self, name     , kind                            , units      = "")               :
        """
        Register an input.
    ...
    def register_global_input(self, name     , kind                            , units      = "")               :
        """
        Register an input.
    ...
    def get_subscription_by_index(self, index     )               :
...
class HelicsMessageFederate(HelicsFederate):
    ...
    def register_endpoint(self, name     , kind      = "")                  :
        """
    ...
    def register_global_endpoint(self, name     , kind      = "")                  :
        """
    ...
    def get_endpoint_by_index(self, index     )                  :
        """
...
def helicsCreateCore(type     , name     , init_string     )              :
    """
...
def helicsCreateCoreFromArgs(type     , name     , arguments           )              :
    """
...
def helicsCreateBroker(type     , name      = "", init_string      = "")                :
    """
...
def helicsCreateBrokerFromArgs(type     , name     , arguments           )                :
    """
    Create a `helics.HelicsCore` by passing command line arguments.
...
def helicsBrokerIsValid(broker              )        :
    """
...
def helicsBrokerDataLink(broker              , source_name     , target_name     ):
    """
...
def helicsBrokerAddSourceFilterToEndpoint(broker              , filter_name     , endpoint_name     ):
    """
...
def helicsBrokerAddDestinationFilterToEndpoint(broker              , filter_name     , endpoint_name     ):
    """
...
def helicsBrokerMakeConnections(broker              , file     ):
    """
...
def helicsCoreWaitForDisconnect(core            , ms_to_wait     )        :
    """
...
def helicsBrokerWaitForDisconnect(broker              , ms_to_wait     )        :
    """
...
def helicsCoreDataLink(core            , source_name     , target_name     ):
    """
...
def helicsCoreAddSourceFilterToEndpoint(core            , filter_name     , endpoint_name     ):
    """
    Link a named filter to a source endpoint.
...
def helicsCoreAddDestinationFilterToEndpoint(core            , filter_name     , endpoint_name     ):
    """
    Link a named filter to a destination endpoint.
...
def helicsCoreMakeConnections(core            , file     ):
    """
    Load a file containing connection information.
...
def helicsBrokerGetIdentifier(broker              )       :
    """
...
def helicsCoreGetIdentifier(core            )       :
    """
...
def helicsBrokerGetAddress(broker              )       :
    """
...
def helicsGetFederateByName(fed_name     )                  :
    """
...
def helicsBrokerDestroy(broker              ):
    """
...
def helicsCreateValueFederate(fed_name     , fi                     = None)                       :
    """
...
def helicsCreateValueFederateFromConfig(config_file     )                       :
    """
...
def helicsCreateMessageFederate(fed_name     , fi                     = None)                         :
    """
...
def helicsCreateMessageFederateFromConfig(config_file     )                         :
    """
...
def helicsCreateCombinationFederate(fed_name     , fi                     = None)                             :
    """
...
def helicsCreateCombinationFederateFromConfig(config_file     )                             :
    """
...
def helicsFederateInfoClone(fi                    )                      :
    """
...
def helicsFederateInfoLoadFromArgs(fi                    , arguments           ):
    """
...
def helicsFederateInfoLoadFromString(fi                    , arguments     ):
    """
...
def helicsFederateInfoSetCoreName(fi                    , core_name     ):
    """
...
def helicsFederateInfoSetCoreInitString(fi                    , core_init_string     ):
    """
...
def helicsFederateInfoSetBrokerInitString(fi                    , broker_init_string     ):
    """
...
def helicsFederateInfoSetCoreType(fi                    , core_type                ):
    """
...
def helicsFederateInfoSetCoreTypeFromString(fi                    , core_type     ):
    """
...
def helicsFederateInfoSetBroker(fi                    , broker_string     ):
    """
...
def helicsFederateInfoSetBrokerKey(fi                    , broker_key     ):
    """
...
def helicsFederateInfoSetBrokerPort(fi                    , broker_port                 ):
    """
...
def helicsFederateInfoSetLocalPort(fi                    , local_port                 ):
    """
...
def helicsGetPropertyIndex(value     )                  :
    """
...
def helicsGetOptionIndex(value     )                      :
    """
...
def helicsGetOptionValue(value     )       :
    """
...
def helicsFederateInfoSetFlagOption(fi                    , flag                                            , value      ):
    """
...
def helicsFederateInfoSetSeparator(fi                    , separator     ):
    """
...
def helicsFederateInfoSetTimeProperty(fi                    , time_property                , value            ):
    """
...
def helicsFederateInfoSetIntegerProperty(fi                    , property                , value     ):
    """
...
def helicsFederateRegisterInterfaces(fed                , file     ):
    """
...
def helicsFederateGlobalError(fed                , error_code     , error_string     ):
    """
...
def helicsBrokerGlobalError(broker              , error_code     , error_string     ):
...
def helicsCoreGlobalError(core            , error_code     , error_string     ):
...
def helicsFederateLocalError(fed                , error_code     , error_string     ):
    """
...
def helicsFederateFinalizeAsync(fed                ):
    """
...
def helicsFederateFinalizeComplete(fed                ):
    """
...
def helicsFederateDisconnectAsync(fed                ):
    """
...
def helicsFederateDisconnectComplete(fed                ):
    """
    Complete the asynchronous disconnect call.
    """
    if HELICS_VERSION == 2:
...
def helicsFederateEnterInitializingMode(fed                ):
    """
...
def helicsFederateEnterInitializingModeAsync(fed                ):
    """
...
def helicsFederateEnterInitializingModeComplete(fed                ):
    """
...
def helicsFederateEnterExecutingModeAsync(fed                ):
    """
    Request that the federate enter the Execution mode.
...
def helicsFederateEnterExecutingModeComplete(fed                ):
    """
...
def helicsFederateEnterExecutingModeIterative(fed                , iterate                        )                         :
    """
...
def helicsFederateEnterExecutingModeIterativeAsync(fed                , iterate                        ):
    """
...
def helicsFederateRequestTime(fed                , request_time            )              :
    """
...
def helicsFederateRequestTimeAdvance(fed                , time_delta            )              :
    """
    Request the next time for federate execution.
...
def helicsFederateRequestNextStep(fed                )              :
    """
...
def helicsFederateRequestTimeAsync(fed                , request_time            ):
    """
...
def helicsFederateRequestTimeIterativeAsync(fed                , request_time            , iterate                        ):
    """
...
def helicsFederateSetTimeProperty(fed                , time_property     , time            ):
    """
...
def helicsFederateSetFlagOption(fed                , flag                                            , value      ):
    """
...
def helicsFederateSetSeparator(fed                , separator     ):
    """
...
def helicsFederateSetIntegerProperty(fed                , property                , value     ):
    """
...
def helicsFederateGetTimeProperty(fed                , time_property     )              :
    """
...
def helicsFederateGetFlagOption(fed                , flag                                            )        :
    """
...
def helicsFederateGetIntegerProperty(fed                , property                )       :
    """
...
def helicsFederateSetGlobal(fed                , name     , value     ):
    """
...
def helicsFederateAddDependency(fed                , name     ):
    """
...
def helicsFederateSetLogFile(fed                , log_file     ):
    """
...
def helicsFederateLogErrorMessage(fed                , log_message     ):
    """
...
def helicsFederateLogWarningMessage(fed                , log_message     ):
    """
...
def helicsFederateLogInfoMessage(fed                , log_message     ):
    """
...
def helicsFederateLogDebugMessage(fed                , log_message     ):
    """
...
def helicsFederateLogLevelMessage(fed                , log_level                , log_message     ):
    """
...
def helicsCoreSetGlobal(core            , name     , value     ):
    """
...
def helicsBrokerSetGlobal(broker              , name     , value     ):
    """
    Set a federation global value.
    This overwrites any previous value for this name.
...
def helicsCoreSetLogFile(core            , log_file     ):
    """
...
def helicsBrokerSetLogFile(broker              , log_file     ):
    """
...
def helicsCreateQuery(target_name     , query_string     )               :
    """
...
def helicsQueryCoreExecute(query             , core            )            :
    """
...
def helicsQueryBrokerExecute(query             , broker              )            :
    """
...
def helicsQuerySetTarget(query             , target_name     ):
    """
...
def helicsQuerySetQueryString(query             , query_string     ):
    """
...
def helicsFederateGetEndpoint(fed                , name     )                  :
    """
...
def helicsFederateGetEndpointByIndex(fed                , index     )                  :
    """
...
def helicsEndpointIsValid(endpoint                )        :
    """
...
def helicsEndpointSetDefaultDestination(endpoint                , destination     ):
    """
...
def helicsEndpointGetDefaultDestination(endpoint                )       :
    """
    Get the default destination for an endpoint.
...
def helicsEndpointSendBytes(endpoint                , data       ):
    """
...
def helicsEndpointSendBytesTo(endpoint                , data       , destination     ):
    """
...
def helicsEndpointSendMessageRaw(endpoint                , destination     , data       ):
    """
    Send a message to the specified destination.
...
def helicsEndpointSendBytesToAt(endpoint                , data       , destination     , time            ):
    """
...
def helicsEndpointSendMessageObject(endpoint                , message               ):
    """
...
def helicsEndpointSendMessageObjectZeroCopy(endpoint                , message               ):
    """
    Send a message object from a specific endpoint.
...
def helicsEndpointSubscribe(endpoint                , name     ):
    """
...
def helicsFederatePendingMessageCount(fed                )       :
    """
...
def helicsFederatePendingMessages(fed                )       :
    """
    Returns the number of pending receives for the specified destination endpoint.
...
def helicsEndpointPendingMessages(endpoint                )       :
    """
...
def helicsEndpointPendingMessageCount(endpoint                )       :
    """
    Returns the number of pending receives for all endpoints of a particular federate.
...
def helicsEndpointGetMessageObject(endpoint                )                 :
    """
...
def helicsEndpointCreateMessageObject(endpoint                )                 :
    """
...
def helicsEndpointCreateMessage(endpoint                )                 :
    """
...
def helicsFederateGetMessageObject(fed                )                 :
    """
...
def helicsFederateCreateMessageObject(fed                )                 :
    """
    Create a new empty message object.
    The message is empty and isValid will return false since there is no data associated with the message yet.
...
def helicsFederateCreateMessage(fed                )                 :
    """
    Create a new empty message object.
    The message is empty and isValid will return false since there is no data associated with the message yet.
...
def helicsFederateClearMessages(fed                ):
    """
...
def helicsEndpointClearMessages(endpoint                ):
    """
...
def helicsEndpointGetType(endpoint                )       :
    """
...
def helicsEndpointGetName(endpoint                )       :
    """
...
def helicsEndpointGetInfo(endpoint                )       :
    """
...
def helicsEndpointSetInfo(endpoint                , info     ):
    """
...
def helicsPublicationGetTag(pub                   , tagname     ):
    """
...
def helicsPublicationSetTag(pub                   , tagname     , tagvalue     ):
    """
...
def helicsEndpointSetOption(endpoint                , option                    , value     ):
    """
...
def helicsEndpointGetOption(endpoint                , option                    )       :
    """
...
def helicsMessageGetSource(message               )       :
    """
...
def helicsMessageGetDestination(message               )       :
    """
...
def helicsMessageGetOriginalSource(message               )       :
    """
...
def helicsMessageGetOriginalDestination(message               )       :
    """
...
def helicsMessageGetTime(message               )              :
    """
...
def helicsMessageGetString(message               )       :
    """
...
def helicsMessageGetMessageID(message               )       :
    """
...
def helicsMessageGetFlagOption(message               , flag     )        :
    """
...
def helicsMessageCheckFlag(message               , flag     )        :
    """
...
def helicsMessageGetByteCount(message               )       :
    """
...
def helicsMessageGetRawDataSize(message               )       :
    """
    Get the size of the data payload in bytes.
...
def helicsMessageGetRawData(message               )         :
    """
...
def helicsMessageGetBytes(message               )         :
    """
    Get the raw data for a message object.
...
def helicsMessageGetRawDataPointer(message               )           :
    """
...
def helicsMessageGetBytesPointer(message               )           :
    """
    Get a pointer to the raw data of a message.
...
def helicsMessageIsValid(message               )        :
    """
...
def helicsMessageSetSource(message               , source     ):
    """
...
def helicsMessageSetDestination(message               , destination     ):
    """
...
def helicsMessageSetOriginalSource(message               , source     ):
    """
...
def helicsMessageSetOriginalDestination(message               , destination     ):
    """
...
def helicsMessageSetTime(message               , time            ):
    """
...
def helicsMessageResize(message               , new_size     ):
    """
...
def helicsMessageReserve(message               , reserve_size     ):
    """
...
def helicsMessageSetMessageID(message               , message_id     ):
    """
...
def helicsMessageClearFlags(message               ):
    """
...
def helicsMessageSetFlagOption(message               , flag     , value      ):
    """
...
def helicsMessageSetString(message               , string     ):
    """
...
def helicsMessageSetData(message               , data       ):
    """
...
def helicsMessageAppendData(message               , data       ):
    """
...
def helicsMessageCopy(source_message               , destination_message               ):
    """
...
def helicsMessageClone(message               )                 :
    """
...
def helicsFederateRegisterFilter(fed                , type                  , name     )                :
    """
...
def helicsFederateRegisterGlobalFilter(fed                , type                  , name     )                :
    """
...
def helicsFederateRegisterCloningFilter(fed                , name     )                       :
    """
    Create a cloning Filter on the specified federate.
    Cloning filters copy a message and send it to multiple locations, source and destination can be added through other functions.
...
def helicsFederateRegisterGlobalCloningFilter(fed                , name     )                       :
    """
...
def helicsCoreRegisterFilter(core            , type                  , name     )                :
    """
...
def helicsCoreRegisterCloningFilter(core            , name     )                       :
    """
...
def helicsFederateGetFilterCount(fed                )       :
    """
...
def helicsFederateGetFilter(fed                , name     )                :
    """
...
def helicsFederateGetFilterByIndex(fed                , index     )                :
    """
...
def helicsFilterIsValid(filter              )        :
    """
...
def helicsFilterGetName(filter              )       :
    """
...
def helicsFilterSet(filter              , property     , value       ):
    """
    Set a property on a filter.
...
def helicsFilterSetString(filter              , property     , value     ):
    """
...
def helicsFilterAddDestinationTarget(filter              , destination     ):
    """
...
def helicsFilterAddSourceTarget(filter              , source_name     ):
    """
...
def helicsFilterAddDeliveryEndpoint(filter              , delivery_endpoint     ):
    """
...
def helicsFilterRemoveTarget(filter              , target_name     ):
    """
...
def helicsFilterRemoveDeliveryEndpoint(filter              , delivery_endpoint     ):
    """
...
def helicsFilterGetInfo(filter              )       :
    """
    Get the data in the info field of a filter.
...
def helicsFilterSetInfo(filter              , info     ):
    """
    Set the data in the info field for a filter
...
def helicsFilterSetOption(filter              , option                    , value     ):
    """
    Set the data in the info field for a filter.
...
def helicsFilterGetOption(filter                     , option                    )       :
    """
...
def helicsFederateRegisterSubscription(fed                , name     , units      = "")               :
    """
...
def helicsFederateRegisterPublication(fed                , name     , type                , units     )                     :
    """
...
def helicsFederateRegisterTypePublication(fed                , name     , type     , units     )                     :
    """
...
def helicsFederateRegisterGlobalPublication(fed                , name     , type                , units      = "")                     :
    """
...
def helicsFederateRegisterGlobalTypePublication(fed                , name     , type     , units     )                     :
    """
...
def helicsFederateRegisterInput(fed                , name     , type                , units     )               :
    """
...
def helicsFederateRegisterTypeInput(fed                , name     , type     , units     )               :
    """
...
def helicsFederateRegisterGlobalInput(fed                , name     , type                , units     )                     :
    """
...
def helicsFederateRegisterGlobalTypeInput(fed                , name     , type     , units     )               :
    """
...
def helicsFederateGetPublication(fed                , name     )                     :
    """
...
def helicsFederateGetPublicationByIndex(fed                , index     )                     :
    """
...
def helicsFederateGetInput(fed                , name     )               :
    """
...
def helicsFederateGetInputByIndex(fed                , index     )               :
    """
...
def helicsFederateGetSubscription(fed                , name     )               :
    """
...
def helicsFederateClearUpdates(fed                ):
    """
...
def helicsFederateRegisterFromPublicationJSON(fed                , json     ):
    """
...
def helicsFederatePublishJSON(fed                , json     ):
    """
...
def helicsPublicationIsValid(pub                   )        :
    """
...
def helicsPublicationPublishRaw(pub                   , data       ):
    """
...
def helicsPublicationPublishBytes(pub                   , data       ):
    """
    Publish raw data from a char * and length.
...
def helicsPublicationPublishString(pub                   , string     ):
    """
    Publish a string.
...
def helicsPublicationPublishInteger(pub                   , value     ):
    """
...
def helicsPublicationPublishBoolean(pub                   , value      ):
    """
    Publish a Boolean Value.
...
def helicsPublicationPublishDouble(pub                   , value       ):
    """
...
def helicsPublicationPublishTime(pub                   , value            ):
    """
...
def helicsPublicationPublishChar(pub                   , value     ):
    """
...
def helicsPublicationPublishComplex(pub                   , real       , imag        = 0):
    """
...
def helicsPublicationPublishNamedPoint(pub                   , string     , value       ):
    """
...
def helicsPublicationAddTarget(pub                   , target_name     ):
    """
...
def helicsInputAddTarget(ipt             , target_name     ):
    """
...
def helicsInputGetRawValueSize(ipt             )       :
    """
...
def helicsInputGetByteCount(ipt             )       :
    """
    Data can be returned in a number of formats,  for instance if data is published as a double it can be returned as a string and vice versa,  not all translations make that much sense but they do work.
    Get the size of the raw value for subscription.
...
def helicsInputGetStringSize(ipt             )       :
    """
...
def helicsInputGetComplexObject(ipt             )                       :
    """
...
def helicsInputGetVectorSize(ipt             )       :
    """
...
def helicsInputGetNamedPoint(ipt             )                     :
    """
...
def helicsInputSetDefaultRaw(ipt             , data       ):
    """
...
def helicsInputSetDefaultBytes(ipt             , data       ):
    """
...
def helicsInputSetDefaultString(ipt             , string     ):
    """
...
def helicsInputSetDefaultInteger(ipt             , value     ):
    """
...
def helicsInputSetDefaultBoolean(ipt             , value      ):
    """
...
def helicsInputSetDefaultTime(ipt             , value            ):
    """
...
def helicsInputSetDefaultChar(ipt             , value     ):
    """
...
def helicsInputSetDefaultDouble(ipt             , value       ):
    """
...
def helicsInputSetDefaultComplex(ipt             , real       , imag        = 0):
    """
...
def helicsInputSetDefaultVector(ipt             , vectorInput             ):
    """
...
def helicsInputSetDefaultNamedPoint(ipt             , string     , value       ):
    """
...
def helicsInputGetPublicationType(ipt             )       :
    """
...
def helicsPublicationGetType(pub                   )       :
    """
...
def helicsSubscriptionGetKey(ipt             )       :
    """
...
def helicsSubscriptionGetTarget(ipt             )       :
    """
...
def helicsPublicationGetKey(pub                   )       :
    """
...
def helicsInputGetInjectionUnits(ipt             )       :
    """
...
def helicsInputGetExtractionUnits(ipt             )       :
    """
    Get the units of an input.
...
def helicsPublicationGetUnits(pub                   )       :
    """
...
def helicsInputSetInfo(ipt             , info     ):
    """
...
def helicsPublicationGetInfo(pub                   )       :
    """
...
def helicsPublicationSetInfo(pub                   , info     ):
    """
...
def helicsInputGetOption(ipt             , option                    )       :
    """
...
def helicsInputSetOption(ipt             , option                    , value     ):
    """
...
def helicsPublicationGetOption(pub                   , option                    )       :
    """
...
def helicsPublicationSetOption(pub                   , option                    , value     ):
    """
...
def helicsPublicationSetMinimumChange(pub                   , tolerance       ):
    """
...
def helicsInputSetMinimumChange(ipt             , tolerance       ):
    """
    Set the minimum change detection tolerance.
...
def helicsInputLastUpdateTime(ipt             )              :
    """
...
def helicsInputClearUpdate(ipt             ):
    """
...
def helicsFederateSetLoggingCallback(fed                , logger, user_data):
    """
...
def helicsFilterSetCustomCallback(filter              , callback, userdata):
...
def helicsBrokerClearTimeBarrier(broker              ):
    f = loadSym("helicsBrokerClearTimeBarrier")
    f(broker.handle)


def helicsBrokerSetTimeBarrier(broker              , barrier_time            ):
    """
...
def helicsFederateSendCommand(fed                , target     , command     ):
...
def helicsFederateGetCommand(fed                )       :
...
def helicsFederateGetCommandSource(fed                )       :
...
def helicsFederateWaitCommand(fed                )       :
...
def helicsFederateRegisterTargetedEndpoint(fed                , name     , type     ):
    """
...
def helicsFederateRegisterGlobalTargetedEndpoint(fed                , name     , type     ):
    """
...
def helicsEndpointAddSourceTarget(endpoint                , source_name     ):
    """
...
def helicsEndpointAddDestinationTarget(endpoint                , destination_name     ):
    """
...
def helicsEndpointRemoveTarget(endpoint                , target     ):
    """
...
def helicsEndpointAddSourceFilter(endpoint                , filter_name     ):
    """
...
def helicsEndpointAddDestinationFilter(endpoint                , filter_name     ):
    """
...
def helicsQuerySetOrdering(query             , mode     ):
    """
...
def helicsAbort(error_code     , message     ):
...
try:
    ...
    def _handle_helicsCallBack(code     ):
        def target():
