...
setup(name='dsbox-primitives',
      ...
      author='USC ISI',
      url='https://gitlab.com/datadrivendiscovery/contrib/dsbox-primitives.git',
      ...
      packages=[
                ...
                'dsbox.datapreprocessing.cleaner.dependencies',
                ...
                'dsbox.datapreprocessing.featurizer.image.yolo_utils',
                'dsbox.datapreprocessing.featurizer.image.yolo_utils.core',
                'dsbox.datapreprocessing.featurizer.pass',
                'dsbox.datapreprocessing.featurizer.timeseries'
               ],
      package_data={
          'dsbox.datapreprocessing.cleaner': ['data_sample/sample1.csv', 'data_sample/sample2.csv'],
          'dsbox.datapreprocessing.featurizer.image.yolo_utils.core': [
              'data/anchors/basline_anchors.txt',
              'data/classes/test.names',
              'data/dataset/test_test.txt',
              'data/dataset/test.txt',
              'data/dataset/yymnist_test.txt',
          ],
          'dsbox.datapreprocessing.featurizer.image': ['yolov3.cfg'],
      },
      zip_safe=False,
      python_requires='>=3.6',
