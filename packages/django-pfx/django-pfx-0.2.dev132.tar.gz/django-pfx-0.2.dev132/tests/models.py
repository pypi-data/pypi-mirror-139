...
from pfx.pfxcore.models import CacheableMixin, CacheDependsMixin, JSONReprMixin
...
class BookType(CacheDependsMixin, JSONReprMixin, models.Model):
...
class Book(CacheDependsMixin, JSONReprMixin, models.Model):
