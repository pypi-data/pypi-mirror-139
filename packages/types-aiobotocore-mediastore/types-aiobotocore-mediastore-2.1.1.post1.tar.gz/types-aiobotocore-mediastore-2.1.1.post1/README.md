...
[aiobotocore.MediaStore 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mediastore.html#MediaStore)
...
[types-aiobotocore-mediastore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore/)

See how it helps to find and fix potential bugs:

![boto3-stubs demo](https://github.com/vemel/mypy_boto3_builder/raw/main/demo.gif)

- [types-aiobotocore-mediastore](#types-aiobotocore-mediastore)
...
- Install `types-aiobotocore[mediastore]` in your environment:
...
- Install `types-aiobotocore[mediastore]` with services you use in your
  environment:
...
`types_aiobotocore_mediastore.literals` module contains literals extracted from shapes
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore/)
