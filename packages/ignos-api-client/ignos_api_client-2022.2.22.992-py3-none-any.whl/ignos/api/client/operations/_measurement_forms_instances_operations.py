...
def build_get_measurement_form_instance_schema_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    sequence = kwargs.pop('sequence', None)  # type: Optional[str]
    tenant_id = kwargs.pop('tenant_id', None)  # type: Optional[str]
    ...
    if sequence is not None:
        _query_parameters['sequence'] = _SERIALIZER.query("sequence", sequence, 'str')
    if tenant_id is not None:
        _query_parameters['tenantId'] = _SERIALIZER.query("tenant_id", tenant_id, 'str')
...
def build_get_audit_log_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    tenant_id = kwargs.pop('tenant_id', None)  # type: Optional[str]
    schema_id = kwargs.pop('schema_id', None)  # type: Optional[str]
    sequence = kwargs.pop('sequence', None)  # type: Optional[str]
    element_id = kwargs.pop('element_id', None)  # type: Optional[str]
    ...
    if schema_id is not None:
        _query_parameters['schemaId'] = _SERIALIZER.query("schema_id", schema_id, 'str')
    if sequence is not None:
        _query_parameters['sequence'] = _SERIALIZER.query("sequence", sequence, 'str')
    if element_id is not None:
        _query_parameters['elementId'] = _SERIALIZER.query("element_id", element_id, 'str')
...
class MeasurementFormsInstancesOperations(object):
    """MeasurementFormsInstancesOperations operations.
