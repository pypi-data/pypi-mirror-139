...
def build_get_machine_utilizations_request(
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    asset_id = kwargs.pop('asset_id', None)  # type: Optional[int]
    favorites = kwargs.pop('favorites', False)  # type: Optional[bool]
    ...
    if asset_id is not None:
        _query_parameters['assetId'] = _SERIALIZER.query("asset_id", asset_id, 'long')
    if favorites is not None:
        _query_parameters['favorites'] = _SERIALIZER.query("favorites", favorites, 'bool')
...
def build_get_utilization_data_point_for_machine_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    start_time = kwargs.pop('start_time', None)  # type: Optional[datetime.datetime]
...
class MachineUtilizationOperations(object):
    """MachineUtilizationOperations operations.
