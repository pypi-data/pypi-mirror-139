...
def build_list_customers_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers")
...
def build_get_customer_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/{id}")
...
def build_list_customer_tenants_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/{id}/tenants")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
    }
...
def build_update_tenant_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/{id}/tenants/{tenantId}")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
...
def build_get_cdf_config_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/{id}/tenants/{tenantId}/config")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
        "tenantId": _SERIALIZER.url("tenant_id", tenant_id, 'str'),
    }
...
def build_list_customer_apps_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/{id}/apps")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
    }
...
def build_list_tenants_details_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/tenants/details")

    # Construct parameters
    _query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    if tenant_id_prefix is not None:
        _query_parameters['tenantIdPrefix'] = _SERIALIZER.query("tenant_id_prefix", tenant_id_prefix, 'str')
    if app_id is not None:
        _query_parameters['appId'] = _SERIALIZER.query("app_id", app_id, 'str')
...
def build_add_customer_app_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/{id}/apps/{appId}")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
...
def build_list_tenant_keys_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/admin/customers/tenantkeys")
