...
from ...operations._countries_operations import build_list_countries_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class CountriesOperations:
    """CountriesOperations async operations.
    ...
    async def list_countries(
        self,
        **kwargs: Any
    ) -> List["_models.CountryDto"]:
        """list_countries.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: list of CountryDto, or the result of cls(response)
    ...
    list_countries.metadata = {'url': "/countries"}  # type: ignore
