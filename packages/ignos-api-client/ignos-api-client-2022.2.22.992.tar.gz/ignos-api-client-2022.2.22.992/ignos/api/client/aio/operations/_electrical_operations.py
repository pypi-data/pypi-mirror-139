...
from ...operations._electrical_operations import build_create_electrical_iot_config_request, build_delete_electrical_iot_config_request, build_list_electrical_data_configs_request, build_list_electrical_source_types_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ElectricalOperations:
    """ElectricalOperations async operations.
    ...
    async def list_electrical_source_types(
        self,
        **kwargs: Any
    ...
    async def list_electrical_data_configs(
        self,
        **kwargs: Any
    ) -> List["_models.ElectricalIotConfigDto"]:
