...
def build_list_measurment_form_schemas_request(
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    page_size = kwargs.pop('page_size', 50)  # type: Optional[int]
    customer_id = kwargs.pop('customer_id', None)  # type: Optional[str]
    part_number = kwargs.pop('part_number', None)  # type: Optional[str]
    part_revision = kwargs.pop('part_revision', None)  # type: Optional[str]
    drawing = kwargs.pop('drawing', None)  # type: Optional[str]
    drawing_revision = kwargs.pop('drawing_revision', None)  # type: Optional[str]
    ...
    if customer_id is not None:
        _query_parameters['customerId'] = _SERIALIZER.query("customer_id", customer_id, 'str')
    if part_number is not None:
        _query_parameters['partNumber'] = _SERIALIZER.query("part_number", part_number, 'str')
    if part_revision is not None:
        _query_parameters['partRevision'] = _SERIALIZER.query("part_revision", part_revision, 'str')
    if drawing is not None:
        _query_parameters['drawing'] = _SERIALIZER.query("drawing", drawing, 'str')
    if drawing_revision is not None:
        _query_parameters['drawingRevision'] = _SERIALIZER.query("drawing_revision", drawing_revision, 'str')
...
class MeasurementFormSchemasOperations(object):
    """MeasurementFormSchemasOperations operations.
