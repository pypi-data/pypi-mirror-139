...
class IgnosPortal:    # pylint: disable=too-many-instance-attributes
    """IgnosPortal.

    :ivar apps: AppsOperations operations
    :vartype apps: ignos.api.client.aio.operations.AppsOperations
    ...
    :vartype cdf_clusters: ignos.api.client.aio.operations.CdfClustersOperations
    ...
    :vartype databases: ignos.api.client.aio.operations.DatabasesOperations
    ...
    :vartype user: ignos.api.client.aio.operations.UserOperations
