...
def build_list_measuring_tools_request(
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    page = kwargs.pop('page', None)  # type: Optional[int]
    page_size = kwargs.pop('page_size', 100)  # type: Optional[int]
    tool_id = kwargs.pop('tool_id', None)  # type: Optional[str]
    tool_name = kwargs.pop('tool_name', None)  # type: Optional[str]
    type_id = kwargs.pop('type_id', None)  # type: Optional[str]
    sub_type_id = kwargs.pop('sub_type_id', None)  # type: Optional[str]
    order_by = kwargs.pop('order_by', None)  # type: Optional[str]
    sort_direction = kwargs.pop('sort_direction', None)  # type: Optional[str]
    include_deprecated = kwargs.pop('include_deprecated', False)  # type: Optional[bool]
    ...
    if page is not None:
        _query_parameters['page'] = _SERIALIZER.query("page", page, 'int')
    if page_size is not None:
        _query_parameters['pageSize'] = _SERIALIZER.query("page_size", page_size, 'int')
    if tool_id is not None:
        _query_parameters['toolId'] = _SERIALIZER.query("tool_id", tool_id, 'str')
    if tool_name is not None:
        _query_parameters['toolName'] = _SERIALIZER.query("tool_name", tool_name, 'str')
    if type_id is not None:
        _query_parameters['typeId'] = _SERIALIZER.query("type_id", type_id, 'str')
    if sub_type_id is not None:
        _query_parameters['subTypeId'] = _SERIALIZER.query("sub_type_id", sub_type_id, 'str')
    if order_by is not None:
        _query_parameters['orderBy'] = _SERIALIZER.query("order_by", order_by, 'str')
    if sort_direction is not None:
        _query_parameters['sortDirection'] = _SERIALIZER.query("sort_direction", sort_direction, 'str')
    if include_deprecated is not None:
        _query_parameters['includeDeprecated'] = _SERIALIZER.query("include_deprecated", include_deprecated, 'bool')
...
def build_get_calibration_list_request(
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    status = kwargs.pop('status', None)  # type: Optional[Union[str, "_models.CalibrationListStatus"]]
...
class MeasuringToolsOperations(object):  # pylint: disable=too-many-public-methods
    """MeasuringToolsOperations operations.
    ...
    def list_measuring_tools(
        ...
        include_deprecated=False,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
