...
def build_list_welding_source_types_request(
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/iot/welding/sourcetypes")
...
def build_list_electrical_data_configs_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/iot/welding")
...
def build_create_welding_iot_config_request(
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_delete_welding_iot_config_request(
    type_id,  # type: str
    id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    # Construct URL
    _url = kwargs.pop("template_url", "/iot/welding/{typeId}/{id}")
...
# fmt: on
class WeldingOperations(object):
    """WeldingOperations operations.
    ...
    @distributed_trace
    def delete_welding_iot_config(  # pylint: disable=inconsistent-return-statements
        self,
        type_id,  # type: str
        id,  # type: str
        **kwargs  # type: Any
