...
def get_request_extra_data(
    ...
    root_action: str = Header(None, alias="x-root-action"),
    user_id: str = Header(None, alias="x-user-id"),
    transaction_id: str = Header(None, alias="x-transaction-id"),
    span_id: str = Header(None, alias="x-span-id"),
):
    return {
        ...
        "current_action": str(request.url.path),
