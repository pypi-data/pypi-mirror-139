...
def main_txt(input_event, input_station, output_event=None,
             output_station=None, input_tt=None, output_tt_template=None):
    ...
    if (input_tt is not None) and (output_tt_template is not None):
        ...
        for tt_table in ttdata.splitUnique(evdata.index, stdata.index,
...
def read_in_one_file(input, output_event=None, output_station=None,
