...
class RelationshipDefinitionsApi(object):
    ...
    def delete_relationship_definition(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteRelationshipDefinition: Delete Relationship Definition  # noqa: E501
        ...
        :param scope: The scope of the relationship to be deleted. (required)
        :type scope: str
        :param code: The code of the relationship to be deleted. Together with the domain and scope this uniquely              identifies the relationship. (required)
        :type code: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
