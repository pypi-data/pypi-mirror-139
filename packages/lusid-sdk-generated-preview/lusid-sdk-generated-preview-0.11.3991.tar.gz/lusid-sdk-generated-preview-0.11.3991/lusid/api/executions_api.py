...
class ExecutionsApi(object):
    ...
    def delete_execution(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteExecution: Delete execution  # noqa: E501
    ...
    def delete_execution_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_execution`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_execution(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetExecution: Get Execution  # noqa: E501
    ...
    def get_execution_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `get_execution`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_executions(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ListExecutions: List Executions  # noqa: E501
    ...
    def list_executions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PagedResourceListOfExecution, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def upsert_executions(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpsertExecutions: Upsert Execution  # noqa: E501
    ...
    def upsert_executions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ResourceListOfExecution, status_code(int), headers(HTTPHeaderDict))
        """
