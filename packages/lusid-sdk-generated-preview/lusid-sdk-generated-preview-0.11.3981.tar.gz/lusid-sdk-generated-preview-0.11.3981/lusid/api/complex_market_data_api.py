...
class ComplexMarketDataApi(object):
    ...
    def list_complex_market_data(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_complex_market_data_with_http_info(**kwargs)  # noqa: E501

    def list_complex_market_data_with_http_info(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ListComplexMarketData: List the set of ComplexMarketData  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_complex_market_data" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
