...
class ReconciliationsApi(object):
    ...
    def reconcile_holdings_preview(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ReconcileHoldingsPreview: Reconcile portfolio holdings with given tolerance  # noqa: E501
        ...
        :type filter: str
        :param portfolios_reconciliation_request_preview: The specifications of the inputs to the reconciliation. This request can take tolerance for units and cost.
        :type portfolios_reconciliation_request_preview: PortfoliosReconciliationRequestPreview
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def reconcile_holdings_preview_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = [
            ...
            'limit',
            'filter',
            'portfolios_reconciliation_request_preview'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
                                                        len(local_var_params['filter']) > 16384):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `reconcile_holdings_preview`, length must be less than or equal to `16384`")  # noqa: E501
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
                                                        len(local_var_params['filter']) < 0):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `reconcile_holdings_preview`, length must be greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'filter' in local_var_params and not re.search(r'^[\s\S]*$', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `reconcile_holdings_preview`, must conform to the pattern `/^[\s\S]*$/`")  # noqa: E501
        collection_formats = {}
