...
class toolkit(object):
    ...
    def validatePAE(self, data: "std::string const &") -> "std::string":
        return _verovio.toolkit_validatePAE(self, data)

    def getPageCount(self) -> "int":
        return _verovio.toolkit_getPageCount(self)

    def getAvailableOptions(self) -> "std::string":
        return _verovio.toolkit_getAvailableOptions(self)

    def setOptions(self, jsonOptions: "std::string const &") -> "bool":
        return _verovio.toolkit_setOptions(self, jsonOptions)

    def getOption(self, option: "std::string const &", defaultValue: "bool"=False) -> "std::string":
        return _verovio.toolkit_getOption(self, option, defaultValue)

    def setOption(self, option: "std::string const &", value: "std::string const &") -> "bool":
    ...
    def edit(self, editorAction: "std::string const &") -> "bool":
        return _verovio.toolkit_edit(self, editorAction)

    def editInfo(self) -> "std::string":
    ...
    def renderToTimemap(self, *args) -> "std::string":
        return _verovio.toolkit_renderToTimemap(self, *args)

    def renderToTimemapFile(self, *args) -> "bool":
        return _verovio.toolkit_renderToTimemapFile(self, *args)
    ...
    def getMEI(self, *args) -> "std::string":
        return _verovio.toolkit_getMEI(self, *args)

    def saveFile(self, *args) -> "bool":
        return _verovio.toolkit_saveFile(self, *args)

    def getDescriptiveFeatures(self, options: "std::string const &") -> "std::string":
        return _verovio.toolkit_getDescriptiveFeatures(self, options)

    def getElementsAtTime(self, millisec: "int") -> "std::string":
    ...
    def getElementAttr(self, xmlId: "std::string const &") -> "std::string":
    ...
    def getExpansionIdsForElement(self, xmlId: "std::string const &") -> "std::string":
    ...
    def getMIDIValuesForElement(self, xmlId: "std::string const &") -> "std::string":
        return _verovio.toolkit_getMIDIValuesForElement(self, xmlId)

    def getTimesForElement(self, xmlId: "std::string const &") -> "std::string":
        return _verovio.toolkit_getTimesForElement(self, xmlId)

    def redoLayout(self, *args) -> "void":
        return _verovio.toolkit_redoLayout(self, *args)
    ...
    def getOptions(self, *args) -> "Options *":
