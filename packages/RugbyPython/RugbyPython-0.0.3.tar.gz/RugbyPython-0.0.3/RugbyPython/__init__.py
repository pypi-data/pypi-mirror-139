def pitch(ax='ax', pitchcolor = 'white', linecolor='Black', poles=False, linestyle='--', labels=False, labelalpha=0.5, shadows=False, linealpha=0.2):
    ...
    ax.add_patch(Rectangle((0, 0), 100, 70, fc = pitchcolor))
...
def leaguepitch(ax='ax', pitchcolor = 'white', linecolor='Black', poles=False, linestyle='--', labels=False, labelalpha=0.5, shadows=False, linealpha=0.2):
    ...
    ax.add_patch(Rectangle((0, 0), 100, 68, fc = pitchcolor))
    
    halfway = plt.vlines(50, 0, 68, color, alpha=1)
    bottom = plt.hlines(0, 0, 100, color)
    top = plt.hlines(68, 0, 100, color)
    
    forty1 = plt.vlines(60, 0, 68, color, '-', alpha=linealpha)
    forty2 = plt.vlines(40, 0, 68, color, '-', alpha=linealpha)
    thirty1 = plt.vlines(30, 0, 68, color, '-', alpha=linealpha)
    thirty2 = plt.vlines(70, 0, 68, color, '-', alpha=linealpha)
    twenty1 = plt.vlines(20, 0, 68, color, '-', alpha=linealpha)
    twenty2 = plt.vlines(80, 0, 68, color, '-', alpha=linealpha)
    ten1 = plt.vlines(10, 0, 68, color, '-', alpha=linealpha)
    ten2 = plt.vlines(90, 0, 68, color, '-', alpha=linealpha)
    ...
    if linestyle == '--':
        ...
        hfivea = plt.hlines(58, 7, 13, color, '-', alpha=0.5)
        hfiveb = plt.hlines(58, 17, 23, color, '-', alpha=0.5)
        hfivec = plt.hlines(58, 27, 33, color, '-', alpha=0.5)
        hfived = plt.hlines(58, 37, 43, color, '-', alpha=0.5)
        hfivee = plt.hlines(58, 47, 53, color, '-', alpha=0.5)
        hfivef = plt.hlines(58, 57, 63, color, '-', alpha=0.5)
        hfiveg = plt.hlines(58, 67, 73, color, '-', alpha=0.5)
        hfiveh = plt.hlines(58, 77, 83, color, '-', alpha=0.5)
        hfivei = plt.hlines(58, 87, 93, color, '-', alpha=0.5)
        
        hfivea = plt.hlines(51, 7, 13, color, '-', alpha=0.5)
        hfiveb = plt.hlines(51, 17, 23, color, '-', alpha=0.5)
        hfivec = plt.hlines(51, 27, 33, color, '-', alpha=0.5)
        hfived = plt.hlines(51, 37, 43, color, '-', alpha=0.5)
        hfivee = plt.hlines(51, 47, 53, color, '-', alpha=0.5)
        hfivef = plt.hlines(51, 57, 63, color, '-', alpha=0.5)
        hfiveg = plt.hlines(51, 67, 73, color, '-', alpha=0.5)
        hfiveh = plt.hlines(51, 77, 83, color, '-', alpha=0.5)
        hfivei = plt.hlines(51, 87, 93, color, '-', alpha=0.5)
        
    if linestyle != '-' and linestyle != '--':
        print("Error, five line type not found, please use: - or --")
    
    end1 = plt.vlines(0, 0, 68, color)
    end2 = plt.vlines(100, 0, 68, color)
...
def vertpitch(ax='ax', pitchcolor = 'white', linecolor='Black', poles=False, linestyle='--', labels=False, labelalpha=0.5, shadows=False, linealpha=0.2):
    ...
    ax.add_patch(Rectangle((0, 0), 70, 100, fc = pitchcolor))
    ...
    if poles == True:
            ...
            polesb = plt.hlines(0, 30, 40, color, '-', alpha=1, linewidth=5)
