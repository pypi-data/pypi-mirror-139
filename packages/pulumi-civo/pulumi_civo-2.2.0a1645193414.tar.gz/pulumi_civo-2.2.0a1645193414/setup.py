...
VERSION = "2.2.0a1645193414"
PLUGIN_VERSION = "2.2.0-alpha.1645193414+4544f847"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the civo resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource civo {PLUGIN_VERSION}`
                """)
            else:
                raise
