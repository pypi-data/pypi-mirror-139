...
def PlotMap(
    ...
    """
    fig = plt.figure(figureNum, figsize=FigSize, facecolor=("#FFFFFF"))
    ax = fig.gca()
    if countrycode != None:
        print(TM_Borders_filename) 
        if TM_Borders_filename == None:
            TM_Borders_filename=pkg_resources.resource_filename(__name__,'/../data/TM_WORLD_BORDERS-0.3.shp')
            print(TM_Borders_filename)
