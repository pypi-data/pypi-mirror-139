...
import assembly_client.api.node_api_client, assembly_client.api.network_syncer
...
class NetworkClient():
    ...
    def reset(self, txe_protocol=12, sympl_version=8):
        """
    ...
    def refresh_config(self, network_config_path):
        ...
        from assembly_client.node_client import NodeSession
