...
[boto3 1.21.4](https://boto3.amazonaws.com/v1/documentation/api/1.21.4/index.html)
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/)
...
- `boto3-stubs-lite[all]` - Type annotations for all 299 services.
