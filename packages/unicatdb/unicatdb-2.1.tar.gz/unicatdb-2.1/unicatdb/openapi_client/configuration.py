...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://localhost:5100" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("unicatdb.openapi_client")
    ...
    def get_host_settings(self):
        ...
        return [
            ...
            {
                'url': "https://api.test.unicatdb.org",
                'description': "Staging",
            },
            {
                'url': "https://api.unicatdb.org",
