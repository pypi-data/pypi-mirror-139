...
class ExistingTenantRequestBody(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """ExistingTenantRequestBody - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ExistingTenantRequestBody.  # noqa: E501

        Friendly name  # noqa: E501

        :return: The name of this ExistingTenantRequestBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ExistingTenantRequestBody.

        Friendly name  # noqa: E501

        :param name: The name of this ExistingTenantRequestBody.  # noqa: E501
        :type name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExistingTenantRequestBody):
            return False
