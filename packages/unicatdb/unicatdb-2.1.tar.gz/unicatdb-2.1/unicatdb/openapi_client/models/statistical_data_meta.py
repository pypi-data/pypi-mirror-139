...
class StatisticalDataMeta(object):
    ...
    def __init__(self, invalid_count=None, local_vars_configuration=None):  # noqa: E501
        """StatisticalDataMeta - a model defined in OpenAPI"""  # noqa: E501
    ...
    def invalid_count(self):
        """Gets the invalid_count of this StatisticalDataMeta.  # noqa: E501

        Number of filtered items with invalid non-numeric type  # noqa: E501

        :return: The invalid_count of this StatisticalDataMeta.  # noqa: E501
        :rtype: int
        """
    ...
    def invalid_count(self, invalid_count):
        """Sets the invalid_count of this StatisticalDataMeta.

        Number of filtered items with invalid non-numeric type  # noqa: E501

        :param invalid_count: The invalid_count of this StatisticalDataMeta.  # noqa: E501
        :type invalid_count: int
        """
        if self.local_vars_configuration.client_side_validation and invalid_count is None:  # noqa: E501
            raise ValueError("Invalid value for `invalid_count`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatisticalDataMeta):
            return False
