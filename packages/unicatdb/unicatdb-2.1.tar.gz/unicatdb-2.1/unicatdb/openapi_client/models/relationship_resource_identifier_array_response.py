...
class RelationshipResourceIdentifierArrayResponse(object):
    ...
    """
    openapi_types = {
        'data': 'list[RelationshipResourceIdentifier]'
    }
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """RelationshipResourceIdentifierArrayResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this RelationshipResourceIdentifierArrayResponse.  # noqa: E501


        :return: The data of this RelationshipResourceIdentifierArrayResponse.  # noqa: E501
        :rtype: list[RelationshipResourceIdentifier]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this RelationshipResourceIdentifierArrayResponse.


        :param data: The data of this RelationshipResourceIdentifierArrayResponse.  # noqa: E501
        :type data: list[RelationshipResourceIdentifier]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RelationshipResourceIdentifierArrayResponse):
            return False
