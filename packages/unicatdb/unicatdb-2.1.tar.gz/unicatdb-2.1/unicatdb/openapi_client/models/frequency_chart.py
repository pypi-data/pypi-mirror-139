...
class FrequencyChart(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """FrequencyChart - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this FrequencyChart.  # noqa: E501


        :return: The data of this FrequencyChart.  # noqa: E501
        :rtype: list[FrequencyChartItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this FrequencyChart.


        :param data: The data of this FrequencyChart.  # noqa: E501
        :type data: list[FrequencyChartItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FrequencyChart):
            return False
