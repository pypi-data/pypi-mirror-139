...
class TenantUserRole(object):
    ...
    allowable_values = [INACTIVE, GUEST, COLLABORATOR, OWNER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TenantUserRole - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TenantUserRole):
            return False
