...
class PageQuery(object):
    ...
    def __init__(self, number=None, size=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def number(self):
        """Gets the number of this PageQuery.  # noqa: E501


        :return: The number of this PageQuery.  # noqa: E501
        :rtype: int
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this PageQuery.


        :param number: The number of this PageQuery.  # noqa: E501
        :type number: int
        """
    ...
    @property
    def size(self):
        """Gets the size of this PageQuery.  # noqa: E501


        :return: The size of this PageQuery.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this PageQuery.


        :param size: The size of this PageQuery.  # noqa: E501
        :type size: int
        """
        if (self.local_vars_configuration.client_side_validation and
