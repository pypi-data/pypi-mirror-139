...
class FindingSchemaDefinitionGroup(object):
    ...
    openapi_types = {
        'name': 'str',
        'definitions': 'list[FindingSchemaElement]'
    }
    ...
    def __init__(self, name=None, definitions=None, local_vars_configuration=None):  # noqa: E501
        """FindingSchemaDefinitionGroup - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this FindingSchemaDefinitionGroup.  # noqa: E501


        :return: The name of this FindingSchemaDefinitionGroup.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FindingSchemaDefinitionGroup.


        :param name: The name of this FindingSchemaDefinitionGroup.  # noqa: E501
        :type name: str
        """
    ...
    def definitions(self):
        """Gets the definitions of this FindingSchemaDefinitionGroup.  # noqa: E501


        :return: The definitions of this FindingSchemaDefinitionGroup.  # noqa: E501
        :rtype: list[FindingSchemaElement]
        """
        return self._definitions

    @definitions.setter
    def definitions(self, definitions):
        """Sets the definitions of this FindingSchemaDefinitionGroup.


        :param definitions: The definitions of this FindingSchemaDefinitionGroup.  # noqa: E501
        :type definitions: list[FindingSchemaElement]
        """
        if self.local_vars_configuration.client_side_validation and definitions is None:  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FindingSchemaDefinitionGroup):
            return False
