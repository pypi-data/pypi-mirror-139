...
class ExistingFindingSchemaRequestBody(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """ExistingFindingSchemaRequestBody - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ExistingFindingSchemaRequestBody.  # noqa: E501


        :return: The data of this ExistingFindingSchemaRequestBody.  # noqa: E501
        :rtype: FindingSchemaResourceObject
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ExistingFindingSchemaRequestBody.


        :param data: The data of this ExistingFindingSchemaRequestBody.  # noqa: E501
        :type data: FindingSchemaResourceObject
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExistingFindingSchemaRequestBody):
            return False
