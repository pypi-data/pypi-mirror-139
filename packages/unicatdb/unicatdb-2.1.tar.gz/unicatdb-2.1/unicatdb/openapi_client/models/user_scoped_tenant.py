...
class UserScopedTenant(object):
    ...
    openapi_types = {
        'id': 'str',
        'name': 'str',
        'current_user_role': 'TenantUserRole'
    }
    ...
    def __init__(self, id=None, name=None, current_user_role=None, local_vars_configuration=None):  # noqa: E501
        """UserScopedTenant - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this UserScopedTenant.  # noqa: E501

        Tenant identifier - use this value in other tenant-aware endpoints  # noqa: E501

        :return: The id of this UserScopedTenant.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserScopedTenant.

        Tenant identifier - use this value in other tenant-aware endpoints  # noqa: E501

        :param id: The id of this UserScopedTenant.  # noqa: E501
        :type id: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this UserScopedTenant.  # noqa: E501

        Friendly name  # noqa: E501

        :return: The name of this UserScopedTenant.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UserScopedTenant.

        Friendly name  # noqa: E501

        :param name: The name of this UserScopedTenant.  # noqa: E501
        :type name: str
        """
    ...
    def current_user_role(self):
        """Gets the current_user_role of this UserScopedTenant.  # noqa: E501


        :return: The current_user_role of this UserScopedTenant.  # noqa: E501
    ...
    def current_user_role(self, current_user_role):
        """Sets the current_user_role of this UserScopedTenant.


        :param current_user_role: The current_user_role of this UserScopedTenant.  # noqa: E501
        :type current_user_role: TenantUserRole
        """
        if self.local_vars_configuration.client_side_validation and current_user_role is None:  # noqa: E501
            raise ValueError("Invalid value for `current_user_role`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserScopedTenant):
            return False
