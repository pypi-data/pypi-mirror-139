...
class FindingResourceObjectRelationships(object):
    ...
    def __init__(self, schema=None, attachments=None, local_vars_configuration=None):  # noqa: E501
        """FindingResourceObjectRelationships - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def schema(self):
        """Gets the schema of this FindingResourceObjectRelationships.  # noqa: E501


        :return: The schema of this FindingResourceObjectRelationships.  # noqa: E501
        :rtype: ResponseRelationshipOneToOne
        """
        return self._schema

    @schema.setter
    def schema(self, schema):
        """Sets the schema of this FindingResourceObjectRelationships.


        :param schema: The schema of this FindingResourceObjectRelationships.  # noqa: E501
        :type schema: ResponseRelationshipOneToOne
        """
    ...
    def attachments(self):
        """Gets the attachments of this FindingResourceObjectRelationships.  # noqa: E501


        :return: The attachments of this FindingResourceObjectRelationships.  # noqa: E501
        :rtype: ResponseRelationshipOneToMany
        """
        return self._attachments

    @attachments.setter
    def attachments(self, attachments):
        """Sets the attachments of this FindingResourceObjectRelationships.


        :param attachments: The attachments of this FindingResourceObjectRelationships.  # noqa: E501
        :type attachments: ResponseRelationshipOneToMany
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FindingResourceObjectRelationships):
            return False
