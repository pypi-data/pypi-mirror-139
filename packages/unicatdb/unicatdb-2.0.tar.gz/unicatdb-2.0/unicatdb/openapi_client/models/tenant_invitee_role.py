...
class TenantInviteeRole(object):
    ...
    allowable_values = [GUEST, COLLABORATOR, OWNER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TenantInviteeRole - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TenantInviteeRole):
            return False
