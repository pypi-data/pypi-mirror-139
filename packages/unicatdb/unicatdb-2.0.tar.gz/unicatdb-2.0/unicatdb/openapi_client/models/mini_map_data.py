...
class MiniMapData(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """MiniMapData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this MiniMapData.  # noqa: E501


        :return: The data of this MiniMapData.  # noqa: E501
        :rtype: list[MiniMapDataItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this MiniMapData.


        :param data: The data of this MiniMapData.  # noqa: E501
        :type data: list[MiniMapDataItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MiniMapData):
            return False
