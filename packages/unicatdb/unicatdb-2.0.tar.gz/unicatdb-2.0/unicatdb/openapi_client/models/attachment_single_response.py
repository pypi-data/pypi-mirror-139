...
class AttachmentSingleResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """AttachmentSingleResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this AttachmentSingleResponse.  # noqa: E501


        :return: The data of this AttachmentSingleResponse.  # noqa: E501
        :rtype: AttachmentResourceObject
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this AttachmentSingleResponse.


        :param data: The data of this AttachmentSingleResponse.  # noqa: E501
        :type data: AttachmentResourceObject
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachmentSingleResponse):
            return False
