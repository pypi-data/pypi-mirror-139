...
class QPlayApiClient:
    """Api Client of the QPlay API
    """
    ...
    def get_volume_info(self, volume_id='', user_name='', device_name=''):
        ...
        :returns: dictionary
        """
        url = QPlayApiClient.BASE_PROD_URL
        
        if volume_id:
            url += "?volume_id={}".format(volume_id)
        elif user_name and device_name:
            url += "?user_name={}&device_name={}".format(user_name, device_name)
        else:
