...
def image_retrieval_benchmark(kapture_map_path: str,
    ...
    if 'pose_approximation' not in skip_list:
        ...
        if 'export_LTVL2020' not in skip_list:
            ...
            BDI_export_LTVL2020_script_name, BDI_export_LTVL2020_args = get_benchmark_format_command(
                benchmark_format_style,
                pose_approx_BDI_path,
                pose_approx_BDI_LTVL2020_output_path,
                force_overwrite_existing,
                logger
            )
            BDI_local_export_LTVL2020_path = path.join(pipeline_import_paths.HERE_PATH,
                                                       f'../../kapture/tools/{BDI_export_LTVL2020_script_name}')
            run_python_command(BDI_local_export_LTVL2020_path, BDI_export_LTVL2020_args, python_binary)
