...
class V1AWSClusterDriverSpec(object):
    ...
    swagger_types = {
        ...
        'region': 'str',
        'role_arn': 'str',
        'tensorboard_node_instance_type': 'str',
        'x_multi_az_count': 'int'
    }
    ...
    attribute_map = {
        ...
        'region': 'region',
        'role_arn': 'roleArn',
        'tensorboard_node_instance_type': 'tensorboardNodeInstanceType',
        'x_multi_az_count': 'xMultiAzCount'
    }

    def __init__(self,
                 az_skip_ids: 'list[str]' = None,
                 bastion_ami_override: 'str' = None,
                 bucket_name: 'str' = None,
                 builder_ami_name_override: 'str' = None,
                 builder_ami_override: 'str' = None,
                 builder_node_instance_type: 'str' = None,
                 cpu_ami_override: 'str' = None,
                 enable_dns_firewall: 'bool' = None,
                 external_id: 'str' = None,
                 gpu_ami_override: 'str' = None,
                 guardduty_integration: 'bool' = None,
                 instance_types: 'list[V1InstanceSpec]' = None,
                 internal_gc_ttl: 'str' = None,
                 internal_test_cluster: 'bool' = None,
                 kubernetes_version: 'str' = None,
                 management_node_instance_type: 'str' = None,
                 original_cluster_name: 'str' = None,
                 region: 'str' = None,
                 role_arn: 'str' = None,
                 tensorboard_node_instance_type: 'str' = None,
                 x_multi_az_count: 'int' = None,
        ...
        self._region = None
        self._role_arn = None
        self._tensorboard_node_instance_type = None
        self._x_multi_az_count = None
        ...
        if tensorboard_node_instance_type is not None:
            self.tensorboard_node_instance_type = tensorboard_node_instance_type
        if x_multi_az_count is not None:
            self.x_multi_az_count = x_multi_az_count
    ...
    def management_node_instance_type(self,
                                      management_node_instance_type: 'str'):
    ...
    @property
    def tensorboard_node_instance_type(self) -> 'str':
        """Gets the tensorboard_node_instance_type of this V1AWSClusterDriverSpec.  # noqa: E501


        :return: The tensorboard_node_instance_type of this V1AWSClusterDriverSpec.  # noqa: E501
        :rtype: str
        """
        return self._tensorboard_node_instance_type

    @tensorboard_node_instance_type.setter
    def tensorboard_node_instance_type(self,
                                       tensorboard_node_instance_type: 'str'):
        """Sets the tensorboard_node_instance_type of this V1AWSClusterDriverSpec.


        :param tensorboard_node_instance_type: The tensorboard_node_instance_type of this V1AWSClusterDriverSpec.  # noqa: E501
        :type: str
        """

        self._tensorboard_node_instance_type = tensorboard_node_instance_type

    @property
    def x_multi_az_count(self) -> 'int':
        """Gets the x_multi_az_count of this V1AWSClusterDriverSpec.  # noqa: E501


        :return: The x_multi_az_count of this V1AWSClusterDriverSpec.  # noqa: E501
        :rtype: int
        """
        return self._x_multi_az_count

    @x_multi_az_count.setter
    def x_multi_az_count(self, x_multi_az_count: 'int'):
        """Sets the x_multi_az_count of this V1AWSClusterDriverSpec.


        :param x_multi_az_count: The x_multi_az_count of this V1AWSClusterDriverSpec.  # noqa: E501
        :type: int
        """

        self._x_multi_az_count = x_multi_az_count
