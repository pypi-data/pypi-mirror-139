...
class Body3(object):
    ...
    """
    swagger_types = {'role_ids': 'list[str]', 'user_id': 'str'}

    attribute_map = {'role_ids': 'roleIds', 'user_id': 'userId'}
    ...
    def role_ids(self) -> 'list[str]':
        """Gets the role_ids of this Body3.  # noqa: E501


        :return: The role_ids of this Body3.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def role_ids(self, role_ids: 'list[str]'):
        """Sets the role_ids of this Body3.


        :param role_ids: The role_ids of this Body3.  # noqa: E501
        :type: list[str]
        """
