...
class Gridv1ImageSpec(object):
    ...
    def __init__(self,
                 actions_on_image_build_end: 'list[str]' = None,
                 actions_on_image_build_start: 'list[str]' = None,
                 dependency_file_info: 'V1DependencyFileInfo' = None,
                 dockerfile: 'str' = None,
                 image: 'str' = None,
                 on_image_build_commands: 'list[str]' = None,
                 _configuration=None):  # noqa: E501
        """Gridv1ImageSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def actions_on_image_build_end(self) -> 'list[str]':
        """Gets the actions_on_image_build_end of this Gridv1ImageSpec.  # noqa: E501
        ...
        :return: The actions_on_image_build_end of this Gridv1ImageSpec.  # noqa: E501
        :rtype: list[str]
        """
        return self._actions_on_image_build_end

    @actions_on_image_build_end.setter
    def actions_on_image_build_end(self,
                                   actions_on_image_build_end: 'list[str]'):
        """Sets the actions_on_image_build_end of this Gridv1ImageSpec.

        commands passed to the image builder which are interpreted as RUN commands in a Dockerfile. Executes after installing dependencies from package manager.  # noqa: E501

        :param actions_on_image_build_end: The actions_on_image_build_end of this Gridv1ImageSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def actions_on_image_build_start(self) -> 'list[str]':
        """Gets the actions_on_image_build_start of this Gridv1ImageSpec.  # noqa: E501
        ...
        :return: The actions_on_image_build_start of this Gridv1ImageSpec.  # noqa: E501
        :rtype: list[str]
        """
        return self._actions_on_image_build_start

    @actions_on_image_build_start.setter
    def actions_on_image_build_start(
            self, actions_on_image_build_start: 'list[str]'):
        """Sets the actions_on_image_build_start of this Gridv1ImageSpec.

        commands passed to the image builder which are interpreted as RUN commands in a Dockerfile. Executes before installing dependencies from package manager.  # noqa: E501

        :param actions_on_image_build_start: The actions_on_image_build_start of this Gridv1ImageSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def dependency_file_info(self) -> 'V1DependencyFileInfo':
        """Gets the dependency_file_info of this Gridv1ImageSpec.  # noqa: E501


        :return: The dependency_file_info of this Gridv1ImageSpec.  # noqa: E501
        :rtype: V1DependencyFileInfo
        """
        return self._dependency_file_info

    @dependency_file_info.setter
    def dependency_file_info(self,
                             dependency_file_info: 'V1DependencyFileInfo'):
        """Sets the dependency_file_info of this Gridv1ImageSpec.


        :param dependency_file_info: The dependency_file_info of this Gridv1ImageSpec.  # noqa: E501
    ...
    def dockerfile(self) -> 'str':
        """Gets the dockerfile of this Gridv1ImageSpec.  # noqa: E501

        this is a relative path to a dockerfile within the build context.  # noqa: E501

        :return: The dockerfile of this Gridv1ImageSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def dockerfile(self, dockerfile: 'str'):
        """Sets the dockerfile of this Gridv1ImageSpec.

        this is a relative path to a dockerfile within the build context.  # noqa: E501

        :param dockerfile: The dockerfile of this Gridv1ImageSpec.  # noqa: E501
        :type: str
        """
    ...
    @property
    def image(self) -> 'str':
        """Gets the image of this Gridv1ImageSpec.  # noqa: E501

        name of the base image to use when rendering dockerfile templates.  # noqa: E501

        :return: The image of this Gridv1ImageSpec.  # noqa: E501
        :rtype: str
        """
        return self._image
    ...
    def image(self, image: 'str'):
        """Sets the image of this Gridv1ImageSpec.

        name of the base image to use when rendering dockerfile templates.  # noqa: E501

        :param image: The image of this Gridv1ImageSpec.  # noqa: E501
        :type: str
        """
    ...
    def on_image_build_commands(self) -> 'list[str]':
        """Gets the on_image_build_commands of this Gridv1ImageSpec.  # noqa: E501
        ...
        :return: The on_image_build_commands of this Gridv1ImageSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def on_image_build_commands(self, on_image_build_commands: 'list[str]'):
        """Sets the on_image_build_commands of this Gridv1ImageSpec.

        DEPRECATED: DO NOT USE! Build commands to add as RUN instructions. These instructions are executed before any dependencies are installed.  # noqa: E501

        :param on_image_build_commands: The on_image_build_commands of this Gridv1ImageSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Gridv1ImageSpec, dict):
    ...
    def __eq__(self, other: 'Gridv1ImageSpec') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, Gridv1ImageSpec):
            return False

        return self.to_dict() == other.to_dict()

    def __ne__(self, other: 'Gridv1ImageSpec') -> bool:
