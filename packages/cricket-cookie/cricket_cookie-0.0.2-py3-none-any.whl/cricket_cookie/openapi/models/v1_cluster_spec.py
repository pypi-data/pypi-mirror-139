...
class V1ClusterSpec(object):
    ...
    def __init__(self,
                 cluster_type: 'V1ClusterType' = None,
                 cost_factor: 'str' = None,
                 desired_state: 'V1ClusterState' = None,
                 driver: 'V1ClusterDriver' = None,
                 gridlet_version: 'str' = None,
                 padding_factor: 'str' = None,
                 pause_automation: 'bool' = None,
                 performance_profile: 'V1ClusterPerformanceProfile' = None,
                 user_id: 'str' = None,
    ...
    def performance_profile(
            self, performance_profile: 'V1ClusterPerformanceProfile'):
