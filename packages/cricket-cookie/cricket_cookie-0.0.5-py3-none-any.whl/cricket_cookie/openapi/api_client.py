...
import cricket_cookie.openapi.models
from cricket_cookie.openapi import rest
...
class ApiClient(object):
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cricket_cookie.openapi.models, klass)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if (not klass.swagger_types
                and not self.__hasattr(klass, 'get_real_child_model')):
            return data
