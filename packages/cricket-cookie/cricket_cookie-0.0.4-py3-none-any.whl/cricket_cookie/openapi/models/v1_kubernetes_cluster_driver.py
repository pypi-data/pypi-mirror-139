...
class V1KubernetesClusterDriver(object):
    ...
    def __init__(self,
                 aws: 'V1AWSClusterDriverSpec' = None,
                 azure: 'V1AzureClusterDriverSpec' = None,
                 extra_gridlet_env_var: 'dict(str, str)' = None,
                 gridlet_resources: 'V1ContainerResources' = None,
                 kubeconfig: 'V1ExternalKubeconfig' = None,
                 kubernetes_only_mode: 'bool' = None,
                 namespace: 'str' = None,
                 private_ssh_gateway: 'bool' = None,
                 root_domain_name: 'str' = None,
