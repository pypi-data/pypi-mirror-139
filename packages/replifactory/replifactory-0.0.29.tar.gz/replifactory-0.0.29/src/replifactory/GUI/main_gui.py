...
from replifactory.GUI.calibration_tab import CalibrationTab
from replifactory.GUI.camera_tab import CameraTab
...
class MainGui:
    def __init__(self):
        ...
        self.device_config_tab = CalibrationTab(main_gui=self)
