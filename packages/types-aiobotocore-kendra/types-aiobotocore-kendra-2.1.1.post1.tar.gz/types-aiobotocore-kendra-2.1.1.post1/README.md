...
[aiobotocore.kendra 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/kendra.html#kendra)
...
- Install `types-aiobotocore[kendra]` with services you use in your
  environment:
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_kendra/)
