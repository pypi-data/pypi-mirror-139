...
- thickness (number; optional):
    Ring thickness."""
    @_explicitize_args
    def __init__(self, class_name=Component.UNDEFINED, id=Component.UNDEFINED, label=Component.UNDEFINED, roundCaps=Component.UNDEFINED, sections=Component.REQUIRED, size=Component.UNDEFINED, thickness=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'class_name', 'label', 'roundCaps', 'sections', 'size', 'thickness']
        self._type = 'RingProgress'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'class_name', 'label', 'roundCaps', 'sections', 'size', 'thickness']
