    ...
    async def run_process_jobs(self) -> None:
        ...
        while self.running:
            ...
            if self.current_job is None:
                ...
                server_url: str = self.get_api_url(self.config.get('dlds_host'))
                ...
                if self.debug:
                    ...
                    args = [sys.executable, '-O', '-m', 'dlds.dlds_model']
                ...
                model_env['DLDS_MODEL_CLASS'] = os.environ.get('DLDS_MODEL_CLASS', 'dldstraining.TrainerModel')
