(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["Airflow"] = root["Airflow"] || {}, root["Airflow"]["events"] = factory();
})(window, function() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return eTooltip; });
...
function eTooltip(e, {
  ...
  let tt = '';
  tt += `<strong>Namespace:</strong> ${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(e[0])}<br><br>`;
  tt += `Event_Key: ${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(e[1])}<br>`;
  tt += `Event_Type: ${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(e[2])}<br><br>`;
  tt += `<em><strong>Internal_Send_Count:</strong> ${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(e[3])}</em><br>`;
  tt += `<em><strong>External_Send_Count:</strong> ${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(e[4])}</em>`;
  return tt;
}
