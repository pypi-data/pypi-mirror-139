(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["taskInstances"] = factory();
	else
		root["Airflow"] = root["Airflow"] || {}, root["Airflow"]["taskInstances"] = factory();
})(window, function() {
...
function generateTooltipDateTimes(startDate, endDate, dagTZ) {
  ...
  tooltipHTML += makeDateTimeHTML(startDate, endDate); // Generate User's Local Start and End Date
  ...
  tooltipHTML += makeDateTimeHTML(startDate, localEndDate); // Generate DAG's Start and End Date
...
function tiTooltip(ti, {
  ...
  if (ti.periodic_config !== undefined) {
    tt += `<br><strong>Schedule:</strong><br>${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(JSON.stringify(ti.periodic_config))}<br>`;
  }

  if (ti.context !== undefined && ti.context !== null) {
    tt += `<br><strong>Context:</strong><br>${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(ti.context)}<br>`;
  }

  if (ti.execution_label !== undefined && ti.execution_label !== null) {
    tt += `<br><strong>Execution Label:</strong><br>${Object(_main__WEBPACK_IMPORTED_MODULE_0__["escapeHtml"])(ti.execution_label)}<br>`;
