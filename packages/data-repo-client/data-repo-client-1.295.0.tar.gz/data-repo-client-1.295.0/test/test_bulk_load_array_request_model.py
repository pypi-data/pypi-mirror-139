...
from data_repo_client.models.bulk_load_array_request_model import BulkLoadArrayRequestModel  # noqa: E501
from data_repo_client.rest import ApiException

class TestBulkLoadArrayRequestModel(unittest.TestCase):
    """BulkLoadArrayRequestModel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test BulkLoadArrayRequestModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.bulk_load_array_request_model.BulkLoadArrayRequestModel()  # noqa: E501
        if include_optional :
            return BulkLoadArrayRequestModel(
                profile_id = '0', 
                load_tag = '0', 
                max_failed_file_loads = 56, 
                load_array = [
                    data_repo_client.models.bulk_load_file_model.BulkLoadFileModel(
                        source_path = '0', 
                        target_path = '0', 
                        mime_type = '0', 
                        description = '0', )
    ...
    def testBulkLoadArrayRequestModel(self):
        """Test BulkLoadArrayRequestModel"""
