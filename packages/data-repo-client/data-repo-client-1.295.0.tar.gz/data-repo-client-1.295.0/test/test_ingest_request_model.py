...
from data_repo_client.models.ingest_request_model import IngestRequestModel  # noqa: E501
from data_repo_client.rest import ApiException

class TestIngestRequestModel(unittest.TestCase):
    """IngestRequestModel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IngestRequestModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.ingest_request_model.IngestRequestModel()  # noqa: E501
        if include_optional :
            return IngestRequestModel(
                table = 'a', 
                path = '0', 
                format = 'csv', 
                load_tag = '0', 
                ...
                csv_field_delimiter = ',', 
                csv_quote = '"', 
                csv_skip_leading_rows = 56, 
                csv_allow_quoted_newlines = True, 
                csv_null_marker = '0', 
                csv_generate_row_ids = True, 
    ...
    def testIngestRequestModel(self):
        """Test IngestRequestModel"""
