...
class BulkLoadHistoryModelList(object):
    ...
    openapi_types = {
        'total': 'int',
        'items': 'list[BulkLoadHistoryModel]'
    }
    ...
    def __init__(self, total=None, items=None, local_vars_configuration=None):  # noqa: E501
        """BulkLoadHistoryModelList - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def total(self):
        """Gets the total of this BulkLoadHistoryModelList.  # noqa: E501

        Total number of results  # noqa: E501

        :return: The total of this BulkLoadHistoryModelList.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this BulkLoadHistoryModelList.

        Total number of results  # noqa: E501

        :param total: The total of this BulkLoadHistoryModelList.  # noqa: E501
        :type: int
        """
    ...
    @property
    def items(self):
        """Gets the items of this BulkLoadHistoryModelList.  # noqa: E501


        :return: The items of this BulkLoadHistoryModelList.  # noqa: E501
        :rtype: list[BulkLoadHistoryModel]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this BulkLoadHistoryModelList.


        :param items: The items of this BulkLoadHistoryModelList.  # noqa: E501
        :type: list[BulkLoadHistoryModel]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkLoadHistoryModelList):
            return False
