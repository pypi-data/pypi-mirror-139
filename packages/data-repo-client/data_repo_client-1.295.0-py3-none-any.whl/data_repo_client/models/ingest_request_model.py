...
class IngestRequestModel(object):
    ...
    def __init__(self, table=None, path=None, format=None, load_tag=None, profile_id=None, max_bad_records=0, max_failed_file_loads=0, ignore_unknown_values=True, csv_field_delimiter=',', csv_quote='"', csv_skip_leading_rows=None, csv_allow_quoted_newlines=True, csv_null_marker='', csv_generate_row_ids=True, resolve_existing_files=False, local_vars_configuration=None):  # noqa: E501
