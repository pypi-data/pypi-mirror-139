...
class SnapshotExportResponseModelFormatWorkspace(object):
    ...
    def __init__(self, namespace=None, name=None, link=None, local_vars_configuration=None):  # noqa: E501
        """SnapshotExportResponseModelFormatWorkspace - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def namespace(self):
        """Gets the namespace of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501

        Workspace namespace the snapshot was exported to  # noqa: E501

        :return: The namespace of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        """Sets the namespace of this SnapshotExportResponseModelFormatWorkspace.

        Workspace namespace the snapshot was exported to  # noqa: E501

        :param namespace: The namespace of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501

        Workspace name the snapshot was exported to  # noqa: E501

        :return: The name of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SnapshotExportResponseModelFormatWorkspace.

        Workspace name the snapshot was exported to  # noqa: E501

        :param name: The name of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501
        :type: str
        """
    ...
    @property
    def link(self):
        """Gets the link of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501

        Link to the workspace the snapshot was exported to  # noqa: E501

        :return: The link of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501
        :rtype: str
        """
        return self._link
    ...
    @link.setter
    def link(self, link):
        """Sets the link of this SnapshotExportResponseModelFormatWorkspace.

        Link to the workspace the snapshot was exported to  # noqa: E501

        :param link: The link of this SnapshotExportResponseModelFormatWorkspace.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotExportResponseModelFormatWorkspace):
            return False
