...
class SnapshotExportResponseModelFormatParquetLocationTables(object):
    ...
    def __init__(self, name=None, paths=None, local_vars_configuration=None):  # noqa: E501
        """SnapshotExportResponseModelFormatParquetLocationTables - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SnapshotExportResponseModelFormatParquetLocationTables.  # noqa: E501

        Name of the table exported  # noqa: E501

        :return: The name of this SnapshotExportResponseModelFormatParquetLocationTables.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SnapshotExportResponseModelFormatParquetLocationTables.

        Name of the table exported  # noqa: E501

        :param name: The name of this SnapshotExportResponseModelFormatParquetLocationTables.  # noqa: E501
        :type: str
        """
    ...
    @property
    def paths(self):
        """Gets the paths of this SnapshotExportResponseModelFormatParquetLocationTables.  # noqa: E501


        :return: The paths of this SnapshotExportResponseModelFormatParquetLocationTables.  # noqa: E501
        :rtype: list[str]
        """
        return self._paths
    ...
    def paths(self, paths):
        """Sets the paths of this SnapshotExportResponseModelFormatParquetLocationTables.


        :param paths: The paths of this SnapshotExportResponseModelFormatParquetLocationTables.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotExportResponseModelFormatParquetLocationTables):
            return False
