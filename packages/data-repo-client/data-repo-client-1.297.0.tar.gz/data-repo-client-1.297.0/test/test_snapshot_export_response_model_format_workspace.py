...
from data_repo_client.models.snapshot_export_response_model_format_workspace import SnapshotExportResponseModelFormatWorkspace  # noqa: E501
from data_repo_client.rest import ApiException

class TestSnapshotExportResponseModelFormatWorkspace(unittest.TestCase):
    """SnapshotExportResponseModelFormatWorkspace unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SnapshotExportResponseModelFormatWorkspace
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.snapshot_export_response_model_format_workspace.SnapshotExportResponseModelFormatWorkspace()  # noqa: E501
        if include_optional :
            return SnapshotExportResponseModelFormatWorkspace(
                namespace = '0', 
                name = '0', 
                link = '0'
            )
    ...
    def testSnapshotExportResponseModelFormatWorkspace(self):
        """Test SnapshotExportResponseModelFormatWorkspace"""
