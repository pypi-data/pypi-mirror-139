...
from data_repo_client.models.snapshot_export_response_model_format_parquet_location_tables import SnapshotExportResponseModelFormatParquetLocationTables  # noqa: E501
from data_repo_client.rest import ApiException

class TestSnapshotExportResponseModelFormatParquetLocationTables(unittest.TestCase):
    """SnapshotExportResponseModelFormatParquetLocationTables unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SnapshotExportResponseModelFormatParquetLocationTables
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.snapshot_export_response_model_format_parquet_location_tables.SnapshotExportResponseModelFormatParquetLocationTables()  # noqa: E501
        if include_optional :
            return SnapshotExportResponseModelFormatParquetLocationTables(
                name = '0', 
                paths = [
                    '0'
                    ]
    ...
    def testSnapshotExportResponseModelFormatParquetLocationTables(self):
        """Test SnapshotExportResponseModelFormatParquetLocationTables"""
