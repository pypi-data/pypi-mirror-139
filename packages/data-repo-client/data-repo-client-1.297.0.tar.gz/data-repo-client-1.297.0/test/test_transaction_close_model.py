...
from data_repo_client.models.transaction_close_model import TransactionCloseModel  # noqa: E501
from data_repo_client.rest import ApiException

class TestTransactionCloseModel(unittest.TestCase):
    """TransactionCloseModel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TransactionCloseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.transaction_close_model.TransactionCloseModel()  # noqa: E501
        if include_optional :
            return TransactionCloseModel(
                mode = 'commit'
            )
        else :
            return TransactionCloseModel(
    ...
    def testTransactionCloseModel(self):
        """Test TransactionCloseModel"""
