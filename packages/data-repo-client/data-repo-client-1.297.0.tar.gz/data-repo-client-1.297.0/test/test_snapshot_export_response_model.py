...
from data_repo_client.models.snapshot_export_response_model import SnapshotExportResponseModel  # noqa: E501
from data_repo_client.rest import ApiException

class TestSnapshotExportResponseModel(unittest.TestCase):
    """SnapshotExportResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SnapshotExportResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.snapshot_export_response_model.SnapshotExportResponseModel()  # noqa: E501
        if include_optional :
            return SnapshotExportResponseModel(
                snapshot = data_repo_client.models.snapshot_model.SnapshotModel(
                    id = '0', 
                    name = 'a', 
                    description = '0', 
                    created_date = '0', 
                ...
                format = data_repo_client.models.snapshot_export_response_model_format.SnapshotExportResponseModel_format(
                    parquet = data_repo_client.models.snapshot_export_response_model_format_parquet.SnapshotExportResponseModel_format_parquet(
                        location = data_repo_client.models.snapshot_export_response_model_format_parquet_location.SnapshotExportResponseModel_format_parquet_location(
                            tables = [
                                data_repo_client.models.snapshot_export_response_model_format_parquet_location_tables.SnapshotExportResponseModel_format_parquet_location_tables(
                                    name = '0', 
                                    paths = [
                                        '0'
                                        ], )
                        ...
                        manifest = '0', ), 
                    workspace = data_repo_client.models.snapshot_export_response_model_format_workspace.SnapshotExportResponseModel_format_workspace(
                        namespace = '0', 
                        name = '0', 
                        link = '0', ), )
            )
    ...
    def testSnapshotExportResponseModel(self):
        """Test SnapshotExportResponseModel"""
