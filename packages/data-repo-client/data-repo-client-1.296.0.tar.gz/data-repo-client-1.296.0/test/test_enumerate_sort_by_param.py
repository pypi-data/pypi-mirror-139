...
from data_repo_client.models.enumerate_sort_by_param import EnumerateSortByParam  # noqa: E501
from data_repo_client.rest import ApiException

class TestEnumerateSortByParam(unittest.TestCase):
    """EnumerateSortByParam unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EnumerateSortByParam
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.enumerate_sort_by_param.EnumerateSortByParam()  # noqa: E501
        if include_optional :
            return EnumerateSortByParam(
            )
        else :
            return EnumerateSortByParam(
        )

    def testEnumerateSortByParam(self):
        """Test EnumerateSortByParam"""
