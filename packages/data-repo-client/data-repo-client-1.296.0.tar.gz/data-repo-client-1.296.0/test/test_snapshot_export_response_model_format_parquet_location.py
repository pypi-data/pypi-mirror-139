...
from data_repo_client.models.snapshot_export_response_model_format_parquet_location import SnapshotExportResponseModelFormatParquetLocation  # noqa: E501
from data_repo_client.rest import ApiException

class TestSnapshotExportResponseModelFormatParquetLocation(unittest.TestCase):
    """SnapshotExportResponseModelFormatParquetLocation unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SnapshotExportResponseModelFormatParquetLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.snapshot_export_response_model_format_parquet_location.SnapshotExportResponseModelFormatParquetLocation()  # noqa: E501
        if include_optional :
            return SnapshotExportResponseModelFormatParquetLocation(
                tables = [
    ...
    def testSnapshotExportResponseModelFormatParquetLocation(self):
        """Test SnapshotExportResponseModelFormatParquetLocation"""
