...
class FileLoadModel(object):
    ...
    def __init__(self, source_path=None, target_path=None, mime_type=None, profile_id=None, load_tag=None, description=None, local_vars_configuration=None):  # noqa: E501
