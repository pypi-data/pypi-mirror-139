...
def DNAC_device(url, username, password):
    try:
        ...
        if insightVlanJSON is not None:
        ...
        # -------------------------
                if loop_counter <= 3:
                    with open(f"DNAC Insight VLANs.{ filetype }", "w") as fh:
                        fh.write(parsed_output)               
                        fh.close()                       
                else:
                    with open("DNAC Insight VLANs Mind Map.md", "w") as fh:
                        fh.write(parsed_output)               
                        fh.close()
                with open(f"DNAC Insight VLANs.json", "w") as fh:
        ...
        if insightSpeedDuplexJSON is not None:
        ...
        # -------------------------
                if loop_counter <= 3:
                    with open(f"DNAC Insight Speed Duplex.{ filetype }", "w") as fh:
                        fh.write(parsed_output)               
                        fh.close()                       
                else:
                    with open("DNAC Insight Speed Duplex Mind Map.md", "w") as fh:
                        fh.write(parsed_output)               
                        fh.close()
                with open(f"DNAC Insight Speed Duplex.json", "w") as fh:
        ...
        if healthJSON is not None:
            device_health_template = env.get_template('DNAC_device_health.j2')
            loop_counter = 0
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = device_health_template.render(health = healthJSON['response'],filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
        ...
        # -------------------------
                if loop_counter <= 3:
                    with open(f"DNAC Device Health.{ filetype }", "w") as fh:
                        fh.write(parsed_output)               
                        fh.close()                       
                else:
                    with open("DNAC Device Health Mind Map.md", "w") as fh:
                        fh.write(parsed_output)               
                        fh.close()
                with open(f"DNAC Device Health.json", "w") as fh:
        ...
        # -------------------------
                ...
                if deviceChassisJSON is not None:
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Chassis.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Chassis Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Chassis.json", "w") as fh:
        ...
        # -------------------------
                ...
                if powerSupplyJSON is not None:
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Power Supplies.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Power Supplies Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Power Supplies.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Fans.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Fans Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Fans.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Backplane.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Backplane Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Backplane.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Modules.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Modules Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Modules.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Processors.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Processors Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Processors.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Other Parts.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Other Parts Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Other Parts.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Power over Ethernet.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Power over Ethernet Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Power over Ethernet.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } VLANs.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } VLANs Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } VLANs.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Interfaces.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Interfaces Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Interfaces.json", "w") as fh:
        ...
        # -------------------------
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Stack.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Stack Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Stack.json", "w") as fh:
        ...
        # -------------------------
                ...
                if complianceJSON is not None:
                    device_compliance_template = env.get_template('DNAC_device_compliance.j2')
                    loop_counter = 0
                # Render Templates
                    for filetype in filetype_loop:
                        parsed_output = device_stack_template.render(compliance = complianceJSON['response'],filetype_loop=loop_counter)
                        loop_counter = loop_counter + 1
                ...
                # -------------------------
                        if loop_counter <= 3:
                            with open(f"DNAC { device['hostname'] } Compliance.{ filetype }", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()                       
                        else:
                            with open(f"DNAC { device['hostname'] } Compliance Mind Map.md", "w") as fh:
                                fh.write(parsed_output)               
                                fh.close()
                        with open(f"DNAC { device['hostname'] } Compliance.json", "w") as fh:
    ...
    # -------------------------
                    if loop_counter <= 3:
                        with open(f"DNAC Device { device['hostname'] }.{ filetype }", "w") as fh:
                            fh.write(parsed_output)               
                    else:
                        with open(f"DNAC Device { device['hostname'] } Mind Map.md", "w") as fh:
                            fh.write(parsed_output)               
                            fh.close()
                            loop_counter = 0
                    with open(f"DNAC Device { device['hostname'] }.json", "w") as fh:
