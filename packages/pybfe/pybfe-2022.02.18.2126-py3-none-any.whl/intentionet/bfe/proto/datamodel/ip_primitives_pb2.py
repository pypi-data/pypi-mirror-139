...
_INTERFACEADDRESS = _descriptor.Descriptor(
  ...
  full_name='com.intentionet.datamodel.InterfaceAddress',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='com.intentionet.datamodel.InterfaceAddress.address', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='subnet_mask', full_name='com.intentionet.datamodel.InterfaceAddress.subnet_mask', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='subnetMask', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_INTERFACEADDRESS.fields_by_name['address'].message_type = _IP
