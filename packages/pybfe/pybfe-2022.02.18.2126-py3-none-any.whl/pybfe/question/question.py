...
from pybatfish.question.question import Questions as BaseQuestions
from pybatfish.util import BfJsonEncoder, get_uuid, validate_question_name
from pybfe.client.internal import _bf_answer_obj, _bf_get_question_templates
...
class AllowedValue(object):
    ...
    @classmethod
    def from_dict(cls, json_dict: Dict) -> "AllowedValue":
...
class QuestionBase(object):
    ...
    def answer(
        ...
        include_one_table_keys: Optional[bool] = None,
    ...
    def set_assertion(self, assertion: Assertion) -> "QuestionBase":
    ...
    def make_check(self) -> "QuestionBase":
...
class Questions(BaseQuestions):
    ...
    def list(
        self, tags: Optional[Iterable[str]] = None
    ) -> List[Dict[str, Union[str, Set]]]:
        """
...
def _list_questions(
    tags: Optional[Iterable[str]], obj: Questions
) -> List[Dict[str, Union[str, Set]]]:
...
def _load_questions_from_dir(
    question_dir: str, session: "Session"
) -> Dict[str, QuestionMeta]:
...
def _load_question_disk(
    question_path: str, session: "Session"
) -> Tuple[str, QuestionMeta]:
...
def _load_question_dict(
    question: Dict[str, Any], session: "Session"
) -> Tuple[str, QuestionMeta]:
...
def _validate_variable_data(
    question_name: str, var_name: str, var_data: Dict[str, Any]
) -> bool:
...
def _validate_variable_name(question_name: str, var_name: str) -> bool:
...
def _has_valid_ordered_variable_names(
    ordered_variable_names: List[str], variables: Dict[str, Dict[str, Any]]
) -> bool:
...
def _compute_docstring(
    base_docstring: str, var_names: List[str], variables: Dict[str, Any]
) -> str:
...
def _compute_var_help(var_name: str, var_data: Dict[str, Any]) -> str:
