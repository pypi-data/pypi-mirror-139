...
setup(
	...
	py_modules=["commonchi.lib.readexcel","commonchi.lib.writeexcel","commonchi.lib.api","commonchi.lib.newReport","commonchi.lib.parsley","commonchi.lib.sendmail","commonchi.lib.utility","commonchi.package.HTMLTestRunner"],
