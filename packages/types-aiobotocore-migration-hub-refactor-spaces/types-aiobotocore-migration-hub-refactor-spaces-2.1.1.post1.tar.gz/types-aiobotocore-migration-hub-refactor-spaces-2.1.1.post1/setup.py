...
setup(
    ...
    description="Type annotations for aiobotocore.MigrationHubRefactorSpaces 2.1.1 service generated with mypy-boto3-builder 7.1.1",
    classifiers=[
    ...
    keywords="aiobotocore migration-hub-refactor-spaces type-annotations boto3-stubs mypy typeshed autocomplete",
