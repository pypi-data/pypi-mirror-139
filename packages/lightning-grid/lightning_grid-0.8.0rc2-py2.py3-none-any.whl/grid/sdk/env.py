...
GRID_DATASTORE_MAX_BYTES_PER_FILE_PART_UPLOAD = int(
    os.getenv("GRID_DATASTORE_MAX_BYTES_PER_FILE_PART_UPLOAD", default=50 * _MB)
)
GRID_DATASTORE_MAX_BYTES_PER_BATCH_UPLOAD = int(os.getenv("GRID_DATASTORE_MAX_BYTES_PER_BATCH_UPLOAD", default=2 * _GB))
GRID_DATASTORE_MAX_FILES_PER_UPLOAD_BATCH = int(os.getenv("GRID_DATASTORE_MAX_FILES_PER_UPLOAD_BATCH", default=3000))
GRID_DATASTORE_MAX_FILES_PER_FINALIZE_BATCH = int(
    os.getenv("GRID_DATASTORE_MAX_FILES_PER_FINALIZE_BATCH", default=3000)
)
