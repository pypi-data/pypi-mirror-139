...
from ai_api_client_sdk.models.base_models import BasicResponse, Order
...
class DeploymentClient(BaseClient):
    ...
    def create(self, configuration_id: str, resource_group: str = None) -> DeploymentCreateResponse:
    ...
    def modify(self, deployment_id: str, target_status: TargetStatus = None, resource_group: str = None) -> BasicResponse:
