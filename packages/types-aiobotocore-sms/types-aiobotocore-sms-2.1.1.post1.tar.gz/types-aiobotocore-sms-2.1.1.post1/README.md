...
[aiobotocore.SMS 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sms.html#SMS)
...
Install `types-aiobotocore-lite[sms]` in your environment:
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms/)
