...
setup(
    ...
    url='https://github.com/thevickypedia/file-server',
    ...
    project_urls={
        'Docs': 'https://thevickypedia.github.io/file-server',
        'Bug Tracker': 'https://github.com/thevickypedia/file-server/issues'
    },
)
