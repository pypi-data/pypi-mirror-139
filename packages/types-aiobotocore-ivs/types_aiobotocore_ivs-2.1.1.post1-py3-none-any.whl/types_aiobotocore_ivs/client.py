...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html)
...
class IVSClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#exceptions)
        """
    ...
    async def batch_get_channel(self, *, arns: Sequence[str]) -> BatchGetChannelResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#batch_get_channel)
        """
    ...
    async def batch_get_stream_key(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#batch_get_stream_key)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#can_paginate)
        """
    ...
    async def create_channel(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#create_channel)
        """
    ...
    async def create_recording_configuration(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#create_recording_configuration)
        """
    ...
    async def create_stream_key(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#create_stream_key)
        """

    async def delete_channel(self, *, arn: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#delete_channel)
        """
    ...
    async def delete_playback_key_pair(self, *, arn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#delete_playback_key_pair)
        """

    async def delete_recording_configuration(self, *, arn: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#delete_recording_configuration)
        """

    async def delete_stream_key(self, *, arn: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#delete_stream_key)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#generate_presigned_url)
        """
    ...
    async def get_channel(self, *, arn: str) -> GetChannelResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#get_channel)
        """
    ...
    async def get_playback_key_pair(self, *, arn: str) -> GetPlaybackKeyPairResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#get_playback_key_pair)
        """
    ...
    async def get_recording_configuration(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#get_recording_configuration)
        """
    ...
    async def get_stream(self, *, channelArn: str) -> GetStreamResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#get_stream)
        """
    ...
    async def get_stream_key(self, *, arn: str) -> GetStreamKeyResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#get_stream_key)
        """
    ...
    async def get_stream_session(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#get_stream_session)
        """
    ...
    async def import_playback_key_pair(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#import_playback_key_pair)
        """
    ...
    async def list_channels(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#list_channels)
        """
    ...
    async def list_playback_key_pairs(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#list_playback_key_pairs)
        """
    ...
    async def list_recording_configurations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#list_recording_configurations)
        """
    ...
    async def list_stream_keys(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#list_stream_keys)
        """
    ...
    async def list_stream_sessions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#list_stream_sessions)
        """
    ...
    async def list_streams(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#list_streams)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#list_tags_for_resource)
        """

    async def put_metadata(self, *, channelArn: str, metadata: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#put_metadata)
        """
    ...
    async def stop_stream(self, *, channelArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#stop_stream)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#untag_resource)
        """
    ...
    async def update_channel(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#update_channel)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_channels"]) -> ListChannelsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ivs/client.html#get_paginator)
        """
