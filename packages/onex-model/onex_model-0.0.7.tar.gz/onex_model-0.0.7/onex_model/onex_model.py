...
def api(location=None, verify=True, logger=None, loglevel=logging.INFO, ext=None):
    ...
    try:
        lib = importlib.import_module("sanity_{}.onex_model_api".format(ext))
...
class Host(OpenApiObject):
    ...
    def __init__(self, parent=None, name=None, address=None, prefix=24):
...
class HostIter(OpenApiIter):
    ...
    def host(self, name=None, address=None, prefix=24):
        # type: (str,str,int) -> HostIter
        ...
        Returns: HostIter
        """
        item = Host(parent=self._parent, name=name, address=address, prefix=prefix)
        self._add(item)
        return self

    def add(self, name=None, address=None, prefix=24):
        # type: (str,str,int) -> Host
...
class Fabric(OpenApiObject):
    ...
    _TYPES = {
        ...
        'spine_pod_rack': {'type': 'FabricSpinePodRack'},
    ...
    SPINE_POD_RACK = 'spine_pod_rack' # type: str
    ...
    @property
    def spine_pod_rack(self):
        # type: () -> FabricSpinePodRack
        """Factory property that returns an instance of the FabricSpinePodRack class

        An emulation of a spine/pod/rack topology

        Returns: FabricSpinePodRack
        """
        return self._get_property('spine_pod_rack', FabricSpinePodRack, self, 'spine_pod_rack')

    @property
    def choice(self):
        # type: () -> Union[Literal["spine_pod_rack"]]
        """choice getter

        TBD

        Returns: Union[Literal["spine_pod_rack"]]
        """
    ...
    def choice(self, value):
        ...
        value: Union[Literal["spine_pod_rack"]]
        """
...
class FabricSpinePodRack(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'spines': {'type': 'FabricSpineIter'},
        'pods': {'type': 'FabricPodIter'},
        'host_links': {'type': 'SwitchHostLinkIter'},
        'pod_profiles': {'type': 'FabricPodProfileIter'},
        'rack_profiles': {'type': 'FabricRackProfileIter'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None):
        super(FabricSpinePodRack, self).__init__()
        self._parent = parent

    @property
    def spines(self):
        # type: () -> FabricSpineIter
        """spines getter

        The spines in the topology.

        Returns: FabricSpineIter
        """
        return self._get_property('spines', FabricSpineIter, self._parent, self._choice)
    ...
    @property
    def rack_profiles(self):
        # type: () -> FabricRackProfileIter
        """rack_profiles getter

        A list of rack profiles

        Returns: FabricRackProfileIter
        """
        return self._get_property('rack_profiles', FabricRackProfileIter, self._parent, self._choice)
...
class FabricSpineIter(OpenApiIter):
    __slots__ = ('_parent', '_choice')

    _GETITEM_RETURNS_CHOICE_OBJECT = False

    def __init__(self, parent=None, choice=None):
        super(FabricSpineIter, self).__init__()
        self._parent = parent
        self._choice = choice

    def __getitem__(self, key):
        # type: (str) -> Union[FabricSpine]
        return self._getitem(key)
    ...
    def spine(self, count=1, downlink_ecmp_mode=None, qos_profile_name=None):
        # type: (int,Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],str) -> FabricSpineIter
        """Factory method that creates an instance of the FabricSpine class

        TBD

        Returns: FabricSpineIter
        """
        item = FabricSpine(parent=self._parent, count=count, downlink_ecmp_mode=downlink_ecmp_mode, qos_profile_name=qos_profile_name)
        self._add(item)
        return self

    def add(self, count=1, downlink_ecmp_mode=None, qos_profile_name=None):
        # type: (int,Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],str) -> FabricSpine
        """Add method that creates and returns an instance of the FabricSpine class
...
class FabricPodIter(OpenApiIter):
    ...
    def pod(self, count=1, pod_profile_name=None):
        # type: (int,List[str]) -> FabricPodIter
...
class SwitchHostLink(OpenApiObject):
    ...
    _TYPES = {
        ...
        'rack': {'type': 'SwitchHostLinkSwitchRef'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None, choice=None, host_name=None, front_panel_port=None, spine=None):
    ...
    def rack(self):
        ...
        Returns: SwitchHostLinkSwitchRef
        """
        return self._get_property('rack', SwitchHostLinkSwitchRef, self, 'rack')
    ...
    @property
    def choice(self):
        # type: () -> Union[Literal["pod"], Literal["rack"], Literal["spine"]]
        """choice getter

        TBD

        Returns: Union[Literal["pod"], Literal["rack"], Literal["spine"]]
        """
        return self._get_property('choice')
    ...
    def choice(self, value):
        ...
        value: Union[Literal["pod"], Literal["rack"], Literal["spine"]]
        """
        self._set_property('choice', value)
    ...
    def spine(self):
        ...
        One based index of the spine switch based on the number of spines . configured in the spine_pod_rack topology.
...
class SwitchHostLinkIter(OpenApiIter):
    ...
    def switchhostlink(self, host_name=None, front_panel_port=None, spine=None):
        # type: (str,int,int) -> SwitchHostLinkIter
        """Factory method that creates an instance of the SwitchHostLink class

        The ingress point of a host which is the index of a spine switch, . a pod/rack switch.

        Returns: SwitchHostLinkIter
        """
        item = SwitchHostLink(parent=self._parent, choice=self._choice, host_name=host_name, front_panel_port=front_panel_port, spine=spine)
        self._add(item)
        return self

    def add(self, host_name=None, front_panel_port=None, spine=None):
        # type: (str,int,int) -> SwitchHostLink
...
class FabricPodProfile(OpenApiObject):
    ...
    def rack(self):
        ...
        Returns: FabricRack
        """
        return self._get_property('rack', FabricRack)
...
class FabricPodSwitch(OpenApiObject):
    ...
    def __init__(self, parent=None, count=1, pod_to_spine_oversubscription=None, uplink_ecmp_mode=None, downlink_ecmp_mode=None, qos_profile_name=None):
    ...
    def qos_profile_name(self):
        ...
        The name of a qos profile associated with this pod switch.. . x-constraint:. - #/components/schemas/QosProfile/properties/name. 
...
class FabricRack(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, count=1, rack_profile_names=None):
        super(FabricRack, self).__init__()
        self._parent = parent
        self._set_property('count', count)
        self._set_property('rack_profile_names', rack_profile_names)
    ...
    @property
    def rack_profile_names(self):
        # type: () -> List[str]
        """rack_profile_names getter

        The names of rack profiles associated with this rack.

        Returns: List[str]
        """
        return self._get_property('rack_profile_names')

    @rack_profile_names.setter
    def rack_profile_names(self, value):
        """rack_profile_names setter
        ...
        value: List[str]
        """
        self._set_property('rack_profile_names', value)
...
class FabricPodProfileIter(OpenApiIter):
    ...
    def podprofile(self, name=None):
        # type: (str) -> FabricPodProfileIter
        ...
        Returns: FabricPodProfileIter
        """
        item = FabricPodProfile(parent=self._parent, name=name)
        self._add(item)
        return self

    def add(self, name=None):
        # type: (str) -> FabricPodProfile
...
class FabricRackProfile(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, name=None, tor_uplink_ecmp_mode=None, tor_downlink_ecmp_mode=None, tor_qos_profile_name=None, tor_to_pod_oversubscription=None):
        super(FabricRackProfile, self).__init__()
        self._parent = parent
        self._set_property('name', name)
        self._set_property('tor_uplink_ecmp_mode', tor_uplink_ecmp_mode)
        self._set_property('tor_downlink_ecmp_mode', tor_downlink_ecmp_mode)
        self._set_property('tor_qos_profile_name', tor_qos_profile_name)
    ...
    @property
    def tor_uplink_ecmp_mode(self):
        # type: () -> Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]]
        """tor_uplink_ecmp_mode getter

        The algorithm for packet distribution over ECMP links.. - random_spray randomly puts each packet on an ECMP member links . - hash_3_tuple is a 3 tuple hash of ipv4 src, dst, protocol. - hash_5_tuple is static_hash_ipv4_l4 but a different resulting RTAG7 hash mode

        Returns: Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]]
        """
        return self._get_property('tor_uplink_ecmp_mode')

    @tor_uplink_ecmp_mode.setter
    def tor_uplink_ecmp_mode(self, value):
        """tor_uplink_ecmp_mode setter
        ...
        value: Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]]
        """
        self._set_property('tor_uplink_ecmp_mode', value)

    @property
    def tor_downlink_ecmp_mode(self):
        # type: () -> Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]]
        """tor_downlink_ecmp_mode getter

        The algorithm for packet distribution over ECMP links.. - random_spray randomly puts each packet on an ECMP member links . - hash_3_tuple is a 3 tuple hash of ipv4 src, dst, protocol. - hash_5_tuple is static_hash_ipv4_l4 but a different resulting RTAG7 hash mode

        Returns: Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]]
        """
        return self._get_property('tor_downlink_ecmp_mode')

    @tor_downlink_ecmp_mode.setter
    def tor_downlink_ecmp_mode(self, value):
        """tor_downlink_ecmp_mode setter
        ...
        value: Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]]
        """
        self._set_property('tor_downlink_ecmp_mode', value)

    @property
    def tor_qos_profile_name(self):
        # type: () -> str
        """tor_qos_profile_name getter

        The name of a qos profile associated with the ToR of this rack. . x-constraint:. - #/components/schemas/QosProfile/properties/name. 

        Returns: str
        """
        return self._get_property('tor_qos_profile_name')

    @tor_qos_profile_name.setter
    def tor_qos_profile_name(self, value):
        """tor_qos_profile_name setter
        ...
        value: str
        """
        self._set_property('tor_qos_profile_name', value)
...
class FabricRackProfileIter(OpenApiIter):
    __slots__ = ('_parent', '_choice')

    _GETITEM_RETURNS_CHOICE_OBJECT = False

    def __init__(self, parent=None, choice=None):
        super(FabricRackProfileIter, self).__init__()
        self._parent = parent
        self._choice = choice

    def __getitem__(self, key):
        # type: (str) -> Union[FabricRackProfile]
        return self._getitem(key)
    ...
    def rackprofile(self, name=None, tor_uplink_ecmp_mode=None, tor_downlink_ecmp_mode=None, tor_qos_profile_name=None, tor_to_pod_oversubscription=None):
        # type: (str,Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],str,str) -> FabricRackProfileIter
        """Factory method that creates an instance of the FabricRackProfile class

        TBD

        Returns: FabricRackProfileIter
        """
        item = FabricRackProfile(parent=self._parent, name=name, tor_uplink_ecmp_mode=tor_uplink_ecmp_mode, tor_downlink_ecmp_mode=tor_downlink_ecmp_mode, tor_qos_profile_name=tor_qos_profile_name, tor_to_pod_oversubscription=tor_to_pod_oversubscription)
        self._add(item)
        return self

    def add(self, name=None, tor_uplink_ecmp_mode=None, tor_downlink_ecmp_mode=None, tor_qos_profile_name=None, tor_to_pod_oversubscription=None):
        # type: (str,Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],str,str) -> FabricRackProfile
        """Add method that creates and returns an instance of the FabricRackProfile class

        TBD

        Returns: FabricRackProfile
        """
        item = FabricRackProfile(parent=self._parent, name=name, tor_uplink_ecmp_mode=tor_uplink_ecmp_mode, tor_downlink_ecmp_mode=tor_downlink_ecmp_mode, tor_qos_profile_name=tor_qos_profile_name, tor_to_pod_oversubscription=tor_to_pod_oversubscription)
        self._add(item)
        return item
...
class FabricQosProfileIngressAdmission(OpenApiObject):
    ...
    def __init__(self, parent=None, reserved_buffer_bytes=0, shared_buffer_bytes=0):
...
class DataflowHostManagement(OpenApiObject):
    ...
    _REQUIRED = ('host_name', 'management_address', 'nic_name') # type: tuple(str)

    _DEFAULTS= {} # type: Dict[str, Union(type)]

    def __init__(self, parent=None, host_name=None, management_address=None, nic_name=None):
        super(DataflowHostManagement, self).__init__()
        self._parent = parent
        self._set_property('host_name', host_name)
        self._set_property('management_address', management_address)
        self._set_property('nic_name', nic_name)
    ...
    def nic_name(self):
        ...
        Returns: str
        """
        return self._get_property('nic_name')

    @nic_name.setter
    def nic_name(self, value):
        """nic_name setter
        ...
        value: str
        """
        self._set_property('nic_name', value)
...
class DataflowHostManagementIter(OpenApiIter):
    ...
    def hostmanagement(self, host_name=None, management_address=None, nic_name=None):
        # type: (str,str,str) -> DataflowHostManagementIter
        ...
        Returns: DataflowHostManagementIter
        """
        item = DataflowHostManagement(parent=self._parent, host_name=host_name, management_address=management_address, nic_name=nic_name)
        self._add(item)
        return self

    def add(self, host_name=None, management_address=None, nic_name=None):
        # type: (str,str,str) -> DataflowHostManagement
...
class DataflowWorkloadItem(OpenApiObject):
    ...
    @property
    def choice(self):
        # type: () -> Union[Literal["all_reduce"], Literal["broadcast"], Literal["compute"], Literal["gather"], Literal["loop"], Literal["scatter"]]
        """choice getter

        The type of workflow item

        Returns: Union[Literal["all_reduce"], Literal["broadcast"], Literal["compute"], Literal["gather"], Literal["loop"], Literal["scatter"]]
        """
        return self._get_property('choice')
    ...
    def choice(self, value):
        ...
        value: Union[Literal["all_reduce"], Literal["broadcast"], Literal["compute"], Literal["gather"], Literal["loop"], Literal["scatter"]]
        """
        self._set_property('choice', value)
    ...
    def all_to_all(self):
        ...
        creates full-mesh flows between all nodescreates full-mesh flows between all nodes

        Returns: DataflowAlltoallWorkload
        """
        return self._get_property('all_to_all', DataflowAlltoallWorkload)
...
class DataflowWorkloadItemIter(OpenApiIter):
    ...
    def __getitem__(self, key):
        # type: (str) -> Union[DataflowAllReduceWorkload, DataflowBroadcastWorkload, DataflowComputeWorkload, DataflowGatherWorkload, DataflowLoopWorkload, DataflowScatterWorkload, DataflowWorkloadItem]
        return self._getitem(key)
...
class DataflowFlowProfile(OpenApiObject):
    ...
    _TYPES = {
        ...
        'ethernet': {'type': 'DataflowFlowProfileEthernet'},
        'l4_protocol_choice': {
            'type': str,
            'enum': [
                'tcp',
        ...
        'tcp': {'type': 'DataflowFlowProfileTcp'},
        'udp': {'type': 'DataflowFlowProfileUdp'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None, name=None, data_size=None, l2_protocol_choice=None, l4_protocol_choice=None):
        super(DataflowFlowProfile, self).__init__()
        self._parent = parent
        self._set_property('name', name)
        self._set_property('data_size', data_size)
        self._set_property('l2_protocol_choice', l2_protocol_choice)
        self._set_property('l4_protocol_choice', l4_protocol_choice)
    ...
    @property
    def l2_protocol_choice(self):
        # type: () -> Union[Literal["ethernet"]]
        """l2_protocol_choice getter

        layer2 protocol selection

        Returns: Union[Literal["ethernet"]]
        """
        return self._get_property('l2_protocol_choice')

    @l2_protocol_choice.setter
    def l2_protocol_choice(self, value):
        """l2_protocol_choice setter

        layer2 protocol selection

        value: Union[Literal["ethernet"]]
        """
        self._set_property('l2_protocol_choice', value)

    @property
    def ethernet(self):
        # type: () -> DataflowFlowProfileEthernet
        """ethernet getter

        

        Returns: DataflowFlowProfileEthernet
        """
        return self._get_property('ethernet', DataflowFlowProfileEthernet)

    @property
    def l4_protocol_choice(self):
        # type: () -> Union[Literal["tcp"], Literal["udp"]]
        """l4_protocol_choice getter

        layer4 protocol selection

        Returns: Union[Literal["tcp"], Literal["udp"]]
        """
        return self._get_property('l4_protocol_choice')

    @l4_protocol_choice.setter
    def l4_protocol_choice(self, value):
        """l4_protocol_choice setter
        ...
        """
        self._set_property('l4_protocol_choice', value)

    @property
    def tcp(self):
        # type: () -> DataflowFlowProfileTcp
        """tcp getter

        

        Returns: DataflowFlowProfileTcp
        """
        return self._get_property('tcp', DataflowFlowProfileTcp)

    @property
    def udp(self):
        # type: () -> DataflowFlowProfileUdp
        """udp getter

        

        Returns: DataflowFlowProfileUdp
        """
        return self._get_property('udp', DataflowFlowProfileUdp)


class DataflowFlowProfileEthernet(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, mtu=1500):
        super(DataflowFlowProfileEthernet, self).__init__()
        self._parent = parent
...
class DataflowFlowProfileTcp(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, congestion_algorithm='cubic', initcwnd=None, send_buf=None, receive_buf=None):
        super(DataflowFlowProfileTcp, self).__init__()
        self._parent = parent
    ...
    def destination_port(self):
        ...
        Layer4 protocol source or destination port valuesLayer4 protocol source or destination port values
...
class DataflowFlowProfileUdp(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None):
        super(DataflowFlowProfileUdp, self).__init__()
        self._parent = parent
...
class DataflowFlowProfileIter(OpenApiIter):
    ...
    def __getitem__(self, key):
        # type: (str) -> Union[DataflowFlowProfile]
        return self._getitem(key)
    ...
    def flowprofile(self, name=None, data_size=None, l2_protocol_choice=None, l4_protocol_choice=None):
        # type: (str,int,Union[Literal["ethernet"]],Union[Literal["tcp"], Literal["udp"]]) -> DataflowFlowProfileIter
        ...
        Returns: DataflowFlowProfileIter
        """
        item = DataflowFlowProfile(parent=self._parent, name=name, data_size=data_size, l2_protocol_choice=l2_protocol_choice, l4_protocol_choice=l4_protocol_choice)
        self._add(item)
        return self

    def add(self, name=None, data_size=None, l2_protocol_choice=None, l4_protocol_choice=None):
        # type: (str,int,Union[Literal["ethernet"]],Union[Literal["tcp"], Literal["udp"]]) -> DataflowFlowProfile
...
class ChaosBackgroundTrafficFlow(OpenApiObject):
    ...
    _TYPES = {
        'name': {'type': str},
        'fabric_entry_point': {'type': 'ChaosBackgroundTrafficFlowEntryPoint'},
        'choice': {
            'type': str,
            'enum': [
                'stateless',
        ...
        'stateless': {'type': 'ChaosBackgroundTrafficFlowStatelessIter'},
    } # type: Dict[str, str]
    ...
    @property
    def fabric_entry_point(self):
        # type: () -> ChaosBackgroundTrafficFlowEntryPoint
        """fabric_entry_point getter

        

        Returns: ChaosBackgroundTrafficFlowEntryPoint
        """
        return self._get_property('fabric_entry_point', ChaosBackgroundTrafficFlowEntryPoint)
    ...
    @property
    def stateless(self):
        # type: () -> ChaosBackgroundTrafficFlowStatelessIter
        """stateless getter

        TBD

        Returns: ChaosBackgroundTrafficFlowStatelessIter
        """
        return self._get_property('stateless', ChaosBackgroundTrafficFlowStatelessIter, self._parent, self._choice)


class ChaosBackgroundTrafficFlowEntryPoint(OpenApiObject):
    __slots__ = ('_parent','_choice')
    ...
    _TYPES = {
        ...
        'switch_reference': {'type': 'ChaosBackgroundTrafficFlowEntryPointSwitchReference'},
        'front_panel_port': {'type': 'ChaosBackgroundTrafficFlowEntryPointFrontPanelPort'},
    } # type: Dict[str, str]
    ...
    SWITCH_REFERENCE = 'switch_reference' # type: str
    FRONT_PANEL_PORT = 'front_panel_port' # type: str

    def __init__(self, parent=None, choice=None):
        super(ChaosBackgroundTrafficFlowEntryPoint, self).__init__()
        self._parent = parent
        if 'choice' in self._DEFAULTS and choice is None:
            getattr(self, self._DEFAULTS['choice'])
        else:
    ...
    def switch_reference(self):
        # type: () -> ChaosBackgroundTrafficFlowEntryPointSwitchReference
        """Factory property that returns an instance of the ChaosBackgroundTrafficFlowEntryPointSwitchReference class

        TBD

        Returns: ChaosBackgroundTrafficFlowEntryPointSwitchReference
        """
        return self._get_property('switch_reference', ChaosBackgroundTrafficFlowEntryPointSwitchReference, self, 'switch_reference')

    @property
    def front_panel_port(self):
        # type: () -> ChaosBackgroundTrafficFlowEntryPointFrontPanelPort
        """Factory property that returns an instance of the ChaosBackgroundTrafficFlowEntryPointFrontPanelPort class

        TBD

        Returns: ChaosBackgroundTrafficFlowEntryPointFrontPanelPort
        """
        return self._get_property('front_panel_port', ChaosBackgroundTrafficFlowEntryPointFrontPanelPort, self, 'front_panel_port')

    @property
    def choice(self):
        # type: () -> Union[Literal["front_panel_port"], Literal["switch_reference"]]
        """choice getter

        TBD

        Returns: Union[Literal["front_panel_port"], Literal["switch_reference"]]
        """
        return self._get_property('choice')
    ...
    def choice(self, value):
        ...
        value: Union[Literal["front_panel_port"], Literal["switch_reference"]]
        """
        self._set_property('choice', value)


class ChaosBackgroundTrafficFlowEntryPointSwitchReference(OpenApiObject):
    __slots__ = ('_parent','_choice')
    ...
    _TYPES = {
        ...
        'spine': {'type': 'ChaosBackgroundTrafficFlowEntryPointSwitchReferenceSpine'},
        'pod': {'type': 'ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference'},
        'tor': {'type': 'ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None, choice=None):
        super(ChaosBackgroundTrafficFlowEntryPointSwitchReference, self).__init__()
        self._parent = parent
        if 'choice' in self._DEFAULTS and choice is None:
            getattr(self, self._DEFAULTS['choice'])
        else:
    ...
    @property
    def spine(self):
        # type: () -> ChaosBackgroundTrafficFlowEntryPointSwitchReferenceSpine
        """Factory property that returns an instance of the ChaosBackgroundTrafficFlowEntryPointSwitchReferenceSpine class

        TBD

        Returns: ChaosBackgroundTrafficFlowEntryPointSwitchReferenceSpine
        """
        return self._get_property('spine', ChaosBackgroundTrafficFlowEntryPointSwitchReferenceSpine, self, 'spine')

    @property
    def pod(self):
        # type: () -> ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference
        """Factory property that returns an instance of the ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference class

        TBD

        Returns: ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference
        """
        return self._get_property('pod', ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference, self, 'pod')
    ...
    def tor(self):
        ...
        Returns: ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference
        """
        return self._get_property('tor', ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference, self, 'tor')
...
class ChaosBackgroundTrafficFlowEntryPointSwitchReferenceSpine(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'switch_index': {'type': int},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None, switch_index=None):
        super(ChaosBackgroundTrafficFlowEntryPointSwitchReferenceSpine, self).__init__()
        self._parent = parent
        self._set_property('switch_index', switch_index)
...
class ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, pod_index=None, switch_index=None):
        super(ChaosBackgroundTrafficFlowEntryPointSwitchReferencePodSwitchReference, self).__init__()
        self._parent = parent
        self._set_property('pod_index', pod_index)
        self._set_property('switch_index', switch_index)
...
class ChaosBackgroundTrafficFlowEntryPointFrontPanelPort(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, front_panel_port=None):
        super(ChaosBackgroundTrafficFlowEntryPointFrontPanelPort, self).__init__()
        self._parent = parent
        self._set_property('front_panel_port', front_panel_port)
...
class ChaosBackgroundTrafficFlowStateless(OpenApiObject):
    ...
    def __init__(self, parent=None, name=None, rate=None, rate_unit=None):
        super(ChaosBackgroundTrafficFlowStateless, self).__init__()
        self._parent = parent
        self._set_property('name', name)
        self._set_property('rate', rate)
        self._set_property('rate_unit', rate_unit)
    ...
    @property
    def rate_unit(self):
        # type: () -> Union[Literal["Gbps"], Literal["Kbps"], Literal["Mbps"], Literal["bps"]]
        """rate_unit getter

        TBD

        Returns: Union[Literal["Gbps"], Literal["Kbps"], Literal["Mbps"], Literal["bps"]]
        """
        return self._get_property('rate_unit')
    ...
    def rate_unit(self, value):
        ...
        value: Union[Literal["Gbps"], Literal["Kbps"], Literal["Mbps"], Literal["bps"]]
        """
        self._set_property('rate_unit', value)
...
class ChaosBackgroundTrafficFlowStatelessIter(OpenApiIter):
    __slots__ = ('_parent', '_choice')

    _GETITEM_RETURNS_CHOICE_OBJECT = False

    def __init__(self, parent=None, choice=None):
        super(ChaosBackgroundTrafficFlowStatelessIter, self).__init__()
        self._parent = parent
        self._choice = choice

    def __getitem__(self, key):
        # type: (str) -> Union[ChaosBackgroundTrafficFlowStateless]
        return self._getitem(key)
    ...
    def stateless(self, name=None, rate=None, rate_unit=None):
        # type: (str,int,Union[Literal["Gbps"], Literal["Kbps"], Literal["Mbps"], Literal["bps"]]) -> ChaosBackgroundTrafficFlowStatelessIter
        """Factory method that creates an instance of the ChaosBackgroundTrafficFlowStateless class

        TBD

        Returns: ChaosBackgroundTrafficFlowStatelessIter
        """
        item = ChaosBackgroundTrafficFlowStateless(parent=self._parent, name=name, rate=rate, rate_unit=rate_unit)
        self._add(item)
        return self

    def add(self, name=None, rate=None, rate_unit=None):
        # type: (str,int,Union[Literal["Gbps"], Literal["Kbps"], Literal["Mbps"], Literal["bps"]]) -> ChaosBackgroundTrafficFlowStateless
        """Add method that creates and returns an instance of the ChaosBackgroundTrafficFlowStateless class
...
class ChaosBackgroundTrafficFlowIter(OpenApiIter):
    ...
    def __getitem__(self, key):
        # type: (str) -> Union[ChaosBackgroundTrafficFlow]
        return self._getitem(key)
    ...
    def flow(self, name=None):
        # type: (str) -> ChaosBackgroundTrafficFlowIter
        ...
        Returns: ChaosBackgroundTrafficFlowIter
        """
        item = ChaosBackgroundTrafficFlow(parent=self._parent, choice=self._choice, name=name)
        self._add(item)
        return self

    def add(self, name=None):
        # type: (str) -> ChaosBackgroundTrafficFlow
