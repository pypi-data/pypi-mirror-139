...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html)
...
from .literals import AssetTypeType, TypeType
...
class DataExchangeClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#can_paginate)
        """
    ...
    async def cancel_job(self, *, JobId: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#cancel_job)
        """
    ...
    async def create_data_set(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#create_data_set)
        """
    ...
    async def create_event_action(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#create_event_action)
        """
    ...
    async def create_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#create_job)
        """

    async def create_revision(
        self, *, DataSetId: str, Comment: str = ..., Tags: Mapping[str, str] = ...
    ) -> CreateRevisionResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#create_revision)
        """

    async def delete_asset(self, *, AssetId: str, DataSetId: str, RevisionId: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#delete_asset)
        """

    async def delete_data_set(self, *, DataSetId: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#delete_data_set)
        """

    async def delete_event_action(self, *, EventActionId: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#delete_event_action)
        """

    async def delete_revision(self, *, DataSetId: str, RevisionId: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#delete_revision)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#generate_presigned_url)
        """
    ...
    async def get_asset(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#get_asset)
        """

    async def get_data_set(self, *, DataSetId: str) -> GetDataSetResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#get_data_set)
        """

    async def get_event_action(self, *, EventActionId: str) -> GetEventActionResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#get_event_action)
        """

    async def get_job(self, *, JobId: str) -> GetJobResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#get_job)
        """

    async def get_revision(self, *, DataSetId: str, RevisionId: str) -> GetRevisionResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#get_revision)
        """
    ...
    async def list_data_set_revisions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#list_data_set_revisions)
        """

    async def list_data_sets(
        self, *, MaxResults: int = ..., NextToken: str = ..., Origin: str = ...
    ) -> ListDataSetsResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#list_data_sets)
        """

    async def list_event_actions(
        self, *, EventSourceId: str = ..., MaxResults: int = ..., NextToken: str = ...
    ) -> ListEventActionsResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#list_event_actions)
        """
    ...
    async def list_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#list_jobs)
        """

    async def list_revision_assets(
        self, *, DataSetId: str, RevisionId: str, MaxResults: int = ..., NextToken: str = ...
    ) -> ListRevisionAssetsResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#list_revision_assets)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#list_tags_for_resource)
        """
    ...
    async def send_api_asset(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#send_api_asset)
        """

    async def start_job(self, *, JobId: str) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#start_job)
        """
    ...
    async def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#untag_resource)
        """
    ...
    async def update_asset(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#update_asset)
        """

    async def update_data_set(
        self, *, DataSetId: str, Description: str = ..., Name: str = ...
    ) -> UpdateDataSetResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#update_data_set)
        """

    async def update_event_action(
        self, *, EventActionId: str, Action: "ActionTypeDef" = ...
    ) -> UpdateEventActionResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#update_event_action)
        """

    async def update_revision(
        self, *, DataSetId: str, RevisionId: str, Comment: str = ..., Finalized: bool = ...
    ) -> UpdateRevisionResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#update_revision)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_dataexchange/client.html#get_paginator)
        """
