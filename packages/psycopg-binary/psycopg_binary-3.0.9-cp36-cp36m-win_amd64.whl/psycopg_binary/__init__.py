...
def _delvewheel_init_patch_0_0_19():
    import os
    import sys
    ...
    if sys.version_info[:2] >= (3, 8):
        ...
        with open(os.path.join(libs_dir, '.load-order-psycopg_binary-3.0.9')) as file:
            load_order = file.read().split()
        for lib in load_order:
            WinDLL(os.path.join(libs_dir, lib))


_delvewheel_init_patch_0_0_19()
del _delvewheel_init_patch_0_0_19
