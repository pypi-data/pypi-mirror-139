...
class AuditSerializerMixin:
    ...
    created_by_name = serializers.SlugRelatedField(slug_field="username", source=created_by_field_name, read_only=True)
    updated_by_name = serializers.SlugRelatedField(slug_field="username", source=updated_by_field_name, read_only=True)
