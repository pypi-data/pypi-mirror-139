...
[aiobotocore.Neptune 2.1.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/neptune.html#Neptune)
...
[types-aiobotocore-neptune docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_neptune/)
...
`types_aiobotocore_neptune.waiter` module contains type annotations for all waiters.
...
`types_aiobotocore_neptune.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

```python
from types_aiobotocore_neptune.literals import (
    ApplyMethodType,
...
[aiobotocore docs](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_neptune/)
