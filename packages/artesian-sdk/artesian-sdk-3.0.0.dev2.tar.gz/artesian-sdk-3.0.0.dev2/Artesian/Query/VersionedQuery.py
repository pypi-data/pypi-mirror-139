...
class VersionedQuery(_Query):
    ...
    def forMUV(self) -> VersionedQuery:
        ...
        return self
    def forLastOfDays(self, start: str, end: str =None) -> VersionedQuery:
        ...
        return self
    def forLastOfMonths(self, start: str, end: str =None) -> VersionedQuery:
    ...
    def forVersion(self, version: str) -> VersionedQuery:
        ...
        return self
    def forMostRecent(self, start: str, end: str=None) -> VersionedQuery:
