...
class ActualQuery(_Query):
    ...
    def forMarketData(self, ids: List[int]) -> ActualQuery:
        ...
        return self
    def forFilterId(self, filterId: int) -> ActualQuery:
        """ 
        ...
        return self
    def inTimeZone(self, tz: str) -> ActualQuery:
        """ 
        ...
        return self
    def inAbsoluteDateRange(self, start: str, end: str) -> ActualQuery:
        """ 
        ...
        return self
    def inRelativePeriodRange(self, pStart: str, pEnd: str) -> ActualQuery:
        """ 
        ...
        return self
    def inRelativePeriod(self, extractionPeriod: str) -> ActualQuery:
        """ 
        ...
        return self
    def inRelativeInterval(self, relativeInterval: RelativeInterval) -> ActualQuery:
        """ 
        ...
        return self
    def withTimeTransform(self, tr: str) -> ActualQuery:
        """ 
        ...
        return self
    def inGranularity(self, granularity: Granularity) -> ActualQuery:
        """ 
        ...
        return self
    def withFillNull(self) -> ActualQuery:
        """ 
