...
class AdiEmsWebApiV2DtoNavigationNavigationProcedureSegment(Model):
    ...
    def __init__(self, *, type: str=None, transition_id: str=None, sequence_number: int=None, track_code: str=None, waypoint_id: int=None, waypoint_desc_codes=None, waypoint_bearing: float=None, waypoint_distance: float=None, navaids=None, turn_direction: str=None, altitude_description: str=None, altitude1: str=None, altitude2: str=None, **kwargs) -> None:
