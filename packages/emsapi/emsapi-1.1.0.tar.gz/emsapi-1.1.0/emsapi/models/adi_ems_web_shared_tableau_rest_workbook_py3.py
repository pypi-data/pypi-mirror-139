...
class AdiEmsWebSharedTableauRestWorkbook(Model):
    ...
    def __init__(self, *, id: str=None, name: str=None, content_url: str=None, show_tabs: bool=None, size: int=None, created_at=None, updated_at=None, project=None, owner=None, tags=None, views=None, **kwargs) -> None:
