...
class AdiEmsWebApiV2ModelAnalyticQuery(Model):
    ...
    def __init__(self, *, select, start: float=None, end: float=None, offsets=None, size: int=None, unsampled_data_mode=None, unsampled_value: str=None, does_not_exist_value: str=None, offset_type=None, discretes_as_strings: bool=None, **kwargs) -> None:
