...
export type GDPSControllerState = {
  renderView: string;
};

export type GDPSControllerProps = {
  serverAddress: string;
  gdpsPort: string;
  jupyterApp: JupyterFrontEnd;
  hostOS: string;
...
export type GDPSInstallerState = {
  renderView: string;
  ...
  sshUsername: string;
  sshKeyfile: string;
  tg_cluster_mode: boolean;
};

export type GDPSInstallerProps = {
  serverAddress: string;
  jupyterApp: JupyterFrontEnd;
  hostOS: string;
  restPort: string;
...
export type SSHFormProps = {
  update: (state: { sshUsername: string; sshKeyfile: string }) => void;
};
