...
VERSION = "3.9.0a1645193195"
PLUGIN_VERSION = "3.9.0-alpha.1645193195+183dff85"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the openstack resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource openstack {PLUGIN_VERSION}`
                """)
            else:
                raise
...
def readme():
    try:
        ...
        return "openstack Pulumi Package - Development Version"
