...
class CustomRolesBetaApi(object):
    ...
    def delete(self, role_name, **kwargs):  # noqa: E501
        """Delete a Role  # noqa: E501

        Delete a role for your organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(role_name, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_with_http_info(role_name, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_with_http_info(role_name, **kwargs)  # noqa: E501
            return data

    def delete_with_http_info(self, role_name, **kwargs):  # noqa: E501
        """Delete a Role  # noqa: E501

        Delete a role for your organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_with_http_info(role_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('role_name' not in params or
            ...
            raise ValueError("Missing the required parameter `role_name` when calling `delete`")  # noqa: E501
    ...
    def update(self, role_name, body, **kwargs):  # noqa: E501
        """Update a Role  # noqa: E501

        Update a role for your organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(role_name, body, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_with_http_info(role_name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_with_http_info(role_name, body, **kwargs)  # noqa: E501
            return data

    def update_with_http_info(self, role_name, body, **kwargs):  # noqa: E501
        """Update a Role  # noqa: E501

        Update a role for your organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_with_http_info(role_name, body, async_req=True)
        >>> result = thread.get()
        ...
        if ('role_name' not in params or
                params['role_name'] is None):
            raise ValueError("Missing the required parameter `role_name` when calling `update`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
