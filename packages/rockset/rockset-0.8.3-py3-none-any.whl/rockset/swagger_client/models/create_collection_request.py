...
from rockset.swagger_client.models.field_mapping_query import FieldMappingQuery  # noqa: F401,E501
...
class CreateCollectionRequest(object):
    ...
    def __init__(self, name, **kwargs):  # noqa: E501
        ...
        self.time_partition_resolution_secs = kwargs.pop('time_partition_resolution_secs', None)
        self.insert_only = kwargs.pop('insert_only', None)
        self.event_time_info = kwargs.pop('event_time_info', None)
        self.field_mappings = kwargs.pop('field_mappings', None)
        self.field_mapping_query = kwargs.pop('field_mapping_query', None)
