...
incoming = {
    "archive_data_output": {
        "Output": {
            "archive_file": {
                "Payload": {
                    "archived_key": "OISST/oisst-avhrr-v02r01.20200401.nc",
                    "archived_bucket": "ncap-archive-dev-nccf-archive",
                    "checksum": 12345,
                    "s3_uri": "s3://ncap-archive-dev-nccf-archive/OISST/oisst-avhrr-v02r01.20200401.nc"
                }
            }
        }
    }
...
new_iri = graph.build_aiu(result, root_iri, "", f"-{str(uuid4())}", incoming)
print(new_iri)
