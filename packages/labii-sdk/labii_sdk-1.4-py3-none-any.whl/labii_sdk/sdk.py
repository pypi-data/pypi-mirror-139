...
class LabiiObject:
    ...
    class APIResource:
        ...
        def create(self, data):
            ...
            """
            return self.instance.api.post(self.instance.api.get_list_url(self.app, self.model, serializer="detail"), data)

        def retrieve(self, sid):
            """ Return an object """
            return self.instance.api.get(self.instance.api.get_detail_url(self.app, self.model, sid=sid))
        ...
        def modify(self, sid, data):
            """
                ...
                - data (dict), the object data
            """
            return self.instance.api.patch(self.instance.api.get_detail_url(self.app, self.model, sid=sid), data)


        def delete(self, sid):
            """ Delete a object """
            self.instance.api.delete(self.instance.api.get_detail_url(self.app, self.model, sid=sid))
