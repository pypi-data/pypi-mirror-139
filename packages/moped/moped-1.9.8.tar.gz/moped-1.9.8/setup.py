...
['Meneco==1.5.3',
 'PyYAML>=6.0,<7.0',
 'cobra>=0.22.1,<0.23.0',
 'cycparser>=1.0.0,<2.0.0',
 'gitchangelog>=3.0.4,<4.0.0',
 'modelbase>=1.5.2,<2.0.0',
 'numpy>=1.21.4,<2.0.0',
 'pandas>=1.3.4,<2.0.0',
 'pipdeptree>=2,<3',
 'pyasp>=1.4.4,<2.0.0',
