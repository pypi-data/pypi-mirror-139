...
class LongIterWarning(PSPrintWarning):
    """
    Warning that the iterator has too many elements (>100)
    """


class DeepIterWarning(PSPrintWarning):
    """
    Warning that the iterator has too much of recursion (>10)
    """
