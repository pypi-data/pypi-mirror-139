...
*DefaultApi* | [**auth_grafana_api_v2_observability_auth_auth_grafana_get**](docs/DefaultApi.md#auth_grafana_api_v2_observability_auth_auth_grafana_get) | **GET** /api/v2/observability_auth/auth_grafana | Auth Grafana
*DefaultApi* | [**auth_observability_tenant_api_v2_observability_auth_auth_observability_tenant_get**](docs/DefaultApi.md#auth_observability_tenant_api_v2_observability_auth_auth_observability_tenant_get) | **GET** /api/v2/observability_auth/auth_observability_tenant | Auth Observability Tenant
...
*DefaultApi* | [**create_service_api_v2_decorated_ha_jobs_create_service_post**](docs/DefaultApi.md#create_service_api_v2_decorated_ha_jobs_create_service_post) | **POST** /api/v2/decorated_ha_jobs/create_service | Create Service
...
*DefaultApi* | [**get_anyscaled_config_api_v2_anyscaled_config_get**](docs/DefaultApi.md#get_anyscaled_config_api_v2_anyscaled_config_get) | **GET** /api/v2/anyscaled/config | Get Anyscaled Config
*DefaultApi* | [**get_anyscaled_dataplane_config_api_v2_anyscaled_instance_id_dataplane_config_get**](docs/DefaultApi.md#get_anyscaled_dataplane_config_api_v2_anyscaled_instance_id_dataplane_config_get) | **GET** /api/v2/anyscaled/{instance_id}/dataplane_config | Get Anyscaled Dataplane Config
...
*DefaultApi* | [**get_decorated_actor_api_v2_decorated_actors_actor_id_get**](docs/DefaultApi.md#get_decorated_actor_api_v2_decorated_actors_actor_id_get) | **GET** /api/v2/decorated_actors/{actor_id} | Get Decorated Actor
*DefaultApi* | [**get_decorated_actor_logs_api_v2_decorated_actors_actor_id_logs_get**](docs/DefaultApi.md#get_decorated_actor_logs_api_v2_decorated_actors_actor_id_logs_get) | **GET** /api/v2/decorated_actors/{actor_id}/logs | Get Decorated Actor Logs
...
*DefaultApi* | [**get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post**](docs/DefaultApi.md#get_or_create_cluster_monitor_api_v2_sessions_session_id_get_or_create_cluster_monitor_post) | **POST** /api/v2/sessions/{session_id}/get_or_create_cluster_monitor | Get Or Create Cluster Monitor
...
*DefaultApi* | [**list_billing_api_v2_clouds_gcp_list_billing_get**](docs/DefaultApi.md#list_billing_api_v2_clouds_gcp_list_billing_get) | **GET** /api/v2/clouds/gcp/list_billing | List Billing
...
*DefaultApi* | [**list_decorated_actors_api_v2_decorated_actors_get**](docs/DefaultApi.md#list_decorated_actors_api_v2_decorated_actors_get) | **GET** /api/v2/decorated_actors/ | List Decorated Actors
...
*DefaultApi* | [**list_decorated_serve_replicas_api_v2_decorated_serve_replicas_get**](docs/DefaultApi.md#list_decorated_serve_replicas_api_v2_decorated_serve_replicas_get) | **GET** /api/v2/decorated_serve_replicas/ | List Decorated Serve Replicas
...
*DefaultApi* | [**list_historical_costs_for_clouds_api_v2_historical_costs_organization_id_cloud_get**](docs/DefaultApi.md#list_historical_costs_for_clouds_api_v2_historical_costs_organization_id_cloud_get) | **GET** /api/v2/historical_costs/{organization_id}/cloud | List Historical Costs For Clouds
*DefaultApi* | [**list_historical_costs_for_clusters_api_v2_historical_costs_organization_id_cluster_get**](docs/DefaultApi.md#list_historical_costs_for_clusters_api_v2_historical_costs_organization_id_cluster_get) | **GET** /api/v2/historical_costs/{organization_id}/cluster | List Historical Costs For Clusters
*DefaultApi* | [**list_historical_costs_for_jobs_api_v2_historical_costs_organization_id_job_get**](docs/DefaultApi.md#list_historical_costs_for_jobs_api_v2_historical_costs_organization_id_job_get) | **GET** /api/v2/historical_costs/{organization_id}/job | List Historical Costs For Jobs
*DefaultApi* | [**list_historical_costs_for_org_api_v2_historical_costs_organization_id_org_get**](docs/DefaultApi.md#list_historical_costs_for_org_api_v2_historical_costs_organization_id_org_get) | **GET** /api/v2/historical_costs/{organization_id}/org | List Historical Costs For Org
*DefaultApi* | [**list_historical_costs_for_projects_api_v2_historical_costs_organization_id_project_get**](docs/DefaultApi.md#list_historical_costs_for_projects_api_v2_historical_costs_organization_id_project_get) | **GET** /api/v2/historical_costs/{organization_id}/project | List Historical Costs For Projects
*DefaultApi* | [**list_historical_costs_for_resource_types_api_v2_historical_costs_organization_id_resource_type_get**](docs/DefaultApi.md#list_historical_costs_for_resource_types_api_v2_historical_costs_organization_id_resource_type_get) | **GET** /api/v2/historical_costs/{organization_id}/resource_type | List Historical Costs For Resource Types
*DefaultApi* | [**list_historical_costs_for_users_api_v2_historical_costs_organization_id_user_get**](docs/DefaultApi.md#list_historical_costs_for_users_api_v2_historical_costs_organization_id_user_get) | **GET** /api/v2/historical_costs/{organization_id}/user | List Historical Costs For Users
...
*DefaultApi* | [**list_organizations_api_v2_clouds_gcp_organizations_get**](docs/DefaultApi.md#list_organizations_api_v2_clouds_gcp_organizations_get) | **GET** /api/v2/clouds/gcp/organizations | List Organizations
...
## Documentation For Models
 ...
 - [AnyscaledConfig](docs/AnyscaledConfig.md)
 - [AnyscaledDataplaneConfig](docs/AnyscaledDataplaneConfig.md)
 - [AnyscaledconfigResponse](docs/AnyscaledconfigResponse.md)
 - [AnyscaleddataplaneconfigResponse](docs/AnyscaleddataplaneconfigResponse.md)
 ...
 - [ClusterMonitorResponse](docs/ClusterMonitorResponse.md)
 ...
 - [ClustermonitorresponseResponse](docs/ClustermonitorresponseResponse.md)
 ...
 - [DecoratedActor](docs/DecoratedActor.md)
 ...
 - [DecoratedactorListResponse](docs/DecoratedactorListResponse.md)
 - [DecoratedactorResponse](docs/DecoratedactorResponse.md)
 ...
 - [ResourceHistoricalCosts](docs/ResourceHistoricalCosts.md)
 ...
 - [ServeReplica](docs/ServeReplica.md)
 - [ServeReplicaMetric](docs/ServeReplicaMetric.md)
 - [ServedeploymentlogsResponse](docs/ServedeploymentlogsResponse.md)
 - [ServerSessionToken](docs/ServerSessionToken.md)
 - [ServereplicaListResponse](docs/ServereplicaListResponse.md)
